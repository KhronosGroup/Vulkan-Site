...
[](#VUID-VkPhysicalDeviceVideoFormatInfoKHR-pNext-pNext) VUID-VkPhysicalDeviceVideoFormatInfoKHR-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html) or [VkVideoProfileListInfoKHR](VkVideoProfileListInfoKHR.html)
