# VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT.html
...
[VK_QUERY_TYPE_PRIMITIVES_GENERATED_EXT](VkQueryType.html) query type.

* 

`primitivesGeneratedQueryWithRasterizerDiscard` indicates whether
the implementation supports this query when
[rasterization discard](../../../../spec/latest/chapters/primsrast.html#primsrast-discard) is enabled.
...
[](#VUID-VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT-sType-sType) VUID-VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVES_GENERATED_QUERY_FEATURES_EXT](VkStructureType.html)
...
[VK_EXT_primitives_generated_query](VK_EXT_primitives_generated_query.html), `VkBool32`, [VkStructureType](VkStructureType.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT).
