...
an access type of [VK_ACCESS_TRANSFER_READ_BIT](VkAccessFlagBits.html).

This command **can** accept micromaps produced by either
[vkCopyMicromapToMemoryEXT](vkCopyMicromapToMemoryEXT.html) or [vkCmdCopyMicromapToMemoryEXT](vkCmdCopyMicromapToMemoryEXT.html).
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMemoryToMicromapEXT).
