...
[`maxUniformBufferRange`](../../../../spec/latest/chapters/limits.html#limits-maxUniformBufferRange)
...
`data->pAddressRange→size` **must** be less than or equal to
[`maxStorageBufferRange`](../../../../spec/latest/chapters/limits.html#limits-maxStorageBufferRange)
...
[effective `usage`](../../../../spec/latest/chapters/resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](VkImageViewCreateInfo.html) **must** include the
[VK_IMAGE_USAGE_SAMPLED_BIT](VkImageUsageFlagBits.html) usage flag
...
[effective `usage`](../../../../spec/latest/chapters/resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](VkImageViewCreateInfo.html) **must** include the
[VK_IMAGE_USAGE_STORAGE_BIT](VkImageUsageFlagBits.html) usage flag
...
[effective `usage`](../../../../spec/latest/chapters/resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](VkImageViewCreateInfo.html) **must** include the
[VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT](VkImageUsageFlagBits.html) usage flag

[](#VUID-VkResourceDescriptorInfoEXT-type-12498) VUID-VkResourceDescriptorInfoEXT-type-12498

If `type` is [VK_DESCRIPTOR_TYPE_SAMPLE_WEIGHT_IMAGE_QCOM](VkDescriptorType.html) and
`data.pImage` is not `NULL`, the
[effective `usage`](../../../../spec/latest/chapters/resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](VkImageViewCreateInfo.html) **must** include the
[VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM](VkImageUsageFlagBits.html) usage flag

[](#VUID-VkResourceDescriptorInfoEXT-type-12499) VUID-VkResourceDescriptorInfoEXT-type-12499

If `type` is [VK_DESCRIPTOR_TYPE_BLOCK_MATCH_IMAGE_QCOM](VkDescriptorType.html) and
`data.pImage` is not `NULL`, the
[effective `usage`](../../../../spec/latest/chapters/resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](VkImageViewCreateInfo.html) **must** include the
[VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM](VkImageUsageFlagBits.html) usage flag
