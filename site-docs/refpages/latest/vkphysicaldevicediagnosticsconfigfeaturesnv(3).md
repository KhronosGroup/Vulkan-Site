# VkPhysicalDeviceDiagnosticsConfigFeaturesNV(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceDiagnosticsConfigFeaturesNV.html
...
[](#VUID-VkPhysicalDeviceDiagnosticsConfigFeaturesNV-sType-sType) VUID-VkPhysicalDeviceDiagnosticsConfigFeaturesNV-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV](VkStructureType.html)
...
[VK_NV_device_diagnostics_config](VK_NV_device_diagnostics_config.html), `VkBool32`, [VkStructureType](VkStructureType.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceDiagnosticsConfigFeaturesNV).
