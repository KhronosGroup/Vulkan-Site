...
When creating a [VkImageView](VkImageView.html), if `image` was created with
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](VkImageCreateFlagBits.html), and the image `format` is a
[multi-planar format](../../../../spec/latest/chapters/formats.html#formats-multiplanar), then `aspectMask` **can** be
set to one of the [multi-planar aspect](../../../../spec/latest/chapters/formats.html#formats-multiplanar-image-aspect)
bits.

When creating a [VkImageView](VkImageView.html), if `image` was created with an
[Android hardware buffer external format](../../../../spec/latest/chapters/memory.html#memory-external-android-hardware-buffer-external-formats), then `aspectMask` **must** equal
...
[descriptor](../../../../spec/latest/chapters/descriptors.html#descriptors) (e.g. for sampling in the shader, or for use as
...
[multi-planar aspect mask](../../../../spec/latest/chapters/formats.html#formats-multiplanar-image-aspect) bits
