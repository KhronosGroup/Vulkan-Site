...
* 
`requiresDedicatedAllocation` will be [VK_TRUE](VK_TRUE.html) if the
[VkTensorDescriptionARM](VkTensorDescriptionARM.html)::`tiling` provided via the
[VkTensorCreateInfoARM](VkTensorCreateInfoARM.html) structure for the call to
[vkCreateTensorARM](vkCreateTensorARM.html) used to create the tensor being queried was
