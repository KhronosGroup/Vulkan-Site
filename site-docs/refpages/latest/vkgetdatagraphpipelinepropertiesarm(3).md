...
[VkDataGraphPipelinePropertyQueryResultARM](VkDataGraphPipelinePropertyQueryResultARM.html) whose `property`
member is
...
[VkDataGraphPipelineNeuralStatisticsCreateInfoARM](VkDataGraphPipelineNeuralStatisticsCreateInfoARM.html) whose
`allowNeuralStatistics` member was [VK_TRUE](VK_TRUE.html) included in the
`pNext` chain of [VkDataGraphPipelineCreateInfoARM](VkDataGraphPipelineCreateInfoARM.html).
