...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_KHR_win32_surface.html
...
the `[VK_KHR_surface](VK_KHR_surface.html)` extension) that refers to a Win32 `HWND`, as
well as a query to determine support for rendering to the windows desktop.

* 
[vkCreateWin32SurfaceKHR](vkCreateWin32SurfaceKHR.html)

* 
[vkGetPhysicalDeviceWin32PresentationSupportKHR](vkGetPhysicalDeviceWin32PresentationSupportKHR.html)

* 
[VkWin32SurfaceCreateInfoKHR](VkWin32SurfaceCreateInfoKHR.html)

* 
[VkWin32SurfaceCreateFlagsKHR](VkWin32SurfaceCreateFlagsKHR.html)
...
window object can prevent [vkCreateSwapchainKHR](vkCreateSwapchainKHR.html) from succeeding on
the same window object.

* 
Creating then destroying a [VkSwapchainKHR](VkSwapchainKHR.html) on a window object can
...
* 
Creating then destroying a [VkSwapchainKHR](VkSwapchainKHR.html) on a window object on
one [VkPhysicalDevice](VkPhysicalDevice.html) can prevent [vkCreateSwapchainKHR](vkCreateSwapchainKHR.html) from
succeeding on the same window object, but on a different
[VkPhysicalDevice](VkPhysicalDevice.html) that is associated with a different Vulkan ICD.
...
implementation to create a [VkSwapchainKHR](VkSwapchainKHR.html) over the same window
object.
...
* 
Creating a [VkSwapchainKHR](VkSwapchainKHR.html) over a window object can alter the
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_KHR_win32_surface).
