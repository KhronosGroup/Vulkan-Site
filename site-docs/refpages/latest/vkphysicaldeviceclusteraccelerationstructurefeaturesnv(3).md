# VkPhysicalDeviceClusterAccelerationStructureFeaturesNV(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceClusterAccelerationStructureFeaturesNV.html
...
[](#VUID-VkPhysicalDeviceClusterAccelerationStructureFeaturesNV-sType-sType) VUID-VkPhysicalDeviceClusterAccelerationStructureFeaturesNV-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_FEATURES_NV](VkStructureType.html)
...
[VK_NV_cluster_acceleration_structure](VK_NV_cluster_acceleration_structure.html), `VkBool32`, [VkStructureType](VkStructureType.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceClusterAccelerationStructureFeaturesNV).
