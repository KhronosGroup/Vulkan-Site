# VkPhysicalDeviceImageAlignmentControlFeaturesMESA(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceImageAlignmentControlFeaturesMESA.html
...
that [VkImageAlignmentControlCreateInfoMESA](VkImageAlignmentControlCreateInfoMESA.html) **can** be chained in
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceImageAlignmentControlFeaturesMESA).
