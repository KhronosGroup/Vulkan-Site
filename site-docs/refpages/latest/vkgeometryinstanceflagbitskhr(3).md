...
* 
[VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR](#) forces
the micromap format to 2 state mode as described in
[traversal](../../../../spec/latest/chapters/raytraversal.html#ray-opacity-micromap).

* 
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](#) disables
any opacity micromaps referenced by acceleration structures referenced
by this instance as described in [traversal](../../../../spec/latest/chapters/raytraversal.html#ray-opacity-micromap).
