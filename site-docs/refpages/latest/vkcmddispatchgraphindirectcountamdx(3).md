...
[VK_ACCESS_2_SHADER_STORAGE_READ_BIT](VkAccessFlagBits2.html) access flag.
...
with the [VK_BUFFER_USAGE_EXECUTION_GRAPH_SCRATCH_BIT_AMDX](VkBufferUsageFlagBits.html)
or [VK_BUFFER_USAGE_2_EXECUTION_GRAPH_SCRATCH_BIT_AMDX](VkBufferUsageFlagBits2.html)
usage flags set
...
created with the [VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT](VkBufferUsageFlagBits.html) usage flag
set
