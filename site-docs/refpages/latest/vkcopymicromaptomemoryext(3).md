...
To copy a [VkMicromapEXT](VkMicromapEXT.html) to host accessible memory, call:

|  | This functionality is superseded by [vkCmdCopyMicromapToMemoryEXT](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapToMemoryEXT). See [Legacy Functionality](../../../../spec/latest/appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
for use with either [vkCmdCopyMemoryToMicromapEXT](vkCmdCopyMemoryToMicromapEXT.html) or
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCopyMicromapToMemoryEXT).
