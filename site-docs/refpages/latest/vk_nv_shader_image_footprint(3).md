...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_NV_shader_image_footprint.html
...
[VkPhysicalDeviceShaderImageFootprintFeaturesNV](VkPhysicalDeviceShaderImageFootprintFeaturesNV.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_NV_shader_image_footprint).
