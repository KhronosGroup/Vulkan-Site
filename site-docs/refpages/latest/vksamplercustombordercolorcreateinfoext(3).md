...
specified custom border color when used on [VK_QUEUE_COMPUTE_BIT](VkQueueFlagBits.html) queues
that do not also support [VK_QUEUE_GRAPHICS_BIT](VkQueueFlagBits.html).
