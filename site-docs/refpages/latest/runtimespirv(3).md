...
supported [VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) as described above, or
one of the supported [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html) returned by
a query with [VkPhysicalDeviceCooperativeMatrixInfo2EXT](VkPhysicalDeviceCooperativeMatrixInfo2EXT.html) specifying
...
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`MGranularity` and the
number of columns **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`KGranularity` and the
type **must** match [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`AType`

* 
for `MatrixB`, the number of rows **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`KGranularity` and the
number of columns **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`NGranularity` and the
type **must** match [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`BType`
...
number of columns **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`NGranularity` and the
type **must** match [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`CType`
or [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`ResultType`

* 
if the scope is [VK_SCOPE_WORKGROUP_KHR](VkScopeKHR.html), the number of invocations
in the local workgroup **must** match
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](VkPhysicalDeviceCooperativeMatrixInfo2EXT.html)::`invocations`
...
or [VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](VkShaderCreateFlagBitsEXT.html)
set, or if the SPIR-V module is version 1.6 or later and no structure
specifying a required subgroup size was chained,
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](VkPhysicalDeviceCooperativeMatrixInfo2EXT.html)::`subgroupSize`
**must** be `0`
...
if the [     `cooperativeMatrixFlexibleDimensions`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixFlexibleDimensions) feature is not enabled, the
...
supported [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html) returned by a query
with [VkPhysicalDeviceCooperativeMatrixInfo2EXT](VkPhysicalDeviceCooperativeMatrixInfo2EXT.html) specifying the
...
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`MGranularity`,
`Columns` be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`KGranularity`, `Use`
be `MatrixAKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`AType`

* 
The type of `B` **must** have `Rows` be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`KGranularity`,
`Columns` be a multiple of
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`NGranularity`, `Use`
be `MatrixBKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`BType`
...
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`CType`
...
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`NGranularity`, `Use`
be `MatrixAccumulatorKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`ResultType`

* 
If and only if [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`AType` is
a signed integer type, `MatrixASignedComponents` **must** be used

* 
If and only if [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`BType` is
a signed integer type, `MatrixBSignedComponents` **must** be used

* 
If and only if [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`CType` is
a signed integer type, `MatrixCSignedComponents` **must** be used

* 
If and only if
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html)::`ResultType` is a signed
integer type, `MatrixResultSignedComponents` **must** be used

* 
If and only if
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](VkPhysicalDeviceCooperativeMatrixInfo2EXT.html)::`flags` contains
...
* 
The scope of all cooperative matrix operands **must** match
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](VkPhysicalDeviceCooperativeMatrixInfo2EXT.html)::`scope`
