...
* 
`faultAddressInfo` is a [VkDeviceFaultAddressInfoKHR](VkDeviceFaultAddressInfoKHR.html) structure
providing details of the memory access which caused a fault.

* 
`instructionAddressInfo` is a [VkDeviceFaultAddressInfoKHR](VkDeviceFaultAddressInfoKHR.html)
structure providing details of the GPU instruction which cause a fault.

* 
`vendorInfo` is a [VkDeviceFaultVendorInfoKHR](VkDeviceFaultVendorInfoKHR.html) structure
