# VkPhysicalDeviceCubicWeightsFeaturesQCOM(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceCubicWeightsFeaturesQCOM.html
...
[](#VUID-VkPhysicalDeviceCubicWeightsFeaturesQCOM-sType-sType) VUID-VkPhysicalDeviceCubicWeightsFeaturesQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUBIC_WEIGHTS_FEATURES_QCOM](VkStructureType.html)
...
[VK_QCOM_filter_cubic_weights](VK_QCOM_filter_cubic_weights.html), `VkBool32`, [VkStructureType](VkStructureType.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceCubicWeightsFeaturesQCOM).
