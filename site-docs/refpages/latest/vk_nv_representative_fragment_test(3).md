...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_NV_representative_fragment_test.html
...
* 
[VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV](VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV.html)
...
[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_REPRESENTATIVE_FRAGMENT_TEST_FEATURES_NV](VkStructureType.html)

* 
[VK_STRUCTURE_TYPE_PIPELINE_REPRESENTATIVE_FRAGMENT_TEST_STATE_CREATE_INFO_NV](VkStructureType.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_NV_representative_fragment_test).
