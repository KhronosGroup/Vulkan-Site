# vkCmdBeginGpaSampleAMD(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdBeginGpaSampleAMD.html
...
[VkGpaSampleBeginInfoAMD](VkGpaSampleBeginInfoAMD.html) structure describing the sample
parameters.
...
[](#VUID-vkCmdBeginGpaSampleAMD-pGpaSampleBeginInfo-parameter) VUID-vkCmdBeginGpaSampleAMD-pGpaSampleBeginInfo-parameter
 ...
 `pGpaSampleBeginInfo` **must** be a valid pointer to a valid [VkGpaSampleBeginInfoAMD](VkGpaSampleBeginInfoAMD.html) structure
...
vkCmdBeginGpaSampleAMD is not affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)
...
[VK_AMD_gpa_interface](VK_AMD_gpa_interface.html), [VkCommandBuffer](VkCommandBuffer.html), [VkGpaSampleBeginInfoAMD](VkGpaSampleBeginInfoAMD.html), [VkGpaSessionAMD](VkGpaSessionAMD.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/gpa_interface.html#vkCmdBeginGpaSampleAMD).
