...
If [VK_KHR_dynamic_rendering](VK_KHR_dynamic_rendering.html) or [Vulkan Version 1.3](../../../../spec/latest/appendices/versions.html#versions-1.3) and [Vulkan Version 1.4](../../../../spec/latest/appendices/versions.html#versions-1.4) or [VK_KHR_extended_flags](VK_KHR_extended_flags.html) or [VK_KHR_maintenance5](VK_KHR_maintenance5.html) is supported:
