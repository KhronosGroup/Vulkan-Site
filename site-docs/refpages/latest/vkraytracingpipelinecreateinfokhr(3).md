...
If `layout` is not [VK_NULL_HANDLE](VK_NULL_HANDLE.html), it **must** not have been
...
If `flags` includes
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](VkPipelineCreateFlagBits.html), at least
...
If `flags` includes
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](VkPipelineCreateFlagBits.html), each
element of `pLibraryInfo->pLibraries` **must** have been created with
the [VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](VkPipelineCreateFlagBits.html) bit
set
...
include both
[VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](VkPipelineCreateFlagBits2.html) and
