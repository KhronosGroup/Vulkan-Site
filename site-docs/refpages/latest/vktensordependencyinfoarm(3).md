...
[](#VUID-VkTensorDependencyInfoARM-pTensorMemoryBarriers-parameter) VUID-VkTensorDependencyInfoARM-pTensorMemoryBarriers-parameter
 ...
 `pTensorMemoryBarriers` **must** be a valid pointer to an array of `tensorMemoryBarrierCount` valid [VkTensorMemoryBarrierARM](VkTensorMemoryBarrierARM.html) structures
