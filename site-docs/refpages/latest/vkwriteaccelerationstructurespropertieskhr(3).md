...
|  | This functionality is superseded by [vkCmdWriteAccelerationStructuresPropertiesKHR](../../../../spec/latest/chapters/accelstructures.html#vkCmdWriteAccelerationStructuresPropertiesKHR). See [Legacy Functionality](../../../../spec/latest/appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
All acceleration structures in `pAccelerationStructures` **must** have
been built with [VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR](VkAccelerationStructureTypeKHR.html) if
`queryType` is
[VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_BOTTOM_LEVEL_POINTERS_KHR](VkQueryType.html)
