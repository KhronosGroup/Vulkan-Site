...
To copy host accessible [VkMicromapEXT](VkMicromapEXT.html) to a micromap, call:

|  | This functionality is superseded by [vkCmdCopyMemoryToMicromapEXT](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMemoryToMicromapEXT). See [Legacy Functionality](../../../../spec/latest/appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCopyMemoryToMicromapEXT).
