...
counter types.
It **must** not include [VK_SURFACE_COUNTER_VBLANK_BIT_EXT](VkSurfaceCounterFlagBitsEXT.html) unless the
surface queried is a [display surface](../../../../spec/latest/chapters/VK_KHR_surface/wsi.html#wsi-display-surfaces)
