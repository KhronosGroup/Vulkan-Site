...
[vkSetSwapchainPresentTimingQueueSizeEXT](vkSetSwapchainPresentTimingQueueSizeEXT.html) was never called, presentation
fails and returns [VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT](VkResult.html).
...
[](#VUID-VkPresentTimingInfoEXT-flags-parameter) VUID-VkPresentTimingInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPresentTimingInfoFlagBitsEXT](VkPresentTimingInfoFlagBitsEXT.html) values

* 
[](#VUID-VkPresentTimingInfoEXT-presentStageQueries-parameter) VUID-VkPresentTimingInfoEXT-presentStageQueries-parameter

 If `presentStageQueries` is not `0`, `presentStageQueries` **must** be a valid combination of [VkPresentStageFlagBitsEXT](VkPresentStageFlagBitsEXT.html) values
...
[](#VUID-VkPresentTimingInfoEXT-targetTimeDomainPresentStage-parameter) VUID-VkPresentTimingInfoEXT-targetTimeDomainPresentStage-parameter
 ...
 If `targetTimeDomainPresentStage` is not `0`, `targetTimeDomainPresentStage` **must** be a valid combination of [VkPresentStageFlagBitsEXT](VkPresentStageFlagBitsEXT.html) values
