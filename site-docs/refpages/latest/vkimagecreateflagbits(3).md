...
[multisampled rendering as a    single-sampled render pass attachment](../../../../spec/latest/chapters/renderpass.html#multisampled-render-to-single-sampled)

[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](#) specifies
...
[VkImageViewCreateInfo](VkImageViewCreateInfo.html)::`viewType` is
[VK_IMAGE_VIEW_TYPE_1D](VkImageViewType.html) or [VK_IMAGE_VIEW_TYPE_2D](VkImageViewType.html), the image is
...
[VkImageViewCreateInfo](VkImageViewCreateInfo.html)::`viewType` is
[VK_IMAGE_VIEW_TYPE_1D_ARRAY](VkImageViewType.html) or [VK_IMAGE_VIEW_TYPE_2D_ARRAY](VkImageViewType.html),
the descriptor is accessed as-if the view was created with
[VK_IMAGE_VIEW_TYPE_1D](VkImageViewType.html) or [VK_IMAGE_VIEW_TYPE_2D](VkImageViewType.html) respectively.
Cube map view aliasing is not included by this flag bit.
Also, image views created with a [multi-planar    format](../../../../spec/latest/chapters/formats.html#formats-multiplanar) **can** not alias like this.
