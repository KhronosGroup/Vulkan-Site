...
members of [VkMemoryBarrier2](VkMemoryBarrier2.html), [VkImageMemoryBarrier2](VkImageMemoryBarrier2.html), and
[VkBufferMemoryBarrier2](VkBufferMemoryBarrier2.html), specifying access behavior, are:
...
[uniform buffer](../../../../spec/latest/chapters/descriptors.html#descriptors-uniformbuffer) in any shader pipeline
stage.
...
[uniform texel buffer](../../../../spec/latest/chapters/descriptors.html#descriptors-uniformtexelbuffer) or
[sampled image](../../../../spec/latest/chapters/descriptors.html#descriptors-sampledimage) in any shader pipeline
stage.

* 
[VK_ACCESS_2_SHADER_STORAGE_READ_BIT](#) specifies read access to a
[storage buffer](../../../../spec/latest/chapters/descriptors.html#descriptors-storagebuffer),
[physical storage buffer](../../../../spec/latest/chapters/descriptors.html#descriptors-physical-storage-buffer),
[storage texel buffer](../../../../spec/latest/chapters/descriptors.html#descriptors-storagetexelbuffer), or
[storage image](../../../../spec/latest/chapters/descriptors.html#descriptors-storageimage) in any shader pipeline
stage.
...
to a [descriptor buffer](../../../../spec/latest/chapters/descriptorbuffers.html#descriptorbuffers) in any shader pipeline
stage.
