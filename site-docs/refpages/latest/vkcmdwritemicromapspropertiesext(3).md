...
To query [VkMicromapEXT](VkMicromapEXT.html) size parameters call:
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdWriteMicromapsPropertiesEXT).
