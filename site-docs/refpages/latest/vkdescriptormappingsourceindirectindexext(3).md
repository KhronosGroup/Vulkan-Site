...
If `pEmbeddedSampler` is a valid pointer to a
[VkSamplerCreateInfo](VkSamplerCreateInfo.html), the [VkSamplerCreateInfo](VkSamplerCreateInfo.html)::`pNext`
chain **must** not contain [VkOpaqueCaptureDescriptorDataCreateInfoEXT](VkOpaqueCaptureDescriptorDataCreateInfoEXT.html)
