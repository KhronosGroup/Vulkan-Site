...
in an instance with
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](VkGeometryInstanceFlagBitsKHR.html) set.
...
* 
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](#) specifies
that micromaps **can** be compressed with a lossy encoding as described in
[Ray Opacity Micromap](../../../../spec/latest/chapters/raytraversal.html#ray-opacity-micromap), which **may** support
