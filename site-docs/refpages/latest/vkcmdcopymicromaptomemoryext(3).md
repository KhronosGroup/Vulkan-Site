...
To copy a [VkMicromapEXT](VkMicromapEXT.html) to device memory call:
...
with the [VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT](VkPipelineStageFlagBits2.html) pipeline stage and
an access type of [VK_ACCESS_TRANSFER_WRITE_BIT](VkAccessFlagBits.html).
...
compatible for use with either [vkCmdCopyMemoryToMicromapEXT](vkCmdCopyMemoryToMicromapEXT.html) or
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapToMemoryEXT).
