...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_KHR_external_memory.html
...
[VkExternalMemoryBufferCreateInfoKHR](VkExternalMemoryBufferCreateInfo.html)

Extending [VkImageCreateInfo](VkImageCreateInfo.html):

* 
[VkExternalMemoryImageCreateInfoKHR](VkExternalMemoryImageCreateInfo.html)

Extending [VkMemoryAllocateInfo](VkMemoryAllocateInfo.html):

* 
[VkExportMemoryAllocateInfoKHR](VkExportMemoryAllocateInfo.html)
...
[VkPhysicalDeviceProperties](VkPhysicalDeviceProperties.html)::`driverVersion` field can be used to
identify compatible devices across processes, drivers, and APIs.
[VkPhysicalDeviceProperties](VkPhysicalDeviceProperties.html)::`pipelineCacheUUID` is not sufficient
...
* 
A new bit in [VkAccessFlags](VkAccessFlags.html) that can be set to indicate an
“external” access.

* 
A new bit in [VkDependencyFlags](VkDependencyFlags.html)
...
Another downside of [VkDependencyFlags](VkDependencyFlags.html) is that it lacks inherent
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_KHR_external_memory).
