# VkImageCreateFlagBits2KHR(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkImageCreateFlagBits2KHR.html
...
VkImageCreateFlagBits2KHR - Bitmask specifying additional parameters of an image

Bits which **can** be set in
[VkImageCreateFlags2CreateInfoKHR](VkImageCreateFlags2CreateInfoKHR.html)::`flags`, specifying additional
...
* 
[VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR](#) specifies that the image
will be backed using sparse memory binding.

* 
[VK_IMAGE_CREATE_2_SPARSE_RESIDENCY_BIT_KHR](#) specifies that the
image **can** be partially backed using sparse memory binding.
Images created with this flag **must** also be created with the
[VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR](#) flag.

* 
[VK_IMAGE_CREATE_2_SPARSE_ALIASED_BIT_KHR](#) specifies that the image
...
* 
[VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR](#) specifies that the image
...
[VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR](#) specifies that a
`VkImageView` can be created of a *plane* of the image.

* 
[VK_IMAGE_CREATE_2_CUBE_COMPATIBLE_BIT_KHR](#) specifies that the image
...
* 
[VK_IMAGE_CREATE_2_2D_ARRAY_COMPATIBLE_BIT_KHR](#) specifies that the
...
* 
[VK_IMAGE_CREATE_2_2D_VIEW_COMPATIBLE_BIT_EXT](#) specifies that the
image **can** be used to create a `VkImageView` of type
[VK_IMAGE_VIEW_TYPE_2D](VkImageViewType.html).

* 
[VK_IMAGE_CREATE_2_PROTECTED_BIT_KHR](#) specifies that the image is a
protected image.

* 
[VK_IMAGE_CREATE_2_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR](#) specifies
...
* 
[VK_IMAGE_CREATE_2_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR](#) specifies
...
* 
[VK_IMAGE_CREATE_2_EXTENDED_USAGE_BIT_KHR](#) specifies that the image
...
* 
[VK_IMAGE_CREATE_2_DISJOINT_BIT_KHR](#) specifies that an image with a
...
* 
[VK_IMAGE_CREATE_2_ALIAS_BIT_KHR](#) specifies that two images created
...
[VkExternalMemoryImageCreateInfoNV](VkExternalMemoryImageCreateInfoNV.html)
    ...
    [VK_IMAGE_CREATE_2_ALIAS_BIT_KHR](#) is set.
...
* 
[VK_IMAGE_CREATE_2_CORNER_SAMPLED_BIT_NV](#) specifies that the image
is a [corner-sampled image](../../../../spec/latest/chapters/resources.html#resources-images-corner-sampled).

* 
[VK_IMAGE_CREATE_2_SUBSAMPLED_BIT_EXT](#) specifies that an image **can**
...
[VK_IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT](#) specifies
...
[VK_IMAGE_CREATE_2_VIDEO_PROFILE_INDEPENDENT_BIT_KHR](#) specifies that
...
[VK_KHR_extended_flags](VK_KHR_extended_flags.html), [VkImageCreateFlags2KHR](VkImageCreateFlags2KHR.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/resources.html#VkImageCreateFlagBits2KHR).
