...
[VkDeviceFaultAddressInfoEXT](VkDeviceFaultAddressInfoKHR.html) structures describing either memory
...
[VkDeviceFaultCountsEXT](VkDeviceFaultCountsEXT.html)::`addressInfoCount` value passed to
...
[VkDeviceFaultVendorInfoEXT](VkDeviceFaultVendorInfoKHR.html) structures describing vendor-specific
fault information.
The length of `pVendorInfos` is specified by the
[VkDeviceFaultCountsEXT](VkDeviceFaultCountsEXT.html)::`vendorInfoCount` value passed to
[vkGetDeviceFaultInfoEXT](vkGetDeviceFaultInfoEXT.html).
...
[Vendor Binary Crash Dumps](../../../../spec/latest/chapters/debugging.html#vendor-binary-crash-dumps).
The size of `pVendorBinaryData` is specified by the
[VkDeviceFaultCountsEXT](VkDeviceFaultCountsEXT.html)::`vendorBinarySize` value passed to
[vkGetDeviceFaultInfoEXT](vkGetDeviceFaultInfoEXT.html).
...
[VK_EXT_device_fault](VK_EXT_device_fault.html), [VkDeviceFaultAddressInfoKHR](VkDeviceFaultAddressInfoKHR.html), [VkDeviceFaultVendorInfoKHR](VkDeviceFaultVendorInfoKHR.html), [VkStructureType](VkStructureType.html), [vkGetDeviceFaultInfoEXT](vkGetDeviceFaultInfoEXT.html)
