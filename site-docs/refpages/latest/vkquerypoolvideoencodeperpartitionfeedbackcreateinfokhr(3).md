...
[](#VUID-VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR-perPartitionEncodeFeedbackFlags-parameter) VUID-VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR-perPartitionEncodeFeedbackFlags-parameter
 ...
 If `perPartitionEncodeFeedbackFlags` is not `0`, `perPartitionEncodeFeedbackFlags` **must** be a valid combination of [VkVideoEncodePerPartitionFeedbackFlagBitsKHR](VkVideoEncodePerPartitionFeedbackFlagBitsKHR.html) values
