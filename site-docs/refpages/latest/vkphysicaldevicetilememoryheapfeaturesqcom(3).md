# VkPhysicalDeviceTileMemoryHeapFeaturesQCOM(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceTileMemoryHeapFeaturesQCOM.html
...
[](#VUID-VkPhysicalDeviceTileMemoryHeapFeaturesQCOM-sType-sType) VUID-VkPhysicalDeviceTileMemoryHeapFeaturesQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM](VkStructureType.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceTileMemoryHeapFeaturesQCOM).
