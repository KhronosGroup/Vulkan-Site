...
state is only affected by the [current value](../../../../spec/latest/chapters/pipelines.html#dynamic-state-current-value)
of `depthClampEnable` if the pipeline was not created with the
[VkPipelineRasterizationDepthClipStateCreateInfoEXT](VkPipelineRasterizationDepthClipStateCreateInfoEXT.html) structure.
If [VkPipelineRasterizationDepthClipStateCreateInfoEXT](VkPipelineRasterizationDepthClipStateCreateInfoEXT.html) was included in
