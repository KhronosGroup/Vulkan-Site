...
If `flags` includes
[VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR](VkGeometryInstanceFlagBitsKHR.html) or
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](VkGeometryInstanceFlagBitsKHR.html), the
...
[](#VUID-VkAccelerationStructureInstanceKHR-flags-parameter) VUID-VkAccelerationStructureInstanceKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkGeometryInstanceFlagBitsKHR](VkGeometryInstanceFlagBitsKHR.html) values
