...
with `isForeign` set to [VK_TRUE](VK_TRUE.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/descriptorbuffers.html#vkCmdBindDescriptorBuffersEXT).
