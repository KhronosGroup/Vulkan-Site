...
`usage` defines the [effective usage flags](../../../../spec/latest/chapters/fundamentals.html#fundamentals-effective-flags) for the buffer.
...
by [VkBufferUsageFlags2CreateInfo](VkBufferUsageFlags2CreateInfo.html)::`usage`.

If [VkBufferDeviceAddressAlignmentAllocateInfoVALVE](VkBufferDeviceAddressAlignmentAllocateInfoVALVE.html) is included in the
...
memory allocation time in [vkAllocateMemory](vkAllocateMemory.html) instead.
...
[VK_BUFFER_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR](VkBufferCreateFlagBits.html),
    [VK_BUFFER_CREATE_SPARSE_BINDING_BIT](VkBufferCreateFlagBits.html),
    [VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT](VkBufferCreateFlagBits.html),
    [VK_BUFFER_CREATE_SPARSE_ALIASED_BIT](VkBufferCreateFlagBits.html), or
    [VK_BUFFER_CREATE_PROTECTED_BIT](VkBufferCreateFlagBits.html) flags
...
[effective usage flags](../../../../spec/latest/chapters/resources.html#resources-effective-buffer-usage) **must** not
...
property is not supported and the [    effective usage flags](../../../../spec/latest/chapters/resources.html#resources-effective-buffer-usage) include the
...
If
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](VkBufferDeviceAddressAlignmentAllocateInfoVALVE.html)::`alignment`
is not 0, the [effective usage    flags](../../../../spec/latest/chapters/resources.html#resources-effective-buffer-usage) **must** include [VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT](VkBufferUsageFlagBits2.html)
...
[](#VUID-VkBufferCreateInfo-flags-parameter) VUID-VkBufferCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBufferCreateFlagBits](VkBufferCreateFlagBits.html) values
