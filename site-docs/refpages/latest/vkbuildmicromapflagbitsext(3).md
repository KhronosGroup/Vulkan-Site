...
* 
[VK_BUILD_MICROMAP_ALLOW_COMPACTION_BIT_EXT](#) specifies that the
micromap **can** act as the source for a [copy micromap    command](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#micromap-copying) with `mode` of [VK_COPY_MICROMAP_MODE_COMPACT_EXT](VkCopyMicromapModeEXT.html) to
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#VkBuildMicromapFlagBitsEXT).
