...
To query [VkMicromapEXT](VkMicromapEXT.html) size parameters on the host, call:

|  | This functionality is superseded by [vkCmdWriteMicromapsPropertiesEXT](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdWriteMicromapsPropertiesEXT). See [Legacy Functionality](../../../../spec/latest/appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
`queryType` **must** be
[VK_QUERY_TYPE_MICROMAP_COMPACTED_SIZE_EXT](VkQueryType.html), or
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkWriteMicromapsPropertiesEXT).
