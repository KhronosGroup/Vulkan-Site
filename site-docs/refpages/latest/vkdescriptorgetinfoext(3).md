...
**must** be less than or equal to [    `maxUniformBufferRange`](../../../../spec/latest/chapters/limits.html#limits-maxUniformBufferRange)

* 
[](#VUID-VkDescriptorGetInfoEXT-type-12493) VUID-VkDescriptorGetInfoEXT-type-12493

If `type` is [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](VkDescriptorType.html),
the [`shader64BitIndexing`](../../../../spec/latest/chapters/features.html#features-shader64BitIndexing) feature
is not enabled,
and `pUniformBuffer->address` is not 0, `pStorageBuffer->range`
**must** be less than or equal to [    `maxStorageBufferRange`](../../../../spec/latest/chapters/limits.html#limits-maxStorageBufferRange)
