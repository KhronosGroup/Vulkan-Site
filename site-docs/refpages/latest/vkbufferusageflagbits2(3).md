...
* 
[VK_BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT](#) specifies
that the buffer **can** be used as a [read-only    ](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#micromap-building)[VkMicromapEXT](VkMicromapEXT.html) build input, which includes the `data` and
`triangleArray` parameters

* 
[VK_BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT](#) specifies that the
buffer **can** be used to [create ](../../../../spec/latest/chapters/resources.html#resources-micromaps)[VkMicromapEXT](VkMicromapEXT.html)    objects.
...
[VK_KHR_extended_flags](VK_KHR_extended_flags.html), [VK_KHR_maintenance5](VK_KHR_maintenance5.html), [VK_VERSION_1_4](VK_VERSION_1_4.html), [VkBufferUsageFlags2](VkBufferUsageFlags2.html)
