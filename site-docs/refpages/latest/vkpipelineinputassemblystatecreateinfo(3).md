...
`vkCmdBindIndexBuffer2` or
    ...
    enabled.
    If the [`primitiveRestartIndex`](../../../../spec/latest/chapters/features.html#features-primitiveRestartIndex)
    feature is enabled, [vkCmdSetPrimitiveRestartIndexEXT](vkCmdSetPrimitiveRestartIndexEXT.html) **can** be used
    to set a custom index for primitive restart.
