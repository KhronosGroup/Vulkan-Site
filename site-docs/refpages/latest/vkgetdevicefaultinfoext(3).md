...
vkGetDeviceFaultInfoEXT - Reports fault information for the specified device
...
If the [vendor-specific crash dumps](../../../../spec/latest/chapters/features.html#features-deviceFaultVendorBinaryEXT)
...
`pFaultCounts->addressInfoCount` [VkDeviceFaultAddressInfoEXT](VkDeviceFaultAddressInfoKHR.html)
structures
...
`pFaultCounts->vendorInfoCount` [VkDeviceFaultVendorInfoEXT](VkDeviceFaultVendorInfoKHR.html)
structures
