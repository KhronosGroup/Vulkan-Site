...
* 
[VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM](#) specifies that the image
**can** be used as a weight image in [weight image    sampling operations](../../../../spec/latest/chapters/textures.html#textures-weightimage).

* 
[VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM](#) specifies that the
image **can** be used in [block matching operations](../../../../spec/latest/chapters/textures.html#textures-blockmatch).
