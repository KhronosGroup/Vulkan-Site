...
To copy or compact a [VkMicromapEXT](VkMicromapEXT.html) on the host, call:

|  | This functionality is superseded by [vkCmdCopyMicromapEXT](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapEXT). See [Legacy Functionality](../../../../spec/latest/appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkCopyMicromapEXT).
