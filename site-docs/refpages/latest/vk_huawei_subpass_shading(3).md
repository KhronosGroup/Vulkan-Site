...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_HUAWEI_subpass_shading.html
...
the [`offset`](../../../../spec/latest/chapters/fundamentals.html#VkRect2D) of the
[VkRenderPassBeginInfo](VkRenderPassBeginInfo.html)::`renderArea`.
`GlobalInvocationId.z` is mapped to the Layer if
`[VK_EXT_shader_viewport_index_layer](VK_EXT_shader_viewport_index_layer.html)` is supported.
...
`LocalInvocationId` and the [`offset`](../../../../spec/latest/chapters/fundamentals.html#VkRect2D) of the
[VkRenderPassBeginInfo](VkRenderPassBeginInfo.html)::`renderArea`.
...
* 
[vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI](vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI.html)

* 
Extending [VkComputePipelineCreateInfo](VkComputePipelineCreateInfo.html):

[VkSubpassShadingPipelineCreateInfoHUAWEI](VkSubpassShadingPipelineCreateInfoHUAWEI.html)

Extending [VkPhysicalDeviceFeatures2](VkPhysicalDeviceFeatures2.html), [VkDeviceCreateInfo](VkDeviceCreateInfo.html):

* 
[VkPhysicalDeviceSubpassShadingFeaturesHUAWEI](VkPhysicalDeviceSubpassShadingFeaturesHUAWEI.html)

Extending [VkPhysicalDeviceProperties2](VkPhysicalDeviceProperties2.html):

* 
[VkPhysicalDeviceSubpassShadingPropertiesHUAWEI](VkPhysicalDeviceSubpassShadingPropertiesHUAWEI.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_HUAWEI_subpass_shading).
