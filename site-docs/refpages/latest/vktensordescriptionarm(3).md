...
If `tiling` is [VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM](VkTensorTilingARM.html) or
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](VkTensorTilingARM.html) then
...
If `tiling` is [VK_TENSOR_TILING_BRICK_16_WIDE_ARM](VkTensorTilingARM.html),
...
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](VkTensorTilingARM.html), then `pStrides`
**must** be `NULL`
