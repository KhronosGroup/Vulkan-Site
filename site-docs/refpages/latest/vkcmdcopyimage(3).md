...
[size-adjusted](../../../../spec/latest/chapters/formats.html#formats-size-compatibility) if the format of the
destination image has a different [block extent](../../../../spec/latest/chapters/formats.html#formats-compatibility-classes) than the format of the source image (e.g. one is a compressed
format).
...
if they [alias each other](../../../../spec/latest/chapters/resources.html#resources-memory-aliasing), both
...
of a [linear image](../../../../spec/latest/appendices/glossary.html#glossary-linear-resource) is according to its
...
If the queue family used to create the [VkCommandPool](VkCommandPool.html) which
`commandBuffer` was allocated from does not support
[VK_QUEUE_GRAPHICS_BIT](VkQueueFlagBits.html) and `srcSubresource.aspectMask` or
`dstSubresource.aspectMask` of any element of `pRegions` contain
[VK_IMAGE_ASPECT_DEPTH_BIT](VkImageAspectFlagBits.html) or [VK_IMAGE_ASPECT_STENCIL_BIT](VkImageAspectFlagBits.html),
then both `srcImage` and `dstImage` **must** have a sample count
equal to [VK_SAMPLE_COUNT_1_BIT](VkSampleCountFlagBits.html)
...
`pRegions` and accessed according to [Copy    Image Addressing](../../../../spec/latest/chapters/copies.html#copies-images-addressing)
...
accessed according to [Copy Image Addressing](../../../../spec/latest/chapters/copies.html#copies-images-addressing)
...
In a copy to or from a plane of a [multi-planar    image](../../../../spec/latest/chapters/formats.html#formats-multiplanar), the [VkFormat](VkFormat.html) of the image and plane **must** be compatible
according to [the description of compatible    planes](../../../../spec/latest/chapters/formats.html#formats-compatible-planes) for the plane being copied
