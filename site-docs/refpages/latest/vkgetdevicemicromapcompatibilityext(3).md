...
To check if a serialized [VkMicromapEXT](VkMicromapEXT.html) is compatible with the current
device call:
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#vkGetDeviceMicromapCompatibilityEXT).
