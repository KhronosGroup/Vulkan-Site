...
* 
Allow `dstCache` in [vkMergePipelineCaches](vkMergePipelineCaches.html) to be implicitly
synchronized.
...
[VkMemoryBarrier2](VkMemoryBarrier2.html), [VkBufferMemoryBarrier2](VkBufferMemoryBarrier2.html), and
