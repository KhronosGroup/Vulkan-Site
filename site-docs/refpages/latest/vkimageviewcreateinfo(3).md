...
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](VkImageCreateFlagBits.html), `format` **must** equal the
`format` used to create `image`.

If `image` was created with [VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](VkImageCreateFlagBits.html),
`format` **can** be set to a [format that is compatible](../../../../spec/latest/chapters/formats.html#formats-compatibility-classes) with the `format` used to create `image`
...
* 
If creating a [single-plane view](../../../../spec/latest/chapters/resources.html#image-views-plane-view), `format`
**must** equal one of the [*plane view formats*](../../../../spec/latest/chapters/resources.html#image-views-plane-view).

* 
If creating a [multi-plane view](../../../../spec/latest/chapters/resources.html#image-views-multi-plane-view),
...
* 
If creating a [single-plane view](../../../../spec/latest/chapters/resources.html#image-views-plane-view), the
dimensions equal the [*plane view    dimensions*](../../../../spec/latest/chapters/resources.html#image-views-plane-view).

* 
Otherwise, the dimensions are equal to the dimensions of the selected
mip level as defined in [Image Mip    Level Sizing](../../../../spec/latest/chapters/resources.html#resources-image-mip-level-sizing)

If `subresourceRange.aspectMask` is one of the
[multi-planar aspect mask](../../../../spec/latest/chapters/formats.html#formats-multiplanar-image-aspect) bits, a
single-plane image view will be created.
The `image` of a single-plane view **must** have been created with a
[multi-planar format](../../../../spec/latest/chapters/formats.html#formats-multiplanar) and the
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](VkImageCreateFlagBits.html) create flag.

The set of *plane view formats* for the plane is the
[compatible plane format](../../../../spec/latest/chapters/formats.html#formats-compatible-planes) and the formats
[compatible](../../../../spec/latest/chapters/formats.html#formats-compatibility-classes) with it.

The *plane view dimensions* are derived from the dimensions of the
`image` in the manner listed for [plane compatibility](../../../../spec/latest/chapters/formats.html#formats-compatible-planes) for the plane.

The plane view’s aspect mask is considered to be equivalent to
[VK_IMAGE_ASPECT_COLOR_BIT](VkImageAspectFlagBits.html) when used as a framebuffer attachment.

If the `format` of the `image` is a
[multi-planar format](../../../../spec/latest/chapters/formats.html#formats-multiplanar) and
`subresourceRange.aspectMask` is equal to
[VK_IMAGE_ASPECT_COLOR_BIT](VkImageAspectFlagBits.html), a multi-plane image view will be created.
...
Image views with [formats that require YCBCR conversion](../../../../spec/latest/chapters/formats.html#formats-requiring-sampler-ycbcr-conversion) and `usage` containing
...
flag,
and a [single-plane view](../../../../spec/latest/chapters/resources.html#image-views-plane-view) and a
[multi-plane view](../../../../spec/latest/chapters/resources.html#image-views-multi-plane-view) is not being created,
...
If creating a [single-plane view](../../../../spec/latest/chapters/resources.html#image-views-plane-view), `image`
...
If creating a [single-plane view](../../../../spec/latest/chapters/resources.html#image-views-plane-view), `format`
**must** be compatible with the [VkFormat](VkFormat.html) for the plane of the
`image` `format` indicated by `subresourceRange.aspectMask`,
as defined in [Compatible Formats of Planes of Multi-Planar Formats](../../../../spec/latest/chapters/formats.html#formats-compatible-planes)
...
If `usage` contains [VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM](VkImageUsageFlagBits.html),
then the image view’s [format    features](../../../../spec/latest/chapters/resources.html#resources-image-view-format-features) **must** contain [VK_FORMAT_FEATURE_2_WEIGHT_IMAGE_BIT_QCOM](VkFormatFeatureFlagBits2.html)

[](#VUID-VkImageViewCreateInfo-usage-12507) VUID-VkImageViewCreateInfo-usage-12507

If `usage` contains
[VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM](VkImageUsageFlagBits.html), then the image view’s
[format features](../../../../spec/latest/chapters/resources.html#resources-image-view-format-features) **must** contain
...
[VkImageViewUsageCreateInfo](VkImageViewUsageCreateInfo.html) and
[VkImageViewUsage2CreateInfoKHR](VkImageViewUsage2CreateInfoKHR.html) structures
