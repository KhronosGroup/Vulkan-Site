...
|  | This functionality is superseded by [vkCmdCopyMemoryToAccelerationStructureKHR](../../../../spec/latest/chapters/accelstructures.html#vkCmdCopyMemoryToAccelerationStructureKHR). See [Legacy Functionality](../../../../spec/latest/appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
