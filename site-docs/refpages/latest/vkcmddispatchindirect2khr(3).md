# vkCmdDispatchIndirect2KHR(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdDispatchIndirect2KHR.html
...
vkCmdDispatchIndirect2KHR - Dispatch compute work items with indirect parameters through an address range
...
* 
`pInfo` is a pointer to a [VkDispatchIndirect2InfoKHR](VkDispatchIndirect2InfoKHR.html) structure
defining parameters of this command.

`vkCmdDispatchIndirect2KHR` behaves similarly to
[vkCmdDispatchIndirect](vkCmdDispatchIndirect.html) except that the parameters, encoded in a
[VkDispatchIndirectCommand](VkDispatchIndirectCommand.html) structure, are read by the device from an
...
If a [VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR](VkDescriptorType.html) descriptor is
...
[VkOpacityMicromapSpecialIndexKHR](VkOpacityMicromapSpecialIndexKHR.html) values and indices into an
associated micromap array, any [VkPipeline](VkPipeline.html) bound to the pipeline
...
built using geometry with an `indexBuffer` containing both
[VkOpacityMicromapSpecialIndexKHR](VkOpacityMicromapSpecialIndexKHR.html) values and indices into an
associated micromap array, any [VkShaderEXT](VkShaderEXT.html) that accessed the
...
[](#VUID-vkCmdDispatchIndirect2KHR-pInfo-parameter) VUID-vkCmdDispatchIndirect2KHR-pInfo-parameter
 ...
 `pInfo` **must** be a valid pointer to a valid [VkDispatchIndirect2InfoKHR](VkDispatchIndirect2InfoKHR.html) structure
...
vkCmdDispatchIndirect2KHR is affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)

[VK_KHR_device_address_commands](VK_KHR_device_address_commands.html), [VkCommandBuffer](VkCommandBuffer.html), [VkDispatchIndirect2InfoKHR](VkDispatchIndirect2InfoKHR.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/dispatch.html#vkCmdDispatchIndirect2KHR).
