...
* 
[VK_COMPONENT_TYPE_FLOAT6_E2M3_EXT](#) corresponds to SPIR-V
`OpTypeFloat` 6 Float6E2M3EXT.

* 
[VK_COMPONENT_TYPE_FLOAT6_E3M2_EXT](#) corresponds to SPIR-V
`OpTypeFloat` 6 Float6E3M2EXT.

* 
[VK_COMPONENT_TYPE_FLOAT4_E2M1_EXT](#) corresponds to SPIR-V
`OpTypeFloat` 4 Float4E2M1EXT.

* 
[VK_COMPONENT_TYPE_FLOAT8_UNSIGNED_E8M0_EXT](#) corresponds to SPIR-V
`OpTypeFloat` 8 Float8UnsignedE8M0EXT.

* 
[VK_COMPONENT_TYPE_MXINT8_EXT](#) corresponds to SPIR-V
