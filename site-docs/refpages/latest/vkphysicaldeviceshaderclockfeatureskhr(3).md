...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceShaderClockFeaturesKHR.html
...
[](#VUID-VkPhysicalDeviceShaderClockFeaturesKHR-sType-sType) VUID-VkPhysicalDeviceShaderClockFeaturesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR](VkStructureType.html)
...
[VK_KHR_shader_clock](VK_KHR_shader_clock.html), `VkBool32`, [VkStructureType](VkStructureType.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceShaderClockFeaturesKHR).
