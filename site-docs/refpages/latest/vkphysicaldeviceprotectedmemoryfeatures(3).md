...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDeviceProtectedMemoryFeatures.html
...
[](#VUID-VkPhysicalDeviceProtectedMemoryFeatures-sType-sType) VUID-VkPhysicalDeviceProtectedMemoryFeatures-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES](VkStructureType.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDeviceProtectedMemoryFeatures).
