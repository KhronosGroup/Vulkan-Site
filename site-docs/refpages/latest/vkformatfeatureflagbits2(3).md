...
* 
[VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_2D_BIT_IMG](#)
specifies that a format supports the behavior required by
[VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT](#) but only for
[VkImageType](VkImageType.html) [VK_IMAGE_TYPE_2D](VkImageType.html) and [VK_IMAGE_TYPE_1D](VkImageType.html)
...
* 
[VK_FORMAT_FEATURE_2_BLOCK_MATCHING_SXD_BIT_QCOM](#) specifies that
...
[VK_FORMAT_FEATURE_2_BLOCK_MATCHING_BIT_QCOM](#) flag.
