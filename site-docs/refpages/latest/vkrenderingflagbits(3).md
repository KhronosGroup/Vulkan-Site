...
command buffers, and [vkCmdExecuteCommands](vkCmdExecuteCommands.html) is the only valid
command in the command buffer until
[vkCmdEndRendering2KHR](vkCmdEndRendering2KHR.html) or
...
* 
[VK_RENDERING_CONTENTS_INLINE_BIT_KHR](#) specifies that contents for
