...
`FlagBits2`.
For example, a flag value of type [VkAccessFlags2](VkAccessFlags2.html) **must** contain only
bit flags defined by [VkAccessFlagBits2](VkAccessFlagBits2.html).
