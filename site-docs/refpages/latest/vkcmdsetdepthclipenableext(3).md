...
If [VkPipelineRasterizationDepthClipStateCreateInfoEXT](VkPipelineRasterizationDepthClipStateCreateInfoEXT.html) was not
specified, depth clipping is set to the inverse of the
[current value](../../../../spec/latest/chapters/pipelines.html#dynamic-state-current-value) of `depthClampEnable`.
