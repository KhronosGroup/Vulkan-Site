# VkPhysicalDevicePipelineOpacityMicromapFeaturesARM(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkPhysicalDevicePipelineOpacityMicromapFeaturesARM.html
...
The [VkPhysicalDevicePipelineOpacityMicromapFeaturesARM](#) structure is
defined as:
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/features.html#VkPhysicalDevicePipelineOpacityMicromapFeaturesARM).
