...
- **Component**: glsl
- **Version**: latest
- **URL**: /glsl/latest/chapters/spirvmappings.html

## Table of Contents

- [Feature Comparisons](#_feature_comparisons)
- [Mapping from GLSL to SPIR-V](#_mapping_from_glsl_to_spir_v)
- [Mapping_from_GLSL_to_SPIR-V](#_mapping_from_glsl_to_spir_v)
- [Specialization Constants](#_specialization_constants)
- [Vulkan Only: Push Constants](#_vulkan_only_push_constants)
- [Vulkan_Only:_Push_Constants](#_vulkan_only_push_constants)
- [Vulkan Only: Descriptor Sets](#_vulkan_only_descriptor_sets)
- [Vulkan_Only:_Descriptor_Sets](#_vulkan_only_descriptor_sets)
- [Vulkan Only: Samplers, Images, Textures, and Buffers](#_vulkan_only_samplers_images_textures_and_buffers)
- [Vulkan_Only:_Samplers,_Images,_Textures,_and_Buffers](#_vulkan_only_samplers_images_textures_and_buffers)
- [Storage Images](#_storage_images)
- [Samplers](#_samplers)
- [Textures (Sampled Images)](#_textures_sampled_images)
- [Textures_(Sampled_Images)](#_textures_sampled_images)
- [Combined Texture and Samplers](#_combined_texture_and_samplers)
- [Combined_Texture_and_Samplers](#_combined_texture_and_samplers)
- [Combining Separate Samplers and Textures](#_combining_separate_samplers_and_textures)
- [Combining_Separate_Samplers_and_Textures](#_combining_separate_samplers_and_textures)
- [Texture Buffers (Uniform Texel Buffers)](#_texture_buffers_uniform_texel_buffers)
- [Texture_Buffers_(Uniform_Texel_Buffers)](#_texture_buffers_uniform_texel_buffers)
- [Image Buffers (Storage Texel Buffers)](#_image_buffers_storage_texel_buffers)
- [Image_Buffers_(Storage_Texel_Buffers)](#_image_buffers_storage_texel_buffers)
- [Storage Buffers](#_storage_buffers)
- [Uniform Buffers](#_uniform_buffers)
- [Subpass Inputs](#_subpass_inputs)
- [Mapping Variables](#_mapping_variables)
- [Vulkan gl_VertexIndex and gl_InstanceIndex](#_vulkan_gl_vertexindex_and_gl_instanceindex)
- [Vulkan_gl_VertexIndex_and_gl_InstanceIndex](#_vulkan_gl_vertexindex_and_gl_instanceindex)
- [Storage Classes:](#_storage_classes)
- [Input/Output](#_inputoutput)
- [Vulkan Only: Mapping of Precision Qualifiers](#_vulkan_only_mapping_of_precision_qualifiers)
- [Vulkan_Only:_Mapping_of_Precision_Qualifiers](#_vulkan_only_mapping_of_precision_qualifiers)
- [Mapping of precise:](#_mapping_of_precise)
- [Mapping_of_precise:](#_mapping_of_precise)
- [OpenGL_Mapping_of_atomic_uint_offset_layout_qualifier](#_opengl_mapping_of_atomic_uint_offset_layout_qualifier)
- [Mapping of Images](#_mapping_of_images)
- [Mapping_of_Images](#_mapping_of_images)
- [Mapping of Layouts](#_mapping_of_layouts)
- [Mapping_of_Layouts](#_mapping_of_layouts)
- [Mapping of barriers](#_mapping_of_barriers)
- [Mapping_of_barriers](#_mapping_of_barriers)
- [Mapping of atomics](#_mapping_of_atomics)
- [Mapping_of_atomics](#_mapping_of_atomics)
- [OpenGL Only: Mapping of Atomics](#_opengl_only_mapping_of_atomics)
- [OpenGL_Only:_Mapping_of_Atomics](#_opengl_only_mapping_of_atomics)
- [Mapping of other instructions](#_mapping_of_other_instructions)
- [Mapping_of_other_instructions](#_mapping_of_other_instructions)
...
* 
GLSL atomic-counter bindings have the *offset* layout qualifier →
...
The *constant_id* can only be applied to a scalar integer, a scalar floating-point
or a scalar Boolean.
