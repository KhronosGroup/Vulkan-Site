...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/vulkan_profiles.html

## Table of Contents

- [What are Vulkan Profiles?](#_what_are_vulkan_profiles)
- [What_are_Vulkan_Profiles?](#_what_are_vulkan_profiles)
- [History and Purpose](#_history_and_purpose)
- [History_and_Purpose](#_history_and_purpose)
- [Relationship with Vulkan Versions](#_relationship_with_vulkan_versions)
- [Relationship_with_Vulkan_Versions](#_relationship_with_vulkan_versions)
- [Maintained Profiles](#_maintained_profiles)
- [LunarG Desktop Baseline 2022 Profile Details](#_lunarg_desktop_baseline_2022_profile_details)
- [LunarG_Desktop_Baseline_2022_Profile_Details](#_lunarg_desktop_baseline_2022_profile_details)
- [Android Baseline 2022 Profile Details](#_android_baseline_2022_profile_details)
- [Android_Baseline_2022_Profile_Details](#_android_baseline_2022_profile_details)
- [Roadmap 2022 Profile](#_roadmap_2022_profile)
- [Roadmap_2022_Profile](#_roadmap_2022_profile)
- [Profile Versioning Strategy](#_profile_versioning_strategy)
- [Profile_Versioning_Strategy](#_profile_versioning_strategy)
- [Using Vulkan Profiles](#_using_vulkan_profiles)
- [Using_Vulkan_Profiles](#_using_vulkan_profiles)
- [Automatic Feature Enabling](#_automatic_feature_enabling)
- [Automatic_Feature_Enabling](#_automatic_feature_enabling)
- [1. Using the Vulkan Profiles header](#_1_using_the_vulkan_profiles_header)
- [1._Using_the_Vulkan_Profiles_header](#_1_using_the_vulkan_profiles_header)
- [2. Using the Vulkan Profiles, JSON files directly](#_2_using_the_vulkan_profiles_json_files_directly)
- [2._Using_the_Vulkan_Profiles,_JSON_files_directly](#_2_using_the_vulkan_profiles_json_files_directly)
- [Understanding Profile JSON Structure](#_understanding_profile_json_structure)
- [Understanding_Profile_JSON_Structure](#_understanding_profile_json_structure)
- [Types of Vulkan Profiles](#_types_of_vulkan_profiles)
- [Types_of_Vulkan_Profiles](#_types_of_vulkan_profiles)
- [Creating Custom Profiles](#_creating_custom_profiles)
- [Creating_Custom_Profiles](#_creating_custom_profiles)
- [Android Baseline Profile](#_android_baseline_profile)
- [Android_Baseline_Profile](#_android_baseline_profile)
- [Example: Targeting Android Baseline Profile](#_example_targeting_android_baseline_profile)
- [Example:_Targeting_Android_Baseline_Profile](#_example_targeting_android_baseline_profile)
- [Integration with Existing Applications](#_integration_with_existing_applications)
- [Integration_with_Existing_Applications](#_integration_with_existing_applications)
- [Performance Considerations](#_performance_considerations)
- [Troubleshooting and Common Issues](#_troubleshooting_and_common_issues)
- [Troubleshooting_and_Common_Issues](#_troubleshooting_and_common_issues)
- [Profile Isn’t Supported](#_profile_isnt_supported)
- [Profile_Isn’t_Supported](#_profile_isnt_supported)
- [Version Compatibility Issues](#_version_compatibility_issues)
- [Version_Compatibility_Issues](#_version_compatibility_issues)
- [Integration with Validation Layers](#_integration_with_validation_layers)
- [Integration_with_Validation_Layers](#_integration_with_validation_layers)
- [Benefits of Using Vulkan Profiles](#_benefits_of_using_vulkan_profiles)
- [Benefits_of_Using_Vulkan_Profiles](#_benefits_of_using_vulkan_profiles)
...
For detailed information, refer to the [Vulkan Profiles API Library](https://vulkan.lunarg.com/doc/sdk/latest/windows/profiles_api_library.html) documentation on LunarG’s website.
...
([JSON Definitions](https://github.com/KhronosGroup/Vulkan-Profiles/blob/main/profiles/VP_LUNARG_desktop_baseline_2022))

* 
**Android Baseline 2022** - A baseline profile specifically for Android devices ([Documentation](https://vulkan.lunarg.com/doc/sdk/latest/windows/profiles_api_library.html), [JSON Definition](https://github.com/KhronosGroup/Vulkan-Profiles/blob/main/profiles/VP_ANDROID_baseline_2022.json))

* 
**Roadmap 2024** - A forward-looking profile that hardware vendors are
encouraged to support in future implementations ([Documentation](https://vulkan.lunarg.com/doc/sdk/latest/windows/profiles_api_library.html),
[JSON Definition](https://docs.vulkan.org/spec/latest/appendices/roadmap.html#roadmap-2024), [roadmap](https://docs.vulkan.org/spec/latest/appendices/roadmap.html))

These profiles are versioned by year to allow for evolution over time while maintaining backward compatibility. You can find sample code demonstrating the use of these profiles in the [Vulkan-Samples repository](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/tooling/profiles).
...
The simplest way to use Vulkan Profiles is through the Vulkan Profiles header (`vulkan_profiles.hpp`), which is available in the [Vulkan SDK](https://vulkan.lunarg.com/sdk/home). This header provides a C++ API that simplifies working with profiles. The header is documented in the [Vulkan-Profiles library documentation](https://github.com/KhronosGroup/Vulkan-Profiles/tree/main):
...
profiles in the [Vulkan-Profiles](https://github.com/KhronosGroup/Vulkan-Profiles/blob/main/layer/TUTORIAL.md):
...
Creating a "Platform" profile - a profile that represents all the devices you want your Vulkan application to run on. Here, the starting point would be to use data from [https://vulkan.gpuinfo.org/](https://vulkan.gpuinfo.org/) when merging device capabilities.
...
Start with an appropriate existing profile as a template (see [profiles](https://github.com/KhronosGroup/Vulkan-Profiles/tree/main/profiles))
...
You can find examples of custom profiles in the [Vulkan-Samples profiles examples](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/tooling/profiles).
...
The Android Baseline Profile is particularly useful for Android developers as it provides a guaranteed set of features that are available on a wide range of Android devices. This profile is documented in the [Vulkan Profiles API Library documentation](https://vulkan.lunarg.com/doc/sdk/latest/windows/profiles_api_library.html) and the [JSON definition](https://github.com/KhronosGroup/Vulkan-Profiles/blob/main/profiles/VP_ANDROID_baseline_2022.json). This profile includes:
...
Integrating Vulkan Profiles into an existing Vulkan application involves several steps, which are described in the [Vulkan-Profiles library documentation](https://github.com/KhronosGroup/Vulkan-Profiles/blob/main/library/TUTORIAL.md):
...
For examples of integrating profiles with existing applications, see the [Vulkan-Samples profiles examples](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/tooling/profiles) and the [Vulkan-Profiles test directory](https://github.com/KhronosGroup/Vulkan-Profiles/tree/main/library/test).
...
When working with Vulkan Profiles, developers might encounter several common issues. The [Vulkan-Profiles library documentation](https://github.com/KhronosGroup/Vulkan-Profiles/blob/main/library/TUTORIAL.md) provides guidance on troubleshooting, and the [Vulkan Validation Layers documentation](https://github.com/KhronosGroup/Vulkan-ValidationLayers/blob/main/docs/khronos_validation_layer.md) can help identify issues with profile usage:

If `CheckSupport()` returns `VK_FALSE`, it means the device doesn’t support all the requirements of the profile. To troubleshoot:

Use the profile’s `GetProfileCapabilitiesReport()` function to get detailed information about which specific requirements are not met
...
* 
[Vulkan Profiles API Library documentation](https://vulkan.lunarg.com/doc/sdk/latest/windows/profiles_api_library.html)

* 
[Vulkan-Profiles repository](https://github.com/KhronosGroup/Vulkan-Profiles)

Contains profile definitions, library code, and tools

[Vulkan-Samples profiles examples](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/tooling/profiles)

* 
Sample code demonstrating profile usage

[Vulkan Profiles pdf](https://www.lunarg.com/wp-content/uploads/2024/02/The-Vulkan-Profiles-Tools-LunarG-Christophe-Riccio-02-01-2024.pdf)
