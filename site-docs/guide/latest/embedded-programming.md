...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/embedded_programming.html

## Table of Contents

- [Hardware Architecture: Power and Bandwidth](#_hardware_architecture_power_and_bandwidth)
- [Hardware_Architecture:_Power_and_Bandwidth](#_hardware_architecture_power_and_bandwidth)
- [Tile-Based Rendering (TBR)](#_tile_based_rendering_tbr)
- [Tile-Based_Rendering_(TBR)](#_tile_based_rendering_tbr)
- [Graphics vs. Compute Bandwidth](#_graphics_vs_compute_bandwidth)
- [Graphics_vs._Compute_Bandwidth](#_graphics_vs_compute_bandwidth)
- [Memory Management in UMA](#_memory_management_in_uma)
- [Memory_Management_in_UMA](#_memory_management_in_uma)
- [Identifying Memory Types](#_identifying_memory_types)
- [Identifying_Memory_Types](#_identifying_memory_types)
- [Lazily Allocated Memory and Transient Attachments](#_lazily_allocated_memory_and_transient_attachments)
- [Lazily_Allocated_Memory_and_Transient_Attachments](#_lazily_allocated_memory_and_transient_attachments)
- [Sub-allocation and Fragmentation](#_sub_allocation_and_fragmentation)
- [Sub-allocation_and_Fragmentation](#_sub_allocation_and_fragmentation)
- [The Direct-to-Display Workflow (VK_KHR_display)](#_the_direct_to_display_workflow_vk_khr_display)
- [The_Direct-to-Display_Workflow_(VK_KHR_display)](#_the_direct_to_display_workflow_vk_khr_display)
- [Platform-Specific Deep Dives](#_platform_specific_deep_dives)
- [Platform-Specific_Deep_Dives](#_platform_specific_deep_dives)
- [Raspberry Pi: VideoCore VI and VII](#_raspberry_pi_videocore_vi_and_vii)
- [Raspberry_Pi:_VideoCore_VI_and_VII](#_raspberry_pi_videocore_vi_and_vii)
- [Smart Televisions and Set-Top Boxes](#_smart_televisions_and_set_top_boxes)
- [Smart_Televisions_and_Set-Top_Boxes](#_smart_televisions_and_set_top_boxes)
- [Wearables and Smartwatches](#_wearables_and_smartwatches)
- [Wearables_and_Smartwatches](#_wearables_and_smartwatches)
- [Automotive and Vulkan SC](#_automotive_and_vulkan_sc)
- [Automotive_and_Vulkan_SC](#_automotive_and_vulkan_sc)
- [Reliability and Predictability](#_reliability_and_predictability)
- [Reliability_and_Predictability](#_reliability_and_predictability)
...
See the [Tile Based Rendering Best Practices](tile_based_rendering_best_practices.html) chapter for more information on how these GPUs work.
...
* 
**Custom Allocators**: Use the [Memory Allocation](memory_allocation.html) strategies to allocate large blocks (e.g., 64MB or 256MB) and sub-allocate buffers and images within them.
...
* 
[Vulkan Samples](https://github.com/KhronosGroup/Vulkan-Samples): Practical examples of embedded optimizations (subpasses, lazy allocation, pre-rotation).  Several Vulkan Samples work on embedded systems.

* 
[Vulkan Registry](https://registry.khronos.org/vulkan/): Official documentation for the various extensions mentioned above.

* 
[ARM Graphics Developer](https://developer.arm.com/graphics): Detailed documentation on Mali GPU architecture and optimization.

* 
[ARM: AFBC Textures for Vulkan](https://developer.arm.com/documentation/101897/0304/Buffers-and-textures/AFBC-textures-for-Vulkan): Specific guidance on avoiding compression-disabling flags.

* 
[Mesa V3D/V3DV Documentation](https://docs.mesa3d.org/drivers/v3d.html): Technical details on the Raspberry Pi Vulkan driver implementation and the underlying VideoCore architecture.

* 
[Vulkan SC](https://www.khronos.org/vulkansc/): Official page for Safety Critical Vulkan.

* 
[Vulkan Spec: VK_KHR_display](https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#VK_KHR_display): Deep dive into the direct-to-display extension.
