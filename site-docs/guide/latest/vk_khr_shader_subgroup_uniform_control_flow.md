...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/extensions/VK_KHR_shader_subgroup_uniform_control_flow.html

## Table of Contents

- [Overview](#_overview)
- [Example](#_example)
- [Related Extensions](#_related_extensions)
...
the subgroup election if all the invocations in the *workgroup* are converged at
...
* 
[SPV_KHR_subgroup_uniform_control_flow](http://htmlpreview.github.io/?https://github.com/KhronosGroup/SPIRV-Registry/blob/main/extensions/KHR/SPV_KHR_subgroup_uniform_control_flow.html) - adds an execution mode for entry
