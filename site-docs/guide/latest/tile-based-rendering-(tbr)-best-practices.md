...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/tile_based_rendering_best_practices.html

## Table of Contents

- [Understanding Tiler Architectures](#mobile-gpu-architectures)
- [Understanding_Tiler_Architectures](#mobile-gpu-architectures)
- [How Hardware Tilers Work](#tbr-hardware-implementations)
- [How_Hardware_Tilers_Work](#tbr-hardware-implementations)
- [Optimization Strategies for TBR](#tbr-optimization-considerations)
- [Optimization_Strategies_for_TBR](#tbr-optimization-considerations)
- [Attachment Load and Store Ops](#attachment-management)
- [Attachment_Load_and_Store_Ops](#attachment-management)
- [Transient Attachments and Lazy Allocation](#transient-attachments)
- [Transient_Attachments_and_Lazy_Allocation](#transient-attachments)
- [Efficiency with MSAA](#msaa-resolve-patterns)
- [Efficiency_with_MSAA](#msaa-resolve-patterns)
- [TBR vs IMR: A Practical Comparison](#tbr-vs-imr-detailed-analysis)
- [TBR_vs_IMR:_A_Practical_Comparison](#tbr-vs-imr-detailed-analysis)
- [Modern Extensions for Tile Efficiency](#vulkan-extensions-comprehensive-guide)
- [Modern_Extensions_for_Tile_Efficiency](#vulkan-extensions-comprehensive-guide)
- [Dynamic Rendering and Local Reads](#vk-khr-dynamic-rendering-local-read)
- [Dynamic_Rendering_and_Local_Reads](#vk-khr-dynamic-rendering-local-read)
- [Shader Tile Image](#vk-ext-shader-tile-image)
- [Shader_Tile_Image](#vk-ext-shader-tile-image)
- [Advanced Performance Tuning](#performance-considerations)
- [Advanced_Performance_Tuning](#performance-considerations)
- [Pipelining and Barriers](#pipelining-and-barriers)
- [Pipelining_and_Barriers](#pipelining-and-barriers)
- [Depth Testing and Hidden Surface Removal](#depth-and-hsr)
- [Depth_Testing_and_Hidden_Surface_Removal](#depth-and-hsr)
- [Precision and Texture Optimization](#precision-and-prefetch)
- [Precision_and_Texture_Optimization](#precision-and-prefetch)
- [Summary of Best Practices](#best-practices-summary)
- [Summary_of_Best_Practices](#best-practices-summary)
...
**Communicate your intent clearly.** Use `loadOp` and `storeOp` to tell the GPU when it can discard data instead of wasting bandwidth.

**Keep data on-chip.** Leverage transient attachments, lazy memory allocation, and extensions like `VK_KHR_dynamic_rendering_local_read` to avoid external memory round-trips.

**Optimize the binning pass.** Separate vertex positions from other attributes to reduce the amount of data the geometry engine has to read.

**Allow for stage overlap.** Use specific pipeline barriers (e.g., separating `VERTEX_SHADER_BIT` and `FRAGMENT_SHADER_BIT`) to ensure the binning and fragment passes can overlap as much as possible.

**Leverage hardware depth culling.** Use consistent depth comparison operations and enable depth writes whenever possible to keep the hardware’s Hidden Surface Removal (HSR) and early-Z logic active.

**Be smart with textures.** Perform coordinate math in the vertex shader to enable hardware prefetch and group similar sampling operations to leverage texture reuse units.

**Manage precision carefully.** Use `mediump` or explicit 16-bit types to improve bandwidth and occupancy on mobile GPUs, and keep in mind that some desktop GPUs can also benefit from 16-bit math. Always verify the visual results across a range of target hardware.

For more in-depth information, consult the performance guides from major GPU vendors:

* 
**ARM Mali GPU Best Practices**: [Official ARM guidance for tilers](https://developer.arm.com/documentation/101897/latest/)

* 
**Imagination PowerVR Architecture**: [Tiler architecture deep-dive](https://docs.imgtec.com/starter-guides/powervr-architecture/html/index.html)

* 
**HUAWEI Maleoon GPU Best Practices**: [Broadly applicable mobile tiler optimizations](https://developer.huawei.com/consumer/en/doc/best-practices/bpta-maleoon-gpu-best-practices)

* 
**Samsung GPU framebuffer**: [Explains how to optimize framebuffer usage for better performance](https://developer.samsung.com/galaxy-gamedev/resources/articles/gpu-framebuffer.html)
