...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/buffer_device_address_alignment.html

## Table of Contents

- [Setting Alignment Example](#_setting_alignment_example)
- [Setting_Alignment_Example](#_setting_alignment_example)
- [Matching Alignment From The Host](#_matching_alignment_from_the_host)
- [Matching_Alignment_From_The_Host](#_matching_alignment_from_the_host)
...
Take the following GLSL code as an example ([view online](https://godbolt.org/z/G4P8GdG9q))
...
![buffer_device_address_alignment_1.svg](_images/buffer_device_address_alignment_1.svg)
...
If we examine the C++ code here ([https://godbolt.org/z/Gq75qq1x6](https://godbolt.org/z/Gq75qq1x6)) we can see the assembly also automatically maps the offsets the same as the GLSL code above!
