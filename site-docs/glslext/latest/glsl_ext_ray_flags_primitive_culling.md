...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GLSL_EXT_ray_flags_primitive_culling.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
      ...
      #extension GL_EXT_ray_flags_primitive_culling : 
...
(Built-in Variables)
    ...
    The behaviour of traceRayEXT is undefined if the  parameter has
...
Interactions with GL_EXT_ray_tracing/GL_EXT_ray_query
    ...
    The behaviour of rayQueryInitializeEXT is undefined if the  parameter has
