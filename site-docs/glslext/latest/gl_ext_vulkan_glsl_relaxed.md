...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GL_EXT_vulkan_glsl_relaxed.html
...
Overview
    ...
    'gl_AtomicBufferBlock'. The block name will suffixed with '_'.
    Where  is the original binding specified for the
