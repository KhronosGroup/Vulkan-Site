...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GLSL_EXT_spirv_intrinsics.html
...
(Variables and Types)
    ...
    Add a new section 4.14. SPIR-V Types
        ...
        always generate constant instruction s for the parameter; if not,
...
Revision History
    ...
    ----  ----------  -------  -----------------------------------------------
     ...
     9    2023-06-16  thector  Added `spirv_id` qualifier to type parameter
                               lists to differentiate literals from s.
