...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GLSL_EXT_fragment_invocation_density.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
      ...
      #extension GL_EXT_fragment_invocation_density : 
...
Issues
    ...
    (2) How do derivatives work for dFdx and texture LOD calculations when a
      ...
      where  and  are X coordinates of for the two fragment shader
      invocations used for differencing.   is typically either  or
      .  For normal fragment shader invocations, where each fragment
