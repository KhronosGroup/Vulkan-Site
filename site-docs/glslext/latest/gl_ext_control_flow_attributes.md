...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GL_EXT_control_flow_attributes.html
...
Issues
    ...
    1. Should we use namespaces? E.g. . These seem pretty
       universal. OpenCL has .
