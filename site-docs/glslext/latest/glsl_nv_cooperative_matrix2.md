...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/nv/GLSL_NV_cooperative_matrix2.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
      ...
      #extension GL_NV_cooperative_matrix2 : 
...
Add a new Section 4.1.X, Tensor Layout Types
    ...
    Tensor layouts are created by calling:
        ...
        tensorLayoutNV createTensorLayoutNV(uint32_t Dim,
    ...
    The layout's block size can be set by calling
        ...
        tensorLayoutNV setTensorLayoutBlockSizeNV(tensorLayoutNV t, uint32_t blockSize0, ..., uint32_t blockSize);
    ...
    The layout's dimensions and span can be initialized by calling:
        ...
        tensorLayoutNV setTensorLayoutDimensionNV(tensorLayoutNV t, uint32_t dim0, ..., uint32_t dim);
    ...
    The layout's stride can be set by calling:
        ...
        tensorLayoutNV setTensorLayoutStrideNV(tensorLayoutNV t, uint32_t s0, ..., uint32_t s);

    The returned tensorLayoutNV is initialized to a copy of _t_. The
    stride elements are set to the _s_ parameters, in order. s* must be
    at least s*ceiling(dim / t.blockSize[i+1]).

    The offset and span members can be updated by slicing the tensor layout
    by calling:

        tensorLayoutNV sliceTensorLayoutNV(tensorLayoutNV t, int32_t offset0, uint32_t span0, ..., int32_t offset, uint32_t span);
    ...
    Tensor views are created by calling:
        ...
        tensorViewNV> createTensorViewNV(uint32_t Dim,
    ...
    The view's dimensions can be initialized by calling:
        ...
        tensorViewNV setTensorViewDimensionsNV(tensorViewNV v, uint32_t dim0, ..., uint32_t dim);
    ...
    to the product of dim to dim (and viewStride[N-1] is set to 1).

    The view's stride can be set by calling:

        tensorViewNV setTensorViewStrideNV(tensorViewNV v, uint32_t s0, ..., uint32_t s);
...
Modify Section 8.X, Cooperative Matrix Functions
    ...
    (row,col) of the matrix _m_, where _m_ has M rows and N columns:
        ...
        auto spanCoordToTensorCoord(tensorLayoutNV t, Coord spanCoord)
        {
            ...
            for (uint32_t dim = 0; dim = t.layoutDimension[dim]) {
        ...
        uint32_t tensorCoordToLinear(tensorLayoutNV t, Coord blockCoord)
        {
            ...
            for (uint32_t dim = 0; dim  linear index in span -> span coordinate -> tensor coordinate -> linear index in tensor
    ...
    for each (row,col) of the matrix _m_, where _m_ has M rows and N columns:
        ...
        {
            if (row = v.clipRowOffset + v.clipRowSpan ||
...
Examples
    ...
    Load from row-major matrix:
        ...
        tensorLayoutNV t = createTensorLayoutNV(2);
    ...
    Load an 8x8 patch, where each element of the patch has 32 channels
        ...
        // HWC layout
        tensorLayoutNV t = createTensorLayoutNV(3);
    ...
    Perform 2x2 space_to_depth transform while loading from memory:
        ...
        tensorViewNV v = createTensorViewNV(5, true, 0, 2, 1, 3, 4);
