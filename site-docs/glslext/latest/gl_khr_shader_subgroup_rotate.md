...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/khr/GL_KHR_shader_subgroup_rotate.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
      ...
      #extension GL_KHR_shader_subgroup_rotate : 
...
(Built-in Functions)
    ...
    The function subgroupRotate() returns the  whose
     is equal to the remainder of the division
    of this invocation's  plus  by
    .

    If the selected invocation is inactive, an undefined value is returned.

     must be dynamically uniform within the calling subgroub.

    When the addition of  and  results in
