...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/arm/GL_ARM_tensors.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
        ...
        #extension GL_ARM_tensors : 
        #extension GL_ARM_tensors_bfloat16 : 
        #extension GL_ARM_tensors_float_e5m2 : 
        #extension GL_ARM_tensors_float_e4m3 : 
    ...
    The parameters are specified in order between angle brackets ('')
    ...
    Examples of tensor declarations:
        ...
        layout(set=0, binding=0) uniform readonly tensorARM t0;

        // int8 tensor of rank 4 that can only be written.
        layout(set=0, binding=1) uniform writeonly tensorARM t1;

        // int tensor of rank 1 that can be read and written.
        layout(set=0, binding=2) uniform tensorARM t2;
