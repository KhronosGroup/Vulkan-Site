...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GL_EXT_nonuniform_qualifier.html
...
Modifications to GL_KHR_vulkan_glsl
    ...
    Mapping of arrays:
      ...
      include all variables with storage class `Uniform`,
      `StorageBuffer`, or `UniformConstant` (e.g. an array of
