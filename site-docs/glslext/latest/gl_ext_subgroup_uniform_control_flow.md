...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GL_EXT_subgroup_uniform_control_flow.html
...
Modifications to GL_KHR_vulkan_glsl
  ...
  Add to the "Mapping to SPIR-V" section:
   ...
   maps to the SubgroupUniformControlFlowKHR
...
Modifications to the OpenGL Shading Language Specification, Version 4.60 (revision 7)
  ...
  language features described in this extension:
    ...
    #extension GL_EXT_subgroup_uniform_control_flow : 
