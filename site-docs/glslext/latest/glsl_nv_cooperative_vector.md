...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/nv/GLSL_NV_cooperative_vector.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
        ...
        #extension GL_NV_cooperative_vector : 
...
Add a new Section 4.1.X, Cooperative Vector Types
    ...
    Example cooperative vector declaration:
        ...
        coopvecNV vec1; // float16, 6 components
...
Add a new Section 8.X, Cooperative Vector Functions
    ...
    the product before it is stored in 'result'.
        ...
        void coopVecMatMulAddNV(out coopvecNV result,
                                coopvecNV input,
        ...
        void coopVecMatMulNV   (out coopvecNV result,
                                coopvecNV input,
                                int inputInterpretation,
                                const MatrixTy[] matrix,
                                uint matrixOffset,
    ...
    result[j] = sum_{k v, volatile coherent ArrayElemTy[] buf, uint offset);
    ...
    The following function stores a cooperative vector to memory:
        ...
        void coopVecStoreNV(coopvecNV v, volatile coherent ArrayElemTy[] buf, uint offset);
    ...
    (with device scope) accumulated in memory.
        ...
        void coopVecOuterProductAccumulateNV(const coopvecNV v1, const coopvecNV v2,
    ...
    memory.
        ...
        void coopVecReduceSumAccumulateNV(const coopvecNV v,
                                          T[] buf, uint offset);
...
Example syntax:
    ...
    coopvecNV inputVec = coopvecNV(materialstate, shininess, ... );
