...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/nv/GLSL_NV_shader_invocation_reorder.html
...
(Built-in Functions)
    ...
    Result are undefined for negative or out of bounds index.
     ...
     refers to the index of the primitive (triangle or bounding
    box) within  acceleration structure for which this hit object is created.
    ...
    Results are undefined for negative or out of bounds index.
     ...
     is used to describe the kind of intersection for which this hit
    object is created. Refer to 'Fixed Constants' for details

     and  parameters influence the
    ...
    object is created. Refer to 'Fixed Constants' in EXT_ray_tracing for details
     ...
     refers to the record index of the closest-hit shader of
    ...
    Returns 'true' if  encodes a nop, 'false' otherwise.
