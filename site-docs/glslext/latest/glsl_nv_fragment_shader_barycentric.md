...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/nv/GLSL_NV_fragment_shader_barycentric.html
...
Overview
    ...
    the expression "inputs[0].f" reads the value of  for the first vertex
    of the original primitive, while "inputs[2].g" reads the value of  for
    the third vertex.
    ...
    shaders can fetch the values of  for the three vertices of a
    primitive using:
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
      ...
      #extension GL_NV_fragment_shader_barycentric : 
