...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/khr/GL_KHR_memory_scope_semantics.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.50
    ...
    language features described in this extension:
      ...
      #extension GL_KHR_memory_scope_semantics           : 
...
(Built-in Functions)
    ...
    (Add new built-in functions)
        ...
        // Atomically loads the value from  and returns it
        ...
        // Atomically stores the value of  to 
    ...
    (Add new built-in functions)
        ...
        // Atomically stores the value of  to the image
