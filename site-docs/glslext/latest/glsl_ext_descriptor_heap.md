...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/ext/GLSL_EXT_descriptor_heap.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.60
    ...
    language features described in this extension:
      ...
      #extension GL_EXT_descriptor_heap : 
...
(Variables and Types)
    ...
    |-------------------------------------------------------------------------------------|
    | descriptor_heap     |           | arrays of       | arrays of |        | uniform /  |
    |                     |     X     | opaque types    | blocks    |        | buffer     |
    |                     |           | only            | only      |        |            |
    |-------------------------------------------------------------------------------------|
    ...
    Remove the following sentence:
        ...
        It is a compile-time or link-time error to use the same binding
        number for more than one uniform block or for more than one buffer
        block.
    ...
    Add to the end of the section:
        ...
        heap.
        Indexing into a descriptor_heap qualified array will index
    ...
    Add the following sentences:
        ...
        When targeting Vulkan, it is a compile-time or link-time error to use
        the same binding and set numbers for more than one `sampler`,
        `samplerShadow`, or `*sampler*` declaration, for more than one
        `*texture*` or `*sampler*` declaration, or for more than one
        `*image*` declaration, in the same shader stage.
        When targeting OpenGL, it is a compile-time or link-time error
        to use the same binding number for any two declarations in the same
        shader stage, with the exception of two atomic counters with
