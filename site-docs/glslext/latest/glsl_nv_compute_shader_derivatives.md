...
- **Component**: glslext
- **Version**: latest
- **URL**: /glslext/latest/glslext/nv/GLSL_NV_compute_shader_derivatives.html
...
Modifications to the OpenGL Shading Language Specification, Version 4.50
    ...
    language features described in this extension:
      ...
      #extension GL_NV_compute_shader_derivatives : 
    ...
    In all functions below, the  parameter is optional for fragment and
    compute shaders.  ... For a fragment or compute shader, if  is
    present, it is added...
    ...
    , , and  are integers, and  and  must be zero or one.  When
    ...
    integer and  and  must be zero or one.  If neither
    ...
    (x,y) coordinates of (m,n), where values of  and  are zero or one as
    described above.  If F(m,n) specifies the value of F for the invocation at
    (m,n), fine derivatives with respect to  for an invocation at (m,n) are
    evaluated as
