...
Image views for any attachment may be [VK_NULL_HANDLE](../../../../refpages/latest/refpages/source/VK_NULL_HANDLE.html), indicating that writes to the attachment are discarded, and reads return undefined values.
...
A new store operation is provided as originally described by [VK_QCOM_render_pass_store_ops](../../../../refpages/latest/refpages/source/VK_QCOM_render_pass_store_ops.html):
...
If either of [VK_NV_framebuffer_mixed_samples](../../../../refpages/latest/refpages/source/VK_NV_framebuffer_mixed_samples.html) or [VK_AMD_mixed_attachment_samples](../../../../refpages/latest/refpages/source/VK_AMD_mixed_attachment_samples.html) are enabled, the sample counts of color and depth attachments may vary from the `rasterizationSamples`.
...
If [VK_NVX_multiview_per_view_attributes](../../../../refpages/latest/refpages/source/VK_NVX_multiview_per_view_attributes.html) is enabled, the multiview per-view attributes can be specified by including the `VkMultiviewPerViewAttributesInfoNVX` structure in the same `pNext` chain.
...
The [VkDeviceGroupRenderPassBeginInfo](../../../../refpages/latest/refpages/source/VkDeviceGroupRenderPassBeginInfo.html) structure can be chained from `VkRenderingInfoKHR`, with the same effect as when chained to [VkRenderPassBeginInfo](../../../../refpages/latest/refpages/source/VkRenderPassBeginInfo.html) - setting the device mask and setting independent render areas per device.

If [VK_KHR_fragment_shading_rate](../../../../refpages/latest/refpages/source/VK_KHR_fragment_shading_rate.html) is enabled, when calling `vkCmdBeginRenderingKHR`, the following structure should be chained to `VkRenderingInfoKHR` to include a fragment shading rate attachment:
...
If [VK_EXT_fragment_density_map](../../../../refpages/latest/refpages/source/VK_EXT_fragment_density_map.html) is enabled, when calling `vkCmdBeginRenderingKHR`, the following structure should be chained to `VkRenderingInfoKHR` to include a fragment density map attachment:
...
This structure is chained from [VkGraphicsPipelineCreateInfo](../../../../refpages/latest/refpages/source/VkGraphicsPipelineCreateInfo.html):
...
If either of [VK_NV_framebuffer_mixed_samples](../../../../refpages/latest/refpages/source/VK_NV_framebuffer_mixed_samples.html) or [VK_AMD_mixed_attachment_samples](../../../../refpages/latest/refpages/source/VK_AMD_mixed_attachment_samples.html) are enabled, the sample counts of color and depth attachments must be specified at pipeline creation as well.
...
If the structure is omitted, the sample count for each attachment is considered equal to [`VkPipelineMultisampleStateCreateInfo::rasterizationSamples`](../../../../refpages/latest/refpages/source/VkPipelineMultisampleStateCreateInfo.html).

If [VK_KHR_fragment_shading_rate](../../../../refpages/latest/refpages/source/VK_KHR_fragment_shading_rate.html) is enabled, a new rasterization state pipeline creation flag must be provided if a shading rate attachment will be used:

VK_PIPELINE_CREATE_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR

If [VK_EXT_fragment_density_map](../../../../refpages/latest/refpages/source/VK_EXT_fragment_density_map.html) is enabled, a new rasterization state pipeline creation flag must be provided if a fragment density map will be used:
...
If vendors have performance concerns, extensions such as [VK_QCOM_tile_properties](../../../../refpages/latest/refpages/source/VK_QCOM_tile_properties.html) can be exposed, and there may be scope for a future cross-vendor extension.
