...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_maintenance9.html
...
- [2.1. 2D Views of 3D Sparse Images](#_2d_views_of_3d_sparse_images)
- [2.1._2D_Views_of_3D_Sparse_Images](#_2d_views_of_3d_sparse_images)
- [2.2. vkCmdSetEvent2 Without Dependencies](#_vkcmdsetevent2_without_dependencies)
- [2.2._vkCmdSetEvent2_Without_Dependencies](#_vkcmdsetevent2_without_dependencies)
- [2.3. Barriers with 2D array compatible 3D images](#_barriers_with_2d_array_compatible_3d_images)
- [2.3._Barriers_with_2D_array_compatible_3D_images](#_barriers_with_2d_array_compatible_3d_images)
...
- [3.3. vkCmdSetEvent2 Without Dependencies](#_vkcmdsetevent2_without_dependencies_2)
- [3.3._vkCmdSetEvent2_Without_Dependencies](#_vkcmdsetevent2_without_dependencies_2)
- [4. Issues](#_issues)
