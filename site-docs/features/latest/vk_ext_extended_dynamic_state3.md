...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_extended_dynamic_state3.html
...
- [3.1. New Dynamic State](#_new_dynamic_state)
- [3.1._New_Dynamic_State](#_new_dynamic_state)
