...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_legacy_dithering.html
...
- [2.1. Emulation Through Per-Draw Dithering](#_emulation_through_per_draw_dithering)
- [2.1._Emulation_Through_Per-Draw_Dithering](#_emulation_through_per_draw_dithering)
- [2.2. Emulation Through Per-Subpass Dithering](#_emulation_through_per_subpass_dithering)
- [2.2._Emulation_Through_Per-Subpass_Dithering](#_emulation_through_per_subpass_dithering)
- [2.3. Exposing Dithering Hardware Through a Vulkan Extension](#_exposing_dithering_hardware_through_a_vulkan_extension)
- [2.3._Exposing_Dithering_Hardware_Through_a_Vulkan_Extension](#_exposing_dithering_hardware_through_a_vulkan_extension)
- [3. Proposal](#_proposal)
- [3.1. Features](#_features)
- [3.2. Enabling Dithering](#_enabling_dithering)
- [3.2._Enabling_Dithering](#_enabling_dithering)
- [3.3. Limitations](#_limitations)
