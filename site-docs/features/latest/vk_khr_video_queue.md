...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_video_queue.html
...
- [3.2. Video Profiles](#_video_profiles)
- [3.2._Video_Profiles](#_video_profiles)
- [3.3. Video Queues](#_video_queues)
- [3.3._Video_Queues](#_video_queues)
- [3.4. Video Picture Resources](#_video_picture_resources)
- [3.4._Video_Picture_Resources](#_video_picture_resources)
- [3.5. Decoded Picture Buffer](#_decoded_picture_buffer)
- [3.5._Decoded_Picture_Buffer](#_decoded_picture_buffer)
- [3.6. Video Session](#_video_session)
- [3.6._Video_Session](#_video_session)
- [3.7. Video Session Parameters](#_video_session_parameters)
- [3.7._Video_Session_Parameters](#_video_session_parameters)
- [3.8. Command Buffer Commands](#_command_buffer_commands)
- [3.8._Command_Buffer_Commands](#_command_buffer_commands)
- [3.9. Status Queries](#_status_queries)
- [3.9._Status_Queries](#_status_queries)
- [3.10. Device Memory Management](#_device_memory_management)
- [3.10._Device_Memory_Management](#_device_memory_management)
- [3.11. Resource Creation](#_resource_creation)
- [3.11._Resource_Creation](#_resource_creation)
- [3.12. Protected Content Support](#_protected_content_support)
- [3.12._Protected_Content_Support](#_protected_content_support)
- [3.13. Capabilities](#_capabilities)
- [4. Examples](#_examples)
- [4.1. Select queue family with support for a given video codec operation and result status queries](#_select_queue_family_with_support_for_a_given_video_codec_operation_and_result_status_queries)
- [4.1._Select_queue_family_with_support_for_a_given_video_codec_operation_and_result_status_queries](#_select_queue_family_with_support_for_a_given_video_codec_operation_and_result_status_queries)
- [4.2. Check support and query the capabilities for a video profile](#_check_support_and_query_the_capabilities_for_a_video_profile)
- [4.2._Check_support_and_query_the_capabilities_for_a_video_profile](#_check_support_and_query_the_capabilities_for_a_video_profile)
- [4.3. Enumerate supported formats for a video profile with a given usage](#_enumerate_supported_formats_for_a_video_profile_with_a_given_usage)
- [4.3._Enumerate_supported_formats_for_a_video_profile_with_a_given_usage](#_enumerate_supported_formats_for_a_video_profile_with_a_given_usage)
- [4.4. Create video session for a video profile](#_create_video_session_for_a_video_profile)
- [4.4._Create_video_session_for_a_video_profile](#_create_video_session_for_a_video_profile)
- [4.5. Query memory requirements and bind memory to a video session](#_query_memory_requirements_and_bind_memory_to_a_video_session)
- [4.5._Query_memory_requirements_and_bind_memory_to_a_video_session](#_query_memory_requirements_and_bind_memory_to_a_video_session)
- [4.6. Create and update video session parameters objects](#_create_and_update_video_session_parameters_objects)
- [4.6._Create_and_update_video_session_parameters_objects](#_create_and_update_video_session_parameters_objects)
- [4.7. Create bitstream buffer](#_create_bitstream_buffer)
- [4.7._Create_bitstream_buffer](#_create_bitstream_buffer)
- [4.8. Create image and image view backing video picture resources](#_create_image_and_image_view_backing_video_picture_resources)
- [4.8._Create_image_and_image_view_backing_video_picture_resources](#_create_image_and_image_view_backing_video_picture_resources)
- [4.9. Record video coding operations into command buffers](#_record_video_coding_operations_into_command_buffers)
- [4.9._Record_video_coding_operations_into_command_buffers](#_record_video_coding_operations_into_command_buffers)
- [4.10. Create and use result status query pool with a video session](#_create_and_use_result_status_query_pool_with_a_video_session)
- [4.10._Create_and_use_result_status_query_pool_with_a_video_session](#_create_and_use_result_status_query_pool_with_a_video_session)
- [5. Issues](#_issues)
- [5.1. What is within the scope of this extension?](#_what_is_within_the_scope_of_this_extension)
- [5.1._What_is_within_the_scope_of_this_extension?](#_what_is_within_the_scope_of_this_extension)
- [5.2. Are Vulkan video profiles equivalent to the corresponding concepts of video compression standards?](#_are_vulkan_video_profiles_equivalent_to_the_corresponding_concepts_of_video_compression_standards)
- [5.2._Are_Vulkan_video_profiles_equivalent_to_the_corresponding_concepts_of_video_compression_standards?](#_are_vulkan_video_profiles_equivalent_to_the_corresponding_concepts_of_video_compression_standards)
- [5.3. Do we need a query to be able to enumerate all supported video profiles?](#_do_we_need_a_query_to_be_able_to_enumerate_all_supported_video_profiles)
- [5.3._Do_we_need_a_query_to_be_able_to_enumerate_all_supported_video_profiles?](#_do_we_need_a_query_to_be_able_to_enumerate_all_supported_video_profiles)
- [5.4. Do we need queries that allow determining how multiple video profiles can be used in conjunction?](#_do_we_need_queries_that_allow_determining_how_multiple_video_profiles_can_be_used_in_conjunction)
- [5.4._Do_we_need_queries_that_allow_determining_how_multiple_video_profiles_can_be_used_in_conjunction?](#_do_we_need_queries_that_allow_determining_how_multiple_video_profiles_can_be_used_in_conjunction)
- [5.5. What kind of capabilitity queries do we need?](#_what_kind_of_capabilitity_queries_do_we_need)
- [5.5._What_kind_of_capabilitity_queries_do_we_need?](#_what_kind_of_capabilitity_queries_do_we_need)
- [5.6. What kind of command buffer commands do we need?](#_what_kind_of_command_buffer_commands_do_we_need)
- [5.6._What_kind_of_command_buffer_commands_do_we_need?](#_what_kind_of_command_buffer_commands_do_we_need)
- [5.7. How can the application get feedback about the status of video coding operations?](#_how_can_the_application_get_feedback_about_the_status_of_video_coding_operations)
- [5.7._How_can_the_application_get_feedback_about_the_status_of_video_coding_operations?](#_how_can_the_application_get_feedback_about_the_status_of_video_coding_operations)
- [5.8. Do we need to introduce new vkCmdBeginQueryRangeKHR and vkCmdEndQueryRangeKHR commands to allow capturing feedback about multiple video coding operations using a single scope?](#_do_we_need_to_introduce_new_vkcmdbeginqueryrangekhr_and_vkcmdendqueryrangekhr_commands_to_allow_capturing_feedback_about_multiple_video_coding_operations_using_a_single_scope)
- [5.8._Do_we_need_to_introduce_new_vkCmdBeginQueryRangeKHR_and_vkCmdEndQueryRangeKHR_commands_to_allow_capturing_feedback_about_multiple_video_coding_operations_using_a_single_scope?](#_do_we_need_to_introduce_new_vkcmdbeginqueryrangekhr_and_vkcmdendqueryrangekhr_commands_to_allow_capturing_feedback_about_multiple_video_coding_operations_using_a_single_scope)
- [5.9. Can resources be shared across video sessions, potentially ones using different video profiles?](#_can_resources_be_shared_across_video_sessions_potentially_ones_using_different_video_profiles)
- [5.9._Can_resources_be_shared_across_video_sessions,_potentially_ones_using_different_video_profiles?](#_can_resources_be_shared_across_video_sessions_potentially_ones_using_different_video_profiles)
- [5.10. How are video coding operations synchronized with respect to other Vulkan operations?](#_how_are_video_coding_operations_synchronized_with_respect_to_other_vulkan_operations)
- [5.10._How_are_video_coding_operations_synchronized_with_respect_to_other_Vulkan_operations?](#_how_are_video_coding_operations_synchronized_with_respect_to_other_vulkan_operations)
- [5.11. Why do some of the members of VkVideoProfileInfoKHR have Flags types instead of FlagBits types when only a single bit can be used?](#_why_do_some_of_the_members_of_vkvideoprofileinfokhr_have_flags_types_instead_of_flagbits_types_when_only_a_single_bit_can_be_used)
- [5.11._Why_do_some_of_the_members_of_VkVideoProfileInfoKHR_have_Flags_types_instead_of_FlagBits_types_when_only_a_single_bit_can_be_used?](#_why_do_some_of_the_members_of_vkvideoprofileinfokhr_have_flags_types_instead_of_flagbits_types_when_only_a_single_bit_can_be_used)
- [5.12. Can the application create video sessions with any maxDpbSlots and maxActiveReferencePictures values within the supported capabilities?](#_can_the_application_create_video_sessions_with_any_maxdpbslots_and_maxactivereferencepictures_values_within_the_supported_capabilities)
- [5.12._Can_the_application_create_video_sessions_with_any_maxDpbSlots_and_maxActiveReferencePictures_values_within_the_supported_capabilities?](#_can_the_application_create_video_sessions_with_any_maxdpbslots_and_maxactivereferencepictures_values_within_the_supported_capabilities)
- [5.13. Are VkVideoSessionParametersKHR objects internally or externally synchronized?](#_are_vkvideosessionparameterskhr_objects_internally_or_externally_synchronized)
- [5.13._Are_VkVideoSessionParametersKHR_objects_internally_or_externally_synchronized?](#_are_vkvideosessionparameterskhr_objects_internally_or_externally_synchronized)
...
Rely on external sharing capabilities to interact with existing video APIs

Add new dedicated APIs to Vulkan separately for video decoding and video encoding

Add a common set of APIs to Vulkan enabling video coding operations in general
