...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_maintenance6.html
...
- [2.2. New properties](#_new_properties)
- [2.2._New_properties](#_new_properties)
- [2.3. New binding status structure](#_new_binding_status_structure)
- [2.3._New_binding_status_structure](#_new_binding_status_structure)
- [2.4. New index buffer binding functionality](#_new_index_buffer_binding_functionality)
- [2.4._New_index_buffer_binding_functionality](#_new_index_buffer_binding_functionality)
- [2.5. New functions](#_new_functions)
- [2.5._New_functions](#_new_functions)
- [3. Issues](#_issues)
...
you need to size sampled image descriptors with YCbcr conversion, but do not
know which formats will be used (and therefore cannot query it).
...
* 
The `maxCombinedImageSamplerDescriptorCount` property indicates the maximum number of descriptors needed by sampled images with YCbCr conversion
