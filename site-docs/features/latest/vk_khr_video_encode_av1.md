...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_video_encode_av1.html
...
- [3.1. AV1 Specific Nomenclature](#_av1_specific_nomenclature)
- [3.1._AV1_Specific_Nomenclature](#_av1_specific_nomenclature)
- [3.2. Video Std Headers](#_video_std_headers)
- [3.2._Video_Std_Headers](#_video_std_headers)
- [3.3. AV1 Encode Profiles](#_av1_encode_profiles)
- [3.3._AV1_Encode_Profiles](#_av1_encode_profiles)
- [3.4. AV1 Encode Capabilities](#_av1_encode_capabilities)
- [3.4._AV1_Encode_Capabilities](#_av1_encode_capabilities)
- [3.5. AV1 Encode Parameter Sets](#_av1_encode_parameter_sets)
- [3.5._AV1_Encode_Parameter_Sets](#_av1_encode_parameter_sets)
- [3.6. AV1 Encoding Parameters](#_av1_encoding_parameters)
- [3.6._AV1_Encoding_Parameters](#_av1_encoding_parameters)
- [3.7. AV1 Reference Management](#_av1_reference_management)
- [3.7._AV1_Reference_Management](#_av1_reference_management)
- [3.8. AV1 Rate Control](#_av1_rate_control)
- [3.8._AV1_Rate_Control](#_av1_rate_control)
- [4. Examples](#_examples)
- [4.1. Select queue family with AV1 encode support](#_select_queue_family_with_av1_encode_support)
- [4.1._Select_queue_family_with_AV1_encode_support](#_select_queue_family_with_av1_encode_support)
- [4.2. Check support and query the capabilities for an AV1 encode profile](#_check_support_and_query_the_capabilities_for_an_av1_encode_profile)
- [4.2._Check_support_and_query_the_capabilities_for_an_AV1_encode_profile](#_check_support_and_query_the_capabilities_for_an_av1_encode_profile)
...
- [4.4. Record AV1 encode operation producing a key frame that is also set up as a reference](#_record_av1_encode_operation_producing_a_key_frame_that_is_also_set_up_as_a_reference)
- [4.4._Record_AV1_encode_operation_producing_a_key_frame_that_is_also_set_up_as_a_reference](#_record_av1_encode_operation_producing_a_key_frame_that_is_also_set_up_as_a_reference)
- [4.5. Record AV1 encode operation producing an inter frame with a single forward reference](#_record_av1_encode_operation_producing_an_inter_frame_with_a_single_forward_reference)
- [4.5._Record_AV1_encode_operation_producing_an_inter_frame_with_a_single_forward_reference](#_record_av1_encode_operation_producing_an_inter_frame_with_a_single_forward_reference)
- [4.6. Record AV1 encode operation producing an inter frame with a forward and a backward reference](#_record_av1_encode_operation_producing_an_inter_frame_with_a_forward_and_a_backward_reference)
- [4.6._Record_AV1_encode_operation_producing_an_inter_frame_with_a_forward_and_a_backward_reference](#_record_av1_encode_operation_producing_an_inter_frame_with_a_forward_and_a_backward_reference)
- [4.7. Change the rate control configuration of an AV1 encode session with optional AV1 controls](#_change_the_rate_control_configuration_of_an_av1_encode_session_with_optional_av1_controls)
- [4.7._Change_the_rate_control_configuration_of_an_AV1_encode_session_with_optional_AV1_controls](#_change_the_rate_control_configuration_of_an_av1_encode_session_with_optional_av1_controls)
- [5. Issues](#_issues)
...
- [5.2. What are the requirements for the codec-specific input parameters?](#_what_are_the_requirements_for_the_codec_specific_input_parameters)
- [5.2._What_are_the_requirements_for_the_codec-specific_input_parameters?](#_what_are_the_requirements_for_the_codec_specific_input_parameters)
- [5.3. Are OBU extension headers generated by the implementation when multiple temporal or spatial layers are used?](#_are_obu_extension_headers_generated_by_the_implementation_when_multiple_temporal_or_spatial_layers_are_used)
- [5.3._Are_OBU_extension_headers_generated_by_the_implementation_when_multiple_temporal_or_spatial_layers_are_used?](#_are_obu_extension_headers_generated_by_the_implementation_when_multiple_temporal_or_spatial_layers_are_used)
- [5.4. What codec-specific parameters are guaranteed to not be overridden by implementations?](#_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.4._What_codec-specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations?](#_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.5. How is reference picture setup requested for AV1 encode operations?](#_how_is_reference_picture_setup_requested_for_av1_encode_operations)
- [5.5._How_is_reference_picture_setup_requested_for_AV1_encode_operations?](#_how_is_reference_picture_setup_requested_for_av1_encode_operations)
- [5.6. Should we have separate rate control configuration parameters (quantizer indices, frame sizes) for each AV1 prediction mode?](#_should_we_have_separate_rate_control_configuration_parameters_quantizer_indices_frame_sizes_for_each_av1_prediction_mode)
- [5.6._Should_we_have_separate_rate_control_configuration_parameters_(quantizer_indices,_frame_sizes)_for_each_AV1_prediction_mode?](#_should_we_have_separate_rate_control_configuration_parameters_quantizer_indices_frame_sizes_for_each_av1_prediction_mode)
- [5.7. How can the application indicate the use of a primary_ref_frame that is used for CDF data but not for picture prediction?](#_how_can_the_application_indicate_the_use_of_a_primary_ref_frame_that_is_used_for_cdf_data_but_not_for_picture_prediction)
- [5.7._How_can_the_application_indicate_the_use_of_a_primary_ref_frame_that_is_used_for_CDF_data_but_not_for_picture_prediction?](#_how_can_the_application_indicate_the_use_of_a_primary_ref_frame_that_is_used_for_cdf_data_but_not_for_picture_prediction)
- [5.8. Why there is no maxUnidirectionalCompoundGroup2ReferenceCount capability?](#_why_there_is_no_maxunidirectionalcompoundgroup2referencecount_capability)
- [5.8._Why_there_is_no_maxUnidirectionalCompoundGroup2ReferenceCount_capability?](#_why_there_is_no_maxunidirectionalcompoundgroup2referencecount_capability)
- [5.9. Why are implementations allowed to override the coded resolution?](#_why_are_implementations_allowed_to_override_the_coded_resolution)
- [5.9._Why_are_implementations_allowed_to_override_the_coded_resolution?](#_why_are_implementations_allowed_to_override_the_coded_resolution)
...
For more information about individual AV1 bitstream syntax elements, derived values, and, in general, how to interpret these parameters, please refer to the corresponding sections of the [AV1 Specification](https://aomediacodec.github.io/av1-spec/av1-spec.pdf).
