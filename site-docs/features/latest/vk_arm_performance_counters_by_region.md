...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_ARM_performance_counters_by_region.html
...
- [3.3. Enumerating available counters](#_enumerating_available_counters)
- [3.3._Enumerating_available_counters](#_enumerating_available_counters)
- [3.4. Enabling performance counters](#_enabling_performance_counters)
- [3.4._Enabling_performance_counters](#_enabling_performance_counters)
- [4. Examples](#_examples)
- [4.1. Enumerate available counters](#_enumerate_available_counters)
- [4.1._Enumerate_available_counters](#_enumerate_available_counters)
