...
`vkCmdDrawMesh*` commands are added as an interaction with [VK_EXT_mesh_shader](../../../../refpages/latest/refpages/source/VK_EXT_mesh_shader.html), and `vkCmdDraw*IndirectCount2KHR` commands are added as an interaction with [VK_KHR_draw_indirect_count](../../../../refpages/latest/refpages/source/VK_KHR_draw_indirect_count.html) or Vulkan 1.2.
...
Copy commands are based on [VK_KHR_copy_commands2](../../../../refpages/latest/refpages/source/VK_KHR_copy_commands2.html), which is required by this extension.
...
`VkMemoryRangeBarriersInfoKHR` can be chained to [VkDependencyInfo](../../../../refpages/latest/refpages/source/VkDependencyInfo.html) structures to define memory dependencies on memory ranges directly, rather than buffer objects.

A revised version of [vkCmdBeginConditionalRenderingEXT](../../../../refpages/latest/refpages/source/vkCmdBeginConditionalRenderingEXT.html) is added when [VK_EXT_conditional_rendering](../../../../refpages/latest/refpages/source/VK_EXT_conditional_rendering.html) is supported, that functions identically but takes an address range instead of a buffer and offset:
...
Transform feedback commands added by [VK_EXT_transform_feedback](../../../../refpages/latest/refpages/source/VK_EXT_transform_feedback.html) now accept address ranges rather than buffer objects, but are otherwise unmodified.
...
If [VK_AMD_buffer_marker](../../../../refpages/latest/refpages/source/VK_AMD_buffer_marker.html) is supported, a new function is added that accepts an address rather than a buffer.
...
If [VK_KHR_acceleration_structure](../../../../refpages/latest/refpages/source/VK_KHR_acceleration_structure.html) is supported, a new function is added that accepts an address rather than a buffer.
