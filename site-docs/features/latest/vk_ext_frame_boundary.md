...
- [1.1. Graphics applications bypassing the Khronos swapchain](#_graphics_applications_bypassing_the_khronos_swapchain)
- [1.1._Graphics_applications_bypassing_the_Khronos_swapchain](#_graphics_applications_bypassing_the_khronos_swapchain)
- [1.2. Compute-only applications](#_compute_only_applications)
- [1.2._Compute-only_applications](#_compute_only_applications)
- [1.3. Overlapping frames](#_overlapping_frames)
- [1.3._Overlapping_frames](#_overlapping_frames)
- [2. Solution Space](#_solution_space)
- [2._Solution_Space](#_solution_space)
- [3. Proposal](#_proposal)
- [3.1. Overview](#_overview)
- [3.2. The VkFrameBoundaryEXT type](#_the_vkframeboundaryext_type)
- [3.2._The_VkFrameBoundaryEXT_type](#_the_vkframeboundaryext_type)
- [3.3. Validation](#_validation)
- [4. Examples](#_examples)
- [4.1. Compute-only](#_compute_only)
- [4.2. Graphics, sequential frames, not using the KHR swapchain](#_graphics_sequential_frames_not_using_the_khr_swapchain)
- [4.2._Graphics,_sequential_frames,_not_using_the_KHR_swapchain](#_graphics_sequential_frames_not_using_the_khr_swapchain)
