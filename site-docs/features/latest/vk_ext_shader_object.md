...
If [VK_KHR_fragment_shading_rate](../../../../refpages/latest/refpages/source/VK_KHR_fragment_shading_rate.html) is supported and enabled:

* 
`vkCmdSetFragmentShadingRateKHR()`

If [VK_EXT_transform_feedback](../../../../refpages/latest/refpages/source/VK_EXT_transform_feedback.html) is supported and enabled:

* 
`vkCmdSetRasterizationStreamEXT()`

If [VK_EXT_discard_rectangles](../../../../refpages/latest/refpages/source/VK_EXT_discard_rectangles.html) is supported and enabled:
...
If [VK_EXT_conservative_rasterization](../../../../refpages/latest/refpages/source/VK_EXT_conservative_rasterization.html) is supported and enabled:
...
If [VK_EXT_depth_clip_enable](../../../../refpages/latest/refpages/source/VK_EXT_depth_clip_enable.html) is supported and enabled:

* 
`vkCmdSetDepthClipEnableEXT()`

If [VK_EXT_sample_locations](../../../../refpages/latest/refpages/source/VK_EXT_sample_locations.html) is supported and enabled:
...
If [VK_EXT_blend_operation_advanced](../../../../refpages/latest/refpages/source/VK_EXT_blend_operation_advanced.html) is supported and enabled:

* 
`vkCmdSetColorBlendAdvancedEXT()`

If [VK_EXT_provoking_vertex](../../../../refpages/latest/refpages/source/VK_EXT_provoking_vertex.html) is supported and enabled:

* 
`vkCmdSetProvokingVertexModeEXT()`

If [VK_EXT_line_rasterization](../../../../refpages/latest/refpages/source/VK_EXT_line_rasterization.html) is supported and enabled:
...
If [VK_EXT_depth_clip_control](../../../../refpages/latest/refpages/source/VK_EXT_depth_clip_control.html) is supported and enabled:

* 
`vkCmdSetDepthClipNegativeOneToOneEXT()`

If [VK_EXT_color_write_enable](../../../../refpages/latest/refpages/source/VK_EXT_color_write_enable.html) is supported and enabled:

* 
`vkCmdSetColorWriteEnableEXT()`

If [VK_NV_clip_space_w_scaling](../../../../refpages/latest/refpages/source/VK_NV_clip_space_w_scaling.html) is supported and enabled:
...
If [VK_NV_viewport_swizzle](../../../../refpages/latest/refpages/source/VK_NV_viewport_swizzle.html) is supported and enabled:

* 
`vkCmdSetViewportSwizzleNV()`

If [VK_NV_fragment_coverage_to_color](../../../../refpages/latest/refpages/source/VK_NV_fragment_coverage_to_color.html) is supported and enabled:
...
If [VK_NV_framebuffer_mixed_samples](../../../../refpages/latest/refpages/source/VK_NV_framebuffer_mixed_samples.html) is supported and enabled:
...
If [VK_NV_coverage_reduction_mode](../../../../refpages/latest/refpages/source/VK_NV_coverage_reduction_mode.html) is supported and enabled:

* 
`vkCmdSetCoverageReductionModeNV()`

If [VK_NV_representative_fragment_test](../../../../refpages/latest/refpages/source/VK_NV_representative_fragment_test.html) is supported and enabled:

* 
`vkCmdSetRepresentativeFragmentTestEnableNV()`

If [VK_NV_shading_rate_image](../../../../refpages/latest/refpages/source/VK_NV_shading_rate_image.html) is supported and enabled:
...
If [VK_NV_scissor_exclusive](../../../../refpages/latest/refpages/source/VK_NV_scissor_exclusive.html) is supported and enabled:
...
If [VK_NV_fragment_shading_rate_enums](../../../../refpages/latest/refpages/source/VK_NV_fragment_shading_rate_enums.html) is supported and enabled:
