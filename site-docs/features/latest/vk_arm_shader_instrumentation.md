...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_ARM_shader_instrumentation.html
...
- [2.1. Gathering data](#solution-space-gathering-data)
- [2.1._Gathering_data](#solution-space-gathering-data)
- [2.2. Data format](#solution-space-data-format)
- [2.2._Data_format](#solution-space-data-format)
- [3. Proposal](#_proposal)
- [3.1. Overview](#_overview)
- [3.2. Creating/destroying instrumentation objects](#_creatingdestroying_instrumentation_objects)
- [3.2._Creating/destroying_instrumentation_objects](#_creatingdestroying_instrumentation_objects)
- [3.3. Capturing counters](#_capturing_counters)
- [3.3._Capturing_counters](#_capturing_counters)
- [3.4. Processing counters](#_processing_counters)
- [3.4._Processing_counters](#_processing_counters)
- [3.4.1. Enumerating counters](#_enumerating_counters)
- [3.4.1._Enumerating_counters](#_enumerating_counters)
- [3.4.2. Retrieving counters](#_retrieving_counters)
- [3.4.2._Retrieving_counters](#_retrieving_counters)
- [3.4.3. Clearing metric values](#_clearing_metric_values)
- [3.4.3._Clearing_metric_values](#_clearing_metric_values)
- [4. Examples](#_examples)
- [5. Issues](#_issues)
- [5.1. Should we support per-basic-block counters?](#_should_we_support_per_basic_block_counters)
- [5.1._Should_we_support_per-basic-block_counters?](#_should_we_support_per_basic_block_counters)
- [5.2. Can shader objects be instrumented?](#_can_shader_objects_be_instrumented)
- [5.2._Can_shader_objects_be_instrumented?](#_can_shader_objects_be_instrumented)
- [5.3. Should the instrumentation object support a reset operation?](#_should_the_instrumentation_object_support_a_reset_operation)
- [5.3._Should_the_instrumentation_object_support_a_reset_operation?](#_should_the_instrumentation_object_support_a_reset_operation)
- [5.4. The VkShaderInstrumentationCreateInfoARM has no parameters, and can be used to chain additional structures via pNext in the future. Is it worth keeping?](#_the_vkshaderinstrumentationcreateinfoarm_has_no_parameters_and_can_be_used_to_chain_additional_structures_via_pnext_in_the_future_is_it_worth_keeping)
- [5.4._The_VkShaderInstrumentationCreateInfoARM_has_no_parameters,_and_can_be_used_to_chain_additional_structures_via_pNext_in_the_future._Is_it_worth_keeping?](#_the_vkshaderinstrumentationcreateinfoarm_has_no_parameters_and_can_be_used_to_chain_additional_structures_via_pnext_in_the_future_is_it_worth_keeping)
- [6. Validation and Tools](#_validation_and_tools)
- [6._Validation_and_Tools](#_validation_and_tools)
- [6.1. Can tools safely replay with this extension enabled?](#_can_tools_safely_replay_with_this_extension_enabled)
- [6.1._Can_tools_safely_replay_with_this_extension_enabled?](#_can_tools_safely_replay_with_this_extension_enabled)
- [6.2. What happens if a capture is replayed without instrumentation enabled?](#_what_happens_if_a_capture_is_replayed_without_instrumentation_enabled)
- [6.2._What_happens_if_a_capture_is_replayed_without_instrumentation_enabled?](#_what_happens_if_a_capture_is_replayed_without_instrumentation_enabled)
...
[VK_KHR_pipeline_executable_properties](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_KHR_pipeline_executable_properties) is insufficient to address these concerns since the metrics returned here can only cover values known or estimated at compile time.
...
Something that matches how [VK_KHR_pipeline_executable_properties](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_KHR_pipeline_executable_properties) exposes data to the user, but make it apply to an instrumentation object rather than a pipeline/shader object.
...
One struct/entry point for describing the data that contains a unique ID and a description. The struct used for reading out data contains that same unique ID, which can then be used to look up the description. Similar to what is done in [VK_ARM_performance_counter_by_region](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_ARM_performance_counter_by_region). Also similar to (3) but extracts the "name" and "description" from the data struct which requires less memory.
...
for (uint32_t i = 0; i resultIndex resultIndex > target_idx) {
