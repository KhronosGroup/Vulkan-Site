...
The [DirectX 12 Variable Shading Rate](https://microsoft.github.io/DirectX-Specs/d3d/VariableRateShading.html) feature allows applications to specify a shading rate image that is smaller than would be required to provide shading rates for all rendered texels.
...
A new set of structures are included, accessible through [VkPhysicalDeviceLayeredApiPropertiesListKHR](../../../../refpages/latest/refpages/source/VkPhysicalDeviceLayeredApiPropertiesListKHR.html) when chained to [VkPhysicalDeviceProperties2](../../../../refpages/latest/refpages/source/VkPhysicalDeviceProperties2.html).
...
[VkImageSubresourceRange](../../../../refpages/latest/refpages/source/VkImageSubresourceRange.html)::`baseMipLevel`
equal to 0 can
