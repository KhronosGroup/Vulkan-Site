...
A new set of structures are included, accessible through [VkPhysicalDeviceLayeredApiPropertiesListKHR](https://docs.vulkan.org/spec/latest/chapters/limits.html#VkPhysicalDeviceLayeredApiPropertiesListKHR) when chained to [VkPhysicalDeviceProperties2](https://docs.vulkan.org/spec/latest/chapters/devsandqueues.html#VkPhysicalDeviceProperties2).
...
[VkImageSubresourceRange](https://docs.vulkan.org/spec/latest/chapters/resources.html#VkImageSubresourceRange)::`baseMipLevel`
equal to 0 can
