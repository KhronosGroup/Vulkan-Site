...
synchronization, [vkCmdPipelineBarrier](../../../../refpages/latest/refpages/source/vkCmdPipelineBarrier.html)
and [vkCmdPipelineBarrier2](../../../../refpages/latest/refpages/source/vkCmdPipelineBarrier2.html)
can now be called inside a render pass instance started with
[vkCmdBeginRendering](../../../../refpages/latest/refpages/source/vkCmdBeginRendering.html).
...
* 
The stages in the `srcStageMask` and `dstStageMask` members of [VkMemoryBarrier2](../../../../refpages/latest/refpages/source/VkMemoryBarrier2.html) are restricted to framebuffer
space stages.

* 
The access types in the `srcAccessMask` and `dstAccessMask` members of [VkMemoryBarrier2](../../../../refpages/latest/refpages/source/VkMemoryBarrier2.html) are restricted to the
