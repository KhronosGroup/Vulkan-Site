...
Finally, the `VK_TIME_DOMAIN_DEVICE_EXT` is the time domain used by the device for all [vkCmdWriteTimestamp](../../../../refpages/latest/refpages/source/vkCmdWriteTimestamp.html) commands on any queue that supports timestamps.
