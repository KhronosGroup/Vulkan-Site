...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_video_decode_av1.html
...
- [3.2. AV1 Decode Profiles](#_av1_decode_profiles)
- [3.2._AV1_Decode_Profiles](#_av1_decode_profiles)
- [3.3. AV1 Decode Capabilities](#_av1_decode_capabilities)
- [3.3._AV1_Decode_Capabilities](#_av1_decode_capabilities)
- [3.4. AV1 Decode Parameter Sets](#_av1_decode_parameter_sets)
- [3.4._AV1_Decode_Parameter_Sets](#_av1_decode_parameter_sets)
- [3.5. AV1 Decoding Parameters](#_av1_decoding_parameters)
- [3.5._AV1_Decoding_Parameters](#_av1_decoding_parameters)
- [3.6. AV1 Reference Management](#_av1_reference_management)
- [3.6._AV1_Reference_Management](#_av1_reference_management)
- [4. Examples](#_examples)
- [4.1. Select queue family with AV1 decode support](#_select_queue_family_with_av1_decode_support)
- [4.1._Select_queue_family_with_AV1_decode_support](#_select_queue_family_with_av1_decode_support)
- [4.2. Check support and query the capabilities for an AV1 decode profile](#_check_support_and_query_the_capabilities_for_an_av1_decode_profile)
- [4.2._Check_support_and_query_the_capabilities_for_an_AV1_decode_profile](#_check_support_and_query_the_capabilities_for_an_av1_decode_profile)
- [4.3. Create AV1 video session parameters objects](#_create_av1_video_session_parameters_objects)
- [4.3._Create_AV1_video_session_parameters_objects](#_create_av1_video_session_parameters_objects)
- [4.4. Record AV1 decode operation (video session without DPB slots)](#_record_av1_decode_operation_video_session_without_dpb_slots)
- [4.4._Record_AV1_decode_operation_(video_session_without_DPB_slots)](#_record_av1_decode_operation_video_session_without_dpb_slots)
- [4.5. Record AV1 decode operation without reference picture list](#_record_av1_decode_operation_without_reference_picture_list)
- [4.5._Record_AV1_decode_operation_without_reference_picture_list](#_record_av1_decode_operation_without_reference_picture_list)
- [4.6. Record AV1 decode operation with reference picture list](#_record_av1_decode_operation_with_reference_picture_list)
- [4.6._Record_AV1_decode_operation_with_reference_picture_list](#_record_av1_decode_operation_with_reference_picture_list)
- [5. Issues](#_issues)
...
- [5.3. What type of AV1 parameter sets do we want to store in video session parameters objects?](#_what_type_of_av1_parameter_sets_do_we_want_to_store_in_video_session_parameters_objects)
- [5.3._What_type_of_AV1_parameter_sets_do_we_want_to_store_in_video_session_parameters_objects?](#_what_type_of_av1_parameter_sets_do_we_want_to_store_in_video_session_parameters_objects)
- [5.4. What should be the contents of the input bitstream buffer when decoding an AV1 frame?](#_what_should_be_the_contents_of_the_input_bitstream_buffer_when_decoding_an_av1_frame)
- [5.4._What_should_be_the_contents_of_the_input_bitstream_buffer_when_decoding_an_AV1_frame?](#_what_should_be_the_contents_of_the_input_bitstream_buffer_when_decoding_an_av1_frame)
...
- [5.6. Does the application also need to specify the sizes of individual tiles?](#_does_the_application_also_need_to_specify_the_sizes_of_individual_tiles)
- [5.6._Does_the_application_also_need_to_specify_the_sizes_of_individual_tiles?](#_does_the_application_also_need_to_specify_the_sizes_of_individual_tiles)
- [5.7. Does the application also need to specify the offset of the frame header OBU?](#_does_the_application_also_need_to_specify_the_offset_of_the_frame_header_obu)
- [5.7._Does_the_application_also_need_to_specify_the_offset_of_the_frame_header_OBU?](#_does_the_application_also_need_to_specify_the_offset_of_the_frame_header_obu)
- [5.8. Does the application also need to specify the offsets of the tile group OBUs and the range of tiles they cover?](#_does_the_application_also_need_to_specify_the_offsets_of_the_tile_group_obus_and_the_range_of_tiles_they_cover)
- [5.8._Does_the_application_also_need_to_specify_the_offsets_of_the_tile_group_OBUs_and_the_range_of_tiles_they_cover?](#_does_the_application_also_need_to_specify_the_offsets_of_the_tile_group_obus_and_the_range_of_tiles_they_cover)
- [5.9. How do AV1 references map to DPB slot indices?](#_how_do_av1_references_map_to_dpb_slot_indices)
- [5.9._How_do_AV1_references_map_to_DPB_slot_indices?](#_how_do_av1_references_map_to_dpb_slot_indices)
- [5.10. Does AV1 decode support the coincide mode?](#_does_av1_decode_support_the_coincide_mode)
- [5.10._Does_AV1_decode_support_the_coincide_mode?](#_does_av1_decode_support_the_coincide_mode)
- [5.11. Should film grain be a capability or part of the video profile definition?](#_should_film_grain_be_a_capability_or_part_of_the_video_profile_definition)
- [5.11._Should_film_grain_be_a_capability_or_part_of_the_video_profile_definition?](#_should_film_grain_be_a_capability_or_part_of_the_video_profile_definition)
- [5.12. Do the additional memory requirements imposed by AV1 film grain support affect the memory requirements of images created with VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR?](#_do_the_additional_memory_requirements_imposed_by_av1_film_grain_support_affect_the_memory_requirements_of_images_created_with_vk_image_create_video_profile_independent_bit_khr)
- [5.12._Do_the_additional_memory_requirements_imposed_by_AV1_film_grain_support_affect_the_memory_requirements_of_images_created_with_VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR?](#_do_the_additional_memory_requirements_imposed_by_av1_film_grain_support_affect_the_memory_requirements_of_images_created_with_vk_image_create_video_profile_independent_bit_khr)
- [5.13. Does the application has to send frame OBUs that have show_existing_frame set for decoding?](#_does_the_application_has_to_send_frame_obus_that_have_show_existing_frame_set_for_decoding)
- [5.13._Does_the_application_has_to_send_frame_OBUs_that_have_show_existing_frame_set_for_decoding?](#_does_the_application_has_to_send_frame_obus_that_have_show_existing_frame_set_for_decoding)
- [5.14. Are any of the frame_width_minus_1, frame_height_minus_1, render_width_minus_1, and render_height_minus_1 parameters from the frame header redundant with respect to the decoded frame size specified in VkVideoDecodeInfoKHR::dstPictureResource.codedExtent?](#_are_any_of_the_frame_width_minus_1_frame_height_minus_1_render_width_minus_1_and_render_height_minus_1_parameters_from_the_frame_header_redundant_with_respect_to_the_decoded_frame_size_specified_in_vkvideodecodeinfokhrdstpictureresource_codedextent)
- [5.14._Are_any_of_the_frame_width_minus_1,_frame_height_minus_1,_render_width_minus_1,_and_render_height_minus_1_parameters_from_the_frame_header_redundant_with_respect_to_the_decoded_frame_size_specified_in_VkVideoDecodeInfoKHR::dstPictureResource.codedExtent?](#_are_any_of_the_frame_width_minus_1_frame_height_minus_1_render_width_minus_1_and_render_height_minus_1_parameters_from_the_frame_header_redundant_with_respect_to_the_decoded_frame_size_specified_in_vkvideodecodeinfokhrdstpictureresource_codedextent)
- [5.15. Are the extents in superblocks specified by the width_in_sbs_minus_1 and height_in_sbs_minus_1 tile parameters necessary?](#_are_the_extents_in_superblocks_specified_by_the_width_in_sbs_minus_1_and_height_in_sbs_minus_1_tile_parameters_necessary)
- [5.15._Are_the_extents_in_superblocks_specified_by_the_width_in_sbs_minus_1_and_height_in_sbs_minus_1_tile_parameters_necessary?](#_are_the_extents_in_superblocks_specified_by_the_width_in_sbs_minus_1_and_height_in_sbs_minus_1_tile_parameters_necessary)
- [5.16. What codec-specific parameters need to be specified for the active reference pictures?](#_what_codec_specific_parameters_need_to_be_specified_for_the_active_reference_pictures)
- [5.16._What_codec-specific_parameters_need_to_be_specified_for_the_active_reference_pictures?](#_what_codec_specific_parameters_need_to_be_specified_for_the_active_reference_pictures)
- [5.17. How is reference picture setup requested for AV1 decode operations?](#_how_is_reference_picture_setup_requested_for_av1_decode_operations)
- [5.17._How_is_reference_picture_setup_requested_for_AV1_decode_operations?](#_how_is_reference_picture_setup_requested_for_av1_decode_operations)
- [5.18. Are film grain parameters tracked as part of DPB slot reference picture metadata?](#_are_film_grain_parameters_tracked_as_part_of_dpb_slot_reference_picture_metadata)
- [5.18._Are_film_grain_parameters_tracked_as_part_of_DPB_slot_reference_picture_metadata?](#_are_film_grain_parameters_tracked_as_part_of_dpb_slot_reference_picture_metadata)
- [5.19. Should the size of the GmType and gm_params arrays be STD_VIDEO_AV1_NUM_REF_FRAMES or STD_VIDEO_AV1_REFS_PER_FRAME?](#_should_the_size_of_the_gmtype_and_gm_params_arrays_be_std_video_av1_num_ref_frames_or_std_video_av1_refs_per_frame)
- [5.19._Should_the_size_of_the_GmType_and_gm_params_arrays_be_STD_VIDEO_AV1_NUM_REF_FRAMES_or_STD_VIDEO_AV1_REFS_PER_FRAME?](#_should_the_size_of_the_gmtype_and_gm_params_arrays_be_std_video_av1_num_ref_frames_or_std_video_av1_refs_per_frame)
...
For more information about how to parse individual AV1 bitstream syntax elements, calculate derived values, and, in general, how to interpret these parameters, please refer to the corresponding sections of the [AV1 Specification](https://aomediacodec.github.io/av1-spec/av1-spec.pdf).
