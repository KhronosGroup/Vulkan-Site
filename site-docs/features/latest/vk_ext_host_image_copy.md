...
The [vkGetImageSubresourceLayout2EXT](../../../../refpages/latest/refpages/source/vkGetImageSubresourceLayout2.html) function can be used for this purpose:
...
For example, an image that is only created with the `VK_IMAGE_USAGE_SAMPLED_BIT` and `VK_IMAGE_USAGE_TRANSFER_DST_BIT` usage flags set
