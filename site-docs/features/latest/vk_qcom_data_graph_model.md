...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_QCOM_data_graph_model.html
...
- [3.1. Querying engine capabilities](#_querying_engine_capabilities)
- [3.1._Querying_engine_capabilities](#_querying_engine_capabilities)
- [3.2. Foreign pipeline creation](#_foreign_pipeline_creation)
- [3.2._Foreign_pipeline_creation](#_foreign_pipeline_creation)
- [3.2.1. Prepare external pipeline cache](#_prepare_external_pipeline_cache)
- [3.2.1._Prepare_external_pipeline_cache](#_prepare_external_pipeline_cache)
- [3.2.2. Import pipeline cache](#_import_pipeline_cache)
- [3.2.2._Import_pipeline_cache](#_import_pipeline_cache)
- [3.2.3. Create data graph pipeline](#_create_data_graph_pipeline)
- [3.2.3._Create_data_graph_pipeline](#_create_data_graph_pipeline)
- [3.3. Foreign built-in models](#_foreign_built_in_models)
- [3.3._Foreign_built-in_models](#_foreign_built_in_models)
- [3.4. Descriptor sets](#_descriptor_sets)
- [3.4._Descriptor_sets](#_descriptor_sets)
- [3.5. Tensors](#_tensors)
- [3.6. Command buffers](#_command_buffers)
- [3.6._Command_buffers](#_command_buffers)
- [3.7. Synchronization](#_synchronization)
- [3.8. Features structure](#_features_structure)
- [3.8._Features_structure](#_features_structure)
- [4. Example](#_example)
- [4.1. Prepare cache](#_prepare_cache)
- [4.1._Prepare_cache](#_prepare_cache)
- [4.2. Queue properties](#_queue_properties)
- [4.2._Queue_properties](#_queue_properties)
- [4.3. Engine properties](#_engine_properties)
- [4.3._Engine_properties](#_engine_properties)
- [4.4. Create descriptor set layout](#_create_descriptor_set_layout)
- [4.4._Create_descriptor_set_layout](#_create_descriptor_set_layout)
- [4.5. Create pipeline cache](#_create_pipeline_cache)
- [4.5._Create_pipeline_cache](#_create_pipeline_cache)
- [4.6. Create pipeline](#_create_pipeline)
- [4.6._Create_pipeline](#_create_pipeline)
- [4.7. Create tensors](#_create_tensors)
- [4.7._Create_tensors](#_create_tensors)
- [4.8. Create aliased image](#_create_aliased_image)
- [4.8._Create_aliased_image](#_create_aliased_image)
- [4.9. Create descriptors](#_create_descriptors)
- [4.9._Create_descriptors](#_create_descriptors)
- [4.10. Create command pool](#_create_command_pool)
- [4.10._Create_command_pool](#_create_command_pool)
...
[VK_ARM_data_graph](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_ARM_data_graph) to allow applications
...
platforms, such as the Qualcomm® AI Engine.

Image processing is a primary use case for these models, leveraging the Adreno™ GPU for pre- and post-processing
...
* 
[VK_ARM_tensors](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_ARM_tensors) which defines tensor objects that can be used in the model’s inputs and outputs

* 
[VK_ARM_data_graph](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_ARM_data_graph)
...
[vkGetPhysicalDeviceQueueFamilyProperties](https://docs.vulkan.org/spec/latest/chapters/devsandqueues.html#vkGetPhysicalDeviceQueueFamilyProperties)
...
[vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM)
...
[vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM).
...
documentation can be found at the [QNN Documentation](https://docs.qualcomm.com/bundle/publicresource/topics/80-63442-50/introduction.html?product=1601111740009302).

See the [setup](https://docs.qualcomm.com/bundle/publicresource/topics/80-63442-50/setup.html?product=1601111740009302) instructions for information about how to
...
[vkCreatePipelineCache](https://docs.vulkan.org/spec/latest//chapters/pipelines.html#vkCreatePipelineCache) by specifying the blob in the
...
[vkCreateDataGraphPipelinesARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#vkCreateDataGraphPipelinesARM) will
...
the [vkCreateDataGraphPipelinesARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#vkCreateDataGraphPipelinesARM) call.

The appropriate engine type must be attached to the `VkDataGraphPipelineCreateInfoARM::pNext` with the
[VkDataGraphProcessingEngineCreateInfoARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#VkDataGraphProcessingEngineCreateInfoARM)
...
[VkDataGraphPipelineIdentifierCreateInfoARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#VkDataGraphPipelineIdentifierCreateInfoARM)
...
[VkDataGraphPipelineCompilerControlCreateInfoARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#VkDataGraphPipelineCompilerControlCreateInfoARM).
...
[VkExternalMemoryTensorCreateInfoARM](https://docs.vulkan.org/spec/latest/chapters/resources.html#VkExternalMemoryTensorCreateInfoARM) and
...
See the [memory aliasing](https://docs.vulkan.org/spec/latest/chapters/resources.html#resources-memory-aliasing) section for rules about
...
[vkCmdCopyTensorARM](https://docs.vulkan.org/spec/latest/chapters/copies.html#vkCmdCopyTensorARM) to copy it to/from a tensor that is compatible with
the model.
...
[vkGetImageSubresourceLayout](https://docs.vulkan.org/spec/latest/chapters/resources.html#vkGetImageSubresourceLayout) to get
...
The
[vkCmdDispatchDataGraphARM](https://docs.vulkan.org/spec/latest/chapters/VK_ARM_data_graph/graphs.html#vkCmdDispatchDataGraphARM) command
...
[Tensor section](#tensor-compatibility).
