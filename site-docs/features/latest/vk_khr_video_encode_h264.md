...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_video_encode_h264.html
...
- [3.2. H.264 Encode Profiles](#_h_264_encode_profiles)
- [3.2._H.264_Encode_Profiles](#_h_264_encode_profiles)
- [3.3. H.264 Encode Capabilities](#_h_264_encode_capabilities)
- [3.3._H.264_Encode_Capabilities](#_h_264_encode_capabilities)
- [3.4. H.264 Encode Parameter Sets](#_h_264_encode_parameter_sets)
- [3.4._H.264_Encode_Parameter_Sets](#_h_264_encode_parameter_sets)
- [3.5. H.264 Encoding Parameters](#_h_264_encoding_parameters)
- [3.5._H.264_Encoding_Parameters](#_h_264_encoding_parameters)
- [3.6. H.264 Reference Lists](#_h_264_reference_lists)
- [3.6._H.264_Reference_Lists](#_h_264_reference_lists)
- [3.7. H.264 Rate Control](#_h_264_rate_control)
- [3.7._H.264_Rate_Control](#_h_264_rate_control)
- [4. Examples](#_examples)
- [4.1. Select queue family with H.264 encode support](#_select_queue_family_with_h_264_encode_support)
- [4.1._Select_queue_family_with_H.264_encode_support](#_select_queue_family_with_h_264_encode_support)
- [4.2. Check support and query the capabilities for an H.264 encode profile](#_check_support_and_query_the_capabilities_for_an_h_264_encode_profile)
- [4.2._Check_support_and_query_the_capabilities_for_an_H.264_encode_profile](#_check_support_and_query_the_capabilities_for_an_h_264_encode_profile)
...
- [4.4. Record H.264 encode operation producing an I frame that is also set up as a reference](#_record_h_264_encode_operation_producing_an_i_frame_that_is_also_set_up_as_a_reference)
- [4.4._Record_H.264_encode_operation_producing_an_I_frame_that_is_also_set_up_as_a_reference](#_record_h_264_encode_operation_producing_an_i_frame_that_is_also_set_up_as_a_reference)
- [4.5. Record H.264 encode operation producing a P frame with a single forward reference](#_record_h_264_encode_operation_producing_a_p_frame_with_a_single_forward_reference)
- [4.5._Record_H.264_encode_operation_producing_a_P_frame_with_a_single_forward_reference](#_record_h_264_encode_operation_producing_a_p_frame_with_a_single_forward_reference)
- [4.6. Record H.264 encode operation producing a B frame with a forward and a backward reference](#_record_h_264_encode_operation_producing_a_b_frame_with_a_forward_and_a_backward_reference)
- [4.6._Record_H.264_encode_operation_producing_a_B_frame_with_a_forward_and_a_backward_reference](#_record_h_264_encode_operation_producing_a_b_frame_with_a_forward_and_a_backward_reference)
- [4.7. Change the rate control configuration of an H.264 encode session with optional H.264 controls](#_change_the_rate_control_configuration_of_an_h_264_encode_session_with_optional_h_264_controls)
- [4.7._Change_the_rate_control_configuration_of_an_H.264_encode_session_with_optional_H.264_controls](#_change_the_rate_control_configuration_of_an_h_264_encode_session_with_optional_h_264_controls)
- [5. Issues](#_issues)
...
- [5.4. Are interlaced frames supported?](#_are_interlaced_frames_supported)
- [5.4._Are_interlaced_frames_supported?](#_are_interlaced_frames_supported)
- [5.5. Do we want to allow the application to specify separate reference lists for each slice?](#_do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice)
- [5.5._Do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice?](#_do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice)
- [5.6. Are prefix NAL units generated by the implementation when multiple temporal layers are used?](#_are_prefix_nal_units_generated_by_the_implementation_when_multiple_temporal_layers_are_used)
- [5.6._Are_prefix_NAL_units_generated_by_the_implementation_when_multiple_temporal_layers_are_used?](#_are_prefix_nal_units_generated_by_the_implementation_when_multiple_temporal_layers_are_used)
- [5.7. What codec-specific parameters are guaranteed to not be overridden by implementations?](#_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.7._What_codec-specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations?](#_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.8. How is reference picture setup requested for H.264 encode operations?](#_how_is_reference_picture_setup_requested_for_h_264_encode_operations)
- [5.8._How_is_reference_picture_setup_requested_for_H.264_encode_operations?](#_how_is_reference_picture_setup_requested_for_h_264_encode_operations)
...
For more information about individual H.264 bitstream syntax elements, derived values, and, in general, how to interpret these parameters, please refer to the corresponding sections of the [ITU-T H.264 Specification](https://www.itu.int/rec/T-REC-H.264-202108-I/).
