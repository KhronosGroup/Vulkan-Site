...
* 
`VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_EXT` specifies that [submission order](../../../../spec/latest/chapters/synchronization.html#synchronization-submission-order) is not affected by the ordering of sequences, and sequences may be processed in any order.
