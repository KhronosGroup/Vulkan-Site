...
[VK_QUEUE_FAMILY_FOREIGN_EXT](../../../../refpages/latest/refpages/source/VK_QUEUE_FAMILY_FOREIGN_EXT.html)).
...
of [VkDeviceMemory](../../../../refpages/latest/refpages/source/VkDeviceMemory.html) bound to the resource,
where the [VkDeviceMemory](../../../../refpages/latest/refpages/source/VkDeviceMemory.html) has been imported or
exported with an API related to
[VK_KHR_external_memory](../../../../refpages/latest/refpages/source/VK_KHR_external_memory.html).
...
and does not reside in any range of [VkDeviceMemory](../../../../refpages/latest/refpages/source/VkDeviceMemory.html) bound to the resource.
For example, if the external resource is a [VkImage](../../../../refpages/latest/refpages/source/VkImage.html),
...
For example, each [VkDevice](../../../../refpages/latest/refpages/source/VkDevice.html)
...
[VkImageMemoryBarrier](../../../../refpages/latest/refpages/source/VkImageMemoryBarrier.html).
...
during the execution of the [VkImageMemoryBarrier](../../../../refpages/latest/refpages/source/VkImageMemoryBarrier.html).

The problem is especially relevant for systems that implement
[VkSwapchainKHR](../../../../refpages/latest/refpages/source/VkSwapchainKHR.html)
by layering it atop the external memory extensions such as
[VK_EXT_external_memory_dma_buf](../../../../refpages/latest/refpages/source/VK_EXT_external_memory_dma_buf.html).
...
[VK_IMAGE_LAYOUT_PRESENT_SRC_KHR](../../../../refpages/latest/refpages/source/VkImageLayout.html)
after [vkAcquireNextImageKHR](../../../../refpages/latest/refpages/source/vkAcquireNextImageKHR.html).
...
[VkImageLayout](../../../../refpages/latest/refpages/source/VkImageLayout.html) of external images.
...
[VkSwapchainKHR](../../../../refpages/latest/refpages/source/VkSwapchainKHR.html) by layering it atop external
...
[VK_IMAGE_LAYOUT_PRESENT_SRC_LAYOUT_KHR](../../../../refpages/latest/refpages/source/VkImageLayout.html)
(which preserves the image’s pixels) or [VK_IMAGE_LAYOUT_UNDEFINED](../../../../refpages/latest/refpages/source/VkImageLayout.html)
...
* 
**B**. Extend resource creation, such as [VkImageCreateInfo](../../../../refpages/latest/refpages/source/VkImageCreateInfo.html),
...
[VkImageMemoryBarrier](../../../../refpages/latest/refpages/source/VkImageMemoryBarrier.html), with a new
...
engine, such as [vkCreateWaylandSurfaceKHR](../../../../refpages/latest/refpages/source/vkCreateWaylandSurfaceKHR.html),
[VkSwapchainKHR](../../../../refpages/latest/refpages/source/VkSwapchainKHR.html), and
[vkQueuePresentKHR](../../../../refpages/latest/refpages/source/vkQueuePresentKHR.html).
Instead, the application effectively implements these
functions itself with a combination of
[VK_EXT_external_memory_dma_buf](../../../../refpages/latest/refpages/source/VK_EXT_external_memory_dma_buf.html),
[VK_EXT_queue_family_foreign](../../../../refpages/latest/refpages/source/VK_EXT_queue_family_foreign.html),
...
performance hint to [VkImageMemoryBarrier](../../../../refpages/latest/refpages/source/VkImageMemoryBarrier.html) in step (g).
...
[VkSwapchainKHR](../../../../refpages/latest/refpages/source/VkSwapchainKHR.html) atop
[VK_KHR_external_memory](../../../../refpages/latest/refpages/source/VK_KHR_external_memory.html) and native
window system APIs.
...
and transfer commands such as [vkCmdCopyImage](../../../../refpages/latest/refpages/source/vkCmdCopyImage.html).
