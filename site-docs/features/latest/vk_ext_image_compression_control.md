...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_image_compression_control.html
...
- [3.2. Enabling compression](#_enabling_compression)
- [3.2._Enabling_compression](#_enabling_compression)
- [3.3. Querying compression](#_querying_compression)
...
`VK_FORMAT_R8G8B8A8_UNORM` compressed to half *its* original size is 4 bits per channel, 16 bits per pixel.
