...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_multisampled_render_to_single_sampled.html
...
[`vkCmdResolveImage`](https://docs.vulkan.org/spec/latest/chapters/copies.html#vkCmdResolveImage) after the subpass,
...
samples.
This means that
[`VkPipelineMultisampleStateCreateInfo::rasterizationSamples`](https://docs.vulkan.org/spec/latest/chapters/primsrast.html#VkPipelineMultisampleStateCreateInfo)
