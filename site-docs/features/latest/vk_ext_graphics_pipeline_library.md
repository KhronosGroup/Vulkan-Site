...
- [5. Issues](#_issues)
- [5.1. Should the pre-rasterization stages be separated?](#_should_the_pre_rasterization_stages_be_separated)
- [5.1._Should_the_pre-rasterization_stages_be_separated?](#_should_the_pre_rasterization_stages_be_separated)
- [5.2. What is the expected usage model?](#_what_is_the_expected_usage_model)
- [5.2._What_is_the_expected_usage_model?](#_what_is_the_expected_usage_model)
- [5.3. Why is there suggested behavior for the implementation of pipeline caches instead of letting the caching be driven by the application?](#_why_is_there_suggested_behavior_for_the_implementation_of_pipeline_caches_instead_of_letting_the_caching_be_driven_by_the_application)
- [5.3._Why_is_there_suggested_behavior_for_the_implementation_of_pipeline_caches_instead_of_letting_the_caching_be_driven_by_the_application?](#_why_is_there_suggested_behavior_for_the_implementation_of_pipeline_caches_instead_of_letting_the_caching_be_driven_by_the_application)
- [5.4. What are the downsides to using unoptimized pipelines?](#_what_are_the_downsides_to_using_unoptimized_pipelines)
- [5.4._What_are_the_downsides_to_using_unoptimized_pipelines?](#_what_are_the_downsides_to_using_unoptimized_pipelines)
- [5.5. Are there any interactions with specialization constants?](#_are_there_any_interactions_with_specialization_constants)
- [5.5._Are_there_any_interactions_with_specialization_constants?](#_are_there_any_interactions_with_specialization_constants)
- [5.6. Are there any interface matching requirements that will need to change, like SSOs in OpenGL/ES?](#_are_there_any_interface_matching_requirements_that_will_need_to_change_like_ssos_in_opengles)
- [5.6._Are_there_any_interface_matching_requirements_that_will_need_to_change,_like_SSOs_in_OpenGL/ES?](#_are_there_any_interface_matching_requirements_that_will_need_to_change_like_ssos_in_opengles)
- [5.7. Should we allow passing SPIR-V directly into pipeline creation?](#_should_we_allow_passing_spir_v_directly_into_pipeline_creation)
- [5.7._Should_we_allow_passing_SPIR-V_directly_into_pipeline_creation?](#_should_we_allow_passing_spir_v_directly_into_pipeline_creation)
- [5.8. Should we advertise a property for “free link” vs. “fast link”?](#_should_we_advertise_a_property_for_free_link_vs_fast_link)
- [5.8._Should_we_advertise_a_property_for_“free_link”_vs._“fast_link”?](#_should_we_advertise_a_property_for_free_link_vs_fast_link)
- [5.9. Does anyone need the depth/stencil format to be provided with the depth bias state?](#_does_anyone_need_the_depthstencil_format_to_be_provided_with_the_depth_bias_state)
- [5.9._Does_anyone_need_the_depth/stencil_format_to_be_provided_with_the_depth_bias_state?](#_does_anyone_need_the_depthstencil_format_to_be_provided_with_the_depth_bias_state)
- [5.10. With the recommendation to create an optimized pipeline as well as a fast linked pipeline, will this lead to additional memory consumption?](#_with_the_recommendation_to_create_an_optimized_pipeline_as_well_as_a_fast_linked_pipeline_will_this_lead_to_additional_memory_consumption)
- [5.10._With_the_recommendation_to_create_an_optimized_pipeline_as_well_as_a_fast_linked_pipeline,_will_this_lead_to_additional_memory_consumption?](#_with_the_recommendation_to_create_an_optimized_pipeline_as_well_as_a_fast_linked_pipeline_will_this_lead_to_additional_memory_consumption)
- [5.11. Should the link time optimization bits apply to other pipeline libraries (e.g. ray tracing)?](#_should_the_link_time_optimization_bits_apply_to_other_pipeline_libraries_e_g_ray_tracing)
- [5.11._Should_the_link_time_optimization_bits_apply_to_other_pipeline_libraries_(e.g._ray_tracing)?](#_should_the_link_time_optimization_bits_apply_to_other_pipeline_libraries_e_g_ray_tracing)
- [5.12. Does the shader module deprecation apply to other pipelines?](#_does_the_shader_module_deprecation_apply_to_other_pipelines)
- [5.12._Does_the_shader_module_deprecation_apply_to_other_pipelines?](#_does_the_shader_module_deprecation_apply_to_other_pipelines)
- [5.13. Should VkPipelineDepthStencilStateCreateInfo be part of the fragment shader state or fragment output interface state?](#_should_vkpipelinedepthstencilstatecreateinfo_be_part_of_the_fragment_shader_state_or_fragment_output_interface_state)
- [5.13._Should_VkPipelineDepthStencilStateCreateInfo_be_part_of_the_fragment_shader_state_or_fragment_output_interface_state?](#_should_vkpipelinedepthstencilstatecreateinfo_be_part_of_the_fragment_shader_state_or_fragment_output_interface_state)
- [5.14. Should VkPipelineMultisampleStateCreateInfo be required, even when the fragment shader does not make use of multisampling shader features?](#_should_vkpipelinemultisamplestatecreateinfo_be_required_even_when_the_fragment_shader_does_not_make_use_of_multisampling_shader_features)
- [5.14._Should_VkPipelineMultisampleStateCreateInfo_be_required,_even_when_the_fragment_shader_does_not_make_use_of_multisampling_shader_features?](#_should_vkpipelinemultisamplestatecreateinfo_be_required_even_when_the_fragment_shader_does_not_make_use_of_multisampling_shader_features)
- [5.15. Should VkPipelineMultisampleStateCreateInfo be part of the fragment output interface instead?](#_should_vkpipelinemultisamplestatecreateinfo_be_part_of_the_fragment_output_interface_instead)
- [5.15._Should_VkPipelineMultisampleStateCreateInfo_be_part_of_the_fragment_output_interface_instead?](#_should_vkpipelinemultisamplestatecreateinfo_be_part_of_the_fragment_output_interface_instead)
- [5.16. Should we add an explicit result code to pipeline creation to indicate that a pipeline compiled with link time optimization has been returned?](#_should_we_add_an_explicit_result_code_to_pipeline_creation_to_indicate_that_a_pipeline_compiled_with_link_time_optimization_has_been_returned)
- [5.16._Should_we_add_an_explicit_result_code_to_pipeline_creation_to_indicate_that_a_pipeline_compiled_with_link_time_optimization_has_been_returned?](#_should_we_add_an_explicit_result_code_to_pipeline_creation_to_indicate_that_a_pipeline_compiled_with_link_time_optimization_has_been_returned)
- [5.17. Can pipeline caches return optimized pipelines without the VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT set?](#_can_pipeline_caches_return_optimized_pipelines_without_the_vk_pipeline_layout_create_independent_sets_bit_ext_set)
- [5.17._Can_pipeline_caches_return_optimized_pipelines_without_the_VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT_set?](#_can_pipeline_caches_return_optimized_pipelines_without_the_vk_pipeline_layout_create_independent_sets_bit_ext_set)
...
For [VK_KHR_ray_tracing_pipeline](../../../../refpages/latest/refpages/source/VK_KHR_ray_tracing_pipeline.html), pipelines
contain a significant number of shaders - making monolithic compilation
very slow.
[VK_KHR_pipeline_library](../../../../refpages/latest/refpages/source/VK_KHR_pipeline_library.html) allowed
...
[VkPipelineCache](../../../../refpages/latest/refpages/source/VkPipelineCache.html), `basePipelineHandle`,
`basePipelineIndex`,
[VkPipelineCreationFeedbackCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineCreationFeedbackCreateInfo.html),
and
[VkPipelineCompilerControlCreateInfoAMD](../../../../refpages/latest/refpages/source/VkPipelineCompilerControlCreateInfoAMD.html)
parameters are independently consumed and do not need to match between
libraries or for any final pipeline.
[VkPipelineCreateFlags](../../../../refpages/latest/refpages/source/VkPipelineCreateFlags.html) are also
...
The subset of
[VkGraphicsPipelineCreateInfo](../../../../refpages/latest/refpages/source/VkGraphicsPipelineCreateInfo.html)
...
* 
[VkPipelineVertexInputStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineVertexInputStateCreateInfo.html)

* 
[VkPipelineInputAssemblyStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineInputAssemblyStateCreateInfo.html)

A pre-rasterization shader library is defined by the following state:

* 
A valid [VkPipelineShaderStageCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineShaderStageCreateInfo.html)
for each pre-rasterization shader stage used

* 
Within the [VkPipelineLayout](../../../../refpages/latest/refpages/source/VkPipelineLayout.html), all
...
[VkPipelineViewportStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineViewportStateCreateInfo.html)
...
[VkPipelineRasterizationStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineRasterizationStateCreateInfo.html)

[VkPipelineTessellationStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineTessellationStateCreateInfo.html)
is required if tessellation stages are included.

[VkRenderPass](../../../../refpages/latest/refpages/source/VkRenderPass.html) and `subpass` parameter

[VkPipelineRenderingCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineRenderingCreateInfo.html) for the `viewMask` parameter - formats are ignored.

[VkPipelineDiscardRectangleStateCreateInfoEXT](../../../../refpages/latest/refpages/source/VkPipelineDiscardRectangleStateCreateInfoEXT.html)

[VkPipelineFragmentShadingRateStateCreateInfoKHR](../../../../refpages/latest/refpages/source/VkPipelineFragmentShadingRateStateCreateInfoKHR.html)
...
[VkPipelineMultisampleStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineMultisampleStateCreateInfo.html)
if sample shading is enabled or `renderpass` is not `VK_NULL_HANDLE`.

[VkPipelineDepthStencilStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineDepthStencilStateCreateInfo.html)
...
[VkPipelineFragmentShadingRateEnumStateCreateInfoNV](../../../../refpages/latest/refpages/source/VkPipelineFragmentShadingRateEnumStateCreateInfoNV.html)

[VkPipelineRepresentativeFragmentTestStateCreateInfoNV](../../../../refpages/latest/refpages/source/VkPipelineRepresentativeFragmentTestStateCreateInfoNV.html)
...
* 
[VkPipelineColorBlendStateCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineColorBlendStateCreateInfo.html)
...
* 
[VkPipelineRenderingCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineRenderingCreateInfo.html)

* 
[VkAttachmentSampleCountInfoAMD/NV](../../../../refpages/latest/refpages/source/VkAttachmentSampleCountInfoAMD.html)
...
[VkPipelineLibraryCreateInfoKHR](../../../../refpages/latest/refpages/source/VkPipelineLibraryCreateInfoKHR.html) structure in the pNext chain of
[VkGraphicsPipelineCreateInfo](../../../../refpages/latest/refpages/source/VkGraphicsPipelineCreateInfo.html).
...
[VkGraphicsPipelineLibraryCreateInfoEXT](../../../../refpages/latest/refpages/source/VkGraphicsPipelineLibraryCreateInfoEXT.html).
...
deprecated by allowing [VkShaderModuleCreateInfo](../../../../refpages/latest/refpages/source/VkShaderModuleCreateInfo.html) to be chained to
[VkPipelineShaderStageCreateInfo](../../../../refpages/latest/refpages/source/VkPipelineShaderStageCreateInfo.html), and allowing the
[VkShaderModule](../../../../refpages/latest/refpages/source/VkShaderModule.html) to be [VK_NULL_HANDLE](../../../../refpages/latest/refpages/source/VK_NULL_HANDLE.html) in this case.
...
| --- | --- |
[VK_KHR_dynamic_rendering](../../../../refpages/latest/refpages/source/VK_KHR_dynamic_rendering.html) to
...
the same [VkPipelineCache](../../../../refpages/latest/refpages/source/VkPipelineCache.html), to avoid unnecessary lookup overhead.
...
Using a [VkPipelineCache](../../../../refpages/latest/refpages/source/VkPipelineCache.html) for this suboptimal pipeline is recommended;
