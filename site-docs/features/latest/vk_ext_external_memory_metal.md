...
While [VK_EXT_metal_objects](../../../../refpages/latest/refpages/source/VK_EXT_metal_objects.html) provides a way to expose underlying Metal resources,
when importing an image from an `id` handle, said images and their backing memory will be imported at
[VkImage](../../../../refpages/latest/refpages/source/VkImage.html) creation.
According to point [12.8 Memory Resource Association](../../../../spec/latest/chapters/resources.html#resources-association)
...
[VK_EXT_metal_objects](../../../../refpages/latest/refpages/source/VK_EXT_metal_objects.html) differently.

This extension aims to import both resources through [VkDeviceMemory](../../../../refpages/latest/refpages/source/VkDeviceMemory.html)
so that later can be bound to a existing
[VkImage](../../../../refpages/latest/refpages/source/VkImage.html) or
[VkBuffer](../../../../refpages/latest/refpages/source/VkBuffer.html) respectively.

This extension aims to standardize memory imports and exports of Vulkan resources using
[VK_KHR_external_memory](../../../../refpages/latest/refpages/source/VK_KHR_external_memory.html) as baseline to conform to what other platforms have done with
extensions like [VK_KHR_external_memory_win32](../../../../refpages/latest/refpages/source/VK_KHR_external_memory_win32.html) and
[VK_ANDROID_external_memory_android_hardware_buffer](../../../../refpages/latest/refpages/source/VK_ANDROID_external_memory_android_hardware_buffer.html) to name a few.

This means that external Metal resources will be imported through [VkDeviceMemory](../../../../refpages/latest/refpages/source/VkDeviceMemory.html) to later be bound.

3 new bit values will be added to [VkExternalMemoryHandleTypeFlagBits](../../../../refpages/latest/refpages/source/VkExternalMemoryHandleTypeFlagBits.html):
...
[VkDeviceMemory](../../../../refpages/latest/refpages/source/VkDeviceMemory.html), the
[VkImage](../../../../refpages/latest/refpages/source/VkImage.html) it will be bound to must have the same
