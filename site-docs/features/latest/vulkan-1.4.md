...
The [`VK_KHR_global_priority`](../../../../refpages/latest/refpages/source/VK_KHR_global_priority.html) extension is promoted in its entirety to Vulkan 1.4.
...
* 
[`VK_KHR_load_store_op_none`](../../../../refpages/latest/refpages/source/VK_KHR_load_store_op_none.html)

* 
[`VK_KHR_shader_subgroup_rotate`](../../../../refpages/latest/refpages/source/VK_KHR_shader_subgroup_rotate.html)

* 
[`VK_KHR_shader_float_controls2`](../../../../refpages/latest/refpages/source/VK_KHR_shader_float_controls2.html)

* 
[`VK_KHR_shader_expect_assume`](../../../../refpages/latest/refpages/source/VK_KHR_shader_expect_assume.html)

* 
[`VK_KHR_line_rasterization`](../../../../refpages/latest/refpages/source/VK_KHR_line_rasterization.html)

* 
[`VK_KHR_vertex_attribute_divisor`](../../../../refpages/latest/refpages/source/VK_KHR_vertex_attribute_divisor.html)

* 
[`VK_KHR_index_type_uint8`](../../../../refpages/latest/refpages/source/VK_KHR_index_type_uint8.html)

* 
[`VK_KHR_map_memory2`](../../../../refpages/latest/refpages/source/VK_KHR_map_memory2.html)

* 
[`VK_KHR_maintenance5`](../../../../refpages/latest/refpages/source/VK_KHR_maintenance5.html)

* 
[`VK_KHR_push_descriptor`](../../../../refpages/latest/refpages/source/VK_KHR_push_descriptor.html)

Additionally, [`VK_KHR_dynamic_rendering_local_read`](../../../../refpages/latest/refpages/source/VK_KHR_dynamic_rendering_local_read.html) is partially promoted; implementations must support local read for storage resources and single sampled color attachments.
...
* 
[`VK_KHR_maintenance6`](../../../../refpages/latest/refpages/source/VK_KHR_maintenance6.html)

* 
[`VK_EXT_pipeline_protected_access`](../../../../refpages/latest/refpages/source/VK_EXT_pipeline_protected_access.html)

* 
[`VK_EXT_pipeline_robustness`](../../../../refpages/latest/refpages/source/VK_EXT_pipeline_robustness.html)

Clustered subgroup operations must also be advertised in Vulkan 1.4 via setting both `VK_SUBGROUP_FEATURE_CLUSTERED_BIT` and `VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT` (as an interaction with the newly-promoted [`VK_KHR_shader_subgroup_rotate`](../../../../refpages/latest/refpages/source/VK_KHR_shader_subgroup_rotate.html) extension) in `subgroupSupportedOperations`.
...
Vendors are free to expose a dedicated transfer queue if they have one, and more recently [`VK_EXT_host_image_copy`](../../../../refpages/latest/refpages/source/VK_EXT_host_image_copy.html) has enabled drivers to advertise host copies as an option if they do not have a separate transfer queue.
...
* 
[`VK_EXT_host_image_copy`](../../../../refpages/latest/refpages/source/VK_EXT_host_image_copy.html) is promoted to core, but supporting its functionality is optional
...
* 
`pushDescriptor`, which is added as an additional feature for the functionality of [`VK_KHR_push_descriptor`](../../../../refpages/latest/refpages/source/VK_KHR_push_descriptor.html) and is required
