...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_shader_float_controls2.html
...
- [3. Issues](#_issues)
- [3.1. Should support for all combinations of float controls be required?](#_should_support_for_all_combinations_of_float_controls_be_required)
- [3.1._Should_support_for_all_combinations_of_float_controls_be_required?](#_should_support_for_all_combinations_of_float_controls_be_required)
- [3.2. Which extended instructions should support float controls?](#_which_extended_instructions_should_support_float_controls)
- [3.2._Which_extended_instructions_should_support_float_controls?](#_which_extended_instructions_should_support_float_controls)
