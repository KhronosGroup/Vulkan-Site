...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_pipeline_protected_access.html
...
- [2.1. Per Pipeline Protected Access Flag](#_per_pipeline_protected_access_flag)
- [2.1._Per_Pipeline_Protected_Access_Flag](#_per_pipeline_protected_access_flag)
- [2.2. Per Usage Access Flags](#_per_usage_access_flags)
- [2.2._Per_Usage_Access_Flags](#_per_usage_access_flags)
- [2.3. Per Resource Access Flags](#_per_resource_access_flags)
- [2.3._Per_Resource_Access_Flags](#_per_resource_access_flags)
