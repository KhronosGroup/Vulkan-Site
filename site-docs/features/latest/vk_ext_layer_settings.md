...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_layer_settings.html
...
`VK_EXT_layer_settings` extends the `pNext` chain of [VkInstanceCreateInfo](https://docs.vulkan.org/spec/latest/chapters/initialization.html#VkInstanceCreateInfo) to
