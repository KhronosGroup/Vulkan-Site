...
Two new [VkComponentTypeKHR](../../../../refpages/latest/refpages/source/VkComponentTypeKHR.html) are added that can be reported as supported by [vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR](../../../../refpages/latest/refpages/source/vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.html):
...
If `shaderFloat8CooperativeMatrix` is supported, at least one entry in [vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR::pProperties](../../../../refpages/latest/refpages/source/vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.html) must include this type in all of its `AType`, `BType`, and `CType` members.
