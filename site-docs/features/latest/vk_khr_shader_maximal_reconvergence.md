...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_shader_maximal_reconvergence.html
...
- [3.1. SPV_KHR_maximal_reconvergence](#_spv_khr_maximal_reconvergence)
...
[tangled
instructions](https://www.khronos.org/registry/SPIR-V/specs/unified1/SPIRV.html#tangled_instruction).
...
The
[guarantees](https://www.khronos.org/registry/SPIR-V/specs/unified1/SPIRV.html#uniform_control_flow)
...
Add new mechanisms to SPIR-V, and optionally HLLs, that provide explicit
divergence and reconvergence information directly in the shader.

Add new guarantees to SPIR-V (through a new execution mode) that guarantee
...
[guide
for VK_KHR_shader_subgroup_uniform_control flow](https://github.com/KhronosGroup/Vulkan-Guide/blob/main/chapters/extensions/VK_KHR_shader_subgroup_uniform_control_flow.adoc).
