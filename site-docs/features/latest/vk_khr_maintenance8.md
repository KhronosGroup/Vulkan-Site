...
When `VK_DEPENDENCY_QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES_BIT_KHR` is included in [VkDependencyFlags](../../../../refpages/latest/refpages/source/VkDependencyFlags.html), buffer and image memory barriers that specify queue family ownership transfers will make use of both synchronization scopes.
