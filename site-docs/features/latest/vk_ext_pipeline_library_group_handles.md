...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_pipeline_library_group_handles.html
...
- [4. Example](#_example)
- [4.1. Incrementally linking](#_incrementally_linking)
- [4.1._Incrementally_linking](#_incrementally_linking)
