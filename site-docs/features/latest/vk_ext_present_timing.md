...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_present_timing.html
...
- [3.2. Present stages](#present_stages)
- [3.2._Present_stages](#present_stages)
- [3.3. Enabling present timing for a swapchain](#_enabling_present_timing_for_a_swapchain)
- [3.3._Enabling_present_timing_for_a_swapchain](#_enabling_present_timing_for_a_swapchain)
- [3.4. Swapchain Timing Information](#_swapchain_timing_information)
- [3.4._Swapchain_Timing_Information](#_swapchain_timing_information)
- [3.4.1. Timing Properties](#_timing_properties)
- [3.4.1._Timing_Properties](#_timing_properties)
- [3.4.2. Time Domains](#_time_domains)
- [3.4.2._Time_Domains](#_time_domains)
- [3.5. Presentation timings feedback](#statistics)
- [3.5._Presentation_timings_feedback](#statistics)
- [3.6. Scheduling presents](#scheduling)
- [3.6._Scheduling_presents](#scheduling)
- [4. Examples](#_examples)
- [4.1. Enabling present timing for a swapchain](#_enabling_present_timing_for_a_swapchain_2)
- [4.1._Enabling_present_timing_for_a_swapchain](#_enabling_present_timing_for_a_swapchain_2)
- [4.2. Query presentation timing results](#_query_presentation_timing_results)
- [4.2._Query_presentation_timing_results](#_query_presentation_timing_results)
- [4.3. Handling VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT: waiting for results](#_handling_vk_error_present_timing_queue_full_ext_waiting_for_results)
- [4.3._Handling_VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT:_waiting_for_results](#_handling_vk_error_present_timing_queue_full_ext_waiting_for_results)
- [4.4. Setting absolute target present times](#_setting_absolute_target_present_times)
- [4.4._Setting_absolute_target_present_times](#_setting_absolute_target_present_times)
- [5. Issues](#_issues)
...
- [5.5._PROPOSED:_How_are_dropped_presentation_requests_handled?](#_proposed_how_are_dropped_presentation_requests_handled)
...
- [5.6._PROPOSED:_How_do_different_variable_refresh_rate_technologies_interact_with_this_extension?](#_proposed_how_do_different_variable_refresh_rate_technologies_interact_with_this_extension)
- [5.7. PROPOSED: How does an application adjust its IPD to match the swapchain’s refresh rate?](#_proposed_how_does_an_application_adjust_its_ipd_to_match_the_swapchains_refresh_rate)
- [5.7._PROPOSED:_How_does_an_application_adjust_its_IPD_to_match_the_swapchain’s_refresh_rate?](#_proposed_how_does_an_application_adjust_its_ipd_to_match_the_swapchains_refresh_rate)
...
In addition of the present timing and present scheduling features, surfaces also advertise which [Present stages](#present_stages) are available to query timings for.
...
When queueing a presentation request for a swapchain, a set of present stages is specified to inform the implementation that timing for those stages is desired. See [Presentation timings feedback](#statistics).
...
Similar to [Timing Properties](#_timing_properties), supported time domains may change dynamically. `pTimeDomainsCounter` identifies the current list of available time domains, and further internal changes to this list are notified to the application when calling `vkGetPastPresentationTimingEXT`.
