...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_maintenance10.html
...
- [2.1. New image format feature bits](#_new_image_format_feature_bits)
- [2.1._New_image_format_feature_bits](#_new_image_format_feature_bits)
- [2.2. vkCmdSetSampleMaskEXT called with pSampleMask=NULL](#_vkcmdsetsamplemaskext_called_with_psamplemasknull)
- [2.2._vkCmdSetSampleMaskEXT_called_with_pSampleMask=NULL](#_vkcmdsetsamplemaskext_called_with_psamplemasknull)
- [2.3. vkCmdEndRendering2KHR](#_vkcmdendrendering2khr)
- [2.4. Add flags for extending dynamic rendering attachment info](#_add_flags_for_extending_dynamic_rendering_attachment_info)
- [2.4._Add_flags_for_extending_dynamic_rendering_attachment_info](#_add_flags_for_extending_dynamic_rendering_attachment_info)
- [2.5. Add input attachment information to dynamic rendering](#_add_input_attachment_information_to_dynamic_rendering)
- [2.5._Add_input_attachment_information_to_dynamic_rendering](#_add_input_attachment_information_to_dynamic_rendering)
- [2.6. Clarifying the behavior of sRGB vertex input formats](#_clarifying_the_behavior_of_srgb_vertex_input_formats)
- [2.6._Clarifying_the_behavior_of_sRGB_vertex_input_formats](#_clarifying_the_behavior_of_srgb_vertex_input_formats)
- [2.7. Add resolve modes and depth-stencil resolve support to vkCmdResolveImage2](#_add_resolve_modes_and_depth_stencil_resolve_support_to_vkcmdresolveimage2)
- [2.7._Add_resolve_modes_and_depth-stencil_resolve_support_to_vkCmdResolveImage2](#_add_resolve_modes_and_depth_stencil_resolve_support_to_vkcmdresolveimage2)
- [2.8. Make multi-sampled sRGB format resolves well defined](#_make_multi_sampled_srgb_format_resolves_well_defined)
- [2.8._Make_multi-sampled_sRGB_format_resolves_well_defined](#_make_multi_sampled_srgb_format_resolves_well_defined)
- [3. Issues](#_issues)
