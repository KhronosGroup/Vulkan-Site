...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_unified_image_layouts.html
...
- [3.1. Replacing Transition Out Of VK_IMAGE_LAYOUT_UNDEFINED](#_replacing_transition_out_of_vk_image_layout_undefined)
- [3.1._Replacing_Transition_Out_Of_VK_IMAGE_LAYOUT_UNDEFINED](#_replacing_transition_out_of_vk_image_layout_undefined)
- [3.2. Replacing VK_IMAGE_LAYOUT_PREINITIALIZED](#_replacing_vk_image_layout_preinitialized)
- [3.2._Replacing_VK_IMAGE_LAYOUT_PREINITIALIZED](#_replacing_vk_image_layout_preinitialized)
- [3.3. Replacing VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT](#_replacing_vk_image_layout_attachment_feedback_loop_optimal_ext)
- [3.3._Replacing_VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT](#_replacing_vk_image_layout_attachment_feedback_loop_optimal_ext)
- [3.4. Replacing VK_IMAGE_LAYOUT_PRESENT_SRC_KHR and VK_IMAGE_LAYOUT_SHARED_PRESENT_KHR](#_replacing_vk_image_layout_present_src_khr_and_vk_image_layout_shared_present_khr)
- [3.4._Replacing_VK_IMAGE_LAYOUT_PRESENT_SRC_KHR_and_VK_IMAGE_LAYOUT_SHARED_PRESENT_KHR](#_replacing_vk_image_layout_present_src_khr_and_vk_image_layout_shared_present_khr)
- [3.5. Replacing Vulkan Video Layouts](#_replacing_vulkan_video_layouts)
- [3.5._Replacing_Vulkan_Video_Layouts](#_replacing_vulkan_video_layouts)
- [4. Issues](#_issues)
- [4.1. Can VK_IMAGE_LAYOUT_UNDEFINED be avoided in this extension?](#_can_vk_image_layout_undefined_be_avoided_in_this_extension)
- [4.1._Can_VK_IMAGE_LAYOUT_UNDEFINED_be_avoided_in_this_extension?](#_can_vk_image_layout_undefined_be_avoided_in_this_extension)
- [4.2. Should VK_IMAGE_LAYOUT_PREINITIALIZED be replaced by VK_IMAGE_LAYOUT_GENERAL?](#_should_vk_image_layout_preinitialized_be_replaced_by_vk_image_layout_general)
- [4.2._Should_VK_IMAGE_LAYOUT_PREINITIALIZED_be_replaced_by_VK_IMAGE_LAYOUT_GENERAL?](#_should_vk_image_layout_preinitialized_be_replaced_by_vk_image_layout_general)
- [4.3. Should VK_IMAGE_LAYOUT_PRESENT_SRC_KHR be replaced by VK_IMAGE_LAYOUT_GENERAL and a queue family ownership transfer?](#_should_vk_image_layout_present_src_khr_be_replaced_by_vk_image_layout_general_and_a_queue_family_ownership_transfer)
- [4.3._Should_VK_IMAGE_LAYOUT_PRESENT_SRC_KHR_be_replaced_by_VK_IMAGE_LAYOUT_GENERAL_and_a_queue_family_ownership_transfer?](#_should_vk_image_layout_present_src_khr_be_replaced_by_vk_image_layout_general_and_a_queue_family_ownership_transfer)
- [4.4. Can VK_IMAGE_LAYOUT_SHARED_PRESENT_KHR be replaced by VK_IMAGE_LAYOUT_GENERAL?](#_can_vk_image_layout_shared_present_khr_be_replaced_by_vk_image_layout_general)
- [4.4._Can_VK_IMAGE_LAYOUT_SHARED_PRESENT_KHR_be_replaced_by_VK_IMAGE_LAYOUT_GENERAL?](#_can_vk_image_layout_shared_present_khr_be_replaced_by_vk_image_layout_general)
- [4.5. Can the Vulkan Video layouts be replaced by VK_IMAGE_LAYOUT_GENERAL?](#_can_the_vulkan_video_layouts_be_replaced_by_vk_image_layout_general)
- [4.5._Can_the_Vulkan_Video_layouts_be_replaced_by_VK_IMAGE_LAYOUT_GENERAL?](#_can_the_vulkan_video_layouts_be_replaced_by_vk_image_layout_general)
- [4.6. Can VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT be replaced by VK_IMAGE_LAYOUT_GENERAL?](#_can_vk_image_layout_attachment_feedback_loop_optimal_ext_be_replaced_by_vk_image_layout_general)
- [4.6._Can_VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT_be_replaced_by_VK_IMAGE_LAYOUT_GENERAL?](#_can_vk_image_layout_attachment_feedback_loop_optimal_ext_be_replaced_by_vk_image_layout_general)
- [4.7. Should image layouts in the API be ignored, required to be VK_IMAGE_LAYOUT_GENERAL, or simply provide the possibility of that layout and a guarantee of efficiency?](#_should_image_layouts_in_the_api_be_ignored_required_to_be_vk_image_layout_general_or_simply_provide_the_possibility_of_that_layout_and_a_guarantee_of_efficiency)
- [4.7._Should_image_layouts_in_the_API_be_ignored,_required_to_be_VK_IMAGE_LAYOUT_GENERAL,_or_simply_provide_the_possibility_of_that_layout_and_a_guarantee_of_efficiency?](#_should_image_layouts_in_the_api_be_ignored_required_to_be_vk_image_layout_general_or_simply_provide_the_possibility_of_that_layout_and_a_guarantee_of_efficiency)
...
For some drivers, they are *all* identical.
...
This image layout is identical to `VK_IMAGE_LAYOUT_GENERAL` in this extension, but `VK_IMAGE_LAYOUT_GENERAL` is *not* allowed when creating an image.
...
These layouts *are* different from `VK_IMAGE_LAYOUT_GENERAL`, due to interaction with components outside of Vulkan, namely the operating system’s compositor.
...
Since then however, `VK_QUEUE_FAMILY_EXTERNAL` and `VK_QUEUE_FAMILY_FOREIGN_EXT` in [queue family ownership transfers](https://docs.vulkan.org/spec/latest/chapters/synchronization.html#synchronization-queue-transfers) provided a better mechanism to interact with such external entities.
...
No.
While *technically* replacing `VK_IMAGE_LAYOUT_PREINITIALIZED` with `VK_IMAGE_LAYOUT_GENERAL` during image creation would have worked, mistakenly using `VK_IMAGE_LAYOUT_GENERAL` instead of `VK_IMAGE_LAYOUT_UNDEFINED` would have been hard to catch in validation layers.
