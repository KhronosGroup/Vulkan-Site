...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_ARM_tensors.html
...
- [2.1. Structured buffers](#_structured_buffers)
- [2.1._Structured_buffers](#_structured_buffers)
- [2.2. Extended images](#_extended_images)
- [2.2._Extended_images](#_extended_images)
- [2.3. New tensor resource type](#_new_tensor_resource_type)
- [2.3._New_tensor_resource_type](#_new_tensor_resource_type)
- [3. Proposal](#_proposal)
- [3.1. API additions](#_api_additions)
- [3.1._API_additions](#_api_additions)
- [3.2. SPIR-V support](#_spir_v_support)
- [3.2._SPIR-V_support](#_spir_v_support)
- [3.2.1. Type system](#_type_system)
- [3.2.1._Type_system](#_type_system)
- [3.2.2. Accessors](#_accessors)
- [3.2.3. Size queries](#_size_queries)
- [3.2.3._Size_queries](#_size_queries)
- [3.3. GLSL support](#_glsl_support)
- [3.3._GLSL_support](#_glsl_support)
...
const std::array dimensions = { 1, 16, 16, 16 };
...
layout(set = 0, binding = 0) uniform tensorARM intensor;
layout(set = 0, binding = 1) uniform tensorARM outtensor;
