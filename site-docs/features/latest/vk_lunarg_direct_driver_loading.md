...
[VkInstanceCreateInfo](../../../../refpages/latest/refpages/source/VkInstanceCreateInfo.html) to provide a list
of structures which contain the information needed by the loader to load the drivers.
This is achieved by providing the driver’s [vkGetInstanceProcAddr](../../../../refpages/latest/refpages/source/vkGetInstanceProcAddr.html),
