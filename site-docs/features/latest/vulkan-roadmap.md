...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/Roadmap.html
...
- [3.1. Target Markets](#_target_markets)
- [3.1._Target_Markets](#_target_markets)
- [3.2. Defining the roadmap](#_defining_the_roadmap)
- [3.2._Defining_the_roadmap](#_defining_the_roadmap)
- [3.3. Milestone release cadence](#_milestone_release_cadence)
- [3.3._Milestone_release_cadence](#_milestone_release_cadence)
- [3.4. Criteria for including a feature in a milestone](#_criteria_for_including_a_feature_in_a_milestone)
- [3.4._Criteria_for_including_a_feature_in_a_milestone](#_criteria_for_including_a_feature_in_a_milestone)
- [3.5. Milestone Documentation](#_milestone_documentation)
- [3.5._Milestone_Documentation](#_milestone_documentation)
- [3.6. Initial milestone](#_initial_milestone)
- [3.6._Initial_milestone](#_initial_milestone)
