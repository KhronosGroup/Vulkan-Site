...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_AMD_gpa_interface.html
...
- [3.1. Session handle](#_session_handle)
- [3.1._Session_handle](#_session_handle)
- [3.2. Session creation/destruction](#_session_creationdestruction)
- [3.2._Session_creation/destruction](#_session_creationdestruction)
- [3.3. Setting and getting clock information](#_setting_and_getting_clock_information)
- [3.3._Setting_and_getting_clock_information](#_setting_and_getting_clock_information)
- [3.3.1. Setting the clock mode](#_setting_the_clock_mode)
- [3.3.1._Setting_the_clock_mode](#_setting_the_clock_mode)
- [3.3.2. Querying clock info](#_querying_clock_info)
- [3.3.2._Querying_clock_info](#_querying_clock_info)
- [3.4. Beginning and ending a GPA session](#_beginning_and_ending_a_gpa_session)
- [3.4._Beginning_and_ending_a_GPA_session](#_beginning_and_ending_a_gpa_session)
- [3.5. Beginning and ending sampling](#_beginning_and_ending_sampling)
- [3.5._Beginning_and_ending_sampling](#_beginning_and_ending_sampling)
- [3.6. Session status and results querying](#_session_status_and_results_querying)
- [3.6._Session_status_and_results_querying](#_session_status_and_results_querying)
- [3.6.1. Session status query](#_session_status_query)
- [3.6.1._Session_status_query](#_session_status_query)
- [3.6.2. Sample results query](#_sample_results_query)
- [3.6.2._Sample_results_query](#_sample_results_query)
- [3.7. Resetting and copying session results](#_resetting_and_copying_session_results)
- [3.7._Resetting_and_copying_session_results](#_resetting_and_copying_session_results)
- [3.7.1. Resetting a session](#_resetting_a_session)
- [3.7.1._Resetting_a_session](#_resetting_a_session)
- [3.7.2. Copying results from secondary command buffers](#_copying_results_from_secondary_command_buffers)
- [3.7.2._Copying_results_from_secondary_command_buffers](#_copying_results_from_secondary_command_buffers)
- [3.8. Properties](#_properties)
- [3.9. Features](#_features)
- [4. Examples](#_examples)
- [4.1. Sample setup](#_sample_setup)
- [4.1._Sample_setup](#_sample_setup)
- [4.2. Using secondary command buffers that are executed multiple times](#_using_secondary_command_buffers_that_are_executed_multiple_times)
- [4.2._Using_secondary_command_buffers_that_are_executed_multiple_times](#_using_secondary_command_buffers_that_are_executed_multiple_times)
- [5. Validation and Tools](#_validation_and_tools)
- [5._Validation_and_Tools](#_validation_and_tools)
...
for (uint32_t i = 0; i handle, primarySession, &sampleInfo, &sampleID);
