...
|  | The source for this sample can be found in the [Khronos Vulkan samples github repository](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/performance/hpp_pipeline_cache). |
| --- | --- |

|  | A transcoded version of the performance sample [Pipeline Cache](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/performance/pipeline_cache) that illustrates the usage of the C++ bindings of vulkan provided by vulkan.hpp. |
| --- | --- |
