...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/device_fault/README.html

## Table of Contents

- [Overview](#_overview)
- [VK_EXT_device_fault Extension Setup](#_vk_ext_device_fault_extension_setup)
- [VK_EXT_device_fault_Extension_Setup](#_vk_ext_device_fault_extension_setup)
- [Address Binding Report Extension Setup](#_address_binding_report_extension_setup)
- [Address_Binding_Report_Extension_Setup](#_address_binding_report_extension_setup)
- [Vulkan Validation Layer Configuration](#_vulkan_validation_layer_configuration)
- [Vulkan_Validation_Layer_Configuration](#_vulkan_validation_layer_configuration)
- [VK_EXT_device_fault Implementation](#_vk_ext_device_fault_implementation)
- [VK_EXT_device_fault_Implementation](#_vk_ext_device_fault_implementation)
- [VK_EXT_device_address_binding_report Implementation](#_vk_ext_device_address_binding_report_implementation)
- [VK_EXT_device_address_binding_report_Implementation](#_vk_ext_device_address_binding_report_implementation)
- [Debug Utils Integration](#_debug_utils_integration)
- [Debug_Utils_Integration](#_debug_utils_integration)
- [Testing the Implementation](#_testing_the_implementation)
- [Testing_the_Implementation](#_testing_the_implementation)
- [Triggering VK_ERROR_DEVICE_LOST in Shader](#_triggering_vk_error_device_lost_in_shader)
- [Triggering_VK_ERROR_DEVICE_LOST_in_Shader](#_triggering_vk_error_device_lost_in_shader)
- [Debugging Details](#_debugging_details)
- [Conclusion](#_conclusion)

## Content

|  | The source for this sample can be found in the [Khronos Vulkan samples github repository](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/extensions/device_fault). |
| --- | --- |
...
if (faultCount.addressInfoCount > 0 || faultCount.vendorInfoCount > 0) {
        std::vector addressInfos(faultCount.addressInfoCount);
        std::vector vendorInfos(faultCount.vendorInfoCount);
        std::vector vendorBinaryData(faultCount.vendorBinarySize);
...
VkResult faultResult = vkGetDeviceFaultInfoEXT(vk_device, &faultCount, &faultInfo);
    ...
    if (faultResult == VK_SUCCESS) {
        ...
        for (uint32_t i = 0; i (addressInfos[i].addressType)));
            LOGE("Fault Address Info Reported Address -> Decimal: {} | Hex: 0x{:X}", addressInfos[i].reportedAddress, static_cast(addressInfos[i].reportedAddress));
        }
    }
}
...
void DeviceFault::handle_address_binding(const VkDeviceAddressBindingCallbackDataEXT& callbackData)
{
    ...
    switch (callbackData.bindingType) {
        case VK_DEVICE_ADDRESS_BINDING_TYPE_BIND_EXT:
            LOGI("{} : Address Bound -> Decimal: {} | Hex: 0x{:X} | Size = {} Bytes", current_memory_label, std::to_string(callbackData.baseAddress), static_cast(callbackData.baseAddress), callbackData.size);
            break;

        case VK_DEVICE_ADDRESS_BINDING_TYPE_UNBIND_EXT:
            LOGI("{} : Address Unbound -> Decimal: {} | Hex: 0x{:X} | Size = {} Bytes", current_memory_label, std::to_string(callbackData.baseAddress), static_cast(callbackData.baseAddress), callbackData.size);
            break;
...
[https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/extensions/buffer_device_address](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/extensions/buffer_device_address)
...
![DeviceFault](../../../_images/samples/extensions/device_fault/images/device_fault_ui.png)
...
![DeviceFault](../../../_images/samples/extensions/device_fault/images/binding_address_info.png)
...
![DeviceFault](../../../_images/samples/extensions/device_fault/images/failed_logcat_output.png)
