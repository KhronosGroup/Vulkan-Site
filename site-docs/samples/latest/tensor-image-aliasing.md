...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/tensor_and_data_graph/tensor_image_aliasing/README.html
...
- [Resource creation](#_resource_creation)
- [Running the data graph pipeline](#_running_the_data_graph_pipeline)
- [Running_the_data_graph_pipeline](#_running_the_data_graph_pipeline)
- [Synchronization and image layout](#_synchronization_and_image_layout)
- [Synchronization_and_image_layout](#_synchronization_and_image_layout)
...
![Sample](../../../../_images/samples/extensions/tensor_and_data_graph/tensor_image_aliasing/images/sample.png)

This is the fourth sample in a series, which follows on from the previous [graph_constants sample](../graph_constants/README.html). To best understand this sample, it would be helpful to have first looked at the [previous samples in the series](../README.html).
This sample shows how to use [tensor/image aliasing](https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#resources-memory-aliasing) so that tensors and images use the same memory. This enables the mixing of traditional compute and graphics operations with ML operations without overhead from copying or format conversions. In this sample we show how to run a simple post-processing effect on a 3D scene using a convolutional neural network.
