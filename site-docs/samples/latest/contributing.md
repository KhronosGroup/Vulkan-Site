...
- [AI-Assisted Contributions](#_ai_assisted_contributions)
...
Submit a pull request via GitHub for the contribution, including electronically signing the [Khronos Contributor License Agreement (CLA)](https://cla-assistant.io/KhronosGroup/Vulkan-Samples) for the repository using CLA-Assistant.
