...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/api/hpp_hello_triangle_1_3/README.html
...
|  | The source for this sample can be found in the [Khronos Vulkan samples github repository](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/api/hpp_hello_triangle_1_3). |
| --- | --- |

|  | A transcoded version of the API sample [Hello Triangle 1.3](https://github.com/KhronosGroup/Vulkan-Samples/tree/main/samples/api/hello_triangle_1_3) that illustrates the usage of the C++ bindings of Vulkan provided by Vulkan-Hpp. |
| --- | --- |
