...
- [Layer Settings](#_layer_settings)
...
**Extension**: [`VK_EXT_layer_settings`](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_EXT_layer_settings)
...
Unresolved include directive in modules/ROOT/pages/samples/README.adoc - include::../complex/README.adoc[]
