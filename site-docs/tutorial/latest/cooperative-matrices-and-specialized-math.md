...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/09_Specialized_Math/01_introduction.html
...
[Previous: Queue Priority](../08_Asynchronous_Compute/04_queue_priority.html) | [Next: Cooperative Matrices](02_cooperative_matrices.html)
