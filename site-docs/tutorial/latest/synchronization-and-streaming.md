...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Advanced_Topics/Synchronization_and_Streaming.html

## Table of Contents

- [The idea](#_the_idea)
- [The background uploader](#_the_background_uploader)
- [The_background_uploader](#_the_background_uploader)
- [The safe point for descriptor updates](#_the_safe_point_for_descriptor_updates)
- [The_safe_point_for_descriptor_updates](#_the_safe_point_for_descriptor_updates)
- [Synchronization 2 in practice](#_synchronization_2_in_practice)
- [Synchronization_2_in_practice](#_synchronization_2_in_practice)
- [A typical texture’s journey](#_a_typical_textures_journey)
- [A_typical_texture’s_journey](#_a_typical_textures_journey)
- [Tips and pitfalls](#_tips_and_pitfalls)
- [Tips_and_pitfalls](#_tips_and_pitfalls)
...
Records layout transitions from `TRANSFER_DST_OPTIMAL` to `SHADER_READ_ONLY_OPTIMAL` using Synchronization 2.
