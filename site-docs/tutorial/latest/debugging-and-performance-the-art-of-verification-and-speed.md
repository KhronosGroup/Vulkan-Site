...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Debugging_and_Performance/01_introduction.html

## Table of Contents

- [The "Silent Failure" Problem](#_the_silent_failure_problem)
- [The_"Silent_Failure"_Problem](#_the_silent_failure_problem)
- [The Anatomy of a Silent Bug](#_the_anatomy_of_a_silent_bug)
- [The_Anatomy_of_a_Silent_Bug](#_the_anatomy_of_a_silent_bug)
- [The Expert Mindset: Verify, Profile, Optimize](#_the_expert_mindset_verify_profile_optimize)
- [The_Expert_Mindset:_Verify,_Profile,_Optimize](#_the_expert_mindset_verify_profile_optimize)
- [1. Verify Correctness (The "Ground Truth" Phase)](#_1_verify_correctness_the_ground_truth_phase)
- [1._Verify_Correctness_(The_"Ground_Truth"_Phase)](#_1_verify_correctness_the_ground_truth_phase)
- [2. Profile Bottlenecks (The "Detective" Phase)](#_2_profile_bottlenecks_the_detective_phase)
- [2._Profile_Bottlenecks_(The_"Detective"_Phase)](#_2_profile_bottlenecks_the_detective_phase)
- [3. Optimize the Critical Path (The "Formula 1" Phase)](#_3_optimize_the_critical_path_the_formula_1_phase)
- [3._Optimize_the_Critical_Path_(The_"Formula_1"_Phase)](#_3_optimize_the_critical_path_the_formula_1_phase)
- [The Cost of Inefficiency](#_the_cost_of_inefficiency)
- [The_Cost_of_Inefficiency](#_the_cost_of_inefficiency)
- [What You’ll Master](#_what_youll_master)
- [What_You’ll_Master](#_what_youll_master)
...
[Previous: Putting it Together](../Building_the_Inference_Engine/07_putting_it_together.html) | [Next: Debugging Vulkan Compute](02_debugging_vulkan_compute.html)
