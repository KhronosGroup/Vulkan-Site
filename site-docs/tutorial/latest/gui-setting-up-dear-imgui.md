...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/GUI/02_imgui_setup.html
...
- [Resource Initialization: Font Data Extraction and Memory Calculation](#_resource_initialization_font_data_extraction_and_memory_calculation)
- [Resource_Initialization:_Font_Data_Extraction_and_Memory_Calculation](#_resource_initialization_font_data_extraction_and_memory_calculation)
- [Resource Initialization: GPU Image Creation and Memory Allocation](#_resource_initialization_gpu_image_creation_and_memory_allocation)
- [Resource_Initialization:_GPU_Image_Creation_and_Memory_Allocation](#_resource_initialization_gpu_image_creation_and_memory_allocation)
- [Resource Initialization — Staging Buffer Creation and Data Transfer](#_resource_initialization_staging_buffer_creation_and_data_transfer)
- [Resource_Initialization_—_Staging_Buffer_Creation_and_Data_Transfer](#_resource_initialization_staging_buffer_creation_and_data_transfer)
- [Resource Initialization — Image Layout Transitions and Data Upload](#_resource_initialization_image_layout_transitions_and_data_upload)
- [Resource_Initialization_—_Image_Layout_Transitions_and_Data_Upload](#_resource_initialization_image_layout_transitions_and_data_upload)
- [Resource Initialization — Texture Sampling Configuration and Descriptor Management](#_resource_initialization_texture_sampling_configuration_and_descriptor_management)
...
Next, create the GPU image resources that will store the font texture data in video memory.
    ...
    vk::Extent3D fontExtent{
        static_cast(texWidth),        // Image width in pixels
        static_cast(texHeight),       // Image height in pixels
