...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Third_Party_Libraries/08_data_transfer_optimization.html

## Table of Contents

- [Introduction](#_introduction)
- [Understanding the Transfer Bottleneck](#_understanding_the_transfer_bottleneck)
- [Understanding_the_Transfer_Bottleneck](#_understanding_the_transfer_bottleneck)
- [Types of Transfers](#_types_of_transfers)
- [Types_of_Transfers](#_types_of_transfers)
- [Measuring Transfer Performance](#_measuring_transfer_performance)
- [Measuring_Transfer_Performance](#_measuring_transfer_performance)
- [Strategy 1: Minimize Transfers](#_strategy_1_minimize_transfers)
- [Strategy_1:_Minimize_Transfers](#_strategy_1_minimize_transfers)
- [In-Place Operations](#_in_place_operations)
- [Shared Memory Regions](#_shared_memory_regions)
- [Shared_Memory_Regions](#_shared_memory_regions)
- [Persistent Buffers](#_persistent_buffers)
- [Lazy Transfers](#_lazy_transfers)
- [Strategy 2: Asynchronous Transfer Queues](#_strategy_2_asynchronous_transfer_queues)
- [Strategy_2:_Asynchronous_Transfer_Queues](#_strategy_2_asynchronous_transfer_queues)
- [Understanding Queue Families](#_understanding_queue_families)
- [Understanding_Queue_Families](#_understanding_queue_families)
- [Overlapping Transfers with Computation](#_overlapping_transfers_with_computation)
- [Overlapping_Transfers_with_Computation](#_overlapping_transfers_with_computation)
- [Implementation Pattern](#_implementation_pattern)
- [Queue Ownership Transfer](#_queue_ownership_transfer)
- [Queue_Ownership_Transfer](#_queue_ownership_transfer)
- [Strategy 3: Memory Mapping and Staging](#_strategy_3_memory_mapping_and_staging)
- [Strategy_3:_Memory_Mapping_and_Staging](#_strategy_3_memory_mapping_and_staging)
- [Staging Buffers](#_staging_buffers)
- [Persistent Mapping](#_persistent_mapping)
- [Write-Combined Memory](#_write_combined_memory)
- [Readback Optimization](#_readback_optimization)
- [Strategy 4: Batching](#_strategy_4_batching)
- [Strategy_4:_Batching](#_strategy_4_batching)
- [Batch Size Selection](#_batch_size_selection)
- [Batch_Size_Selection](#_batch_size_selection)
- [Memory Layout for Batching](#_memory_layout_for_batching)
- [Memory_Layout_for_Batching](#_memory_layout_for_batching)
- [Dynamic Batching](#_dynamic_batching)
- [Strategy 5: Format Conversion Optimization](#_strategy_5_format_conversion_optimization)
- [Strategy_5:_Format_Conversion_Optimization](#_strategy_5_format_conversion_optimization)
- [Compute Shader Conversions](#_compute_shader_conversions)
- [Compute_Shader_Conversions](#_compute_shader_conversions)
- [Fused Operations](#_fused_operations)
- [Texture Compression](#_texture_compression)
- [Strategy 6: Pipeline Optimization](#_strategy_6_pipeline_optimization)
- [Strategy_6:_Pipeline_Optimization](#_strategy_6_pipeline_optimization)
- [Pipelining Multiple Frames](#_pipelining_multiple_frames)
- [Pipelining_Multiple_Frames](#_pipelining_multiple_frames)
- [Lazy Synchronization](#_lazy_synchronization)
- [Memory Aliasing](#_memory_aliasing)
- [Practical Considerations](#_practical_considerations)
- [Profile First, Optimize Second](#_profile_first_optimize_second)
- [Profile_First,_Optimize_Second](#_profile_first_optimize_second)
- [Platform Differences](#_platform_differences)
- [Fallback Paths](#_fallback_paths)
- [Debugging Transfer Issues](#_debugging_transfer_issues)
- [Debugging_Transfer_Issues](#_debugging_transfer_issues)
- [Summary](#_summary)
...
std::array waitSemaphores = {*transferCompleteSemaphore, *renderCompleteSemaphore};
...
void queueInference(InputData input) {
    ...
    auto elapsed = std::chrono::duration_cast(now - batchStartTime);
...
This runs entirely on the GPU, leveraging parallel execution. For a 1920×1080 image, this completes in 
...
std::array renderCompleteSemaphores;
std::array transferCompleteSemaphores;
std::array inferenceCompleteSemaphores;
std::array frameFences;
...
[Previous: GPU Resource Sharing](07_gpu_resource_sharing.html) | [Next: Practical Examples](09_practical_examples.html)
