...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/ML_Inference_Pipeline/05_transfer_learning.html

## Table of Contents

- [The Problem: Training Is Expensive](#_the_problem_training_is_expensive)
- [The_Problem:_Training_Is_Expensive](#_the_problem_training_is_expensive)
- [Computational Costs: Time and Hardware](#_computational_costs_time_and_hardware)
- [Computational_Costs:_Time_and_Hardware](#_computational_costs_time_and_hardware)
- [Data Requirements: Millions of Examples](#_data_requirements_millions_of_examples)
- [Data_Requirements:_Millions_of_Examples](#_data_requirements_millions_of_examples)
- [Expertise Requirements: It’s Not Just Pressing "Train"](#_expertise_requirements_its_not_just_pressing_train)
- [Expertise_Requirements:_It’s_Not_Just_Pressing_"Train"](#_expertise_requirements_its_not_just_pressing_train)
- [The Opportunity Cost](#_the_opportunity_cost)
- [The_Opportunity_Cost](#_the_opportunity_cost)
- [A Concrete Example: Your Game’s Weapon Recognition](#_a_concrete_example_your_games_weapon_recognition)
- [A_Concrete_Example:_Your_Game’s_Weapon_Recognition](#_a_concrete_example_your_games_weapon_recognition)
- [The Insight: Features Are Reusable](#_the_insight_features_are_reusable)
- [The_Insight:_Features_Are_Reusable](#_the_insight_features_are_reusable)
- [Hierarchical Feature Learning: From Simple to Complex](#_hierarchical_feature_learning_from_simple_to_complex)
- [Hierarchical_Feature_Learning:_From_Simple_to_Complex](#_hierarchical_feature_learning_from_simple_to_complex)
- [Why This Hierarchy Emerges](#_why_this_hierarchy_emerges)
- [Why_This_Hierarchy_Emerges](#_why_this_hierarchy_emerges)
- [Visualizing Feature Reusability](#_visualizing_feature_reusability)
- [Visualizing_Feature_Reusability](#_visualizing_feature_reusability)
- [The Practical Implication](#_the_practical_implication)
- [The_Practical_Implication](#_the_practical_implication)
- [Cross-Domain Transfer: How Far Can You Go?](#_cross_domain_transfer_how_far_can_you_go)
- [Cross-Domain_Transfer:_How_Far_Can_You_Go?](#_cross_domain_transfer_how_far_can_you_go)
- [How Transfer Learning Works](#_how_transfer_learning_works)
- [How_Transfer_Learning_Works](#_how_transfer_learning_works)
- [Feature Extraction: The Fast Approach](#_feature_extraction_the_fast_approach)
- [Feature_Extraction:_The_Fast_Approach](#_feature_extraction_the_fast_approach)
- [How Feature Extraction Works](#_how_feature_extraction_works)
- [How_Feature_Extraction_Works](#_how_feature_extraction_works)
- [Why This Is Fast](#_why_this_is_fast)
- [Why_This_Is_Fast](#_why_this_is_fast)
- [When Feature Extraction Works Best](#_when_feature_extraction_works_best)
- [When_Feature_Extraction_Works_Best](#_when_feature_extraction_works_best)
- [Example: Game Weapon Recognition](#_example_game_weapon_recognition)
- [Example:_Game_Weapon_Recognition](#_example_game_weapon_recognition)
- [The Limitations](#_the_limitations)
- [Fine-Tuning: The Balanced Approach](#_fine_tuning_the_balanced_approach)
- [Fine-Tuning:_The_Balanced_Approach](#_fine_tuning_the_balanced_approach)
- [How Fine-Tuning Works](#_how_fine_tuning_works)
- [How_Fine-Tuning_Works](#_how_fine_tuning_works)
- [Why Lower Learning Rates Matter](#_why_lower_learning_rates_matter)
- [Why_Lower_Learning_Rates_Matter](#_why_lower_learning_rates_matter)
- [When Fine-Tuning Works Best](#_when_fine_tuning_works_best)
- [When_Fine-Tuning_Works_Best](#_when_fine_tuning_works_best)
- [Example: Medical Image Classification](#_example_medical_image_classification)
- [Example:_Medical_Image_Classification](#_example_medical_image_classification)
- [The Tradeoffs](#_the_tradeoffs)
- [Domain Adaptation: The Complex Approach](#_domain_adaptation_the_complex_approach)
- [Domain_Adaptation:_The_Complex_Approach](#_domain_adaptation_the_complex_approach)
- [The Domain Shift Problem](#_the_domain_shift_problem)
- [The_Domain_Shift_Problem](#_the_domain_shift_problem)
- [Domain Adaptation Techniques](#_domain_adaptation_techniques)
- [Domain_Adaptation_Techniques](#_domain_adaptation_techniques)
- [When You Need Domain Adaptation](#_when_you_need_domain_adaptation)
- [When_You_Need_Domain_Adaptation](#_when_you_need_domain_adaptation)
...
- [Model Selection and Architecture Understanding](#_model_selection_and_architecture_understanding)
- [Model_Selection_and_Architecture_Understanding](#_model_selection_and_architecture_understanding)
- [Preprocessing Requirements: The Critical Detail](#_preprocessing_requirements_the_critical_detail)
- [Preprocessing_Requirements:_The_Critical_Detail](#_preprocessing_requirements_the_critical_detail)
- [Debugging and Performance Expectations](#_debugging_and_performance_expectations)
- [Debugging_and_Performance_Expectations](#_debugging_and_performance_expectations)
- [The Practical Workflow](#_the_practical_workflow)
- [The_Practical_Workflow](#_the_practical_workflow)
- [Step 1: Select a Pre-Trained Model](#_step_1_select_a_pre_trained_model)
- [Step_1:_Select_a_Pre-Trained_Model](#_step_1_select_a_pre_trained_model)
- [Step 2: Evaluate Out-of-the-Box Performance](#_step_2_evaluate_out_of_the_box_performance)
- [Step_2:_Evaluate_Out-of-the-Box_Performance](#_step_2_evaluate_out_of_the_box_performance)
- [Step 3: Fine-Tune If Needed](#_step_3_fine_tune_if_needed)
- [Step_3:_Fine-Tune_If_Needed](#_step_3_fine_tune_if_needed)
- [Step 4: Export to Inference Format](#_step_4_export_to_inference_format)
- [Step_4:_Export_to_Inference_Format](#_step_4_export_to_inference_format)
- [Step 5: Implement Inference in Vulkan](#_step_5_implement_inference_in_vulkan)
- [Step_5:_Implement_Inference_in_Vulkan](#_step_5_implement_inference_in_vulkan)
- [The Beauty of This Workflow](#_the_beauty_of_this_workflow)
- [The_Beauty_of_This_Workflow](#_the_beauty_of_this_workflow)
- [Summary](#_summary)
...
[Previous: Inference Explained](04_inference_explained.html) | [Next: Model Formats](06_model_formats.html)
