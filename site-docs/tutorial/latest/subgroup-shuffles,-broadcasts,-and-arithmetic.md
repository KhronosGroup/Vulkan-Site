...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/04_Subgroup_Operations/02_cross_invocation_communication.html

## Table of Contents

- [Exchanging Data Without Memory](#_exchanging_data_without_memory)
- [Exchanging_Data_Without_Memory](#_exchanging_data_without_memory)
- [Subgroup Broadcasts](#_subgroup_broadcasts)
- [GLSL: The Subgroup Way](#_glsl_the_subgroup_way)
- [GLSL:_The_Subgroup_Way](#_glsl_the_subgroup_way)
- [Subgroup Shuffles](#_subgroup_shuffles)
- [Subgroup Arithmetic (Reductions and Scans)](#_subgroup_arithmetic_reductions_and_scans)
- [Subgroup_Arithmetic_(Reductions_and_Scans)](#_subgroup_arithmetic_reductions_and_scans)
- [Choosing the Right Operation](#_choosing_the_right_operation)
- [Choosing_the_Right_Operation](#_choosing_the_right_operation)
...
[Previous: Introduction to Subgroups](01_introduction.html) | [Next: Subgroup Partitioning](03_subgroup_partitioning.html)
