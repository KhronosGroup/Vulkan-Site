...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/08_Asynchronous_Compute/04_queue_priority.html

## Table of Contents

- [How the Scheduler Uses Priority](#_how_the_scheduler_uses_priority)
- [How_the_Scheduler_Uses_Priority](#_how_the_scheduler_uses_priority)
- [Global Queue Priority](#_global_queue_priority)
- [Global_Queue_Priority](#_global_queue_priority)
- [Avoiding the "Single-Queue Trap"](#_avoiding_the_single_queue_trap)
- [Avoiding_the_"Single-Queue_Trap"](#_avoiding_the_single_queue_trap)
...
**Strict Priority**: The scheduler will always pick a task from a higher-priority queue if one is ready. This is great for responsiveness but can lead to **starvation** of low-priority tasks if the high-priority queue is constantly busy.

**Weighted Round-Robin**: The scheduler assigns a certain percentage of execution time to each queue based on its priority. For example, a queue with priority 1.0 might get twice as many "scheduling slots" as a queue with priority 0.5.
...
[Previous: Timeline Semaphores](03_timeline_semaphores.html) | [Next: Specialized Math](../09_Specialized_Math/01_introduction.html)
