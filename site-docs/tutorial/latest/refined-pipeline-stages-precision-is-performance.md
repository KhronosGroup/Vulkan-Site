...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Anatomy_of_a_Dependency/04_refined_pipeline_stages.html

## Table of Contents

- [Introduction](#_introduction)
- [The Pipeline Bubble](#_the_pipeline_bubble)
- [The_Pipeline_Bubble](#_the_pipeline_bubble)
- [Choosing the Right Stage](#_choosing_the_right_stage)
- [Choosing_the_Right_Stage](#_choosing_the_right_stage)
- [The Power of Access Flags](#_the_power_of_access_flags)
- [The_Power_of_Access_Flags](#_the_power_of_access_flags)
- [Conclusion](#_conclusion)
- [Simple Engine: Targeting the Right Units](#_simple_engine_targeting_the_right_units)
- [Simple_Engine:_Targeting_the_Right_Units](#_simple_engine_targeting_the_right_units)
...
![A block diagram of the Vulkan graphics pipeline showing its various stages](../../_images/images/vulkan_pipeline_block_diagram.png)
...
Previous: [The Synchronization 2 Advantage](03_sync2_advantage.html) | Next: [Pipeline Barriers and Transitions - Introduction](../Pipeline_Barriers_Transitions/01_introduction.html)
