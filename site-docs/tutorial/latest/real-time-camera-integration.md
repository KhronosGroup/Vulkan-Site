...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Desktop_Applications/05_real_time_camera.html

## Table of Contents

- [The "Stop-and-Go" Problem](#_the_stop_and_go_problem)
- [The_"Stop-and-Go"_Problem](#_the_stop_and_go_problem)
- [Understanding Latency vs. Throughput](#_understanding_latency_vs_throughput)
- [Understanding_Latency_vs._Throughput](#_understanding_latency_vs_throughput)
- [Step 1: Grabbing Frames with OpenCV](#_step_1_grabbing_frames_with_opencv)
- [Step_1:_Grabbing_Frames_with_OpenCV](#_step_1_grabbing_frames_with_opencv)
- [Designing a Responsive Pipeline](#_designing_a_responsive_pipeline)
- [Designing_a_Responsive_Pipeline](#_designing_a_responsive_pipeline)
- [GPU-Accelerated Preprocessing](#_gpu_accelerated_preprocessing)
- [Bilinear Resizing in a Shader](#_bilinear_resizing_in_a_shader)
- [Bilinear_Resizing_in_a_Shader](#_bilinear_resizing_in_a_shader)
- [Mathematical Normalization](#_mathematical_normalization)
- [The NCHW Transpose in Parallel](#_the_nchw_transpose_in_parallel)
- [The_NCHW_Transpose_in_Parallel](#_the_nchw_transpose_in_parallel)
- [Preprocessing Shader Code](#_preprocessing_shader_code)
- [Preprocessing_Shader_Code](#_preprocessing_shader_code)
- [Async Compute: The Secret to High Performance](#_async_compute_the_secret_to_high_performance)
- [Async_Compute:_The_Secret_to_High_Performance](#_async_compute_the_secret_to_high_performance)
- [The Timeline Semaphore Handshake](#_the_timeline_semaphore_handshake)
- [The_Timeline_Semaphore_Handshake](#_the_timeline_semaphore_handshake)
- [Rendering the Results: Keeping the UI Responsive](#_rendering_the_results_keeping_the_ui_responsive)
- [Rendering_the_Results:_Keeping_the_UI_Responsive](#_rendering_the_results_keeping_the_ui_responsive)
- [Non-Blocking Result Fetching](#_non_blocking_result_fetching)
- [Non-Blocking_Result_Fetching](#_non_blocking_result_fetching)
- [Measuring Real-World Performance](#_measuring_real_world_performance)
- [Measuring_Real-World_Performance](#_measuring_real_world_performance)
- [Summary](#_summary)
...
![Diagram showing the Producer-Consumer pipeline between camera capture](../../_images/images/ML_Inference/Desktop_Applications/camera_pipeline_diagram.svg)

Figure 1. Asynchronous Camera Inference Pipeline
...
[Previous: CI/CD Render Validation](04_ci_render_validation.html) | [Next: RL-Based Automated Exploration](06_rl_automated_exploration.html)
