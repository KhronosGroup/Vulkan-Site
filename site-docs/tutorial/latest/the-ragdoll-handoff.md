...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Physics_Integration/04_ragdoll_handoff.html

## Table of Contents

- [The Problem with Simply Switching Modes](#_the_problem_with_simply_switching_modes)
- [The_Problem_with_Simply_Switching_Modes](#_the_problem_with_simply_switching_modes)
- [The State Machine](#_the_state_machine)
- [The_State_Machine](#_the_state_machine)
- [Triggering the Handoff](#_triggering_the_handoff)
- [Triggering_the_Handoff](#_triggering_the_handoff)
- [The Transition Frame](#_the_transition_frame)
- [The_Transition_Frame](#_the_transition_frame)
- [Reading Physics Results Back into the Scene Graph](#_reading_physics_results_back_into_the_scene_graph)
- [Reading_Physics_Results_Back_into_the_Scene_Graph](#_reading_physics_results_back_into_the_scene_graph)
- [The Visual Blend](#_the_visual_blend)
- [The_Visual_Blend](#_the_visual_blend)
...
[Previous: Constraints & Joint Limits](03_constraints_and_joint_limits.html) | [Next: Self-Collision Filtering](05_self_collision_filtering.html)
