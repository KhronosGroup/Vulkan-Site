...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Physics_Integration/01_introduction.html

## Table of Contents

- [The Gap Between Looking Right and Behaving Right](#_the_gap_between_looking_right_and_behaving_right)
- [The_Gap_Between_Looking_Right_and_Behaving_Right](#_the_gap_between_looking_right_and_behaving_right)
- [What This Chapter Will Build](#_what_this_chapter_will_build)
- [What_This_Chapter_Will_Build](#_what_this_chapter_will_build)
- [Recommended Engine: Jolt Physics](#_recommended_engine_jolt_physics)
- [Recommended_Engine:_Jolt_Physics](#_recommended_engine_jolt_physics)
- [Jolt Physics Setup](#_jolt_physics_setup)
- [Jolt_Physics_Setup](#_jolt_physics_setup)
- [The PhysicsWorld Interface](#_the_physicsworld_interface)
- [The_PhysicsWorld_Interface](#_the_physicsworld_interface)
- [Concrete Implementation: Jolt Physics](#_concrete_implementation_jolt_physics)
- [Concrete_Implementation:_Jolt_Physics](#_concrete_implementation_jolt_physics)
...
public:
    ...
    static std::unique_ptr create(); // Returns a JoltPhysicsWorld
...
public:
    ...
    {
        temp_allocator_ = std::make_unique(32 * 1024 * 1024);
        job_system_     = std::make_unique(
...
private:
    ...
    std::unique_ptr   temp_allocator_;
    std::unique_ptr job_system_;
    JPH::PhysicsSystem  system_;
    JPH::BodyInterface* body_interface_ = nullptr;
};

[Previous: Compute Skinning Conclusion](../Skeletal_Compute_Skinning/06_conclusion.html) | [Next: Bone Proxy Colliders](02_bone_proxy_colliders.html)
