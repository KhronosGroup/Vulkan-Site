...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Lighting_Materials/06_conclusion.html

## Table of Contents

- [What We’ve Learned](#_what_weve_learned)
- [What_We’ve_Learned](#_what_weve_learned)
- [Making it click: a mental model of this PBR pipeline](#_making_it_click_a_mental_model_of_this_pbr_pipeline)
- [Making_it_click:_a_mental_model_of_this_PBR_pipeline](#_making_it_click_a_mental_model_of_this_pbr_pipeline)
...
Confirm spaces and order: linear lighting ➜ tone map ➜ gamma. Check you’re not doing double-gamma.

Probe the BRDF: plastic look on everything? Roughness too low or kD not reduced by metallic. Dim, muddy highlights? Roughness too high or exposure too low.

Validate normals/TBN: inverted green channel or wrong tangent handedness causes odd shading and seams.

Calibrate exposure/tone map: if whites clip harshly, add exposure control and/or switch to ACES/Hable for smoother roll-off.

Use AO and emissive judiciously: AO should affect ambient/IBL, not direct specular; emissive is additive and independent of lights.
...
[Previous: Shadows](07_shadows.html) | [Next: GUI](../GUI/01_introduction.html)
