...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Tooling_Production_Pipeline/04_gltf_viewer_audit.html

## Table of Contents

- [The Purpose of a Ground Truth](#_the_purpose_of_a_ground_truth)
- [The_Purpose_of_a_Ground_Truth](#_the_purpose_of_a_ground_truth)
- [Recommended Viewers](#_recommended_viewers)
- [What to Look For in the Viewer](#_what_to_look_for_in_the_viewer)
- [What_to_Look_For_in_the_Viewer](#_what_to_look_for_in_the_viewer)
- [From Viewer to Engine: What to Do When They Differ](#_from_viewer_to_engine_what_to_do_when_they_differ)
- [From_Viewer_to_Engine:_What_to_Do_When_They_Differ](#_from_viewer_to_engine_what_to_do_when_they_differ)
...
[Previous: Validation](03_validation.html) | [Next: Conclusion](05_conclusion.html)
