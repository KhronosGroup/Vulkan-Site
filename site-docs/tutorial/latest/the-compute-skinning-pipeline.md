...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Skeletal_Compute_Skinning/03_compute_skinning.html

## Table of Contents

- [Why a Compute Shader?](#_why_a_compute_shader)
- [Why_a_Compute_Shader?](#_why_a_compute_shader)
- [Buffer Architecture](#_buffer_architecture)
- [The Compute Shader](#_the_compute_shader)
- [The_Compute_Shader](#_the_compute_shader)
- [Why Slang?](#_why_slang)
- [Compiling and Loading Slang Shaders](#_compiling_and_loading_slang_shaders)
- [Compiling_and_Loading_Slang_Shaders](#_compiling_and_loading_slang_shaders)
- [Compute Pipeline Setup](#_compute_pipeline_setup)
- [Compute_Pipeline_Setup](#_compute_pipeline_setup)
- [Dispatching the Compute Shader](#_dispatching_the_compute_shader)
- [Dispatching_the_Compute_Shader](#_dispatching_the_compute_shader)
- [Synchronization: The Pipeline Barrier](#_synchronization_the_pipeline_barrier)
- [Synchronization:_The_Pipeline_Barrier](#_synchronization_the_pipeline_barrier)
- [The Frame Loop](#_the_frame_loop)
- [The_Frame_Loop](#_the_frame_loop)
...
* **C++ Compatibility**: Slang’s syntax is so close to C++ that you can often share struct definitions between your engine and your shaders.

|  | The **Slang compiler (`slangc`)** is bundled with the [Vulkan SDK](https://vulkan.lunarg.com/sdk/home), so if you have already installed the SDK to follow this tutorial, `slangc` should already be available in your PATH without any additional download. If you need a standalone installation or a newer version, binaries are also available on the [Slang GitHub releases page](https://github.com/shader-slang/slang/releases). |
| --- | --- |
...
createInfo.pCode = reinterpret_cast(shaderCode.data());
...
[[vk::binding(0, 0)]] StructuredBuffer    input_vertices;
...
[Previous: The Mathematics of Skinning](02_skinning_math.html) | [Next: Skin Once, Use Everywhere](04_shared_vertex_buffer.html)
