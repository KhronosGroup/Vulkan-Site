...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/04_Subgroup_Operations/04_non_uniform_indexing.html

## Table of Contents

- [The Descriptor Limit](#_the_descriptor_limit)
- [The_Descriptor_Limit](#_the_descriptor_limit)
- [Non-Uniform Indexing (Descriptor Indexing)](#_non_uniform_indexing_descriptor_indexing)
- [Non-Uniform_Indexing_(Descriptor_Indexing)](#_non_uniform_indexing_descriptor_indexing)
- [GLSL: nonuniformEXT](#_glsl_nonuniformext)
- [Why Is This a Subgroup Feature?](#_why_is_this_a_subgroup_feature)
- [Why_Is_This_a_Subgroup_Feature?](#_why_is_this_a_subgroup_feature)
- [Performance Best Practices](#_performance_best_practices)
- [Performance_Best_Practices](#_performance_best_practices)
...
[Previous: Subgroup Partitioning](03_subgroup_partitioning.html) | [Next: OpenCL on Vulkan](../05_OpenCL_on_Vulkan/01_introduction.html)
