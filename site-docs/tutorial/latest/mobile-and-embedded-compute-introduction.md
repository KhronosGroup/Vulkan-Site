...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/12_Mobile_and_Embedded_Compute/01_introduction.html

## Table of Contents

- [Overview](#_overview)
- [Why Mobile Compute Matters](#_why_mobile_compute_matters)
- [Why_Mobile_Compute_Matters](#_why_mobile_compute_matters)
- [Why Embedded Compute Matters](#_why_embedded_compute_matters)
- [Why_Embedded_Compute_Matters](#_why_embedded_compute_matters)
- [Chapter Roadmap](#_chapter_roadmap)
...
**Compute on Android**: Setting up Android Studio, the NDK, and Gradle shader compilation; how to dispatch and consume compute results; using `clvk` for OpenCL portability on Android; and the architectural quirks of tile-based mobile GPUs.

**Optimizing for Mobile GPUs**: Power, bandwidth, and precision strategies — minimizing VRAM traffic, exploiting FP16, and keeping the device cool — with links to vendor profilers.

**Beyond Mobile: Embedded and Headless Vulkan Compute**: Development environment setup for CLion, Raspberry Pi, and NVIDIA Jetson; running `clvk` on embedded Linux; headless Vulkan compute with no display; and a complete tool reference table.
...
[Previous: Assistant-Led Optimization](../11_Diagnostics_and_Refinement/03_assistant_led_optimization.html) | [Next: Compute on Android](02_android_compute.html)
