...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Procedural_Animation_IK/04_foot_placement.html

## Table of Contents

- [Why This Is Harder Than It Sounds](#_why_this_is_harder_than_it_sounds)
- [Why_This_Is_Harder_Than_It_Sounds](#_why_this_is_harder_than_it_sounds)
- [The Foot Placement Pipeline](#_the_foot_placement_pipeline)
- [The_Foot_Placement_Pipeline](#_the_foot_placement_pipeline)
- [Implementing the Pelvis Adjustment](#_implementing_the_pelvis_adjustment)
- [Implementing_the_Pelvis_Adjustment](#_implementing_the_pelvis_adjustment)
- [Applying the IK and Foot Rotation](#_applying_the_ik_and_foot_rotation)
- [Applying_the_IK_and_Foot_Rotation](#_applying_the_ik_and_foot_rotation)
- [Blending IK In and Out](#_blending_ik_in_and_out)
- [Blending_IK_In_and_Out](#_blending_ik_in_and_out)
    ...
    FootPlacementState&  state)
{
    ...
    auto raycast_foot = [&](const glm::vec3& foot_world) -> std::pair {
...
[Previous: FABRIK](03_fabrik.html) | [Next: Look-At Controllers](05_look_at.html)
