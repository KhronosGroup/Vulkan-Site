...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Pipeline_Barriers_Transitions/04_global_vs_local_barriers.html

## Table of Contents

- [The Dilemma of Choice](#_the_dilemma_of_choice)
- [The_Dilemma_of_Choice](#_the_dilemma_of_choice)
- [When to Use Global Barriers](#_when_to_use_global_barriers)
- [When_to_Use_Global_Barriers](#_when_to_use_global_barriers)
- [When to Use Resource Barriers](#_when_to_use_resource_barriers)
- [When_to_Use_Resource_Barriers](#_when_to_use_resource_barriers)
- [The Golden Rule: Batching](#_the_golden_rule_batching)
- [The_Golden_Rule:_Batching](#_the_golden_rule_batching)
- [Simple Engine: Optimization](#_simple_engine_optimization)
- [Simple_Engine:_Optimization](#_simple_engine_optimization)
...
auto dependencyInfo = vk::DependencyInfo{
    ...
    .imageMemoryBarrierCount = static_cast(imageBarriers.size()),
...
Previous: [Queue Family Ownership](03_queue_family_ownership.html) | Next: [Timeline Semaphores: The Master Clock](../Timeline_Semaphores/01_introduction.html)
