...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Skeletal_Compute_Skinning/04_shared_vertex_buffer.html

## Table of Contents

- [The Payoff](#_the_payoff)
- [Consumer 1: The Rasterizer](#_consumer_1_the_rasterizer)
- [Consumer_1:_The_Rasterizer](#_consumer_1_the_rasterizer)
- [Consumer 2: The Ray Tracing Acceleration Structure](#_consumer_2_the_ray_tracing_acceleration_structure)
- [Consumer_2:_The_Ray_Tracing_Acceleration_Structure](#_consumer_2_the_ray_tracing_acceleration_structure)
- [Consumer 3: Physics System Integration](#_consumer_3_physics_system_integration)
- [Consumer_3:_Physics_System_Integration](#_consumer_3_physics_system_integration)
- [Approach 1: Bone-Proxy Colliders (Recommended)](#_approach_1_bone_proxy_colliders_recommended)
- [Approach_1:_Bone-Proxy_Colliders_(Recommended)](#_approach_1_bone_proxy_colliders_recommended)
- [Approach 2: Mesh-Accurate Physics Queries (Advanced)](#_approach_2_mesh_accurate_physics_queries_advanced)
- [Approach_2:_Mesh-Accurate_Physics_Queries_(Advanced)](#_approach_2_mesh_accurate_physics_queries_advanced)
- [Putting It Together: The Data Flow](#_putting_it_together_the_data_flow)
- [Putting_It_Together:_The_Data_Flow](#_putting_it_together_the_data_flow)
...
[Previous: The Compute Skinning Pipeline](03_compute_skinning.html) | [Next: Interpolation & Blending](05_interpolation_blending.html)
