...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/10_Performance_Optimization/02_instruction_throughput.html

## Table of Contents

- [The Roofline Model](#_the_roofline_model)
- [The_Roofline_Model](#_the_roofline_model)
- [Identifying the Bottleneck](#_identifying_the_bottleneck)
- [Identifying_the_Bottleneck](#_identifying_the_bottleneck)
- [Compute-Bound Kernels](#_compute_bound_kernels)
- [Memory-Bound Kernels](#_memory_bound_kernels)
- [Understanding Stall Reasons](#_understanding_stall_reasons)
- [Understanding_Stall_Reasons](#_understanding_stall_reasons)
- [Latency Hiding and Occupancy](#_latency_hiding_and_occupancy)
- [Latency_Hiding_and_Occupancy](#_latency_hiding_and_occupancy)
...
[Previous: Introduction](01_introduction.html) | [Next: Divergence Audit](03_divergence_audit.html)
