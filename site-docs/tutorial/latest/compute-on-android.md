...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/12_Mobile_and_Embedded_Compute/02_android_compute.html

## Table of Contents

- [Setting Up Your Android Development Environment](#_setting_up_your_android_development_environment)
- [Setting_Up_Your_Android_Development_Environment](#_setting_up_your_android_development_environment)
- [Android Studio](#_android_studio)
- [Project Structure for a Vulkan Compute Application](#_project_structure_for_a_vulkan_compute_application)
- [Project_Structure_for_a_Vulkan_Compute_Application](#_project_structure_for_a_vulkan_compute_application)
- [Compiling Shaders as Part of the Gradle Build](#_compiling_shaders_as_part_of_the_gradle_build)
- [Compiling_Shaders_as_Part_of_the_Gradle_Build](#_compiling_shaders_as_part_of_the_gradle_build)
- [Deploying to a Device and Using ADB](#_deploying_to_a_device_and_using_adb)
- [Deploying_to_a_Device_and_Using_ADB](#_deploying_to_a_device_and_using_adb)
- [Debugging Native Code with LLDB in Android Studio](#_debugging_native_code_with_lldb_in_android_studio)
- [Debugging_Native_Code_with_LLDB_in_Android_Studio](#_debugging_native_code_with_lldb_in_android_studio)
- [From Desktop Dispatch to Mobile Dispatch](#_from_desktop_dispatch_to_mobile_dispatch)
- [From_Desktop_Dispatch_to_Mobile_Dispatch](#_from_desktop_dispatch_to_mobile_dispatch)
- [Loading the Driver: The Vulkan Loader on Android](#_loading_the_driver_the_vulkan_loader_on_android)
- [Loading_the_Driver:_The_Vulkan_Loader_on_Android](#_loading_the_driver_the_vulkan_loader_on_android)
- [Getting SPIR-V onto the Device](#_getting_spir_v_onto_the_device)
- [Getting_SPIR-V_onto_the_Device](#_getting_spir_v_onto_the_device)
- [Querying What the Phone Can Actually Do](#_querying_what_the_phone_can_actually_do)
- [Querying_What_the_Phone_Can_Actually_Do](#_querying_what_the_phone_can_actually_do)
- [Enabling the Features You Actually Use](#_enabling_the_features_you_actually_use)
- [Enabling_the_Features_You_Actually_Use](#_enabling_the_features_you_actually_use)
- [Tile-Based GPUs Change the Rules](#_tile_based_gpus_change_the_rules)
- [Tile-Based_GPUs_Change_the_Rules](#_tile_based_gpus_change_the_rules)
- [Reading Results Back on Unified Memory](#_reading_results_back_on_unified_memory)
- [Reading_Results_Back_on_Unified_Memory](#_reading_results_back_on_unified_memory)
- [Keeping the Dispatch Off the Main Thread](#_keeping_the_dispatch_off_the_main_thread)
- [Keeping_the_Dispatch_Off_the_Main_Thread](#_keeping_the_dispatch_off_the_main_thread)
- [Using clvk on Android](#_using_clvk_on_android)
- [Using_clvk_on_Android](#_using_clvk_on_android)
- [Building clvk for Android](#_building_clvk_for_android)
- [Building_clvk_for_Android](#_building_clvk_for_android)
- [Loading the clvk OpenCL Library from NDK Code](#_loading_the_clvk_opencl_library_from_ndk_code)
- [Loading_the_clvk_OpenCL_Library_from_NDK_Code](#_loading_the_clvk_opencl_library_from_ndk_code)
- [A Complete clvk Workflow on Android](#_a_complete_clvk_workflow_on_android)
- [A_Complete_clvk_Workflow_on_Android](#_a_complete_clvk_workflow_on_android)
- [When to Use clvk vs. Native Vulkan on Android](#_when_to_use_clvk_vs_native_vulkan_on_android)
- [When_to_Use_clvk_vs._Native_Vulkan_on_Android](#_when_to_use_clvk_vs_native_vulkan_on_android)
- [Summary](#_summary)
...
The following example uses **Slang** (`slangc`), which is the primary shading language for this tutorial series. Download a release binary from [github.com/shader-slang/slang/releases](https://github.com/shader-slang/slang/releases) and place it somewhere on your `PATH` (or hardcode the path in the Gradle task).
...
std::vector loadSpirvAsset(AAssetManager* mgr, const char* name) {
    AAsset* asset = AAssetManager_open(mgr, name, AASSET_MODE_BUFFER);
    if (!asset) throw std::runtime_error("missing shader asset");
    size_t size = AAsset_getLength(asset);
    std::vector code(size / sizeof(uint32_t));
    AAsset_read(asset, code.data(), size);
    AAsset_close(asset);
    return code;
}

That `std::vector` feeds straight into `VkShaderModuleCreateInfo` exactly as on the desktop. Nothing about the SPIR-V itself is mobile-specific; do **not** maintain a separate "mobile" shader unless a queried limit forces a different workgroup size.
...
[Previous: Introduction](01_introduction.html) | [Next: Optimizing for Mobile GPUs](03_mobile_optimization.html)
