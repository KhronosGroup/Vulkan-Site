...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/02_Compute_Architecture/02_workgroups_and_invocations.html

## Table of Contents

- [Introduction](#_introduction)
- [The Three-Tier Hierarchy](#_the_three_tier_hierarchy)
- [The_Three-Tier_Hierarchy](#_the_three_tier_hierarchy)
- [Workgroup Locality](#_workgroup_locality)
- [The Math of Indexing](#_the_math_of_indexing)
- [The_Math_of_Indexing](#_the_math_of_indexing)
- [Choosing Optimal Sizes](#_choosing_optimal_sizes)
- [Choosing_Optimal_Sizes](#_choosing_optimal_sizes)
- [The Rule of 32/64](#_the_rule_of_3264)
- [The_Rule_of_32/64](#_the_rule_of_3264)
- [Dispatching the Work](#_dispatching_the_work)
- [Dispatching_the_Work](#_dispatching_the_work)
...
**Global Dispatch Grid**: This is the entire workload, defined in `vkCmdDispatch(x, y, z)`.

**Workgroups**: The global grid is subdivided into workgroups. The GPU’s hardware scheduler assigns these workgroups to physical compute units.

**Invocations**: Each workgroup contains multiple individual threads, defined by the `local_size` in your shader.
...
* 
**Mobile** GPUs vary the most: Arm Mali and Qualcomm Adreno may report a subgroup size anywhere from 4 to 128, and the maximum invocations per workgroup can be as low as 128 (versus 1024 on desktop). Never hard-code these — query them at runtime, as explained in [Compute on Android](../12_Mobile_and_Embedded_Compute/02_android_compute.html).
...
Note the use of "rounding up" (`(width + 15) / 16`). This ensures that if your image size isn’t a perfect multiple of 16, you don’t miss the last few pixels. Inside the shader, you would then use a bounds check: `if (x 
...
[Previous: Introduction](01_introduction.html) | [Next: Occupancy and Latency Hiding](03_occupancy_and_latency_hiding.html)
