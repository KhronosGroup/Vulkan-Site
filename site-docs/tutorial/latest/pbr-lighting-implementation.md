...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Lighting_Materials/04_lighting_implementation.html

## Table of Contents

- [Implementing the PBR Shader](#_implementing_the_pbr_shader)
- [Implementing_the_PBR_Shader](#_implementing_the_pbr_shader)
- [Section 1: Shader Setup Code - CPU-GPU Communication](#_section_1_shader_setup_code_cpu_gpu_communication)
- [Section_1:_Shader_Setup_Code_-_CPU-GPU_Communication](#_section_1_shader_setup_code_cpu_gpu_communication)
- [Section 2: Helper Functions - PBR Mathematics](#_section_2_helper_functions_pbr_mathematics)
- [Section_2:_Helper_Functions_-_PBR_Mathematics](#_section_2_helper_functions_pbr_mathematics)
- [Section 3: Vertex and Fragment Shader Main Bodies](#_section_3_vertex_and_fragment_shader_main_bodies)
- [Section_3:_Vertex_and_Fragment_Shader_Main_Bodies](#_section_3_vertex_and_fragment_shader_main_bodies)
- [Understanding the "Why" behind the shader](#_understanding_the_why_behind_the_shader)
- [Understanding_the_"Why"_behind_the_shader](#_understanding_the_why_behind_the_shader)
- [Why these BRDF terms (D, G, F)](#_why_these_brdf_terms_d_g_f)
- [Why_these_BRDF_terms_(D,_G,_F)](#_why_these_brdf_terms_d_g_f)
- [Why the metallic-roughness](#_why_the_metallic_roughness)
- [Why_the_metallic-roughness](#_why_the_metallic_roughness)
- [Why normal, occlusion, and emissive maps](#_why_normal_occlusion_and_emissive_maps)
- [Why_normal,_occlusion,_and_emissive_maps](#_why_normal_occlusion_and_emissive_maps)
- [Why HDR, exposure, and tone mapping](#_why_hdr_exposure_and_tone_mapping)
- [Why_HDR,_exposure,_and_tone_mapping](#_why_hdr_exposure_and_tone_mapping)
- [Practical tuning checklist](#_practical_tuning_checklist)
- [Practical_tuning_checklist](#_practical_tuning_checklist)
- [Extending the Renderer](#_extending_the_renderer)
- [Extending_the_Renderer](#_extending_the_renderer)
- [Shader Module Creation and Stage Setup](#_shader_module_creation_and_stage_setup)
- [Shader_Module_Creation_and_Stage_Setup](#_shader_module_creation_and_stage_setup)
- [Vertex Input Configuration](#_vertex_input_configuration)
- [Vertex_Input_Configuration](#_vertex_input_configuration)
- [Input Assembly and Primitive Processing](#_input_assembly_and_primitive_processing)
- [Input_Assembly_and_Primitive_Processing](#_input_assembly_and_primitive_processing)
- [Viewport and Dynamic State Configuration](#_viewport_and_dynamic_state_configuration)
- [Viewport_and_Dynamic_State_Configuration](#_viewport_and_dynamic_state_configuration)
- [Rasterization Configuration](#_rasterization_configuration)
- [Multisampling and Anti-Aliasing](#_multisampling_and_anti_aliasing)
- [Multisampling_and_Anti-Aliasing](#_multisampling_and_anti_aliasing)
- [Phase 7: Depth Testing and Z-Buffer Configuration](#_phase_7_depth_testing_and_z_buffer_configuration)
- [Phase_7:_Depth_Testing_and_Z-Buffer_Configuration](#_phase_7_depth_testing_and_z_buffer_configuration)
- [Phase 8: Color Blending and Transparency](#_phase_8_color_blending_and_transparency)
- [Phase_8:_Color_Blending_and_Transparency](#_phase_8_color_blending_and_transparency)
- [Phase 9: Pipeline Layout and Resource Binding](#_phase_9_pipeline_layout_and_resource_binding)
- [Phase_9:_Pipeline_Layout_and_Resource_Binding](#_phase_9_pipeline_layout_and_resource_binding)
- [Phase 10: Final Pipeline Creation and Dynamic Rendering Setup](#_phase_10_final_pipeline_creation_and_dynamic_rendering_setup)
- [Phase_10:_Final_Pipeline_Creation_and_Dynamic_Rendering_Setup](#_phase_10_final_pipeline_creation_and_dynamic_rendering_setup)
...
The foundation of our PBR implementation rests on microfacet theory, which recognizes that real surfaces consist of countless microscopic facets with varying orientations. Rather than trying to model each individual facet, the BRDF statistically represents their collective behavior, allowing us to achieve realistic lighting without the computational complexity of simulating every surface detail. This approach was thoroughly explored in Walter et al.'s seminal 2007 paper "Microfacet Models for Refraction through Rough Surfaces," which you can find at [their comprehensive BSDF documentation](https://www.graphics.cornell.edu/~bjw/microfacetbsdf.pdf).
...
For deeper exploration of these concepts, "Real-Time Rendering, 4th Edition" Chapter 9 on Physically Based Shading provides comprehensive coverage of the theory and practice. The online "PBR Book" by Pharr, Jakob, and Humphreys at [https://pbr-book.org/](https://pbr-book.org/) offers an exhaustive mathematical treatment of physically based rendering. For practical implementation insights, Epic Games' "Real Shading in Unreal Engine 4" presentation from the [2013 Shading Course](https://blog.selfshadow.com/publications/s2013-shading-course/) demonstrates how these concepts translate into production-ready code.
...
Add a new pipeline for our PBR shader

Add support for push constants

Update the uniform buffer to include light information
...
The vertex input state defines how vertex data flows from our vertex buffers into the vertex shader. This configuration must precisely match the vertex format expected by our PBR shader.
        ...
        vertexInputInfo.setVertexBindingDescriptionCount(1)
                      ...
                      .setVertexAttributeDescriptionCount(static_cast(attributeDescriptions.size()))
...
The viewport state manages the transformation from normalized device coordinates to screen coordinates, while dynamic state configuration allows certain pipeline parameters to be changed without recreating the entire pipeline.
        ...
        dynamicState.setDynamicStateCount(static_cast(dynamicStates.size()))
...
The final phase assembles all configuration states into a complete graphics pipeline and sets up dynamic rendering compatibility for modern Vulkan applications.
        ...
        pipelineInfo.setStageCount(static_cast(shaderStages.size()))   // Number of shader stages
