...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/10_Performance_Optimization/03_divergence_audit.html

## Table of Contents

- [Identifying Divergence](#_identifying_divergence)
- [Tool-Based Identification](#_tool_based_identification)
- [In-Shader Visualization](#_in_shader_visualization)
- [Refactoring Strategies](#_refactoring_strategies)
- [Strategy 1: Subgroup-Level Branching](#_strategy_1_subgroup_level_branching)
- [Strategy_1:_Subgroup-Level_Branching](#_strategy_1_subgroup_level_branching)
- [Strategy 2: Replacing Control Flow with Data Flow](#_strategy_2_replacing_control_flow_with_data_flow)
- [Strategy_2:_Replacing_Control_Flow_with_Data_Flow](#_strategy_2_replacing_control_flow_with_data_flow)
- [Strategy 3: Work Sorting](#_strategy_3_work_sorting)
- [Strategy_3:_Work_Sorting](#_strategy_3_work_sorting)
...
[Previous: Instruction Throughput Analysis](02_instruction_throughput.html) | [Next: Diagnostics and Refinement](../11_Diagnostics_and_Refinement/01_introduction.html)
