...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/courses/18_Ray_tracing/04_TLAS_animation.html

## Table of Contents

- [Task 6: Update the TLAS for animations](#_task_6_update_the_tlas_for_animations)
- [Task_6:_Update_the_TLAS_for_animations](#_task_6_update_the_tlas_for_animations)
...
auto &M = model;
tm.matrix = std::array,3>{{
        std::array{M[0][0], M[1][0], M[2][0], M[3][0]},
        std::array{M[0][1], M[1][1], M[2][1], M[3][1]},
        std::array{M[0][2], M[1][2], M[2][2], M[3][2]}
}};
...
![38 TASK07 shadows dynamic](../../_images/images/38_TASK07_shadows_dynamic.gif)
...
* 
Previous: [Ray query shadows](03_Ray_query_shadows.html)

* 
Next: [Shadow transparency](05_Shadow_transparency.html)
