...
Next, let’s acquire an image from the swap chain after the previous frame has
finished:
...
We’re going to use that index to pick the corresponding swap chain image view. Then we’ll record commands that render into it.
