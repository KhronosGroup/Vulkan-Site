...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/ML_Inference_Pipeline/02_what_is_machine_learning.html

## Table of Contents

- [From Rules to Learning](#_from_rules_to_learning)
- [From_Rules_to_Learning](#_from_rules_to_learning)
- [The Learning Process: A High-Level View](#_the_learning_process_a_high_level_view)
- [The_Learning_Process:_A_High-Level_View](#_the_learning_process_a_high_level_view)
- [Machine Learning in the Real World](#_machine_learning_in_the_real_world)
- [Machine_Learning_in_the_Real_World](#_machine_learning_in_the_real_world)
- [Computer Vision: Teaching Computers to See](#_computer_vision_teaching_computers_to_see)
- [Computer_Vision:_Teaching_Computers_to_See](#_computer_vision_teaching_computers_to_see)
- [Natural Language: Understanding Human Communication](#_natural_language_understanding_human_communication)
- [Natural_Language:_Understanding_Human_Communication](#_natural_language_understanding_human_communication)
- [Audio and Speech: The Sound of AI](#_audio_and_speech_the_sound_of_ai)
- [Audio_and_Speech:_The_Sound_of_AI](#_audio_and_speech_the_sound_of_ai)
- [Gaming and Interactive Applications: AI That Responds](#_gaming_and_interactive_applications_ai_that_responds)
- [Gaming_and_Interactive_Applications:_AI_That_Responds](#_gaming_and_interactive_applications_ai_that_responds)
- [Real-Time Graphics Enhancement: The Vulkan Connection](#_real_time_graphics_enhancement_the_vulkan_connection)
- [Real-Time_Graphics_Enhancement:_The_Vulkan_Connection](#_real_time_graphics_enhancement_the_vulkan_connection)
- [Why Real-Time Matters](#_why_real_time_matters)
- [Why_Real-Time_Matters](#_why_real_time_matters)
- [Summary](#_summary)
...
[Previous: Introduction](01_introduction.html) | [Next: Neural Networks Fundamentals](03_neural_networks_fundamentals.html)
