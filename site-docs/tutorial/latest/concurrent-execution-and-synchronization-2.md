...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/08_Asynchronous_Compute/02_concurrent_execution.html

## Table of Contents

- [Async Compute vs. Concurrent Execution](#_async_compute_vs_concurrent_execution)
- [Async_Compute_vs._Concurrent_Execution](#_async_compute_vs_concurrent_execution)
- [Queue Ownership Transfer: The Handshake](#_queue_ownership_transfer_the_handshake)
- [Queue_Ownership_Transfer:_The_Handshake](#_queue_ownership_transfer_the_handshake)
...
[Previous: Introduction](01_introduction.html) | [Next: Timeline Semaphores](03_timeline_semaphores.html)
