...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Debugging_Visual_Auditing/03_skinning_heatmaps.html

## Table of Contents

- [What Heatmaps Reveal](#_what_heatmaps_reveal)
- [What_Heatmaps_Reveal](#_what_heatmaps_reveal)
- [Implementing the Heatmap Render Mode](#_implementing_the_heatmap_render_mode)
- [Implementing_the_Heatmap_Render_Mode](#_implementing_the_heatmap_render_mode)
- [Reading the Heatmap](#_reading_the_heatmap)
- [Reading_the_Heatmap](#_reading_the_heatmap)
- [The Weight Distribution Heatmap](#_the_weight_distribution_heatmap)
- [The_Weight_Distribution_Heatmap](#_the_weight_distribution_heatmap)
- [Switching to Heatmap Mode at Runtime](#_switching_to_heatmap_mode_at_runtime)
- [Switching_to_Heatmap_Mode_at_Runtime](#_switching_to_heatmap_mode_at_runtime)
...
[[vk::binding(0, 0)]] StructuredBuffer    vertices;
[[vk::binding(1, 0)]] StructuredBuffer  joint_matrices;  // For world position
[[vk::binding(2, 0)]] StructuredBuffer     joint_indices;
[[vk::binding(3, 0)]] StructuredBuffer    joint_weights;
[[vk::binding(4, 0)]] StructuredBuffer    joint_colors;   // One RGBA per joint
...
std::vector generate_joint_colors(uint32_t joint_count)
{
    std::vector colors(joint_count);
    for (uint32_t i = 0; i (i) / joint_count; // 0..1
...
**Multiple Pipelines**: Create two separate `VkPipeline` objects using the same `VkPipelineLayout`. One pipeline uses the PBR fragment shader, and the other uses the heatmap fragment shader. At render time, simply bind the desired pipeline.
...
[Previous: Debug Drawers](02_debug_drawers.html) | [Next: RenderDoc Analysis](04_renderdoc_analysis.html)
