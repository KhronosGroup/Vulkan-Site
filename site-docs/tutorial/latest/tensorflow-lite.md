...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Third_Party_Libraries/03_tensorflow_lite.html

## Table of Contents

- [Introduction](#_introduction)
- [The Mobile-First Philosophy](#_the_mobile_first_philosophy)
- [The_Mobile-First_Philosophy](#_the_mobile_first_philosophy)
- [The Battery Constraint](#_the_battery_constraint)
- [The_Battery_Constraint](#_the_battery_constraint)
- [The Size Constraint](#_the_size_constraint)
- [The_Size_Constraint](#_the_size_constraint)
- [The Performance Constraint](#_the_performance_constraint)
- [The_Performance_Constraint](#_the_performance_constraint)
- [The Diversity Constraint](#_the_diversity_constraint)
- [The_Diversity_Constraint](#_the_diversity_constraint)
- [The Architecture: Designed for Efficiency](#_the_architecture_designed_for_efficiency)
- [The_Architecture:_Designed_for_Efficiency](#_the_architecture_designed_for_efficiency)
- [The FlatBuffers Format](#_the_flatbuffers_format)
- [The_FlatBuffers_Format](#_the_flatbuffers_format)
- [The Operator Set: Focused and Optimized](#_the_operator_set_focused_and_optimized)
- [The_Operator_Set:_Focused_and_Optimized](#_the_operator_set_focused_and_optimized)
- [The Interpreter: Lightweight and Fast](#_the_interpreter_lightweight_and_fast)
- [The_Interpreter:_Lightweight_and_Fast](#_the_interpreter_lightweight_and_fast)
- [The Delegate System: Hardware Acceleration](#_the_delegate_system_hardware_acceleration)
- [The_Delegate_System:_Hardware_Acceleration](#_the_delegate_system_hardware_acceleration)
...
- [What Is Quantization?](#_what_is_quantization)
- [What_Is_Quantization?](#_what_is_quantization)
- [How Quantization Works](#_how_quantization_works)
- [How_Quantization_Works](#_how_quantization_works)
- [Types of Quantization](#_types_of_quantization)
- [Types_of_Quantization](#_types_of_quantization)
- [Practical Quantization Workflow](#_practical_quantization_workflow)
- [Practical_Quantization_Workflow](#_practical_quantization_workflow)
...
- [The Basic Approach: Separate Contexts](#_the_basic_approach_separate_contexts)
- [The_Basic_Approach:_Separate_Contexts](#_the_basic_approach_separate_contexts)
- [Using the GPU Delegate](#_using_the_gpu_delegate)
- [Using_the_GPU_Delegate](#_using_the_gpu_delegate)
- [Advanced: Shared Memory (Platform-Specific)](#_advanced_shared_memory_platform_specific)
- [Advanced:_Shared_Memory_(Platform-Specific)](#_advanced_shared_memory_platform_specific)
- [Mobile-Specific Considerations](#_mobile_specific_considerations)
- [Practical Example: Image Classification](#_practical_example_image_classification)
- [Practical_Example:_Image_Classification](#_practical_example_image_classification)
- [The Scenario](#_the_scenario)
- [Model Selection](#_model_selection)
- [Android Integration](#_android_integration)
- [Vulkan Integration](#_vulkan_integration)
- [Performance Optimization](#_performance_optimization)
- [When TensorFlow Lite Makes Sense](#_when_tensorflow_lite_makes_sense)
- [When_TensorFlow_Lite_Makes_Sense](#_when_tensorflow_lite_makes_sense)
...
Copy relevant data from GPU memory to CPU memory (e.g., a rendered frame)

Preprocess the data as needed (resize, normalize, etc.)

Run TensorFlow Lite inference (which might use GPU internally via its GPU delegate)

Process the inference results on CPU

Copy results back to GPU memory if needed for rendering
...
Allocate memory using Vulkan’s external memory extensions (VK_KHR_external_memory)

Export the memory handle (file descriptor on Linux/Android, handle on Windows)

Import this memory into TensorFlow Lite’s GPU delegate (requires custom delegate implementation or modifications)

Both contexts can now access the same memory, eliminating copies
...
**Capture Frame**: Your Vulkan pipeline renders the camera feed to a texture

**Read Back**: Use `vkCmdCopyImageToBuffer` to copy the texture to a staging buffer

**Map Memory**: Map the staging buffer to CPU memory

**Preprocess**: Resize to 224×224, normalize to [0,1], convert to the format TensorFlow Lite expects

**Inference**: Run TensorFlow Lite inference on a background thread

**Display Results**: When inference completes, update UI with the predicted label
...
[Previous: ONNX Runtime](02_onnx_runtime.html) | [Next: PyTorch Mobile](04_pytorch_mobile.html)
