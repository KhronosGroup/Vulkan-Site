...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/courses/18_Ray_tracing/05_Shadow_transparency.html

## Table of Contents

- [Task 7: Alpha-cut transparency](#_task_7_alpha_cut_transparency)
- [Task_7:_Alpha-cut_transparency](#_task_7_alpha_cut_transparency)
- [Task 8: Inspect the acceleration structures with NVIDIA Nsight Graphics](#_task_8_inspect_the_acceleration_structures_with_nvidia_nsight_graphics)
- [Task_8:_Inspect_the_acceleration_structures_with_NVIDIA_Nsight_Graphics](#_task_8_inspect_the_acceleration_structures_with_nvidia_nsight_graphics)
- [Task 9: Bindless resources and instance look-up table](#_task_9_bindless_resources_and_instance_look_up_table)
- [Task_9:_Bindless_resources_and_instance_look-up_table](#_task_9_bindless_resources_and_instance_look_up_table)
- [Task 10: Ray query with alpha test](#_task_10_ray_query_with_alpha_test)
- [Task_10:_Ray_query_with_alpha_test](#_task_10_ray_query_with_alpha_test)
...
![38 TASK08 alphacut before](../../_images/images/38_TASK08_alphacut_before.png)
...
![38 TASK08 alphacut after](../../_images/images/38_TASK08_alphacut_after.png)
...
![38 TASK04 nsight launch](../../_images/images/38_TASK04_nsight_launch.png)

Then capture a frame and click on "Start Graphics Debugger":

![38 TASK04 nsight capture](../../_images/images/38_TASK04_nsight_capture.png)
...
![38 TASK04 nsight main](../../_images/images/38_TASK04_nsight_main.png)
...
![38 TASK04 nsight inspector](../../_images/images/38_TASK04_nsight_inspector.png)
...
![38 TASK09 instance lut](../../_images/images/38_TASK09_instance_lut.png)
...
instances[i].instanceCustomIndex = static_cast(i);
...
![38 TASK09 instance custom index](../../_images/images/38_TASK09_instance_custom_index.png)
...
instanceLUTs.push_back({ static_cast(submesh.materialID), submesh.indexOffset });
...
[[vk::binding(4,0)]]
StructuredBuffer instanceLUTBuffer;
...
![38 TASK10 alphacut shadows](../../_images/images/38_TASK10_alphacut_shadows.png)
...
* 
Previous: [TLAS animation](04_TLAS_animation.html)

* 
Next: [Reflections](06_Reflections.html)
