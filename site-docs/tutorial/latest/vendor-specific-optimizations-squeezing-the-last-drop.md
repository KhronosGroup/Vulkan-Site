...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Advanced_Topics/03_vendor_optimizations.html

## Table of Contents

- [The Pragmatic Path: Library-Level Hardware Acceleration](#_the_pragmatic_path_library_level_hardware_acceleration)
- [The_Pragmatic_Path:_Library-Level_Hardware_Acceleration](#_the_pragmatic_path_library_level_hardware_acceleration)
- [1. WebGPU / DirectML (Universal Windows/Linux)](#_1_webgpu_directml_universal_windowslinux)
- [1._WebGPU_/_DirectML_(Universal_Windows/Linux)](#_1_webgpu_directml_universal_windowslinux)
- [2. CUDA / TensorRT (NVIDIA Specific)](#_2_cuda_tensorrt_nvidia_specific)
- [2._CUDA_/_TensorRT_(NVIDIA_Specific)](#_2_cuda_tensorrt_nvidia_specific)
- [The Silicon Landscape: Matrix Math Units](#_the_silicon_landscape_matrix_math_units)
- [The_Silicon_Landscape:_Matrix_Math_Units](#_the_silicon_landscape_matrix_math_units)
- [1. NVIDIA (Tensor Cores)](#_1_nvidia_tensor_cores)
- [1._NVIDIA_(Tensor_Cores)](#_1_nvidia_tensor_cores)
- [2. AMD (WMMA - Wave Matrix Multiply-Accumulate)](#_2_amd_wmma_wave_matrix_multiply_accumulate)
- [2._AMD_(WMMA_-_Wave_Matrix_Multiply-Accumulate)](#_2_amd_wmma_wave_matrix_multiply_accumulate)
- [3. Intel (XMX - Xe Matrix Extensions)](#_3_intel_xmx_xe_matrix_extensions)
- [3._Intel_(XMX_-_Xe_Matrix_Extensions)](#_3_intel_xmx_xe_matrix_extensions)
- [Cooperative Matrices: The Universal Fast-Path](#_cooperative_matrices_the_universal_fast_path)
- [Cooperative_Matrices:_The_Universal_Fast-Path](#_cooperative_matrices_the_universal_fast_path)
- [The Concept: Opaque Tiling](#_the_concept_opaque_tiling)
- [The_Concept:_Opaque_Tiling](#_the_concept_opaque_tiling)
- [Hands-on: Querying and Using Matrix Accelerators](#_hands_on_querying_and_using_matrix_accelerators)
- [Hands-on:_Querying_and_Using_Matrix_Accelerators](#_hands_on_querying_and_using_matrix_accelerators)
- [Phase 1: Enabling the Extension (C++)](#_phase_1_enabling_the_extension_c)
- [Phase_1:_Enabling_the_Extension_(C++)](#_phase_1_enabling_the_extension_c)
- [Phase 2: Querying Hardware Capabilities](#_phase_2_querying_hardware_capabilities)
- [Phase_2:_Querying_Hardware_Capabilities](#_phase_2_querying_hardware_capabilities)
- [Phase 3: The Specialization Constant Handshake](#_phase_3_the_specialization_constant_handshake)
- [Phase_3:_The_Specialization_Constant_Handshake](#_phase_3_the_specialization_constant_handshake)
- [Phase 4: Dispatch Orchestration](#_phase_4_dispatch_orchestration)
- [Phase_4:_Dispatch_Orchestration](#_phase_4_dispatch_orchestration)
- [Mastering Registers: The Hidden Bottleneck](#_mastering_registers_the_hidden_bottleneck)
- [Mastering_Registers:_The_Hidden_Bottleneck](#_mastering_registers_the_hidden_bottleneck)
- [The Register File](#_the_register_file)
- [The_Register_File](#_the_register_file)
- [Why Occupancy Matters](#_why_occupancy_matters)
- [Why_Occupancy_Matters](#_why_occupancy_matters)
- [Professional Profiling: The "Microscope"](#_professional_profiling_the_microscope)
- [Professional_Profiling:_The_"Microscope"](#_professional_profiling_the_microscope)
- [Subgroup Shuffles: Communication Without VRAM](#_subgroup_shuffles_communication_without_vram)
- [Subgroup_Shuffles:_Communication_Without_VRAM](#_subgroup_shuffles_communication_without_vram)
- [The "Shuffle" Pattern](#_the_shuffle_pattern)
- [The_"Shuffle"_Pattern](#_the_shuffle_pattern)
- [Vendor Nuance: Wavefront Sizes](#_vendor_nuance_wavefront_sizes)
- [Vendor_Nuance:_Wavefront_Sizes](#_vendor_nuance_wavefront_sizes)
- [The Multi-Vendor Dispatcher Pattern](#_the_multi_vendor_dispatcher_pattern)
- [The_Multi-Vendor_Dispatcher_Pattern](#_the_multi_vendor_dispatcher_pattern)
- [Vendor-Specific Performance Profiles](#_vendor_specific_performance_profiles)
- [Vendor-Specific_Performance_Profiles](#_vendor_specific_performance_profiles)
- [Memory Alignment: The Silent Performance Killer](#_memory_alignment_the_silent_performance_killer)
- [Memory_Alignment:_The_Silent_Performance_Killer](#_memory_alignment_the_silent_performance_killer)
- [Summary: The Hardware Mastery Checklist](#_summary_the_hardware_mastery_checklist)
- [Summary:_The_Hardware_Mastery_Checklist](#_summary_the_hardware_mastery_checklist)
...
![Diagram showing Matrix A and B distribution across a GPU Warp for hardware acceleration](../../_images/images/ML_Inference/Advanced_Topics/coop_matrix_warp.svg)

Figure 1. Warp-Level Matrix Cooperation
...
std::vector props(propertyCount);
...
**Workgroup Size**: Set your `local_size_x` to the `subgroupSize` (e.g., 32).
...
**NVIDIA (Nsight Compute)**: Look at the "Register Pressure" metric. If it says "Spilling to Local Memory," your registers overflowed into slow VRAM. You must shrink your `coopmat` tiles or simplify your loops.
...
std::unique_ptr selectOptimalPath(vk::PhysicalDevice gpu) {
...
* 
**NVIDIA**: [RTX 4090 Product Specifications](https://www.nvidia.com/en-us/geforce/graphics-cards/40-series/rtx-4090/) (Tensor Core throughputs derived from peak compute and sparsity ratios).

* 
**AMD**: [AMD Radeon RX 7900 XTX Specs](https://www.amd.com/en/products/graphics/amd-radeon-rx-7900-xtx) (AI Accelerator performance).

* 
**Intel**: [Intel Arc A770 Specifications](https://www.intel.com/content/www/us/en/products/sku/229151/intel-arc-a770-graphics-16gb/specifications.html) (XMX throughput).
...
**Library Path**: Configure `SessionOptions` to enable `trt_fp16_enable` or the `webgpu` provider.

**Query**: Use `vkGetPhysicalDeviceProperties2` to check for `VkPhysicalDeviceCooperativeMatrixPropertiesKHR`.

**Tiling**: Align your ML layers to 16x16 or 32x32 blocks to match hardware matrix units.

**Cooperative Matrices**: Replace inner loops with `coopMatMulAdd` for a    boost.

**Subgroups**: Use `subgroupMax`, `subgroupSum`, and `subgroupShuffle` for all inter-thread communication.
...
[Previous: Quantization Strategies](02_quantization_strategies.html) | [Next: Advanced Memory Management](04_memory_management.html)
