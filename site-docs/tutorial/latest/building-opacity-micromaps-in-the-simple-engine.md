...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Courses/Opacity_Micromaps/05_implementation_overview.html

## Table of Contents

- [The Conceptual Architecture](#_the_conceptual_architecture)
- [The_Conceptual_Architecture](#_the_conceptual_architecture)
- [Phase Zero: Checking for Support](#_phase_zero_checking_for_support)
- [Phase_Zero:_Checking_for_Support](#_phase_zero_checking_for_support)
- [Phase One: Analysis](#_phase_one_analysis)
- [Phase_One:_Analysis](#_phase_one_analysis)
- [Phase Two: Classification](#_phase_two_classification)
- [Phase_Two:_Classification](#_phase_two_classification)
- [Phase Three: GPU Construction](#_phase_three_gpu_construction)
- [Phase_Three:_GPU_Construction](#_phase_three_gpu_construction)
- [Connecting the Micromap to the BLAS](#_connecting_the_micromap_to_the_blas)
- [Connecting_the_Micromap_to_the_BLAS](#_connecting_the_micromap_to_the_blas)
- [The Shadow Shader Needs One Small Addition](#_the_shadow_shader_needs_one_small_addition)
- [The_Shadow_Shader_Needs_One_Small_Addition](#_the_shadow_shader_needs_one_small_addition)
- [Memory and Object Lifetime](#_memory_and_object_lifetime)
- [Memory_and_Object_Lifetime](#_memory_and_object_lifetime)
...
[Previous: Inside the Traversal: How the GPU Uses Your Micromap](04_hardware_traversal_with_omm.html) | [Next: Seeing the Difference and Knowing When to Use It](06_results_guidance_and_tradeoffs.html)
