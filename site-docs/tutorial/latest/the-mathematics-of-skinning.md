...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Skeletal_Compute_Skinning/02_skinning_math.html

## Table of Contents

- [Why the Math Matters](#_why_the_math_matters)
- [Why_the_Math_Matters](#_why_the_math_matters)
- [The Bind Pose and Why It Exists](#_the_bind_pose_and_why_it_exists)
- [The_Bind_Pose_and_Why_It_Exists](#_the_bind_pose_and_why_it_exists)
- [The Three-Step Skinning Equation](#_the_three_step_skinning_equation)
- [The_Three-Step_Skinning_Equation](#_the_three_step_skinning_equation)
- [Step 1: Transform the Vertex to Bone-Local Space](#_step_1_transform_the_vertex_to_bone_local_space)
- [Step_1:_Transform_the_Vertex_to_Bone-Local_Space](#_step_1_transform_the_vertex_to_bone_local_space)
- [Step 2: Apply the Current Joint Transform](#_step_2_apply_the_current_joint_transform)
- [Step_2:_Apply_the_Current_Joint_Transform](#_step_2_apply_the_current_joint_transform)
- [Step 3: Blend Multiple Joint Influences](#_step_3_blend_multiple_joint_influences)
- [Step_3:_Blend_Multiple_Joint_Influences](#_step_3_blend_multiple_joint_influences)
- [The Joint Matrix: Pre-Computing the Key Operation](#_the_joint_matrix_pre_computing_the_key_operation)
- [The_Joint_Matrix:_Pre-Computing_the_Key_Operation](#_the_joint_matrix_pre_computing_the_key_operation)
- [Handling Normals](#_handling_normals)
- [Tangents and Bitangents](#_tangents_and_bitangents)
- [Tangents_and_Bitangents](#_tangents_and_bitangents)
...
[Previous: Introduction](01_introduction.html) | [Next: The Compute Skinning Pipeline](03_compute_skinning.html)
