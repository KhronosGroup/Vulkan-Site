...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Host_Image_Copies_Memory_Sync/03_visibility_flushes.html

## Table of Contents

- [Understanding Host-Device Synchronization](#_understanding_host_device_synchronization)
- [Understanding_Host-Device_Synchronization](#_understanding_host_device_synchronization)
- [The Host-to-Device Dependency](#_the_host_to_device_dependency)
- [The_Host-to-Device_Dependency](#_the_host_to_device_dependency)
- [The Device-to-Host Dependency](#_the_device_to_host_dependency)
- [The_Device-to-Host_Dependency](#_the_device_to_host_dependency)
...
Previous: [Direct CPU-to-Image Access](02_cpu_to_image_access.html) | Next: [Debugging with Synchronization Validation](../Synchronization_Validation/01_introduction.html)
