...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Third_Party_Libraries/07_gpu_resource_sharing.html

## Table of Contents

- [Introduction](#_introduction)
- [Why GPU Resource Sharing Matters](#_why_gpu_resource_sharing_matters)
- [Why_GPU_Resource_Sharing_Matters](#_why_gpu_resource_sharing_matters)
- [The Cost of CPU Roundtrips](#_the_cost_of_cpu_roundtrips)
- [The_Cost_of_CPU_Roundtrips](#_the_cost_of_cpu_roundtrips)
- [The Zero-Copy Alternative](#_the_zero_copy_alternative)
- [The_Zero-Copy_Alternative](#_the_zero_copy_alternative)
- [Beyond Performance: Memory Efficiency](#_beyond_performance_memory_efficiency)
- [Beyond_Performance:_Memory_Efficiency](#_beyond_performance_memory_efficiency)
- [Vulkan External Memory Extensions](#_vulkan_external_memory_extensions)
- [Vulkan_External_Memory_Extensions](#_vulkan_external_memory_extensions)
- [The Extension Family](#_the_extension_family)
- [The_Extension_Family](#_the_extension_family)
- [Checking for Support](#_checking_for_support)
- [Checking_for_Support](#_checking_for_support)
- [Allocating Exportable Memory](#_allocating_exportable_memory)
- [Allocating_Exportable_Memory](#_allocating_exportable_memory)
- [Exporting Memory Handles](#_exporting_memory_handles)
- [Exporting_Memory_Handles](#_exporting_memory_handles)
- [Platform-Specific Handle Types](#_platform_specific_handle_types)
- [Platform-Specific_Handle_Types](#_platform_specific_handle_types)
- [Linux: File Descriptors and DMA-BUF](#_linux_file_descriptors_and_dma_buf)
- [Linux:_File_Descriptors_and_DMA-BUF](#_linux_file_descriptors_and_dma_buf)
- [Windows: NT Handles](#_windows_nt_handles)
- [Windows:_NT_Handles](#_windows_nt_handles)
- [macOS and iOS: IOSurface](#_macos_and_ios_iosurface)
- [macOS_and_iOS:_IOSurface](#_macos_and_ios_iosurface)
- [Android: Hardware Buffers](#_android_hardware_buffers)
- [Android:_Hardware_Buffers](#_android_hardware_buffers)
- [Importing Memory into ML Libraries](#_importing_memory_into_ml_libraries)
- [Importing_Memory_into_ML_Libraries](#_importing_memory_into_ml_libraries)
- [ONNX Runtime with OpenCL Execution Provider](#_onnx_runtime_with_opencl_execution_provider)
- [ONNX_Runtime_with_OpenCL_Execution_Provider](#_onnx_runtime_with_opencl_execution_provider)
- [TensorFlow Lite with GPU Delegate](#_tensorflow_lite_with_gpu_delegate)
- [TensorFlow_Lite_with_GPU_Delegate](#_tensorflow_lite_with_gpu_delegate)
- [DirectML (Windows)](#_directml_windows)
...
- [Vulkan Semaphores and Fences](#_vulkan_semaphores_and_fences)
- [Vulkan_Semaphores_and_Fences](#_vulkan_semaphores_and_fences)
- [External Semaphores](#_external_semaphores)
- [Timeline Semaphores](#_timeline_semaphores)
- [Practical Considerations](#_practical_considerations)
- [Memory Layout and Format Compatibility](#_memory_layout_and_format_compatibility)
- [Memory_Layout_and_Format_Compatibility](#_memory_layout_and_format_compatibility)
- [Format Conversions](#_format_conversions)
- [Driver and Platform Limitations](#_driver_and_platform_limitations)
- [Driver_and_Platform_Limitations](#_driver_and_platform_limitations)
...
vk::PhysicalDeviceExternalImageFormatInfo externalImageFormatInfo{
    .handleType = static_cast(supportedHandleTypes)
};
...
if (result == vk::Result::eSuccess) {
    ...
    bool canExport = static_cast(externalImageFormatProps.externalMemoryProperties.externalMemoryFeatures &
                     vk::ExternalMemoryFeatureFlagBits::eExportable);
    bool canImport = static_cast(externalImageFormatProps.externalMemoryProperties.externalMemoryFeatures &
...
std::vector shape = {1, 3, 1080, 1920}; // NCHW format
...
[Previous: Integration Patterns](06_integration_patterns.html) | [Next: Data Transfer Optimization](08_data_transfer_optimization.html)
