...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Profiling_Optimization/02_barrier_batching.html

## Table of Contents

- [The Cost of a Call](#_the_cost_of_a_call)
- [The_Cost_of_a_Call](#_the_cost_of_a_call)
- [The Solution: Batching](#_the_solution_batching)
- [The_Solution:_Batching](#_the_solution_batching)
- [Hardware Benefits](#_hardware_benefits)
- [Implementation Strategy](#_implementation_strategy)
- [Simple Engine: Consolidation](#_simple_engine_consolidation)
- [Simple_Engine:_Consolidation](#_simple_engine_consolidation)
...
std::vector imageBarriers = { /* ... multiple image transitions ... */ };
...
Previous: [Introduction](01_introduction.html) | Next: [Visualizing Stalls](03_visualizing_stalls.html)
