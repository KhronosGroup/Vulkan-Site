...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Mobile_Development/04_rendering_approaches.html

## Table of Contents

- [Rendering Approaches for Mobile GPUs](#_rendering_approaches_for_mobile_gpus)
- [Rendering_Approaches_for_Mobile_GPUs](#_rendering_approaches_for_mobile_gpus)
- [Tile-Based Rendering (TBR)](#_tile_based_rendering_tbr)
- [Tile-Based_Rendering_(TBR)](#_tile_based_rendering_tbr)
- [How TBR Works](#_how_tbr_works)
- [How_TBR_Works](#_how_tbr_works)
- [Advantages of TBR](#_advantages_of_tbr)
- [Advantages_of_TBR](#_advantages_of_tbr)
- [Optimizing for TBR](#_optimizing_for_tbr)
- [Optimizing_for_TBR](#_optimizing_for_tbr)
- [Best Practices for TBR](#_best_practices_for_tbr)
- [Best_Practices_for_TBR](#_best_practices_for_tbr)
- [Attachment Load/Store Operations on Tilers](#_attachment_loadstore_operations_on_tilers)
- [Attachment_Load/Store_Operations_on_Tilers](#_attachment_loadstore_operations_on_tilers)
- [Pipelining_on_Tilers:_Subpass_Dependencies_and_BY_REGION](#_pipelining_on_tilers_subpass_dependencies_and_by_region)
- [Memory Management](#_memory_management)
- [Shader Optimizations](#_shader_optimizations)
- [Depth Testing Optimizations](#_depth_testing_optimizations)
- [Depth_Testing_Optimizations](#_depth_testing_optimizations)
- [Immediate Mode Rendering (IMR)](#_immediate_mode_rendering_imr)
- [Immediate_Mode_Rendering_(IMR)](#_immediate_mode_rendering_imr)
- [How IMR Works](#_how_imr_works)
- [How_IMR_Works](#_how_imr_works)
- [Advantages of IMR](#_advantages_of_imr)
- [Advantages_of_IMR](#_advantages_of_imr)
- [Optimizing for IMR](#_optimizing_for_imr)
- [Optimizing_for_IMR](#_optimizing_for_imr)
- [Detecting Rendering Architecture](#_detecting_rendering_architecture)
- [Detecting_Rendering_Architecture](#_detecting_rendering_architecture)
- [Adapting to Both Architectures](#_adapting_to_both_architectures)
- [Adapting_to_Both_Architectures](#_adapting_to_both_architectures)
- [Best Practices for Both Architectures](#_best_practices_for_both_architectures)
- [Best_Practices_for_Both_Architectures](#_best_practices_for_both_architectures)
...
Load the primitives affecting that tile into on-chip memory.

Render the primitives to the tile.

Write the completed tile back to main memory.
...
For further guidance, see the [Vulkan Guide](#https://docs.vulkan.org/guide/latest/) topics on Tile-based GPUs, Render Passes, and Synchronization.
