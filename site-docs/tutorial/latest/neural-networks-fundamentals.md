...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/ML_Inference_Pipeline/03_neural_networks_fundamentals.html

## Table of Contents

- [Introduction](#_introduction)
- [What’s a Function?](#_whats_a_function)
- [What’s_a_Function?](#_whats_a_function)
- [Learning from Nature: Biological Neurons](#_learning_from_nature_biological_neurons)
- [Learning_from_Nature:_Biological_Neurons](#_learning_from_nature_biological_neurons)
- [The Structure: A Communication Network](#_the_structure_a_communication_network)
- [The_Structure:_A_Communication_Network](#_the_structure_a_communication_network)
- [How Neurons Actually Work: The Firing Process](#_how_neurons_actually_work_the_firing_process)
- [How_Neurons_Actually_Work:_The_Firing_Process](#_how_neurons_actually_work_the_firing_process)
- [The Power of Networks: How Complexity Emerges](#_the_power_of_networks_how_complexity_emerges)
- [The_Power_of_Networks:_How_Complexity_Emerges](#_the_power_of_networks_how_complexity_emerges)
- [Plasticity and Learning: The Brain’s Superpower](#_plasticity_and_learning_the_brains_superpower)
- [Plasticity_and_Learning:_The_Brain’s_Superpower](#_plasticity_and_learning_the_brains_superpower)
- [Why This Matters for Artificial Neural Networks](#_why_this_matters_for_artificial_neural_networks)
- [Why_This_Matters_for_Artificial_Neural_Networks](#_why_this_matters_for_artificial_neural_networks)
- [Mimicking Nature: Artificial Neurons](#_mimicking_nature_artificial_neurons)
- [Mimicking_Nature:_Artificial_Neurons](#_mimicking_nature_artificial_neurons)
- [Understanding Weights: The Importance Multipliers](#_understanding_weights_the_importance_multipliers)
- [Understanding_Weights:_The_Importance_Multipliers](#_understanding_weights_the_importance_multipliers)
- [Understanding Bias: The Threshold Adjuster](#_understanding_bias_the_threshold_adjuster)
- [Understanding_Bias:_The_Threshold_Adjuster](#_understanding_bias_the_threshold_adjuster)
- [Putting It Together: The Linear Neuron](#_putting_it_together_the_linear_neuron)
- [Putting_It_Together:_The_Linear_Neuron](#_putting_it_together_the_linear_neuron)
- [The Problem with Linear Functions](#_the_problem_with_linear_functions)
- [The_Problem_with_Linear_Functions](#_the_problem_with_linear_functions)
- [The Solution: Non-Linear Activation Functions](#_the_solution_non_linear_activation_functions)
- [The_Solution:_Non-Linear_Activation_Functions](#_the_solution_non_linear_activation_functions)
- [A Concrete Example: Building an AND Gate](#_a_concrete_example_building_an_and_gate)
- [A_Concrete_Example:_Building_an_AND_Gate](#_a_concrete_example_building_an_and_gate)
- [The Cost of Generality](#_the_cost_of_generality)
- [The_Cost_of_Generality](#_the_cost_of_generality)
- [Modern Activation Functions: Why Sigmoid Isn’t Enough](#_modern_activation_functions_why_sigmoid_isnt_enough)
- [Modern_Activation_Functions:_Why_Sigmoid_Isn’t_Enough](#_modern_activation_functions_why_sigmoid_isnt_enough)
- [How Neural Networks Learn: A Gentle Introduction](#_how_neural_networks_learn_a_gentle_introduction)
- [How_Neural_Networks_Learn:_A_Gentle_Introduction](#_how_neural_networks_learn_a_gentle_introduction)
- [The Learning Problem](#_the_learning_problem)
- [The_Learning_Problem](#_the_learning_problem)
- [Enter Gradients](#_enter_gradients)
- [Gradient Descent: The Mountain Trail Analogy](#_gradient_descent_the_mountain_trail_analogy)
- [Gradient_Descent:_The_Mountain_Trail_Analogy](#_gradient_descent_the_mountain_trail_analogy)
- [Starting with a Random Guess](#_starting_with_a_random_guess)
- [Starting_with_a_Random_Guess](#_starting_with_a_random_guess)
- [The Loss Function: Your Compass](#_the_loss_function_your_compass)
- [The_Loss_Function:_Your_Compass](#_the_loss_function_your_compass)
- [Taking Steps Downhill](#_taking_steps_downhill)
- [Taking_Steps_Downhill](#_taking_steps_downhill)
- [When to Stop: Convergence](#_when_to_stop_convergence)
- [When_to_Stop:_Convergence](#_when_to_stop_convergence)
- [The Challenge: Local vs Global Minima](#_the_challenge_local_vs_global_minima)
- [The_Challenge:_Local_vs_Global_Minima](#_the_challenge_local_vs_global_minima)
- [Evaluating Models: How to Tell When a Model Is Better](#_evaluating_models_how_to_tell_when_a_model_is_better)
- [Evaluating_Models:_How_to_Tell_When_a_Model_Is_Better](#_evaluating_models_how_to_tell_when_a_model_is_better)
- [Training vs Validation vs Test Data](#_training_vs_validation_vs_test_data)
- [Training_vs_Validation_vs_Test_Data](#_training_vs_validation_vs_test_data)
- [Key Evaluation Metrics](#_key_evaluation_metrics)
- [Key_Evaluation_Metrics](#_key_evaluation_metrics)
- [Comparing Models](#_comparing_models)
- [Overfitting vs Underfitting](#_overfitting_vs_underfitting)
- [Overfitting_vs_Underfitting](#_overfitting_vs_underfitting)
- [Backpropagation: Computing Gradients Efficiently](#_backpropagation_computing_gradients_efficiently)
- [Backpropagation:_Computing_Gradients_Efficiently](#_backpropagation_computing_gradients_efficiently)
- [Understanding the Chain Rule](#_understanding_the_chain_rule)
- [Understanding_the_Chain_Rule](#_understanding_the_chain_rule)
- [Why Neural Networks Are Perfect for the Chain Rule](#_why_neural_networks_are_perfect_for_the_chain_rule)
- [Why_Neural_Networks_Are_Perfect_for_the_Chain_Rule](#_why_neural_networks_are_perfect_for_the_chain_rule)
- [The Key Insight for Activation Functions](#_the_key_insight_for_activation_functions)
- [The_Key_Insight_for_Activation_Functions](#_the_key_insight_for_activation_functions)
- [The Training Challenge: Vanishing Gradients](#_the_training_challenge_vanishing_gradients)
- [The_Training_Challenge:_Vanishing_Gradients](#_the_training_challenge_vanishing_gradients)
- [Enter ReLU: A Simple Solution](#_enter_relu_a_simple_solution)
- [Enter_ReLU:_A_Simple_Solution](#_enter_relu_a_simple_solution)
- [Variations and Alternatives](#_variations_and_alternatives)
- [Variations_and_Alternatives](#_variations_and_alternatives)
- [Leaky ReLU: Fixing the Dying Neuron Problem](#_leaky_relu_fixing_the_dying_neuron_problem)
- [Leaky_ReLU:_Fixing_the_Dying_Neuron_Problem](#_leaky_relu_fixing_the_dying_neuron_problem)
- [Tanh: When You Need Symmetry](#_tanh_when_you_need_symmetry)
- [Tanh:_When_You_Need_Symmetry](#_tanh_when_you_need_symmetry)
- [Other Modern Variants: Specialized Solutions](#_other_modern_variants_specialized_solutions)
- [Other_Modern_Variants:_Specialized_Solutions](#_other_modern_variants_specialized_solutions)
- [Why This Matters for Inference](#_why_this_matters_for_inference)
- [Why_This_Matters_for_Inference](#_why_this_matters_for_inference)
- [Summary](#_summary)
...
![A biological neuron showing dendrites](../../_images/images/ML_Inference/ML_Inference_Pipeline/biological_neuron.png)
...
![An artificial neuron (perceptron) with three inputs and one output](../../_images/images/ML_Inference/ML_Inference_Pipeline/linear_perceptron.png)
...
![A simple neural network with input layer](../../_images/images/ML_Inference/ML_Inference_Pipeline/neural_network_example.png)
...
![A single neuron implementing an AND gate with sigmoid activation](../../_images/images/ML_Inference/ML_Inference_Pipeline/basic_and_node.png)
...
| --- | --- | --- | --- |
| 0 | 0 | σ(-30 + 0 + 0) = σ(-30) | ≈ 0 |
| 1 | 0 | σ(-30 + 20 + 0) = σ(-10) | ≈ 0 |
| 0 | 1 | σ(-30 + 0 + 20) = σ(-10) | ≈ 0 |
| 1 | 1 | σ(-30 + 20 + 20) = σ(10) | ≈ 1 |
...
Input layer computes: `h₁ = activation(W₁ × input + b₁)`

Hidden layer computes: `h₂ = activation(W₂ × h₁ + b₂)`

Output layer computes: `output = activation(W₃ × h₂ + b₃)`

Error is computed: `error = (output - target)²`
...
[Previous: What Is Machine Learning?](02_what_is_machine_learning.html) | [Next: Inference Explained](04_inference_explained.html)
