...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/ML_Inference_Pipeline/06_model_formats.html

## Table of Contents

- [The Tower of Babel Problem](#_the_tower_of_babel_problem)
- [The_Tower_of_Babel_Problem](#_the_tower_of_babel_problem)
- [The Framework Explosion](#_the_framework_explosion)
- [The_Framework_Explosion](#_the_framework_explosion)
- [The Lock-In Problem](#_the_lock_in_problem)
- [The_Lock-In_Problem](#_the_lock_in_problem)
- [The Interoperability Crisis](#_the_interoperability_crisis)
- [The_Interoperability_Crisis](#_the_interoperability_crisis)
- [The Solution: Interchange Formats](#_the_solution_interchange_formats)
- [The_Solution:_Interchange_Formats](#_the_solution_interchange_formats)
- [TensorFlow Lite: Mobile-First Optimization](#_tensorflow_lite_mobile_first_optimization)
- [TensorFlow_Lite:_Mobile-First_Optimization](#_tensorflow_lite_mobile_first_optimization)
- [The Design Philosophy](#_the_design_philosophy)
- [The_Design_Philosophy](#_the_design_philosophy)
- [The Format: FlatBuffers for Efficiency](#_the_format_flatbuffers_for_efficiency)
- [The_Format:_FlatBuffers_for_Efficiency](#_the_format_flatbuffers_for_efficiency)
- [Quantization: The Killer Feature](#_quantization_the_killer_feature)
- [Quantization:_The_Killer_Feature](#_quantization_the_killer_feature)
- [The Runtime: Small and Optimized](#_the_runtime_small_and_optimized)
- [The_Runtime:_Small_and_Optimized](#_the_runtime_small_and_optimized)
- [The Ecosystem: Tools and Models](#_the_ecosystem_tools_and_models)
- [The_Ecosystem:_Tools_and_Models](#_the_ecosystem_tools_and_models)
- [The Tradeoffs](#_the_tradeoffs)
- [When TFLite Makes Sense](#_when_tflite_makes_sense)
- [When_TFLite_Makes_Sense](#_when_tflite_makes_sense)
- [ONNX: The Universal Translator](#_onnx_the_universal_translator)
- [ONNX:_The_Universal_Translator](#_onnx_the_universal_translator)
- [The Design: A Common Language](#_the_design_a_common_language)
- [The_Design:_A_Common_Language](#_the_design_a_common_language)
- [The Format: Protocol Buffers](#_the_format_protocol_buffers)
- [The_Format:_Protocol_Buffers](#_the_format_protocol_buffers)
- [Extensibility: Growing with the Field](#_extensibility_growing_with_the_field)
- [Extensibility:_Growing_with_the_Field](#_extensibility_growing_with_the_field)
- [The Ecosystem: Tools and Runtimes](#_the_ecosystem_tools_and_runtimes)
- [The_Ecosystem:_Tools_and_Runtimes](#_the_ecosystem_tools_and_runtimes)
- [The Practical Impact](#_the_practical_impact)
- [The_Practical_Impact](#_the_practical_impact)
- [The Tradeoffs](#_the_tradeoffs_2)
- [When ONNX Makes Sense](#_when_onnx_makes_sense)
- [When_ONNX_Makes_Sense](#_when_onnx_makes_sense)
- [Converting Between Formats: The Reality](#_converting_between_formats_the_reality)
- [Converting_Between_Formats:_The_Reality](#_converting_between_formats_the_reality)
- [Common Conversion Workflows](#_common_conversion_workflows)
- [Common_Conversion_Workflows](#_common_conversion_workflows)
- [Validation: The Critical Step](#_validation_the_critical_step)
- [Validation:_The_Critical_Step](#_validation_the_critical_step)
- [Common Conversion Pitfalls](#_common_conversion_pitfalls)
- [Common_Conversion_Pitfalls](#_common_conversion_pitfalls)
- [Debugging Conversion Issues](#_debugging_conversion_issues)
- [Debugging_Conversion_Issues](#_debugging_conversion_issues)
- [Best Practices](#_best_practices)
- [Choosing a Format for Vulkan Inference](#_choosing_a_format_for_vulkan_inference)
- [Choosing_a_Format_for_Vulkan_Inference](#_choosing_a_format_for_vulkan_inference)
- [What These Formats Actually Contain](#_what_these_formats_actually_contain)
- [What_These_Formats_Actually_Contain](#_what_these_formats_actually_contain)
- [Summary](#_summary)
...
Research team trains a model in PyTorch (their preferred framework)

Export to ONNX with one line of code: `torch.onnx.export(model, …​)`

Validate the export: run inference in both PyTorch and ONNX Runtime, verify outputs match

Deploy using ONNX Runtime on servers (optimized for production)

Convert ONNX → TFLite for mobile deployment

Convert ONNX → TensorRT for NVIDIA GPU deployment
...
Train in PyTorch (researcher-friendly, flexible)

Export to ONNX: `torch.onnx.export(model, dummy_input, "model.onnx")`

Convert ONNX to TensorFlow: Use `onnx-tf` converter

Convert TensorFlow to TFLite: Use TFLite converter with quantization
...
Train in TensorFlow (production-friendly, mature)

Convert to TFLite for mobile: Direct conversion with TFLite converter

Convert to ONNX for other platforms: Use `tf2onnx`

Deploy TFLite on mobile, ONNX elsewhere

This path leverages TensorFlow’s broad support while maintaining flexibility.

**ONNX as Universal Hub**:

Train in any framework (PyTorch, TensorFlow, etc.)

Export to ONNX (most frameworks support this)

Convert ONNX to target format as needed:
...
[Previous: Transfer Learning](05_transfer_learning.html) | [Next: Mental Model: GPU Execution](07_mental_model_gpu_execution.html)
