...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Morph_Targets_Facial_Animation/01_introduction.html

## Table of Contents

- [A Different Kind of Deformation](#_a_different_kind_of_deformation)
- [A_Different_Kind_of_Deformation](#_a_different_kind_of_deformation)
- [What glTF Stores for Morph Targets](#_what_gltf_stores_for_morph_targets)
- [What_glTF_Stores_for_Morph_Targets](#_what_gltf_stores_for_morph_targets)
- [The Memory Challenge](#_the_memory_challenge)
- [The_Memory_Challenge](#_the_memory_challenge)
...
[Previous: Procedural Animation Conclusion](../Procedural_Animation_IK/07_conclusion.html) | [Next: Shape Key Ingestion](02_shape_key_ingestion.html)
