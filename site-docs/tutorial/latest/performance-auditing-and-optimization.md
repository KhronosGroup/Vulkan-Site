...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/10_Performance_Optimization/01_introduction.html

## Table of Contents

- [Moving Beyond Naive Optimization](#_moving_beyond_naive_optimization)
- [Moving_Beyond_Naive_Optimization](#_moving_beyond_naive_optimization)
...
**Instruction Throughput Analysis**: Learning to identify compute-bound vs. memory-bound kernels using the Roofline Model.

**The Divergence Audit**: Techniques for visualizing and refactoring divergent branching logic.

**Previous:** [Mastering Mixed Precision](../09_Specialized_Math/03_mixed_precision.html) | **Next:** [Instruction Throughput Analysis](02_instruction_throughput.html)
