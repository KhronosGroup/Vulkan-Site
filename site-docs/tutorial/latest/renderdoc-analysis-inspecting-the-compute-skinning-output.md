...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Debugging_Visual_Auditing/04_renderdoc_analysis.html

## Table of Contents

- [What RenderDoc Gives You](#_what_renderdoc_gives_you)
- [What_RenderDoc_Gives_You](#_what_renderdoc_gives_you)
- [Capturing a Frame](#_capturing_a_frame)
- [Capturing_a_Frame](#_capturing_a_frame)
- [Inspecting the Output Buffer](#_inspecting_the_output_buffer)
- [Inspecting_the_Output_Buffer](#_inspecting_the_output_buffer)
- [Using the Shader Debugger](#_using_the_shader_debugger)
- [Using_the_Shader_Debugger](#_using_the_shader_debugger)
...
void set_debug_name(VkDevice device, VkBuffer buffer, const char* name)
{
    ...
    info.objectHandle = reinterpret_cast(buffer);
...
[Previous: Skinning Heatmaps](03_skinning_heatmaps.html) | [Next: Conclusion](05_conclusion.html)
