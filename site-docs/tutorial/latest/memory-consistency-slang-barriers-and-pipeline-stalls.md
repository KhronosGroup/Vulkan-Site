...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/03_Memory_Models/04_memory_consistency.html

## Table of Contents

- [The All-In-One Barrier: GroupMemoryBarrierWithGroupSync](#_the_all_in_one_barrier_groupmemorybarrierwithgroupsync)
- [The_All-In-One_Barrier:_GroupMemoryBarrierWithGroupSync](#_the_all_in_one_barrier_groupmemorybarrierwithgroupsync)
- [GLSL: The Explicit Barriers](#_glsl_the_explicit_barriers)
- [GLSL:_The_Explicit_Barriers](#_glsl_the_explicit_barriers)
- [The Cost of Syncing](#_the_cost_of_syncing)
- [The_Cost_of_Syncing](#_the_cost_of_syncing)
- [Reducing the Impact](#_reducing_the_impact)
- [Reducing_the_Impact](#_reducing_the_impact)
- [Fine-Grained Control in Vulkan 1.4](#_fine_grained_control_in_vulkan_1_4)
- [Fine-Grained_Control_in_Vulkan_1.4](#_fine_grained_control_in_vulkan_1_4)
...
**Double-Buffering Shared Memory**: Instead of reading and writing to the same shared memory array (which requires a barrier), use two arrays. Write to `A` while reading from `B`, then swap.

**Atomic Operations**: For simple tasks like incrementing a global counter, use `InterlockedAdd` (which Slang inherits from HLSL). **Atomic operations** handle synchronization at the hardware level, which is often much faster than a manual barrier because they are "uninterruptible" by other threads.
...
[Previous: Shared Memory (LDS)](03_shared_memory_lds.html) | [Next: Why Subgroups Matter](../04_Subgroup_Operations/01_introduction.html)
