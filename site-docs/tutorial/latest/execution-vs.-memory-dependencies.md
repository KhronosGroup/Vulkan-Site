...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Anatomy_of_a_Dependency/02_execution_vs_memory.html

## Table of Contents

- [Introduction](#_introduction)
- [The "When": Execution Dependencies](#_the_when_execution_dependencies)
- [The_"When":_Execution_Dependencies](#_the_when_execution_dependencies)
- [Architectural Realities: Caches and Memory Types](#_architectural_realities_caches_and_memory_types)
- [Architectural_Realities:_Caches_and_Memory_Types](#_architectural_realities_caches_and_memory_types)
- [The "Where": Memory Dependencies](#_the_where_memory_dependencies)
- [The_"Where":_Memory_Dependencies](#_the_where_memory_dependencies)
- [The Practical Handshake](#_the_practical_handshake)
- [The_Practical_Handshake](#_the_practical_handshake)
- [Simple Engine Implementation: Caches and Safety](#_simple_engine_implementation_caches_and_safety)
- [Simple_Engine_Implementation:_Caches_and_Safety](#_simple_engine_implementation_caches_and_safety)
...
* 
**Host Visible**: This memory can be "mapped" into your c++ application’s address space, allowing the CPU to read and write to it directly.
...
**Availability**: This operation "flushes" the data from the source’s local caches so that it is visible to a shared memory pool (like L2 cache or main memory).

**Visibility**: This operation "invalidates" the local caches of the destination stage, forcing it to read the fresh data from the shared memory pool rather than using whatever stale bits it might already have.
...
Previous: [Introduction](01_introduction.html) | Next: [The Synchronization 2 Advantage](03_sync2_advantage.html)
