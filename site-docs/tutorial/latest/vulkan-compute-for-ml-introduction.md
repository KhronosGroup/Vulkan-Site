...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Vulkan_Compute_for_ML/01_introduction.html
...
- [Why This Chapter Matters](#_why_this_chapter_matters)
- [Why_This_Chapter_Matters](#_why_this_chapter_matters)
- [What You’ll Build](#_what_youll_build)
- [What_You’ll_Build](#_what_youll_build)
- [How to Use This Chapter](#_how_to_use_this_chapter)
- [How_to_Use_This_Chapter](#_how_to_use_this_chapter)
- [What’s Inside](#_whats_inside)
...
**[Vulkan Compute Pipeline Review](02_compute_pipeline_review.html)** - A focused review of Vulkan compute pipelines with emphasis on ML-specific requirements: descriptor layouts for tensors, work group sizing strategies, memory access patterns, and pipeline creation patterns that work well for ML operations.

**[Element-Wise Operations](03_element_wise_operations.html)** - The simplest ML operations: ReLU, sigmoid, tanh, and other activation functions. We’ll implement these as compute shaders, discussing parallelization strategies, numerical stability, and performance considerations.

**[Matrix Operations](04_matrix_operations.html)** - Matrix-vector and matrix-matrix multiplication, the workhorses of neural networks. We’ll cover naive implementations, tiled implementations using shared memory, and optimization techniques for different matrix sizes.

**[Data Management](05_data_management.html)** - How to organize tensor data in GPU memory, transfer data efficiently, manage memory allocation and reuse, and handle different tensor layouts (NCHW vs NHWC, row-major vs column-major).

**[Synchronization](06_synchronization.html)** - Using pipeline barriers, memory barriers, and execution dependencies to coordinate ML operations. We’ll cover synchronization patterns for sequential operations, parallel branches, and memory reuse.

**[Vector Addition Example](07_vector_addition_example.html)** - A complete, working example that demonstrates the entire pipeline: setting up Vulkan compute, loading data, dispatching work, synchronizing, and verifying results. This serves as a template for more complex operations.
...
[Previous: Choosing the Right ML Compiler](../Third_Party_Libraries/16_choosing_compiler.html) | [Next: Vulkan Compute Pipeline Review](02_compute_pipeline_review.html)
