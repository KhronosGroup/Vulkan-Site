...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Loading_Models/04_loading_gltf.html
...
- [glTF File Structure and Data Organization](#_gltf_file_structure_and_data_organization)
- [glTF_File_Structure_and_Data_Organization](#_gltf_file_structure_and_data_organization)
- [The Buffer System: Efficient Binary Data Storage](#_the_buffer_system_efficient_binary_data_storage)
- [The_Buffer_System:_Efficient_Binary_Data_Storage](#_the_buffer_system_efficient_binary_data_storage)
- [Using the tinygltf Library for Efficient Parsing](#_using_the_tinygltf_library_for_efficient_parsing)
- [Using_the_tinygltf_Library_for_Efficient_Parsing](#_using_the_tinygltf_library_for_efficient_parsing)
- [Implementing a Robust glTF Loader](#_implementing_a_robust_gltf_loader)
- [Implementing_a_Robust_glTF_Loader](#_implementing_a_robust_gltf_loader)
- [Understanding Physically Based Rendering (PBR) Materials](#_understanding_physically_based_rendering_pbr_materials)
- [Understanding_Physically_Based_Rendering_(PBR)_Materials](#_understanding_physically_based_rendering_pbr_materials)
- [The Evolution of Material Systems](#_the_evolution_of_material_systems)
- [The_Evolution_of_Material_Systems](#_the_evolution_of_material_systems)
- [Key PBR Material Properties](#_key_pbr_material_properties)
- [Key_PBR_Material_Properties](#_key_pbr_material_properties)
- [Texture Formats and Compression](#_texture_formats_and_compression)
- [Texture_Formats_and_Compression](#_texture_formats_and_compression)
- [Embedded Textures in glTF/glb](#_embedded_textures_in_gltfglb)
- [Embedded_Textures_in_glTF/glb](#_embedded_textures_in_gltfglb)
- [Texture Loading: glTF Texture Iteration and Metadata Extraction](#_texture_loading_gltf_texture_iteration_and_metadata_extraction)
- [Texture_Loading:_glTF_Texture_Iteration_and_Metadata_Extraction](#_texture_loading_gltf_texture_iteration_and_metadata_extraction)
- [Texture Loading: Format Detection and Buffer Access](#_texture_loading_format_detection_and_buffer_access)
- [Texture_Loading:_Format_Detection_and_Buffer_Access](#_texture_loading_format_detection_and_buffer_access)
- [Texture Loading: KTX2 Parsing and Validation](#_texture_loading_ktx2_parsing_and_validation)
- [Texture_Loading:_KTX2_Parsing_and_Validation](#_texture_loading_ktx2_parsing_and_validation)
- [Texture Loading: Basis Universal Transcoding](#_texture_loading_basis_universal_transcoding)
- [Texture_Loading:_Basis_Universal_Transcoding](#_texture_loading_basis_universal_transcoding)
- [Texture Loading: Vulkan Resource Creation and GPU Upload](#_texture_loading_vulkan_resource_creation_and_gpu_upload)
- [Texture_Loading:_Vulkan_Resource_Creation_and_GPU_Upload](#_texture_loading_vulkan_resource_creation_and_gpu_upload)
- [Understanding Scene Graphs and Hierarchical Transformations](#_understanding_scene_graphs_and_hierarchical_transformations)
- [Understanding_Scene_Graphs_and_Hierarchical_Transformations](#_understanding_scene_graphs_and_hierarchical_transformations)
- [Why Scene Graphs Matter](#_why_scene_graphs_matter)
- [Why_Scene_Graphs_Matter](#_why_scene_graphs_matter)
- [Transformations in Scene Graphs](#_transformations_in_scene_graphs)
- [Transformations_in_Scene_Graphs](#_transformations_in_scene_graphs)
- [Understanding 3D Geometry and Mesh Data](#_understanding_3d_geometry_and_mesh_data)
- [Understanding_3D_Geometry_and_Mesh_Data](#_understanding_3d_geometry_and_mesh_data)
- [The Building Blocks of 3D Models](#_the_building_blocks_of_3d_models)
- [The_Building_Blocks_of_3D_Models](#_the_building_blocks_of_3d_models)
- [Mesh Organization in glTF](#_mesh_organization_in_gltf)
- [Mesh_Organization_in_glTF](#_mesh_organization_in_gltf)
- [Understanding Animation Systems](#_understanding_animation_systems)
- [Understanding_Animation_Systems](#_understanding_animation_systems)
- [Animation Techniques in 3D Graphics](#_animation_techniques_in_3d_graphics)
- [Animation_Techniques_in_3D_Graphics](#_animation_techniques_in_3d_graphics)
- [Core Animation Concepts](#_core_animation_concepts)
- [Core_Animation_Concepts](#_core_animation_concepts)
- [The glTF Animation System](#_the_gltf_animation_system)
- [The_glTF_Animation_System](#_the_gltf_animation_system)
- [Integration with the Rendering Pipeline](#_integration_with_the_rendering_pipeline)
- [Integration_with_the_Rendering_Pipeline](#_integration_with_the_rendering_pipeline)
- [From Asset Loading to Rendering](#_from_asset_loading_to_rendering)
- [From_Asset_Loading_to_Rendering](#_from_asset_loading_to_rendering)
- [Rendering Optimizations](#_rendering_optimizations)
- [Memory Management Considerations](#_memory_management_considerations)
- [Memory_Management_Considerations](#_memory_management_considerations)
- [Efficient Texture Memory Management with KTX2 and Basis Universal](#_efficient_texture_memory_management_with_ktx2_and_basis_universal)
- [Efficient_Texture_Memory_Management_with_KTX2_and_Basis_Universal](#_efficient_texture_memory_management_with_ktx2_and_basis_universal)
- [Integration with Vulkan Rendering Pipeline](#_integration_with_vulkan_rendering_pipeline)
- [Integration_with_Vulkan_Rendering_Pipeline](#_integration_with_vulkan_rendering_pipeline)
- [Best Practices for Texture Memory Management](#_best_practices_for_texture_memory_management)
- [Best_Practices_for_Texture_Memory_Management](#_best_practices_for_texture_memory_management)
- [Summary and Next Steps](#_summary_and_next_steps)
- [Summary_and_Next_Steps](#_summary_and_next_steps)
...
Finally, create the Vulkan resources needed for GPU rendering and uploads the processed texture data to video memory.
        ...
        vk::Format format = static_cast(ktxTexture2_GetVkFormat(ktxTexture));
        vk::Extent3D extent{
            static_cast(ktxTexture->baseWidth),
            static_cast(ktxTexture->baseHeight),
            static_cast(ktxTexture->baseDepth)
        };
...
for (size_t i = 0; i index = static_cast(i);
...
for (size_t i = 0; i parent = model.linearNodes[i];
