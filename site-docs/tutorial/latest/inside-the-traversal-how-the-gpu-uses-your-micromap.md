...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Courses/Opacity_Micromaps/04_hardware_traversal_with_omm.html

## Table of Contents

- [Two Journeys for One Shadow Ray](#_two_journeys_for_one_shadow_ray)
- [Two_Journeys_for_One_Shadow_Ray](#_two_journeys_for_one_shadow_ray)
- [The Journey Without OMMs](#_the_journey_without_omms)
- [The_Journey_Without_OMMs](#_the_journey_without_omms)
- [The Journey With OMMs](#_the_journey_with_omms)
- [The_Journey_With_OMMs](#_the_journey_with_omms)
- [How the Hardware Reads the Micromap](#_how_the_hardware_reads_the_micromap)
- [How_the_Hardware_Reads_the_Micromap](#_how_the_hardware_reads_the_micromap)
- [The OpacityMicromapKHR Execution Mode](#_the_opacitymicromapkhr_execution_mode)
- [The_OpacityMicromapKHR_Execution_Mode](#_the_opacitymicromapkhr_execution_mode)
- [The Cascade Effect on Warp Efficiency](#_the_cascade_effect_on_warp_efficiency)
- [The_Cascade_Effect_on_Warp_Efficiency](#_the_cascade_effect_on_warp_efficiency)
- [The Multiplier Effect for Soft Shadows](#_the_multiplier_effect_for_soft_shadows)
- [The_Multiplier_Effect_for_Soft_Shadows](#_the_multiplier_effect_for_soft_shadows)
- [The Shadow Ray Lifecycle, Complete](#_the_shadow_ray_lifecycle_complete)
- [The_Shadow_Ray_Lifecycle,_Complete](#_the_shadow_ray_lifecycle_complete)
...
![Side-by-side diagram contrasting shadow ray traversal without OMM (many any-hit shader invocations) versus with OMM (most hits resolved by hardware](../../../_images/images/omm_traversal_comparison.svg)
...
![Flowchart showing the lifecycle of a shadow ray with OMM: cast ray](../../../_images/images/omm_shadow_ray_lifecycle.svg)
...
[Previous: Micromaps: Teaching the Hardware What It Already Should Know](03_what_are_micromaps.html) | [Next: Building Opacity Micromaps in the Simple Engine](05_implementation_overview.html)
