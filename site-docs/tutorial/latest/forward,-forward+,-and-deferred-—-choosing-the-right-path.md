...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Advanced_Topics/Forward_ForwardPlus_Deferred.html

## Table of Contents

- [Forward rendering](#_forward_rendering)
- [Forward+ (what we use for dynamic lights)](#_forward_what_we_use_for_dynamic_lights)
- [Forward+_(what_we_use_for_dynamic_lights)](#_forward_what_we_use_for_dynamic_lights)
- [Deferred shading (when to consider it)](#_deferred_shading_when_to_consider_it)
- [Deferred_shading_(when_to_consider_it)](#_deferred_shading_when_to_consider_it)
- [What the sample uses (and why)](#_what_the_sample_uses_and_why)
- [What_the_sample_uses_(and_why)](#_what_the_sample_uses_and_why)
- [Implementation highlights in this codebase](#_implementation_highlights_in_this_codebase)
- [Implementation_highlights_in_this_codebase](#_implementation_highlights_in_this_codebase)
- [Where to look in the code](#_where_to_look_in_the_code)
- [Where_to_look_in_the_code](#_where_to_look_in_the_code)
- [Choosing for your project](#_choosing_for_your_project)
- [Choosing_for_your_project](#_choosing_for_your_project)
