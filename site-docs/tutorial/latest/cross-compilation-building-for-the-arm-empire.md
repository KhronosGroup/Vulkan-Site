...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Embedded_Applications/02_cross_compilation.html

## Table of Contents

- [The Two-World Problem: Host vs. Target](#_the_two_world_problem_host_vs_target)
- [The_Two-World_Problem:_Host_vs._Target](#_the_two_world_problem_host_vs_target)
- [Pillar 1: The Sysroot (The Target’s Reflection)](#_pillar_1_the_sysroot_the_targets_reflection)
- [Pillar_1:_The_Sysroot_(The_Target’s_Reflection)](#_pillar_1_the_sysroot_the_targets_reflection)
- [Creating a Sysroot with rsync](#_creating_a_sysroot_with_rsync)
- [Creating_a_Sysroot_with_rsync](#_creating_a_sysroot_with_rsync)
- [Deep Dive: The Linker’s search path](#_deep_dive_the_linkers_search_path)
- [Deep_Dive:_The_Linker’s_search_path](#_deep_dive_the_linkers_search_path)
- [Troubleshooting Symlinks](#_troubleshooting_symlinks)
- [Pillar 2: The Docker Advantage (Reproducible Forges)](#_pillar_2_the_docker_advantage_reproducible_forges)
- [Pillar_2:_The_Docker_Advantage_(Reproducible_Forges)](#_pillar_2_the_docker_advantage_reproducible_forges)
- [The Multi-Arch Dockerfile](#_the_multi_arch_dockerfile)
- [The_Multi-Arch_Dockerfile](#_the_multi_arch_dockerfile)
- [Building inside Docker](#_building_inside_docker)
- [Building_inside_Docker](#_building_inside_docker)
- [Pillar 3: The CMake Toolchain File](#_pillar_3_the_cmake_toolchain_file)
- [Pillar_3:_The_CMake_Toolchain_File](#_pillar_3_the_cmake_toolchain_file)
- [Pillar 4: Handling the Vulkan SDK](#_pillar_4_handling_the_vulkan_sdk)
- [Pillar_4:_Handling_the_Vulkan_SDK](#_pillar_4_handling_the_vulkan_sdk)
- [Finding Vulkan Correctly](#_finding_vulkan_correctly)
- [Finding_Vulkan_Correctly](#_finding_vulkan_correctly)
- [Verification](#_verification)
- [Pillar 5: CPU-Specific Optimizations](#_pillar_5_cpu_specific_optimizations)
- [Pillar_5:_CPU-Specific_Optimizations](#_pillar_5_cpu_specific_optimizations)
- [Tuning the Flags](#_tuning_the_flags)
- [Tuning_the_Flags](#_tuning_the_flags)
- [Pillar 6: Managing GLIBC Compatibility](#_pillar_6_managing_glibc_compatibility)
- [Pillar_6:_Managing_GLIBC_Compatibility](#_pillar_6_managing_glibc_compatibility)
- [Pillar 7: Remote Deployment and Debugging](#_pillar_7_remote_deployment_and_debugging)
- [Pillar_7:_Remote_Deployment_and_Debugging](#_pillar_7_remote_deployment_and_debugging)
- [Automated Deployment with SSH Keys](#_automated_deployment_with_ssh_keys)
- [Automated_Deployment_with_SSH_Keys](#_automated_deployment_with_ssh_keys)
- [Deep Dive: Remote Debugging with GDB](#_deep_dive_remote_debugging_with_gdb)
- [Deep_Dive:_Remote_Debugging_with_GDB](#_deep_dive_remote_debugging_with_gdb)
- [Pillar 8: Runtime Search Paths (RPATH)](#_pillar_8_runtime_search_paths_rpath)
- [Pillar_8:_Runtime_Search_Paths_(RPATH)](#_pillar_8_runtime_search_paths_rpath)
- [Summary: The Cross-Compilation Checklist](#_summary_the_cross_compilation_checklist)
- [Summary:_The_Cross-Compilation_Checklist](#_summary_the_cross_compilation_checklist)
...
In this chapter, we are going to demystify the cross-compilation process. We will learn how to set up a **Sysroot**, configure a [**CMake Toolchain**](https://cmake.org/cmake/help/latest/manual/cmake-toolchains.7.html), and build a remote deployment pipeline that feels as seamless as local development.
...
![Diagram showing the relationship between Build Host](../../_images/images/ML_Inference/Embedded_Applications/cross_compilation_architecture.svg)

Figure 1. Cross-Compilation Ecosystem
...
**Docker** allows you to create a "Frozen Forge" that is identical for every developer on your team. It also simplifies the management of [multi-architecture builds](https://docs.docker.com/build/building/multi-platform/) by providing consistent environments.
...
To get production performance, you should add architecture-specific flags to your CMake build. These flags enable specific silicon features like NEON SIMD or Dot-Product instructions. You can find a full list of available flags in the [GCC AArch64 Options](https://gcc.gnu.org/onlinedocs/gcc/AArch64-Options.html) documentation.
...
**The Forge**: `g++-aarch64-linux-gnu` cross-compiler installed on the host or inside a Docker container.

**The Mirror**: A fresh `rsync` of the target’s `/usr/include` and `/usr/lib` folders, with absolute symlinks resolved.

**The Guide**: A toolchain file that sets `CMAKE_SYSROOT`, redirects `pkg-config`, and configures `CMAKE_FIND_ROOT_PATH_MODE_*`.

**The Optimization**: Architecture-specific `-march` and `-mtune` flags for your specific silicon generation (e.g., `+fp16`).

**The Handshake**: ed25519 SSH keys configured for passwordless, fast deployment.

**The Microscope**: `gdbserver` on the target and `gdb-multiarch` on your workstation.
...
[Previous: Introduction](01_introduction.html) | [Next: Camera Integration](03_camera_integration.html)
