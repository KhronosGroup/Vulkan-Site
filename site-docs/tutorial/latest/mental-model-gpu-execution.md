...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/ML_Inference_Pipeline/07_mental_model_gpu_execution.html

## Table of Contents

- [The Journey from Model to GPU](#_the_journey_from_model_to_gpu)
- [The_Journey_from_Model_to_GPU](#_the_journey_from_model_to_gpu)
- [The Key Challenges](#_the_key_challenges)
- [The_Key_Challenges](#_the_key_challenges)
- [Challenge 1: Memory Management](#_challenge_1_memory_management)
- [Challenge_1:_Memory_Management](#_challenge_1_memory_management)
- [Challenge 2: Synchronization](#_challenge_2_synchronization)
- [Challenge_2:_Synchronization](#_challenge_2_synchronization)
- [Challenge 3: Performance Optimization](#_challenge_3_performance_optimization)
- [Challenge_3:_Performance_Optimization](#_challenge_3_performance_optimization)
- [Thinking in Layers and Operations](#_thinking_in_layers_and_operations)
- [Thinking_in_Layers_and_Operations](#_thinking_in_layers_and_operations)
- [Putting It All Together](#_putting_it_all_together)
- [Putting_It_All_Together](#_putting_it_all_together)
- [Summary](#_summary)
- [Looking Back and Forward](#_looking_back_and_forward)
- [Looking_Back_and_Forward](#_looking_back_and_forward)
...
[Previous: Model Formats](06_model_formats.html) | [Next: Vulkan Compute for ML](../Vulkan_Compute_for_ML/01_introduction.html)
