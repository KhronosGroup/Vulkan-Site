...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Vulkan_Compute_for_ML/03_element_wise_operations.html

## Table of Contents

- [Introduction](#_introduction)
- [Why Element-Wise Operations Matter](#_why_element_wise_operations_matter)
- [Why_Element-Wise_Operations_Matter](#_why_element_wise_operations_matter)
- [Computational Intensity](#_computational_intensity)
- [Fusion Opportunities](#_fusion_opportunities)
- [Numerical Stability](#_numerical_stability)
- [ReLU: The Simplest Activation](#_relu_the_simplest_activation)
- [ReLU:_The_Simplest_Activation](#_relu_the_simplest_activation)
- [Why ReLU Dominates](#_why_relu_dominates)
- [Why_ReLU_Dominates](#_why_relu_dominates)
- [Slang Implementation](#_slang_implementation)
- [Dispatching the Shader](#_dispatching_the_shader)
- [Dispatching_the_Shader](#_dispatching_the_shader)
- [Performance Considerations](#_performance_considerations)
- [Sigmoid: The Classic Activation](#_sigmoid_the_classic_activation)
- [Sigmoid:_The_Classic_Activation](#_sigmoid_the_classic_activation)
- [The Numerical Stability Problem](#_the_numerical_stability_problem)
- [The_Numerical_Stability_Problem](#_the_numerical_stability_problem)
- [Slang Implementation](#_slang_implementation_2)
- [Performance Considerations](#_performance_considerations_2)
- [Tanh: The Symmetric Activation](#_tanh_the_symmetric_activation)
- [Tanh:_The_Symmetric_Activation](#_tanh_the_symmetric_activation)
- [Numerical Stability](#_numerical_stability_2)
- [Slang Implementation](#_slang_implementation_3)
- [Operation Fusion](#_operation_fusion)
- [Fusing Convolution and ReLU](#_fusing_convolution_and_relu)
- [Fusing_Convolution_and_ReLU](#_fusing_convolution_and_relu)
- [Benefits of Fusion](#_benefits_of_fusion)
- [Benefits_of_Fusion](#_benefits_of_fusion)
- [Batching and Memory Access Patterns](#_batching_and_memory_access_patterns)
- [Batching_and_Memory_Access_Patterns](#_batching_and_memory_access_patterns)
- [Contiguous vs Strided Access](#_contiguous_vs_strided_access)
- [Contiguous_vs_Strided_Access](#_contiguous_vs_strided_access)
- [Multi-Dimensional Tensors](#_multi_dimensional_tensors)
- [Summary](#_summary)
...
Dispatch convolution shader → write results to buffer

Insert pipeline barrier

Dispatch ReLU shader → read from buffer, write to another buffer

You do:

Dispatch fused convolution+ReLU shader → write final results directly
...
[Previous: Compute Pipeline Review](02_compute_pipeline_review.html) | [Next: Matrix Operations](04_matrix_operations.html)
