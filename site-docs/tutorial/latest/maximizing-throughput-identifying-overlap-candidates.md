...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Async_Compute_Overlap/02_maximizing_throughput.html

## Table of Contents

- [Finding the "Holes" in the GPU](#_finding_the_holes_in_the_gpu)
- [Finding_the_"Holes"_in_the_GPU](#_finding_the_holes_in_the_gpu)
- [The Simple Engine Case Study: Physics and Audio Compute](#_the_simple_engine_case_study_physics_and_audio_compute)
- [The_Simple_Engine_Case_Study:_Physics_and_Audio_Compute](#_the_simple_engine_case_study_physics_and_audio_compute)
- [The Dependency Architecture](#_the_dependency_architecture)
- [The_Dependency_Architecture](#_the_dependency_architecture)
- [Submitting for Overlap](#_submitting_for_overlap)
- [Submitting_for_Overlap](#_submitting_for_overlap)
- [Identifying Dedicated Queues](#_identifying_dedicated_queues)
- [Identifying_Dedicated_Queues](#_identifying_dedicated_queues)
...
uint32_t computeQueueFamilyIndex = std::numeric_limits::max();
...
Previous: [Introduction](01_introduction.html) | Next: [Async Post-Processing](03_async_post_processing.html)
