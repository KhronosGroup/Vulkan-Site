...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Third_Party_Libraries/09_practical_examples.html

## Table of Contents

- [Introduction](#_introduction)
- [Example 1: Desktop Object Detection with ONNX Runtime](#_example_1_desktop_object_detection_with_onnx_runtime)
- [Example_1:_Desktop_Object_Detection_with_ONNX_Runtime](#_example_1_desktop_object_detection_with_onnx_runtime)
- [The Scenario](#_the_scenario)
- [Architecture Overview](#_architecture_overview)
- [Step 1: Setting Up Shared Memory](#_step_1_setting_up_shared_memory)
- [Step_1:_Setting_Up_Shared_Memory](#_step_1_setting_up_shared_memory)
- [Step 2: Importing into OpenCL](#_step_2_importing_into_opencl)
- [Step_2:_Importing_into_OpenCL](#_step_2_importing_into_opencl)
- [Step 3: Setting Up Synchronization](#_step_3_setting_up_synchronization)
- [Step_3:_Setting_Up_Synchronization](#_step_3_setting_up_synchronization)
- [Step 4: Running Inference](#_step_4_running_inference)
- [Step_4:_Running_Inference](#_step_4_running_inference)
- [Step 5: The Main Loop](#_step_5_the_main_loop)
- [Step_5:_The_Main_Loop](#_step_5_the_main_loop)
- [Key Takeaways](#_key_takeaways)
- [Example 2: Mobile Image Classification with TensorFlow Lite](#_example_2_mobile_image_classification_with_tensorflow_lite)
- [Example_2:_Mobile_Image_Classification_with_TensorFlow_Lite](#_example_2_mobile_image_classification_with_tensorflow_lite)
- [The Scenario](#_the_scenario_2)
- [Architecture Overview](#_architecture_overview_2)
- [Step 1: Setting Up AHardwareBuffer](#_step_1_setting_up_ahardwarebuffer)
- [Step_1:_Setting_Up_AHardwareBuffer](#_step_1_setting_up_ahardwarebuffer)
- [Step 2: TensorFlow Lite Integration](#_step_2_tensorflow_lite_integration)
- [Step_2:_TensorFlow_Lite_Integration](#_step_2_tensorflow_lite_integration)
- [Step 3: The Android Main Loop](#_step_3_the_android_main_loop)
- [Step_3:_The_Android_Main_Loop](#_step_3_the_android_main_loop)
- [Key Takeaways](#_key_takeaways_2)
- [Example 3: Real-Time Inference Pipeline](#_example_3_real_time_inference_pipeline)
- [Example_3:_Real-Time_Inference_Pipeline](#_example_3_real_time_inference_pipeline)
- [The Challenge](#_the_challenge)
- [Architecture](#_architecture)
- [Implementation](#_implementation)
- [Key Takeaways](#_key_takeaways_3)
- [Common Pitfalls and Solutions](#_common_pitfalls_and_solutions)
- [Common_Pitfalls_and_Solutions](#_common_pitfalls_and_solutions)
- [Pitfall 1: Synchronization Bugs](#_pitfall_1_synchronization_bugs)
- [Pitfall_1:_Synchronization_Bugs](#_pitfall_1_synchronization_bugs)
- [Pitfall 2: Format Mismatches](#_pitfall_2_format_mismatches)
- [Pitfall_2:_Format_Mismatches](#_pitfall_2_format_mismatches)
- [Pitfall 3: Memory Leaks](#_pitfall_3_memory_leaks)
- [Pitfall_3:_Memory_Leaks](#_pitfall_3_memory_leaks)
- [Pitfall 4: Platform-Specific Issues](#_pitfall_4_platform_specific_issues)
- [Pitfall_4:_Platform-Specific_Issues](#_pitfall_4_platform_specific_issues)
- [Summary](#_summary)
...
public:
    ...
    void runInference(const OpenCLSharedMemory& sharedMem,
        ...
        std::vector inputShape = {1, 3, height, width};
        ...
        auto inputTensor = Ort::Value::CreateTensor(memInfo,
            reinterpret_cast(sharedMem.clImage),
            width * height * 3,
...
public:
    ...
    std::vector classify(AHardwareBuffer* inputBuffer) {
        // Get input tensor
...
[Previous: Data Transfer Optimization](08_data_transfer_optimization.html) | [Next: Choosing the Right Library](10_choosing_library.html)
