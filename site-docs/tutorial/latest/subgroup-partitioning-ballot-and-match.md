...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_Vulkan_Compute/04_Subgroup_Operations/03_subgroup_partitioning.html

## Table of Contents

- [Beyond Lockstep Execution](#_beyond_lockstep_execution)
- [Beyond_Lockstep_Execution](#_beyond_lockstep_execution)
- [Subgroup Ballot](#_subgroup_ballot)
- [Subgroup Match](#_subgroup_match)
- [Subgroup Elect](#_subgroup_elect)
- [Using Masks for Flow Control](#_using_masks_for_flow_control)
- [Using_Masks_for_Flow_Control](#_using_masks_for_flow_control)
...
[Previous: Shuffles and Broadcasts](02_cross_invocation_communication.html) | [Next: Non-Uniform Indexing](04_non_uniform_indexing.html)
