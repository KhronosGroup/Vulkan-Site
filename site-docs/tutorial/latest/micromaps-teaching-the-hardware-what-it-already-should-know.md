...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Courses/Opacity_Micromaps/03_what_are_micromaps.html

## Table of Contents

- [The Central Idea](#_the_central_idea)
- [The_Central_Idea](#_the_central_idea)
- [Two Formats: 2-State and 4-State](#_two_formats_2_state_and_4_state)
- [Two_Formats:_2-State_and_4-State](#_two_formats_2_state_and_4_state)
- [Visualizing the Subdivision](#_visualizing_the_subdivision)
- [Visualizing_the_Subdivision](#_visualizing_the_subdivision)
- [Subdivision Levels: Precision at a Cost](#_subdivision_levels_precision_at_a_cost)
- [Subdivision_Levels:_Precision_at_a_Cost](#_subdivision_levels_precision_at_a_cost)
- [Building the Micromap: A One-Time Investment](#_building_the_micromap_a_one_time_investment)
- [Building_the_Micromap:_A_One-Time_Investment](#_building_the_micromap_a_one_time_investment)
- [Where the Data Lives](#_where_the_data_lives)
- [Where_the_Data_Lives](#_where_the_data_lives)
- [Lossy Builds: Trading Perfection for Higher Precision](#_lossy_builds_trading_perfection_for_higher_precision)
- [Lossy_Builds:_Trading_Perfection_for_Higher_Precision](#_lossy_builds_trading_perfection_for_higher_precision)
- [The Profound Simplicity](#_the_profound_simplicity)
- [The_Profound_Simplicity](#_the_profound_simplicity)
...
![Diagram showing a leaf-shaped triangle subdivided into a regular grid of micro-triangles; center micro-triangles colored green for opaque](../../../_images/images/omm_triangle_subdivision.svg)
...
[Previous: What Your GPU Is Actually Doing](02_why_alpha_testing_is_expensive.html) | [Next: Inside the Traversal: How the GPU Uses Your Micromap](04_hardware_traversal_with_omm.html)
