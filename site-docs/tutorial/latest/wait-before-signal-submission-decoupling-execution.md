...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Timeline_Semaphores/04_wait_before_signal.html

## Table of Contents

- [The Paradigm Shift](#_the_paradigm_shift)
- [The_Paradigm_Shift](#_the_paradigm_shift)
- [How It Works](#_how_it_works)
- [How_It_Works](#_how_it_works)
- [Why This Matters](#_why_this_matters)
- [Why_This_Matters](#_why_this_matters)
- [Simple Engine: Non-Blocking Submission](#_simple_engine_non_blocking_submission)
- [Simple_Engine:_Non-Blocking_Submission](#_simple_engine_non_blocking_submission)
...
Previous: [The Monotonic Counter](03_monotonic_counter.html) | Next: [Frame-in-Flight Architecture](../Frame_in_Flight/01_introduction.html)
