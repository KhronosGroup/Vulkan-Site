...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Physics_Integration/05_self_collision_filtering.html

## Table of Contents

- [Why Characters Explode Without Filtering](#_why_characters_explode_without_filtering)
- [Why_Characters_Explode_Without_Filtering](#_why_characters_explode_without_filtering)
- [Designing the Bitmask Layout](#_designing_the_bitmask_layout)
- [Designing_the_Bitmask_Layout](#_designing_the_bitmask_layout)
- [Applying Masks from glTF Extras](#_applying_masks_from_gltf_extras)
- [Applying_Masks_from_glTF_Extras](#_applying_masks_from_gltf_extras)
- [Filtering Between Characters](#_filtering_between_characters)
- [Filtering_Between_Characters](#_filtering_between_characters)
- [Verifying Your Filters](#_verifying_your_filters)
- [Verifying_Your_Filters](#_verifying_your_filters)
...
{
    static const std::unordered_map group_map = {
...
[Previous: The Ragdoll Handoff](04_ragdoll_handoff.html) | [Next: Conclusion](06_conclusion.html)
