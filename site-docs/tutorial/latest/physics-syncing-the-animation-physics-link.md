...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Advanced_glTF/Scene_Graph_Hierarchy/03_physics_syncing.html

## Table of Contents

- [Bridging Two Worlds: The Animation-Physics Conflict](#_bridging_two_worlds_the_animation_physics_conflict)
- [Bridging_Two_Worlds:_The_Animation-Physics_Conflict](#_bridging_two_worlds_the_animation_physics_conflict)
- [Understanding the Players: Kinematic vs. Dynamic](#_understanding_the_players_kinematic_vs_dynamic)
- [Understanding_the_Players:_Kinematic_vs._Dynamic](#_understanding_the_players_kinematic_vs_dynamic)
- [1. Kinematic: Animation in Control](#_1_kinematic_animation_in_control)
- [1._Kinematic:_Animation_in_Control](#_1_kinematic_animation_in_control)
- [2. Dynamic: Physics in Control](#_2_dynamic_physics_in_control)
- [2._Dynamic:_Physics_in_Control](#_2_dynamic_physics_in_control)
- [The Synchronization Pipeline](#_the_synchronization_pipeline)
- [The_Synchronization_Pipeline](#_the_synchronization_pipeline)
- [Implementation: Kinematic Sync (Animation Driving Physics)](#_implementation_kinematic_sync_animation_driving_physics)
- [Implementation:_Kinematic_Sync_(Animation_Driving_Physics)](#_implementation_kinematic_sync_animation_driving_physics)
- [Implementation: Dynamic Sync (The Ragdoll Handoff)](#_implementation_dynamic_sync_the_ragdoll_handoff)
- [Implementation:_Dynamic_Sync_(The_Ragdoll_Handoff)](#_implementation_dynamic_sync_the_ragdoll_handoff)
- [Managing the Simulation: Collision Filtering](#_managing_the_simulation_collision_filtering)
- [Managing_the_Simulation:_Collision_Filtering](#_managing_the_simulation_collision_filtering)
- [Summary](#_summary)
...
**Scene Graph Update**: We propagate these local poses down the hierarchy to calculate the `world_matrix` for every node (using our **Dirty Flag** system).

**Kinematic Sync (Animation → Physics)**: For every node that is in "Kinematic" mode, we push its newly calculated `world_matrix` into the physics engine. This "positions" the colliders for the upcoming simulation step.
...
[Previous: The Engine Expansion](02_engine_expansion.html) | [Next: Metadata & Physics Extras](04_metadata_and_physics_extras.html)
