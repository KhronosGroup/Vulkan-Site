...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Third_Party_Libraries/04_pytorch_mobile.html

## Table of Contents

- [Introduction](#_introduction)
- [The PyTorch Advantage: One Framework, Everywhere](#_the_pytorch_advantage_one_framework_everywhere)
- [The_PyTorch_Advantage:_One_Framework,_Everywhere](#_the_pytorch_advantage_one_framework_everywhere)
- [The Conversion Problem](#_the_conversion_problem)
- [The_Conversion_Problem](#_the_conversion_problem)
- [The Developer Experience](#_the_developer_experience)
- [The_Developer_Experience](#_the_developer_experience)
- [The Tradeoff: Size and Optimization](#_the_tradeoff_size_and_optimization)
- [The_Tradeoff:_Size_and_Optimization](#_the_tradeoff_size_and_optimization)
- [Architecture: Desktop PyTorch, Optimized for Mobile](#_architecture_desktop_pytorch_optimized_for_mobile)
- [Architecture:_Desktop_PyTorch,_Optimized_for_Mobile](#_architecture_desktop_pytorch_optimized_for_mobile)
- [Selective Build: Only What You Need](#_selective_build_only_what_you_need)
- [Selective_Build:_Only_What_You_Need](#_selective_build_only_what_you_need)
- [TorchScript: The Deployment Format](#_torchscript_the_deployment_format)
- [TorchScript:_The_Deployment_Format](#_torchscript_the_deployment_format)
- [Quantization: Catching Up to TensorFlow Lite](#_quantization_catching_up_to_tensorflow_lite)
- [Quantization:_Catching_Up_to_TensorFlow_Lite](#_quantization_catching_up_to_tensorflow_lite)
- [Mobile Optimization: Operator Fusion and Graph Optimization](#_mobile_optimization_operator_fusion_and_graph_optimization)
- [Mobile_Optimization:_Operator_Fusion_and_Graph_Optimization](#_mobile_optimization_operator_fusion_and_graph_optimization)
...
- [GPU Acceleration: The Vulkan Backend](#_gpu_acceleration_the_vulkan_backend)
- [GPU_Acceleration:_The_Vulkan_Backend](#_gpu_acceleration_the_vulkan_backend)
- [Memory Sharing: Possible but Complex](#_memory_sharing_possible_but_complex)
- [Memory_Sharing:_Possible_but_Complex](#_memory_sharing_possible_but_complex)
- [Cross-Platform Considerations](#_cross_platform_considerations)
- [Practical Example: Real-Time Style Transfer](#_practical_example_real_time_style_transfer)
- [Practical_Example:_Real-Time_Style_Transfer](#_practical_example_real_time_style_transfer)
- [The Scenario](#_the_scenario)
- [Model Selection and Training](#_model_selection_and_training)
- [Model_Selection_and_Training](#_model_selection_and_training)
...
- [Comparing PyTorch Mobile to Alternatives](#_comparing_pytorch_mobile_to_alternatives)
- [Comparing_PyTorch_Mobile_to_Alternatives](#_comparing_pytorch_mobile_to_alternatives)
- [PyTorch Mobile vs TensorFlow Lite](#_pytorch_mobile_vs_tensorflow_lite)
- [PyTorch_Mobile_vs_TensorFlow_Lite](#_pytorch_mobile_vs_tensorflow_lite)
- [PyTorch Mobile vs ONNX Runtime](#_pytorch_mobile_vs_onnx_runtime)
- [PyTorch_Mobile_vs_ONNX_Runtime](#_pytorch_mobile_vs_onnx_runtime)
- [The Hybrid Approach](#_the_hybrid_approach)
- [The_Hybrid_Approach](#_the_hybrid_approach)
- [When PyTorch Mobile Makes Sense](#_when_pytorch_mobile_makes_sense)
- [When_PyTorch_Mobile_Makes_Sense](#_when_pytorch_mobile_makes_sense)
...
**Read Back**: Copy the texture to a staging buffer using `vkCmdCopyImageToBuffer`
...
[Previous: TensorFlow Lite](03_tensorflow_lite.html) | [Next: DirectML](05_directml.html)
