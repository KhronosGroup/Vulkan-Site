...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Third_Party_Libraries/01_introduction.html

## Table of Contents

- [Introduction](#_introduction)
- [The Three-Path Philosophy](#_the_three_path_philosophy)
- [The_Three-Path_Philosophy](#_the_three_path_philosophy)
- [Why Use Third-Party Libraries?](#_why_use_third_party_libraries)
- [Why_Use_Third-Party_Libraries?](#_why_use_third_party_libraries)
...
- [What This Chapter Covers](#_what_this_chapter_covers)
- [What_This_Chapter_Covers](#_what_this_chapter_covers)
- [Library-Specific Chapters](#_library_specific_chapters)
- [Integration and Optimization Chapters](#_integration_and_optimization_chapters)
- [Integration_and_Optimization_Chapters](#_integration_and_optimization_chapters)
- [ML Compiler Chapters](#_ml_compiler_chapters)
- [ML_Compiler_Chapters](#_ml_compiler_chapters)
- [How to Navigate This Chapter](#_how_to_navigate_this_chapter)
- [How_to_Navigate_This_Chapter](#_how_to_navigate_this_chapter)
- [Prerequisites](#_prerequisites)
- [A Note on Practicality](#_a_note_on_practicality)
- [A_Note_on_Practicality](#_a_note_on_practicality)
...
**[ONNX Runtime](02_onnx_runtime.html)** - Microsoft’s framework-agnostic, cross-platform inference engine. Supports models from PyTorch, TensorFlow, and other frameworks. Recommends the **WebGPU** execution provider for generic cross-platform acceleration (utilizing **Vulkan** or **DirectML** natively), while supporting specialized providers like **CUDA** for hardware-specific optimizations.

**[TensorFlow Lite](03_tensorflow_lite.html)** - Google’s mobile-focused library optimized for size, efficiency, and battery life. Excellent quantization support for model compression. Best choice when targeting mobile platforms (Android, iOS).

**[PyTorch Mobile](04_pytorch_mobile.html)** - Facebook’s mobile inference solution with tight PyTorch training workflow integration. Ideal when you’re already using PyTorch for training and want seamless training-to-deployment via TorchScript.

**[DirectML](05_directml.html)** - Microsoft’s DirectX 12-based ML library for vendor-agnostic GPU acceleration on Windows. Works with NVIDIA, AMD, and Intel GPUs. Best used via ONNX Runtime’s DirectML execution provider.

**[Integration Patterns](06_integration_patterns.html)** - Three fundamental approaches for bridging Vulkan and ML libraries: separate contexts (simple, CPU-mediated), shared resources (GPU memory sharing), and interleaved execution (unified command stream).

**[GPU Resource Sharing](07_gpu_resource_sharing.html)** - Technical implementation of zero-copy data transfer using Vulkan external memory extensions, platform-specific handle types, and cross-context synchronization primitives.

**[Data Transfer Optimization](08_data_transfer_optimization.html)** - Techniques for minimizing transfer overhead, asynchronous transfer queues, memory mapping strategies, and batching for improved throughput.

**[Practical Examples](09_practical_examples.html)** - Complete working examples for desktop, mobile, and real-time applications with source code, build instructions, and performance analysis.

**[Choosing the Right Library](10_choosing_library.html)** - Systematic decision framework considering platform support, performance requirements, and integration complexity with recommendation matrices for different use cases.

**[ML Compilers Overview](11_ML_Compilers.html)** - What ML compilers are and when to use them.
**[IREE](12_iree.html)** - Vulkan‑centric compiler/runtime with AOT/JIT options and mobile/desktop focus.
**[Apache TVM](13_apache_tvm.html)** - End‑to‑end compiler stack with auto‑tuning and Vulkan/OpenCL backends.
**[Mojo / MAX](14_mojo_max.html)** - Modular’s compiler‑driven inference with developer‑friendly workflows.
**[OpenXLA](15_openxla.html)** - XLA/StableHLO ecosystem with multiple backends, including Vulkan via IREE.
**[Choosing the Right ML Compiler](16_choosing_compiler.html)** - Decision guidance across compilers and model formats (including NNEF considerations).
...
[Previous: Mental Model: GPU Execution](../ML_Inference_Pipeline/07_mental_model_gpu_execution.html) | [Next: ONNX Runtime](02_onnx_runtime.html)
