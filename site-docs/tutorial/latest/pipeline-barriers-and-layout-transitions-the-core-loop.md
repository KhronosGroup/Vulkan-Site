...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Synchronization/Pipeline_Barriers_Transitions/01_introduction.html
...
Previous: [Refined Pipeline Stages](../Anatomy_of_a_Dependency/04_refined_pipeline_stages.html) | Next: [The Image Barrier](02_image_barrier.html)
