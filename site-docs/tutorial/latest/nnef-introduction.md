...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Building_the_Inference_Engine/06_nnef_introduction.html

## Table of Contents

- [What NNEF is (and isn’t)](#_what_nnef_is_and_isnt)
- [What_NNEF_is_(and_isn’t)](#_what_nnef_is_and_isnt)
- [Anatomy of an NNEF model](#_anatomy_of_an_nnef_model)
- [Anatomy_of_an_NNEF_model](#_anatomy_of_an_nnef_model)
- [Recommended usage in this tutorial](#_recommended_usage_in_this_tutorial)
- [Recommended_usage_in_this_tutorial](#_recommended_usage_in_this_tutorial)
- [Loading NNEF with the official C++ API (adapter pattern)](#_loading_nnef_with_the_official_c_api_adapter_pattern)
- [Loading_NNEF_with_the_official_C++_API_(adapter_pattern)](#_loading_nnef_with_the_official_c_api_adapter_pattern)
- [Build integration (C++)](#_build_integration_c)
- [Build_integration_(C++)](#_build_integration_c)
- [Mapping details that matter (for Vulkan compute)](#_mapping_details_that_matter_for_vulkan_compute)
- [Mapping_details_that_matter_(for_Vulkan_compute)](#_mapping_details_that_matter_for_vulkan_compute)
- [Professional, neutral positioning (ONNX vs NNEF)](#_professional_neutral_positioning_onnx_vs_nnef)
- [Professional,_neutral_positioning_(ONNX_vs_NNEF)](#_professional_neutral_positioning_onnx_vs_nnef)
- [Validation checklist](#_validation_checklist)
- [Authoritative resources](#_authoritative_resources)
...
graph (input: tensor) -> (prob: tensor)
{
...
#include     // From Khronos NNEF‑Tools (C++ API)
...
For deeper details, start with the Khronos NNEF overview at [https://www.khronos.org/nnef/](https://www.khronos.org/nnef/), browse the official tools and C++ API in the repository at [https://github.com/KhronosGroup/NNEF-Tools/tree/main/nnef-pyproject#nnef-parser---repository](https://github.com/KhronosGroup/NNEF-Tools/tree/main/nnef-pyproject#nnef-parser---repository), and keep the concise C++ API notes handy at [https://github.com/KhronosGroup/NNEF-Tools/blob/main/nnef-pyproject/cpp_api.md](https://github.com/KhronosGroup/NNEF-Tools/blob/main/nnef-pyproject/cpp_api.md).

[Previous: Model Formats as Input](05_model_formats_as_input.html) | [Next: Putting It Together](07_putting_it_together.html)
