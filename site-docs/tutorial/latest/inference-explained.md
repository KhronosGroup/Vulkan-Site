...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/ML_Inference_Pipeline/04_inference_explained.html

## Table of Contents

- [Introduction](#_introduction)
- [Two Phases, Two Worlds](#_two_phases_two_worlds)
- [Two_Phases,_Two_Worlds](#_two_phases_two_worlds)
- [Training: The Learning Phase](#_training_the_learning_phase)
- [Training:_The_Learning_Phase](#_training_the_learning_phase)
- [Inference: The Deployment Phase](#_inference_the_deployment_phase)
- [Inference:_The_Deployment_Phase](#_inference_the_deployment_phase)
- [Why This Distinction Matters for Implementation](#_why_this_distinction_matters_for_implementation)
- [Why_This_Distinction_Matters_for_Implementation](#_why_this_distinction_matters_for_implementation)
- [The Inference Pipeline: Following Data Through the System](#_the_inference_pipeline_following_data_through_the_system)
- [The_Inference_Pipeline:_Following_Data_Through_the_System](#_the_inference_pipeline_following_data_through_the_system)
- [Stage 1: Input Data Arrives](#_stage_1_input_data_arrives)
- [Stage_1:_Input_Data_Arrives](#_stage_1_input_data_arrives)
- [Stage 2: Preprocessing Transforms the Data](#_stage_2_preprocessing_transforms_the_data)
- [Stage_2:_Preprocessing_Transforms_the_Data](#_stage_2_preprocessing_transforms_the_data)
- [Image Preprocessing: From Pixels to Tensors](#_image_preprocessing_from_pixels_to_tensors)
- [Image_Preprocessing:_From_Pixels_to_Tensors](#_image_preprocessing_from_pixels_to_tensors)
- [Text Preprocessing: From Strings to Tokens](#_text_preprocessing_from_strings_to_tokens)
- [Text_Preprocessing:_From_Strings_to_Tokens](#_text_preprocessing_from_strings_to_tokens)
- [Audio Preprocessing: From Waveforms to Features](#_audio_preprocessing_from_waveforms_to_features)
- [Audio_Preprocessing:_From_Waveforms_to_Features](#_audio_preprocessing_from_waveforms_to_features)
- [Where Preprocessing Happens: CPU vs GPU](#_where_preprocessing_happens_cpu_vs_gpu)
- [Where_Preprocessing_Happens:_CPU_vs_GPU](#_where_preprocessing_happens_cpu_vs_gpu)
- [The Critical Importance of Matching Training](#_the_critical_importance_of_matching_training)
- [The_Critical_Importance_of_Matching_Training](#_the_critical_importance_of_matching_training)
- [Stage 3: Neural Network Execution](#_stage_3_neural_network_execution)
- [Stage_3:_Neural_Network_Execution](#_stage_3_neural_network_execution)
- [The First Layer: Feature Extraction Begins](#_the_first_layer_feature_extraction_begins)
- [The_First_Layer:_Feature_Extraction_Begins](#_the_first_layer_feature_extraction_begins)
- [Activation Functions: Introducing Non-Linearity](#_activation_functions_introducing_non_linearity)
- [Activation_Functions:_Introducing_Non-Linearity](#_activation_functions_introducing_non_linearity)
- [Deeper Layers: Building Hierarchical Features](#_deeper_layers_building_hierarchical_features)
- [Deeper_Layers:_Building_Hierarchical_Features](#_deeper_layers_building_hierarchical_features)
- [Batch Normalization: Keeping Values in Range](#_batch_normalization_keeping_values_in_range)
- [Batch_Normalization:_Keeping_Values_in_Range](#_batch_normalization_keeping_values_in_range)
- [Pooling: Downsampling for Efficiency](#_pooling_downsampling_for_efficiency)
- [Pooling:_Downsampling_for_Efficiency](#_pooling_downsampling_for_efficiency)
- [Fully Connected Layers: Making the Final Decision](#_fully_connected_layers_making_the_final_decision)
- [Fully_Connected_Layers:_Making_the_Final_Decision](#_fully_connected_layers_making_the_final_decision)
- [The Complete Forward Pass](#_the_complete_forward_pass)
- [The_Complete_Forward_Pass](#_the_complete_forward_pass)
- [Stage 4: Postprocessing Interprets the Output](#_stage_4_postprocessing_interprets_the_output)
- [Stage_4:_Postprocessing_Interprets_the_Output](#_stage_4_postprocessing_interprets_the_output)
- [Classification: From Logits to Labels](#_classification_from_logits_to_labels)
- [Classification:_From_Logits_to_Labels](#_classification_from_logits_to_labels)
- [Object Detection: From Boxes to Objects](#_object_detection_from_boxes_to_objects)
- [Object_Detection:_From_Boxes_to_Objects](#_object_detection_from_boxes_to_objects)
- [Segmentation: From Masks to Regions](#_segmentation_from_masks_to_regions)
- [Segmentation:_From_Masks_to_Regions](#_segmentation_from_masks_to_regions)
- [Generative Models: From Noise to Content](#_generative_models_from_noise_to_content)
- [Generative_Models:_From_Noise_to_Content](#_generative_models_from_noise_to_content)
- [Where Postprocessing Happens: CPU vs GPU](#_where_postprocessing_happens_cpu_vs_gpu)
- [Where_Postprocessing_Happens:_CPU_vs_GPU](#_where_postprocessing_happens_cpu_vs_gpu)
- [Stage 5: Output Returns to Your Application](#_stage_5_output_returns_to_your_application)
- [Stage_5:_Output_Returns_to_Your_Application](#_stage_5_output_returns_to_your_application)
- [Thinking About Neural Networks as Compute Operations](#_thinking_about_neural_networks_as_compute_operations)
- [Thinking_About_Neural_Networks_as_Compute_Operations](#_thinking_about_neural_networks_as_compute_operations)
- [Tensors: The Data Structures](#_tensors_the_data_structures)
- [Tensors:_The_Data_Structures](#_tensors_the_data_structures)
- [Layers: The Operations](#_layers_the_operations)
- [Layers:_The_Operations](#_layers_the_operations)
- [The Execution Model](#_the_execution_model)
- [The_Execution_Model](#_the_execution_model)
- [The Basic Flow](#_the_basic_flow)
- [The_Basic_Flow](#_the_basic_flow)
- [Memory Management: The Challenge of Scale](#_memory_management_the_challenge_of_scale)
- [Memory_Management:_The_Challenge_of_Scale](#_memory_management_the_challenge_of_scale)
- [Memory Reuse: The Solution](#_memory_reuse_the_solution)
- [Memory_Reuse:_The_Solution](#_memory_reuse_the_solution)
- [Synchronization: Ensuring Correctness](#_synchronization_ensuring_correctness)
- [Synchronization:_Ensuring_Correctness](#_synchronization_ensuring_correctness)
- [Work Group Size: Balancing Parallelism and Resources](#_work_group_size_balancing_parallelism_and_resources)
- [Work_Group_Size:_Balancing_Parallelism_and_Resources](#_work_group_size_balancing_parallelism_and_resources)
- [Data Layout: Memory Access Patterns Matter](#_data_layout_memory_access_patterns_matter)
- [Data_Layout:_Memory_Access_Patterns_Matter](#_data_layout_memory_access_patterns_matter)
- [Training vs. Inference: A Detailed Comparison](#_training_vs_inference_a_detailed_comparison)
- [Training_vs._Inference:_A_Detailed_Comparison](#_training_vs_inference_a_detailed_comparison)
...
Analyze the model graph to determine each tensor’s lifetime—which layers produce it and which layers consume it.

Identify tensors whose lifetimes don’t overlap—they can share the same memory.

Allocate a pool of memory buffers and assign tensors to buffers such that no two overlapping tensors share a buffer.
...
| --- | --- | --- |
| **Goal** | Learn patterns from data by adjusting weights | Apply learned patterns to make predictions on new data |
| **Computation** | Forward pass (compute outputs) + backward pass (compute gradients via backpropagation) | Forward pass only—data flows through the network once |
| **Weights** | Constantly changing—adjusted after each batch to reduce loss | Fixed—loaded from the trained model file and never modified |
| **Memory Requirements** | Must store all intermediate activations for backpropagation, plus gradients and optimizer state | Only needs current layer’s activations—can reuse memory as we progress |
| **Batch Size** | Often large (32, 64, 128+) for stable gradient estimates and efficient GPU use | Flexible—can be 1 for low latency or larger for throughput |
| **Hardware** | Typically high-end GPUs or TPUs with lots of memory | Can run on mobile GPUs, embedded devices, or even CPUs |
| **Performance Focus** | Throughput over hours/days—how many examples per second during long training runs | Latency (milliseconds per prediction) for interactive apps, or throughput for batch processing |
| **Frameworks** | PyTorch, TensorFlow, JAX—designed for automatic differentiation and optimization | TFLite, ONNX Runtime, or custom implementations like ours—optimized for forward pass |
| **Typical Environment** | Development/research environment with powerful hardware and no real-time constraints | Production environment with varied hardware and strict latency requirements |
...
[Previous: Neural Networks Fundamentals](03_neural_networks_fundamentals.html) | [Next: Transfer Learning](05_transfer_learning.html)
