...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/OpenXR_Vulkan_Spatial_Computing/06_Late_Latching/01_introduction.html
...
Orchestrate the CPU/GPU handshake using timeline semaphores.

Update our shader data at the "last microsecond" before submission.

Integrate these late-breaking updates into the engine’s command buffer flow.

[Previous](../05_Predictive_Frame_Loop/04_incorporating_into_the_engine.html) | [Next](02_last_second_update.html)
