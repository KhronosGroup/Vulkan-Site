...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/ML_Inference/Embedded_Applications/01_introduction.html

## Table of Contents

- [The Unforgiving Reality of the Edge](#_the_unforgiving_reality_of_the_edge)
- [The_Unforgiving_Reality_of_the_Edge](#_the_unforgiving_reality_of_the_edge)
- [1. Power: The Energy Budget](#_1_power_the_energy_budget)
- [1._Power:_The_Energy_Budget](#_1_power_the_energy_budget)
- [2. Thermals: The Silicon Ceiling](#_2_thermals_the_silicon_ceiling)
- [2._Thermals:_The_Silicon_Ceiling](#_2_thermals_the_silicon_ceiling)
- [3. Determinism: The 99.9th Percentile](#_3_determinism_the_99_9th_percentile)
- [3._Determinism:_The_99.9th_Percentile](#_3_determinism_the_99_9th_percentile)
- [4. Unified Memory: The UMA Advantage](#_4_unified_memory_the_uma_advantage)
- [4._Unified_Memory:_The_UMA_Advantage](#_4_unified_memory_the_uma_advantage)
- [The Embedded Software Ecosystem](#_the_embedded_software_ecosystem)
- [The_Embedded_Software_Ecosystem](#_the_embedded_software_ecosystem)
- [Hardware Archetypes](#_hardware_archetypes)
- [Why Vulkan is the Secret Weapon of the Edge](#_why_vulkan_is_the_secret_weapon_of_the_edge)
- [Why_Vulkan_is_the_Secret_Weapon_of_the_Edge](#_why_vulkan_is_the_secret_weapon_of_the_edge)
- [Section Structure: The Path to Hardening](#_section_structure_the_path_to_hardening)
- [Section_Structure:_The_Path_to_Hardening](#_section_structure_the_path_to_hardening)
- [Your Mission](#_your_mission)
...
* **Real-time Scheduling**: Interacting with Linux [`SCHED_FIFO` or `SCHED_RR`](https://man7.org/linux/man-pages/man7/sched.7.html) to ensure the ML thread isn’t preempted by background tasks.
...
| --- | --- |
| CPU Memory    PCIe    GPU VRAM | Shared RAM (CPU and GPU access same physical pages) |
...
**The Silicon (Hardware)**: The physical ARM cores, GPU clusters, and specialized NPUs (Neural Processing Units).

**The Kernel (Linux/Android/QNX)**: Manages memory, scheduling, and device drivers. This is where [`dmabuf`](https://docs.kernel.org/driver-api/dma-buf.html) and [V4L2](https://docs.kernel.org/userspace-api/media/v4l/v4l2.html) live.

**The Driver (Vulkan Implementation)**: Provided by the SoC vendor (ARM, Qualcomm, NVIDIA, Broadcom). These are often closed-source and have specific quirks.

**The Loader (`libvulkan.so`)**: The bridge between your application and the driver.

**Your Application**: The ML engine we’ve been building throughout this book.
...
**[Cross-Compilation: The Forge](02_cross_compilation.html)**: You can’t compile a complex engine on a micro-computer. We’ll learn how to build for ARM targets from the comfort of a liquid-cooled workstation using **Sysroots**, **Docker**, and **CMake Toolchains**.

**[Camera Integration: The Zero-Copy Pipeline](03_camera_integration.html)**: The "Holy Grail" of vision. We’ll master **V4L2** and **dmabuf** to feed pixels into Vulkan without a single CPU memory copy.

**[Power & Thermal Optimization](04_power_optimization.html)**: Managing the physical limits. We’ll explore **DVFS**, **Race to Sleep** strategies, and software **PID Controllers** for temperature management.

**[Case Study: The Smart Wildlife Camera](05_complete_example.html)**: Bringing it all together. We’ll build a hardened, self-healing system that survives in the field for days, managing its own power and reliability.

**[Scene Understanding: ML in XR](06_scene_understanding_openxr.html)**: A bonus chapter for embedded ML. We’ll learn how to integrate spatial sensors in **OpenXR** to find floors and walls in 3D space at 90 FPS.
...
[Previous: Model Optimization](../Advanced_Topics/05_model_optimization.html) | [Next: Cross-Compilation Setup](02_cross_compilation.html)
