...
[VkPhysicalDeviceDriverProperties](devsandqueues.html#VkPhysicalDeviceDriverProperties)::`conformanceVersion`
less than 1.4.6.0
should be aware that arrays may consume all four `Component` slots in
each `Location` slot. |

Matrices of size n × m are assigned locations identically to
arrays of size n of vectors of length m with an identical
element type.
...
`Location`, any values written to it are discarded.
If a color attachment at a given `Location` does not have an output
...
*Sampled tile attachment* variables **must** be declared with a
    ...
    or [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType), and **can** be used
...
[VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType), and **can** be used with
...
[VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT](descriptors.html#VkDescriptorType), and **can** be used with
...
See [Input Attachment](descriptors.html#descriptors-inputattachment) for more details.
...
Shaders **can** access [resources](resources.html#resources) and [samplers](samplers.html#samplers)
through [Resource Descriptors](descriptors.html#descriptors) created in the API, via the
[Descriptor Heap Interface](#interfaces-resources-descriptorheap) or the
[Descriptor Set Interface](#interfaces-resources-descset).
...
The *descriptor heap interface* provides access to resources through
pointers to heaps of different types, without many of the restrictions that
apply to the [descriptor set interface](#interfaces-resources-descset).

Two built-in pointers are available to shaders:

* 
[`SamplerHeapEXT`](descriptorheaps.html#SamplerHeapEXT) for [samplers](samplers.html#samplers)

* 
[`ResourceHeapEXT`](descriptorheaps.html#ResourceHeapEXT) for [resources](resources.html#resources)
...
| --- | --- | --- |
| [VK_DESCRIPTOR_TYPE_SAMPLER](descriptors.html#VkDescriptorType) | `SamplerHeapEXT` | `OpTypeSampler` |
| [VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_SAMPLE_WEIGHT_IMAGE_QCOM](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_BLOCK_MATCH_IMAGE_QCOM](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeImage` |
| [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeBufferEXT` with the `Uniform` `Storage` `Class` |
| [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeBufferEXT` with the `StorageBuffer` `Storage` `Class` |
| [VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeAccelerationStructureKHR` |
| [VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NV](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeAccelerationStructureNV` |
| [VK_DESCRIPTOR_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_NV](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeAccelerationStructureKHR` |
| [VK_DESCRIPTOR_TYPE_TENSOR_ARM](descriptors.html#VkDescriptorType) | `ResourceHeapEXT` | `OpTypeTensorARM` |
...
a number of bytes equal to value advertised for the [VkDescriptorType](descriptors.html#VkDescriptorType)
...
[combined image sampler descriptor](descriptors.html#descriptors-combinedimagesampler) **can**
...
[weight image](descriptors.html#descriptors-weightimage):
...
[Block matching image](descriptors.html#descriptors-blockmatch):
...
| --- | --- |
| sampler | [VK_DESCRIPTOR_TYPE_SAMPLER](descriptors.html#VkDescriptorType) or
                           [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) |
| sampled image | [VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE](descriptors.html#VkDescriptorType) or
                           [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) |
| storage image | [VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType) |
| combined image sampler | [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType)
                           or both [VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE](descriptors.html#VkDescriptorType) and
                           [VK_DESCRIPTOR_TYPE_SAMPLER](descriptors.html#VkDescriptorType) when using heaps |
| uniform texel buffer | [VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) |
| storage texel buffer | [VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) |
| uniform buffer | [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) or
                           [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) |
| storage buffer | [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) or
                           [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) |
| input attachment | [VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT](descriptors.html#VkDescriptorType) |
| inline uniform block | [VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK](descriptors.html#VkDescriptorType) |
| acceleration structure | [VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR](descriptors.html#VkDescriptorType)
or
[VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NV](descriptors.html#VkDescriptorType) |
| weight image | [VK_DESCRIPTOR_TYPE_SAMPLE_WEIGHT_IMAGE_QCOM](descriptors.html#VkDescriptorType) |
| block matching image | [VK_DESCRIPTOR_TYPE_BLOCK_MATCH_IMAGE_QCOM](descriptors.html#VkDescriptorType) |
| storage tensor | [VK_DESCRIPTOR_TYPE_TENSOR_ARM](descriptors.html#VkDescriptorType) |
...
The [VK_DESCRIPTOR_TYPE_MUTABLE_EXT](descriptors.html#VkDescriptorType) descriptor type counts as one
...
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) that has multiple
...
started.
If the previous stage is a tessellation evaluation shader, it will contain
the same value as the tessellation shaders would read.
...
If the shader was created with [full subgroups](shaders.html#shaders-full-subgroups),
...
If the shader was created with [varying subgroup size allowed](shaders.html#shaders-varying-subgroup-size), the `SubgroupSize` decorated variable will
...
If the shader was created with a [required subgroup size](shaders.html#shaders-required-subgroup-size), the `SubgroupSize` decorated variable will match that
value.

If the shader does not allow [varying subgroup sizes](shaders.html#shaders-varying-subgroup-size), the
