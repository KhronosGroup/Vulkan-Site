...
in its `pNext` chain, `dataSize` **must** equal the size of
...
* 
[](#VUID-vkGetDescriptorEXT-pDescriptorInfo-12521) VUID-vkGetDescriptorEXT-pDescriptorInfo-12521
...
member that was created with a `VkSamplerYcbcrConversionInfo`
structure with an
[Android    external format](memory.html#memory-external-android-hardware-buffer-external-formats) in its `pNext` chain, `dataSize` **must** equal
the size of
[VkPhysicalDeviceDescriptorBufferPropertiesEXT](limits.html#VkPhysicalDeviceDescriptorBufferPropertiesEXT)::`combinedImageSamplerDescriptorSize`
times
...
* 
[](#VUID-VkDescriptorGetInfoEXT-type-12492) VUID-VkDescriptorGetInfoEXT-type-12492

If `type` is [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) and
`pUniformBuffer->address` is not 0, `pUniformBuffer->range`
**must** be less than or equal to [    `maxUniformBufferRange`](limits.html#limits-maxUniformBufferRange)

* 
[](#VUID-VkDescriptorGetInfoEXT-type-12493) VUID-VkDescriptorGetInfoEXT-type-12493

If `type` is [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType),
the [`shader64BitIndexing`](features.html#features-shader64BitIndexing) feature
is not enabled,
and `pUniformBuffer->address` is not 0, `pStorageBuffer->range`
**must** be less than or equal to [    `maxStorageBufferRange`](limits.html#limits-maxStorageBufferRange)
...
[VkDataGraphProcessingEngineCreateInfoARM](VK_ARM_data_graph/graphs.html#VkDataGraphProcessingEngineCreateInfoARM)::`pProcessingEngines`
with `isForeign` set to [VK_TRUE](fundamentals.html#VK_TRUE)
...
immutable samplers in `set` of `layout` to `set` for the command
buffer for subsequent [bound pipeline commands](pipelines.html#pipelines-bindpoint-commands) set by `pipelineBindPoint`.
...
* 
[](#VUID-VkAccelerationStructureCaptureDescriptorDataInfoEXT-None-12430) VUID-VkAccelerationStructureCaptureDescriptorDataInfoEXT-None-12430
...
* 
[](#VUID-VkAccelerationStructureCaptureDescriptorDataInfoEXT-accelerationStructureNV-12431) VUID-VkAccelerationStructureCaptureDescriptorDataInfoEXT-accelerationStructureNV-12431

If the `[VK_NV_ray_tracing](../appendices/extensions.html#VK_NV_ray_tracing) extension` is not enabled, then
`accelerationStructureNV` **must** be [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE)
...
[VkBufferCreateInfo](resources.html#VkBufferCreateInfo), [VkImageCreateInfo](resources.html#VkImageCreateInfo),
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo), or [VkSamplerCreateInfo](samplers.html#VkSamplerCreateInfo) structure.
