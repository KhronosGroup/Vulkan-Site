...
* 
`faultAddressInfo` a [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR) structure
providing details of the memory access which caused a fault.

* 
`instructionAddressInfo` a [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR)
structure providing details of the GPU instruction which cause a fault.

* 
`vendorInfo` a [VkDeviceFaultVendorInfoKHR](#VkDeviceFaultVendorInfoKHR) structure providing
