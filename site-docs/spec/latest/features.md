...
[VK_DYNAMIC_STATE_DEPTH_CLIP_ENABLE_EXT](pipelines.html#VkDynamicState) being set and the
[VkPipelineRasterizationDepthClipStateCreateInfoEXT](primsrast.html#VkPipelineRasterizationDepthClipStateCreateInfoEXT) structure is
not present
...
[VkTensorCreateInfoARM](resources.html#VkTensorCreateInfoARM) when `sharingMode` is
