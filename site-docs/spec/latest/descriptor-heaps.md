...
for an image with an
[Android external format](memory.html#memory-external-android-hardware-buffer-external-formats)
.
...
[VkSamplerYcbcrConversionInfo](samplers.html#VkSamplerYcbcrConversionInfo) structure
without an
[Android    external format](memory.html#memory-external-android-hardware-buffer-external-formats)
in its `pNext` chain, the corresponding element of
`pDescriptors` **must** have a `size` member that is greater than
or equal to the product of the value returned by
[vkGetPhysicalDeviceDescriptorSizeEXT](#vkGetPhysicalDeviceDescriptorSizeEXT) with a `descriptorType`
equal to `type` and
[VkSamplerYcbcrConversionImageFormatProperties](capabilities.html#VkSamplerYcbcrConversionImageFormatProperties)::`combinedImageSamplerDescriptorCount`,
...
* 
[](#VUID-vkWriteResourceDescriptorsEXT-pResources-12522) VUID-vkWriteResourceDescriptorsEXT-pResources-12522

If any element of `pResources` specifies a
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) structure with a
[VkSamplerYcbcrConversionInfo](samplers.html#VkSamplerYcbcrConversionInfo) structure with an
[Android    external format](memory.html#memory-external-android-hardware-buffer-external-formats) in its `pNext` chain, the corresponding element of
`pDescriptors` **must** have a `size` member that is greater than
or equal to the product of the value returned by
[vkGetPhysicalDeviceDescriptorSizeEXT](#vkGetPhysicalDeviceDescriptorSizeEXT) with a `descriptorType`
equal to `type` and
...
* 
[](#VUID-vkWriteResourceDescriptorsEXT-pResources-12494) VUID-vkWriteResourceDescriptorsEXT-pResources-12494

If any element of `pResources` specifies a
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) structure, `device` **must** support at
...
* 
[](#VUID-vkWriteResourceDescriptorsEXT-pResources-12495) VUID-vkWriteResourceDescriptorsEXT-pResources-12495

If any element of `pResources` specifies a
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) structure,
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo)::`image` **must** have been created from
`device`
...
[](#VUID-VkResourceDescriptorInfoEXT-type-12496) VUID-VkResourceDescriptorInfoEXT-type-12496

If `type` is [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType),
`data->pAddressRange→size` **must** be less than or equal to
[`maxUniformBufferRange`](limits.html#limits-maxUniformBufferRange)

[](#VUID-VkResourceDescriptorInfoEXT-type-12497) VUID-VkResourceDescriptorInfoEXT-type-12497

If `type` is [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType),
and the [`shader64BitIndexing`](features.html#features-shader64BitIndexing)
feature is not enabled,
`data->pAddressRange→size` **must** be less than or equal to
[`maxStorageBufferRange`](limits.html#limits-maxStorageBufferRange)
...
`data.pImage` is not `NULL`, the
[effective `usage`](resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) **must** include the
[VK_IMAGE_USAGE_SAMPLED_BIT](resources.html#VkImageUsageFlagBits) usage flag
...
[effective `usage`](resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) **must** include the
[VK_IMAGE_USAGE_STORAGE_BIT](resources.html#VkImageUsageFlagBits) usage flag
...
[effective `usage`](resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) **must** include the
[VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT](resources.html#VkImageUsageFlagBits) usage flag

[](#VUID-VkResourceDescriptorInfoEXT-type-12498) VUID-VkResourceDescriptorInfoEXT-type-12498

If `type` is [VK_DESCRIPTOR_TYPE_SAMPLE_WEIGHT_IMAGE_QCOM](descriptors.html#VkDescriptorType) and
`data.pImage` is not `NULL`, the
[effective `usage`](resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) **must** include the
[VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM](resources.html#VkImageUsageFlagBits) usage flag

[](#VUID-VkResourceDescriptorInfoEXT-type-12499) VUID-VkResourceDescriptorInfoEXT-type-12499

If `type` is [VK_DESCRIPTOR_TYPE_BLOCK_MATCH_IMAGE_QCOM](descriptors.html#VkDescriptorType) and
`data.pImage` is not `NULL`, the
[effective `usage`](resources.html#resources-image-inherited-usage) of the
[VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo) **must** include the
[VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM](resources.html#VkImageUsageFlagBits) usage flag
