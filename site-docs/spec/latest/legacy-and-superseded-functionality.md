...
- [Physical Device Surface Queries: Superseded via version 2](#legacy-gpdsc2)
- [Physical_Device_Surface_Queries:_Superseded_via_version_2](#legacy-gpdsc2)
...
- [Host-Side Build Commands: Superseded by Device Commands](#legacy-host-builds)
- [Host-Side_Build_Commands:_Superseded_by_Device_Commands](#legacy-host-builds)
...
Some parts of [VK_KHR_surface](extensions.html#VK_KHR_surface) were superseded by
[VK_KHR_get_surface_capabilities2](extensions.html#VK_KHR_get_surface_capabilities2), which introduced new versions of
...
[vkGetPhysicalDeviceSurfaceCapabilities2KHR](../chapters/VK_KHR_surface/wsi.html#vkGetPhysicalDeviceSurfaceCapabilities2KHR) **should** be used instead of
[vkGetPhysicalDeviceSurfaceCapabilitiesKHR](../chapters/VK_KHR_surface/wsi.html#vkGetPhysicalDeviceSurfaceCapabilitiesKHR).

When querying surface formats, [vkGetPhysicalDeviceSurfaceFormats2KHR](../chapters/VK_KHR_surface/wsi.html#vkGetPhysicalDeviceSurfaceFormats2KHR)
**should** be used instead of [vkGetPhysicalDeviceSurfaceFormatsKHR](../chapters/VK_KHR_surface/wsi.html#vkGetPhysicalDeviceSurfaceFormatsKHR).
...
The `enabledLayerCount` parameter of [VkDeviceCreateInfo](../chapters/devsandqueues.html#VkDeviceCreateInfo) **must** be
zero.
...
[VK_KHR_acceleration_structure](extensions.html#VK_KHR_acceleration_structure)
and [VK_EXT_opacity_micromap](extensions.html#VK_EXT_opacity_micromap)
originally provided parallel host-side and device-side build, copy, and
query commands for
micromaps and
acceleration structures.
These host commands are enabled by
the [`micromapHostCommands`](../chapters/features.html#features-micromapHostCommandsEXT) feature
and
the [`accelerationStructureHostCommands`](../chapters/features.html#features-accelerationStructureHostCommands) feature.

The following host commands are superseded by their command buffer
equivalents:

* 
[vkBuildAccelerationStructuresKHR](../chapters/accelstructures.html#vkBuildAccelerationStructuresKHR) is superseded by
[vkCmdBuildAccelerationStructuresKHR](../chapters/accelstructures.html#vkCmdBuildAccelerationStructuresKHR).

* 
[vkCopyAccelerationStructureKHR](../chapters/accelstructures.html#vkCopyAccelerationStructureKHR) is superseded by
[vkCmdCopyAccelerationStructureKHR](../chapters/accelstructures.html#vkCmdCopyAccelerationStructureKHR).

* 
[vkCopyAccelerationStructureToMemoryKHR](../chapters/accelstructures.html#vkCopyAccelerationStructureToMemoryKHR) is superseded by
[vkCmdCopyAccelerationStructureToMemoryKHR](../chapters/accelstructures.html#vkCmdCopyAccelerationStructureToMemoryKHR).

* 
[vkCopyMemoryToAccelerationStructureKHR](../chapters/accelstructures.html#vkCopyMemoryToAccelerationStructureKHR) is superseded by
[vkCmdCopyMemoryToAccelerationStructureKHR](../chapters/accelstructures.html#vkCmdCopyMemoryToAccelerationStructureKHR).

* 
[vkWriteAccelerationStructuresPropertiesKHR](../chapters/accelstructures.html#vkWriteAccelerationStructuresPropertiesKHR) is superseded by
[vkCmdWriteAccelerationStructuresPropertiesKHR](../chapters/accelstructures.html#vkCmdWriteAccelerationStructuresPropertiesKHR) (used together with
a query pool, and read back via [vkGetQueryPoolResults](../chapters/queries.html#vkGetQueryPoolResults) or copied
with [vkCmdCopyQueryPoolResults](../chapters/queries.html#vkCmdCopyQueryPoolResults)).

The corresponding micromap host commands in [VK_EXT_opacity_micromap](extensions.html#VK_EXT_opacity_micromap)
are superseded similarly:

* 
[vkBuildMicromapsEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkBuildMicromapsEXT) is superseded by [vkCmdBuildMicromapsEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdBuildMicromapsEXT).

* 
[vkCopyMicromapEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCopyMicromapEXT) is superseded by [vkCmdCopyMicromapEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapEXT).

* 
[vkCopyMicromapToMemoryEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCopyMicromapToMemoryEXT) is superseded by
[vkCmdCopyMicromapToMemoryEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapToMemoryEXT).

* 
[vkCopyMemoryToMicromapEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCopyMemoryToMicromapEXT) is superseded by
[vkCmdCopyMemoryToMicromapEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMemoryToMicromapEXT).

* 
[vkWriteMicromapsPropertiesEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkWriteMicromapsPropertiesEXT) is superseded by
[vkCmdWriteMicromapsPropertiesEXT](../chapters/VK_KHR_opacity_micromap/micromaps.html#vkCmdWriteMicromapsPropertiesEXT).
