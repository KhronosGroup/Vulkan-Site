...
* 
[](#VUID-vkCreateImage-pNext-12442) VUID-vkCreateImage-pNext-12442

The `pNext` chain of `pCreateInfo` **must** contain at most one of
the structures [VkImageStencilUsageCreateInfo](#VkImageStencilUsageCreateInfo) and
...
or slinnk:VkImageViewUsage2CreateInfoKHR
