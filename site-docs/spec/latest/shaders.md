...
- [Varying Subgroup Size](#shaders-varying-subgroup-size)
- [Varying_Subgroup_Size](#shaders-varying-subgroup-size)
- [Full Subgroups](#shaders-full-subgroups)
- [Required Subgroup Size](#shaders-required-subgroup-size)
- [Required_Subgroup_Size](#shaders-required-subgroup-size)
...
- [Cooperative Matrix Property Matching](#shaders-cooperative-matrix-property-matching)
- [Cooperative_Matrix_Property_Matching](#shaders-cooperative-matrix-property-matching)
- [VkCooperativeMatrixPropertiesKHR Matching](#shaders-cooperative-matrix-properties-khr-matching)
- [VkCooperativeMatrixPropertiesKHR Type Matching](#shaders-cooperative-matrix-properties-khr-type-matching)
- [VkCooperativeMatrixPropertiesKHR_Type_Matching](#shaders-cooperative-matrix-properties-khr-type-matching)
- [VkCooperativeMatrixPropertiesKHR Multiply-Add Matching](#shaders-cooperative-matrix-properties-khr-muladd-matching)
- [VkCooperativeMatrixPropertiesKHR_Multiply-Add_Matching](#shaders-cooperative-matrix-properties-khr-muladd-matching)
- [VkCooperativeMatrixProperties2EXT Matching](#shaders-cooperative-matrix-properties2-matching)
- [VkPhysicalDeviceCooperativeMatrixInfo2EXT Query Applicability](#shaders-cooperative-matrix-properties2-query-matching)
- [VkPhysicalDeviceCooperativeMatrixInfo2EXT_Query_Applicability](#shaders-cooperative-matrix-properties2-query-matching)
- [VkCooperativeMatrixProperties2EXT Type Matching](#shaders-cooperative-matrix-properties2-type-matching)
- [VkCooperativeMatrixProperties2EXT_Type_Matching](#shaders-cooperative-matrix-properties2-type-matching)
- [VkCooperativeMatrixProperties2EXT Multiply-Add Matching](#shaders-cooperative-matrix-properties2-muladd-matching)
- [VkCooperativeMatrixProperties2EXT_Multiply-Add_Matching](#shaders-cooperative-matrix-properties2-muladd-matching)
- [VkCooperativeMatrixFlexibleDimensionsPropertiesNV Matching](#shaders-cooperative-matrix-flexible-dimensions-properties-matching)
- [VkCooperativeMatrixFlexibleDimensionsPropertiesNV Type Matching](#shaders-cooperative-matrix-flexible-dimensions-properties-type-matching)
- [VkCooperativeMatrixFlexibleDimensionsPropertiesNV_Type_Matching](#shaders-cooperative-matrix-flexible-dimensions-properties-type-matching)
- [VkCooperativeMatrixFlexibleDimensionsPropertiesNV Multiply-Add Matching](#shaders-cooperative-matrix-flexible-dimensions-properties-muladd-matching)
- [VkCooperativeMatrixFlexibleDimensionsPropertiesNV_Multiply-Add_Matching](#shaders-cooperative-matrix-flexible-dimensions-properties-muladd-matching)
...
When determining [pipeline layout compatibility](descriptorsets.html#descriptors-compatibility), compatibility is determined as if a the shader was created
with a pipeline layout object that was created with identical values of
`setLayoutCount`, `pSetLayouts`, `pushConstantRangeCount`, and
`pPushConstantRanges`, and with
[VkPipelineLayoutCreateInfo](descriptorsets.html#VkPipelineLayoutCreateInfo)::`flags` set to 0.
If `flags` includes [VK_SHADER_CREATE_DESCRIPTOR_HEAP_BIT_EXT](#VkShaderCreateFlagBitsEXT), the
...
[`maxPushDataSize`](limits.html#limits-maxPushDataSize) minus the
`pushDataOffset` used in the mapping

* 
[](#VUID-VkShaderCreateInfoEXT-pNext-12454) VUID-VkShaderCreateInfoEXT-pNext-12454

If the `pNext` chain specifies a [    descriptor mapping](descriptorheaps.html#descriptorheaps-bindings) using
[VK_DESCRIPTOR_MAPPING_SOURCE_HEAP_WITH_SHADER_RECORD_INDEX_EXT](descriptorheaps.html#VkDescriptorMappingSourceEXT),
[VK_DESCRIPTOR_MAPPING_SOURCE_SHADER_RECORD_DATA_EXT](descriptorheaps.html#VkDescriptorMappingSourceEXT), or
[VK_DESCRIPTOR_MAPPING_SOURCE_SHADER_RECORD_ADDRESS_EXT](descriptorheaps.html#VkDescriptorMappingSourceEXT), and there
is a variable in the shader that matches the mapping, the `stage`
**must** be a ray tracing stage
...
[VK_DESCRIPTOR_MAPPING_SOURCE_PUSH_ADDRESS_EXT](descriptorheaps.html#VkDescriptorMappingSourceEXT), or
[VK_DESCRIPTOR_MAPPING_SOURCE_INDIRECT_ADDRESS_EXT](descriptorheaps.html#VkDescriptorMappingSourceEXT) the mapped
resource in the shader **must** be one of:
...
* 
[](#VUID-VkShaderCreateInfoEXT-micromap-11623) VUID-VkShaderCreateInfoEXT-micromap-11623

If `flags` includes
[VK_SHADER_CREATE_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_EXT](#VkShaderCreateFlagBitsEXT),
the
...
* 
[](#VUID-VkShaderCreateInfoEXT-setLayoutCount-13359) VUID-VkShaderCreateInfoEXT-setLayoutCount-13359

If `setLayoutCount` is not 0, pSetLayouts is not `NULL`,
and `flags` does not include
[VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](#VkShaderCreateFlagBitsEXT),
then `pSetLayouts` must be a valid pointer to an array of
`setLayoutCount` valid [VkDescriptorSetLayout](descriptorsets.html#VkDescriptorSetLayout) handles

* 
[](#VUID-VkShaderCreateInfoEXT-setLayoutCount-13360) VUID-VkShaderCreateInfoEXT-setLayoutCount-13360

If `setLayoutCount` is not 0, pSetLayouts is not `NULL`, and
`flags` includes [VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](#VkShaderCreateFlagBitsEXT),
then `pSetLayouts` must be a valid pointer to an array of
`setLayoutCount` [VkDescriptorSetLayout](descriptorsets.html#VkDescriptorSetLayout) or `VK_NULL_HANDLE`
handles

* 
[](#VUID-VkShaderCreateInfoEXT-stage-12428) VUID-VkShaderCreateInfoEXT-stage-12428

If `stage` is [VK_SHADER_STAGE_COMPUTE_BIT](pipelines.html#VkShaderStageFlagBits), then `flags`
**must** not include [VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](#VkShaderCreateFlagBitsEXT)

* 
[](#VUID-VkShaderCreateInfoEXT-flags-12490) VUID-VkShaderCreateInfoEXT-flags-12490

If `flags` includes [VK_SHADER_CREATE_DESCRIPTOR_HEAP_BIT_EXT](#VkShaderCreateFlagBitsEXT),
it **must** not include [VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](#VkShaderCreateFlagBitsEXT)
...
* 
[](#VUID-VkShaderCreateInfoEXT-stage-12445) VUID-VkShaderCreateInfoEXT-stage-12445

`stage` **must** not contain [VK_SHADER_STAGE_RAYGEN_BIT_KHR](pipelines.html#VkShaderStageFlagBits),
...
[](#VUID-VkShaderCreateInfoEXT-flags-parameter) VUID-VkShaderCreateInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkShaderCreateFlagBitsEXT](#VkShaderCreateFlagBitsEXT) values
...
[](#VUID-VkShaderCreateInfoEXT-nextStage-parameter) VUID-VkShaderCreateInfoEXT-nextStage-parameter
 ...
 If `nextStage` is not `0`, `nextStage` **must** be a valid combination of [VkShaderStageFlagBits](pipelines.html#VkShaderStageFlagBits) values
...
* 
[VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](#VkShaderCreateFlagBitsEXT) specifies that
...
* 
`pShaders` is a pointer to an array of [VkShaderEXT](#VkShaderEXT) handles
...
* 
[vkCmdSetLineWidth](primsrast.html#vkCmdSetLineWidth), if the [    effective rasterization input topology](drawing.html#drawing-rasterization-input-topology) is in the line
...
[effective rasterization input topology](drawing.html#drawing-rasterization-input-topology) is in the line [topology class](drawing.html#drawing-primitive-topology-class), the following commands **must** have been called in the command buffer
prior to drawing:
...
required [shader inputs](#shaders-inputs).

|  | This execution ordering guarantee is limited to variables in the shader
| --- | --- |
input and output interface and payloads sent between stages.
In particular, stores or atomic operations on storage buffers or images are
not part of these interfaces and such operations in a previous pipeline
stage are not guaranteed to be visible in the subsequent pipeline stage. |
...
Shaders **may** report a different value of [`SubgroupSize`](interfaces.html#interfaces-builtin-variables-sgs) for different subgroups if varying subgroups are
allowed.

If varying subgroups are not allowed, [`SubgroupSize`](interfaces.html#interfaces-builtin-variables-sgs) will always be equal to [limits-subgroupSize](devsandqueues.html#limits-subgroupSize).
If varying subgroups are allowed, [`SubgroupSize`](interfaces.html#interfaces-builtin-variables-sgs) **must** be a power-of-two value between
[`minSubgroupSize`](devsandqueues.html#limits-minSubgroupSize) and
[`maxSubgroupSize`](devsandqueues.html#limits-maxSubgroupSize) and **must** be uniform with
[subgroup scope](#shaders-scope-subgroup).
For
task, mesh, or
compute shaders, subgroups in the same [command scope](#shaders-scope-command) will have the same size.
For other stages, every subgroup **may** have a different size even within a
single command.

Varying subgroups are allowed if any of the following conditions are true:

* 
The shader was created from SPIR-V with version number of 1.6 or higher.

* 
The shader was created with [vkCreateShadersEXT](#vkCreateShadersEXT) and the
[VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](#VkShaderCreateFlagBitsEXT) flag was set.

* 
The shader was created as part of a pipeline and the
[VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT](pipelines.html#VkPipelineShaderStageCreateFlagBits)
flag was set.

When full subgroups are **required**, subgroups **must** be launched with all
invocations active, i.e., there is an active invocation with
`SubgroupLocalInvocationId` for each value in range
[0,`SubgroupSize`-1].

Full subgroups are **required** when the `X` dimension of the workgroup size
is a multiple of the reported value of [the `SubgroupSize` built-in](interfaces.html#interfaces-builtin-variables-sgs), and one of the following is true:
...
* 
The shader was created with [vkCreateShadersEXT](#vkCreateShadersEXT) and the
[VK_SHADER_CREATE_REQUIRE_FULL_SUBGROUPS_BIT_EXT](#VkShaderCreateFlagBitsEXT) flag was set.
...
|  | If [varying subgroup sizes](#shaders-varying-subgroup-size) are allowed,
| --- | --- |
this can only be statically guaranteed if the x dimension of the workgroup
size is a multiple of the [`maxSubgroupSize`](devsandqueues.html#limits-maxSubgroupSize).
Otherwise, the subgroup size in a particular subgroup may be set to any of
the supported sizes, making this a dynamic condition.
[Requiring a specific subgroup size](#shaders-required-subgroup-size) will
also ensure this is statically known. |

|  | Many algorithms cannot easily be implemented without
| --- | --- |
[full subgroups](#shaders-full-subgroups).
For implementations, full subgroup guarantees can be provided more often
with [varying subgroup sizes](#shaders-varying-subgroup-size).
The behavior of this built-in without that guarantee is considered legacy,
and implementations are encouraged to implement the tighter behavior
unconditionally. |

A specific subgroup size **can** be **required** for a shader between
[`minSubgroupSize`](devsandqueues.html#limits-minSubgroupSize) and
[`maxSubgroupSize`](devsandqueues.html#limits-maxSubgroupSize).
The required size **can** be specified by:

* 
Adding an instance of
[VkPipelineShaderStageRequiredSubgroupSizeCreateInfo](pipelines.html#VkPipelineShaderStageRequiredSubgroupSizeCreateInfo) to the
`pNext` chain of [VkPipelineShaderStageCreateInfo](pipelines.html#VkPipelineShaderStageCreateInfo) with
`requiredSize` set to the desired value.

* 
Adding an instance of [VkShaderRequiredSubgroupSizeCreateInfoEXT](pipelines.html#VkShaderRequiredSubgroupSizeCreateInfoEXT) to
the `pNext` chain of [VkShaderCreateInfoEXT](#VkShaderCreateInfoEXT) with
`requiredSize` set to the desired value.

When specified, the value of [`SubgroupSize`](interfaces.html#interfaces-builtin-variables-sgs) **must** match the required value for all invocations of
the shader.
...
memory locations unless some form of bounds checking is enabled or behavior
is otherwise explicitly defined.
...
void main()
{
    uint local_draw_data = subgroupBroadcastFirst(draw_data[vDrawID]);
}
...
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT) structure describing
...
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT) structures.
...
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`flags` does not
contain [VK_COOPERATIVE_MATRIX_SATURATING_ACCUMULATION_BIT_EXT](#VkCooperativeMatrixFlagBitsEXT):

* 
`scope` equals [VK_SCOPE_SUBGROUP_KHR](#VkScopeNV) and `subgroupSize` is
`0`

* 
`scope` equals [VK_SCOPE_SUBGROUP_KHR](#VkScopeNV) and `subgroupSize` is
equal to [VkPhysicalDeviceSubgroupProperties](limits.html#VkPhysicalDeviceSubgroupProperties)::`subgroupSize`

* 
if the [](features.html#features-cooperativeMatrixWorkgroupScope)[VkPhysicalDeviceCooperativeMatrix2FeaturesNV](features.html#VkPhysicalDeviceCooperativeMatrix2FeaturesNV)::`cooperativeMatrixWorkgroupScope`
feature is supported: `scope` equals [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV),
`invocations` is any power of two between
[VkPhysicalDeviceSubgroupProperties](limits.html#VkPhysicalDeviceSubgroupProperties)::`subgroupSize` and
[    `cooperativeMatrixWorkgroupScopeMaxWorkgroupSize`](limits.html#limits-cooperativeMatrixWorkgroupScopeMaxWorkgroupSize) inclusive, and
`subgroupSize` is either `0` or equal to
[VkPhysicalDeviceSubgroupProperties](limits.html#VkPhysicalDeviceSubgroupProperties)::`subgroupSize`
...
* 
`AType` and `BType` are [VK_COMPONENT_TYPE_FLOAT16_KHR](#VkComponentTypeNV),
`CType` and `ResultType` are either both
[VK_COMPONENT_TYPE_FLOAT16_KHR](#VkComponentTypeNV) or both
[VK_COMPONENT_TYPE_FLOAT32_KHR](#VkComponentTypeNV)

* 
`AType` and `BType` are [VK_COMPONENT_TYPE_UINT8_KHR](#VkComponentTypeNV),
`CType` and `ResultType` are either both
[VK_COMPONENT_TYPE_UINT32_KHR](#VkComponentTypeNV) or both
[VK_COMPONENT_TYPE_SINT32_KHR](#VkComponentTypeNV)

* 
`AType` and `BType` are [VK_COMPONENT_TYPE_SINT8_KHR](#VkComponentTypeNV),
`CType` and `ResultType` are [VK_COMPONENT_TYPE_SINT32_KHR](#VkComponentTypeNV)
...
The
[`cooperativeMatrixProperties2`](features.html#features-cooperativeMatrixProperties2EXT)
...
[](#VUID-vkGetPhysicalDeviceCooperativeMatrixProperties2EXT-pCooperativeMatrixInfo-parameter) VUID-vkGetPhysicalDeviceCooperativeMatrixProperties2EXT-pCooperativeMatrixInfo-parameter
 ...
 `pCooperativeMatrixInfo` **must** be a valid pointer to a valid [VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT) structure
...
[](#VUID-vkGetPhysicalDeviceCooperativeMatrixProperties2EXT-pProperties-parameter) VUID-vkGetPhysicalDeviceCooperativeMatrixProperties2EXT-pProperties-parameter
 ...
 If the value referenced by `pPropertyCount` is not `0`, and `pProperties` is not `NULL`, `pProperties` **must** be a valid pointer to an array of `pPropertyCount` [VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT) structures
...
* 
`scope` is the scope of the matrices, of type [VkScopeKHR](#VkScopeKHR).

* 
`invocations` is the number of invocations within the local
workgroup.
`invocations` is ignored unless `scope` is
[VK_SCOPE_WORKGROUP_KHR](#VkScopeNV).

* 
`subgroupSize` is the size of the subgroup.

* 
`flags` is a bitmask of [VkCooperativeMatrixFlagBitsEXT](#VkCooperativeMatrixFlagBitsEXT)
...
If `scope` is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), `invocations` specifies
...
|  | If `scope` is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV) scope, the retrieved
| --- | --- |
...
[VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](#VkShaderCreateFlagBitsEXT),
...
via [VkPipelineShaderStageRequiredSubgroupSizeCreateInfo](pipelines.html#VkPipelineShaderStageRequiredSubgroupSizeCreateInfo),
or [VkShaderRequiredSubgroupSizeCreateInfoEXT](pipelines.html#VkShaderRequiredSubgroupSizeCreateInfoEXT) for shader objects,
...
[VkPhysicalDeviceSubgroupProperties](limits.html#VkPhysicalDeviceSubgroupProperties)::`subgroupSize`, and the
...
`scope` **must** equal [VK_SCOPE_SUBGROUP_KHR](#VkScopeNV)
or [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV)
...
`scope` **must** not equal [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV)
...
If `scope` is [VK_SCOPE_SUBGROUP_KHR](#VkScopeNV), `subgroupSize` does
not equal `0`, and the
[`subgroupSizeControl`](features.html#features-subgroupSizeControl) feature is
...
If `scope` is [VK_SCOPE_SUBGROUP_KHR](#VkScopeNV) and the
[`subgroupSizeControl`](features.html#features-subgroupSizeControl) feature is
...
If `scope` is [VK_SCOPE_SUBGROUP_KHR](#VkScopeNV),
the [`subgroupSizeControl`](features.html#features-subgroupSizeControl) feature
is not supported,
...
If scope is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), `invocations` **must** be a
power of two
...
If scope is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), and `subgroupSize` does
...
If `scope` is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), `invocations` **must**
...
If scope is not [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), `invocations` **must** be
equal `0`
...
[](#VUID-VkPhysicalDeviceCooperativeMatrixInfo2EXT-sType-sType) VUID-VkPhysicalDeviceCooperativeMatrixInfo2EXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_INFO_2_EXT](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceCooperativeMatrixInfo2EXT-scope-parameter) VUID-VkPhysicalDeviceCooperativeMatrixInfo2EXT-scope-parameter
 ...
 `scope` **must** be a valid [VkScopeKHR](#VkScopeKHR) value
...
[](#VUID-VkPhysicalDeviceCooperativeMatrixInfo2EXT-flags-parameter) VUID-VkPhysicalDeviceCooperativeMatrixInfo2EXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkCooperativeMatrixFlagBitsEXT](#VkCooperativeMatrixFlagBitsEXT) values

Bits which **can** be set in
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`flags` to select the
...
* 
[VK_COOPERATIVE_MATRIX_SATURATING_ACCUMULATION_BIT_EXT](#VkCooperativeMatrixFlagBitsEXT) specifies
...
[VkCooperativeMatrixFlagsEXT](#VkCooperativeMatrixFlagsEXT) is a bitmask type for setting a mask of
zero or more [VkCooperativeMatrixFlagBitsEXT](#VkCooperativeMatrixFlagBitsEXT).
...
[](#VUID-VkCooperativeMatrixProperties2EXT-sType-sType) VUID-VkCooperativeMatrixProperties2EXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_2_EXT](fundamentals.html#VkStructureType)
...
typedef enum VkComponentTypeKHR {
  ...
  // Provided by VK_KHR_cooperative_matrix with VK_EXT_shader_ocp_microscaling_types
...
* 
[VK_COMPONENT_TYPE_FLOAT6_E2M3_EXT](#VkComponentTypeNV) corresponds to SPIR-V
`OpTypeFloat` 6 Float6E2M3EXT.

* 
[VK_COMPONENT_TYPE_FLOAT6_E3M2_EXT](#VkComponentTypeNV) corresponds to SPIR-V
`OpTypeFloat` 6 Float6E3M2EXT.

* 
[VK_COMPONENT_TYPE_FLOAT4_E2M1_EXT](#VkComponentTypeNV) corresponds to SPIR-V
`OpTypeFloat` 4 Float4E2M1EXT.

* 
[VK_COMPONENT_TYPE_FLOAT8_UNSIGNED_E8M0_EXT](#VkComponentTypeNV) corresponds to SPIR-V
`OpTypeFloat` 8 Float8UnsignedE8M0EXT.

* 
[VK_COMPONENT_TYPE_MXINT8_EXT](#VkComponentTypeNV) corresponds to SPIR-V
`OpTypeFloat` 8 MXInt8EXT.

Cooperative matrix types and instructions match cooperative matrix
properties as defined in this section.

The following rules define how cooperative matrix types and instructions
match a [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR) structure returned by
[vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR](#vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR).

An `OpTypeCooperativeMatrixKHR` type matches a
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR) structure if all of the following
conditions are satisfied:

* 
Its scope matches [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`scope`.

* 
If `Use` is `MatrixA`, its number of rows matches
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`MSize`, its number of
columns matches [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`KSize`, and
its component type matches
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`AType`.

* 
If `Use` is `MatrixB`, its number of rows matches
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`KSize`, its number of
columns matches [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`NSize`, and
its component type matches
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`BType`.

* 
If `Use` is `MatrixAccumulator`, its number of rows matches
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`MSize`, its number of
columns matches [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`NSize`, and
its component type matches either
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`CType` or
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`ResultType`.

The operands of an `OpCooperativeMatrixMulAddKHR` instruction match a
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR) structure if all of the following
conditions are satisfied:

* 
The type of `A` has `Rows` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`MSize`, `Columns`
matching [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`KSize`, `Use`
equal to `MatrixAKHR`, and `ComponentType` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`AType`.

* 
The type of `B` has `Rows` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`KSize`, `Columns`
matching [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`NSize`, `Use`
equal to `MatrixBKHR`, and `ComponentType` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`BType`.

* 
The type of `C` has `Rows` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`MSize`, `Columns`
matching [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`NSize`, `Use`
equal to `MatrixAccumulatorKHR`, and `ComponentType` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`CType`.

* 
The type of `Result` has `Rows` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`MSize`, `Columns`
matching [VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`NSize`, `Use`
equal to `MatrixAccumulatorKHR`, and `ComponentType` matching
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`ResultType`.
...
* 
`MatrixASignedComponents` is used if and only if
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`AType` is a signed integer
type.

* 
`MatrixBSignedComponents` is used if and only if
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`BType` is a signed integer
type.

* 
`MatrixCSignedComponents` is used if and only if
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`CType` is a signed integer
type.

* 
`MatrixResultSignedComponents` is used if and only if
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`ResultType` is a signed
integer type.

* 
`SaturatingAccumulationKHR` is used if and only if
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`saturatingAccumulation` is
[VK_TRUE](fundamentals.html#VK_TRUE).

* 
`SaturatingAccumulationKHR` is not used if and only if
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`saturatingAccumulation` is
[VK_FALSE](fundamentals.html#VK_FALSE).

* 
The scope of all cooperative matrix operands matches
[VkCooperativeMatrixPropertiesKHR](#VkCooperativeMatrixPropertiesKHR)::`scope`.

The following rules define how cooperative matrix types and instructions
match a [VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT) structure returned by
[vkGetPhysicalDeviceCooperativeMatrixProperties2EXT](#vkGetPhysicalDeviceCooperativeMatrixProperties2EXT).

A query using a [VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT) structure is
applicable to a cooperative matrix type in a shader if all of the following
conditions are satisfied:

* 
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`scope` matches the
type’s scope.

* 
If [VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`scope` is
[VK_SCOPE_WORKGROUP_KHR](#VkScopeNV),
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`invocations`
matches the number of invocations in the local workgroup.

* 
If the shader was created with
[VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT](pipelines.html#VkPipelineShaderStageCreateFlagBits)
or [VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](#VkShaderCreateFlagBitsEXT)
set, or if the SPIR-V module is version 1.6 or later and no structure
specifying a required subgroup size was chained,
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`subgroupSize` is
`0`.
...
[VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT](pipelines.html#VkPipelineShaderStageCreateFlagBits)
or [VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](#VkShaderCreateFlagBitsEXT)
set, [VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`subgroupSize`
equals the shader’s effective subgroup size.

An `OpTypeCooperativeMatrixKHR` type in a shader matches a
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT) structure returned by a query if all
of the following conditions are satisfied:

* 
The query is applicable to the type in the shader as defined in
[VkPhysicalDeviceCooperativeMatrixInfo2EXT Query Applicability](#shaders-cooperative-matrix-properties2-query-matching).

* 
If `Use` is `MatrixA`, its number of rows is a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`MGranularity`, its number
of columns is a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`KGranularity`, and its
component type matches
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`AType`.

* 
If `Use` is `MatrixB`, its number of rows is a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`KGranularity`, its number
of columns is a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`NGranularity`, and its
component type matches
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`BType`.

* 
If `Use` is `MatrixAccumulator`, its number of rows is a multiple
of [VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`MGranularity`, its
number of columns is a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`NGranularity`, and its
component type matches either
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`CType` or
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`ResultType`.

* 
If the [    `cooperativeMatrixFlexibleDimensions`](features.html#features-cooperativeMatrixFlexibleDimensions) feature is not enabled, the
dimensions match the granularities exactly.

The operands of an `OpCooperativeMatrixMulAddKHR` instruction in a shader
match a [VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT) structure returned by a
query if all of the following conditions are satisfied:

* 
The query is applicable to every cooperative matrix operand type in the
shader as defined in
[VkPhysicalDeviceCooperativeMatrixInfo2EXT Query Applicability](#shaders-cooperative-matrix-properties2-query-matching).

* 
The type of `A` has `Rows` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`MGranularity`,
`Columns` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`KGranularity`, `Use`
equal to `MatrixAKHR`, and `ComponentType` matching
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`AType`.

* 
The type of `B` has `Rows` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`KGranularity`,
`Columns` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`NGranularity`, `Use`
equal to `MatrixBKHR`, and `ComponentType` matching
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`BType`.

* 
The type of `C` has `Rows` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`MGranularity`,
`Columns` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`NGranularity`, `Use`
equal to `MatrixAccumulatorKHR`, and `ComponentType` matching
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`CType`.

* 
The type of `Result` has `Rows` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`MGranularity`,
`Columns` that are a multiple of
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`NGranularity`, `Use`
equal to `MatrixAccumulatorKHR`, and `ComponentType` matching
...
* 
`MatrixASignedComponents` is used if and only if
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`AType` is a signed integer
type.

* 
`MatrixBSignedComponents` is used if and only if
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`BType` is a signed integer
type.

* 
`MatrixCSignedComponents` is used if and only if
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`CType` is a signed integer
type.

* 
`MatrixResultSignedComponents` is used if and only if
[VkCooperativeMatrixProperties2EXT](#VkCooperativeMatrixProperties2EXT)::`ResultType` is a signed
integer type.

* 
`SaturatingAccumulationKHR` is used if and only if
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`flags` contains
[VK_COOPERATIVE_MATRIX_SATURATING_ACCUMULATION_BIT_EXT](#VkCooperativeMatrixFlagBitsEXT).
...
The following rules define how cooperative matrix types and instructions
match a [VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV) structure
returned by
...
An `OpTypeCooperativeMatrixKHR` type matches a
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV) structure if all of
the following conditions are satisfied:

* 
Its scope matches
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`scope`.

* 
If `Use` is `MatrixA`, its number of rows is a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`MGranularity`,
its number of columns is a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`KGranularity`,
and its component type matches
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`AType`.

* 
If `Use` is `MatrixB`, its number of rows is a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`KGranularity`,
its number of columns is a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`NGranularity`,
and its component type matches
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`BType`.
...
its number of columns is a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`NGranularity`,
and its component type matches either
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`CType` or
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`ResultType`.

* 
If its scope is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), the number of invocations
in the local workgroup matches
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`workgroupInvocations`.
...
`Columns` that are a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`KGranularity`,
`Use` equal to `MatrixAKHR`, and `ComponentType` matching
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`AType`.
...
`Columns` that are a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`NGranularity`,
`Use` equal to `MatrixBKHR`, and `ComponentType` matching
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`BType`.
...
`Columns` that are a multiple of
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`NGranularity`,
`Use` equal to `MatrixAccumulatorKHR`, and `ComponentType`
matching
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`CType`.
...
* 
`MatrixASignedComponents` is used if and only if
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`AType` is
a signed integer type.

* 
`MatrixBSignedComponents` is used if and only if
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`BType` is
a signed integer type.

* 
`MatrixCSignedComponents` is used if and only if
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`CType` is
a signed integer type.
...
* 
`SaturatingAccumulationKHR` is used if and only if
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`saturatingAccumulation`
is [VK_TRUE](fundamentals.html#VK_TRUE).
...
* 
If the scope is [VK_SCOPE_WORKGROUP_KHR](#VkScopeNV), the number of invocations
in the local workgroup matches
[VkCooperativeMatrixFlexibleDimensionsPropertiesNV](#VkCooperativeMatrixFlexibleDimensionsPropertiesNV)::`workgroupInvocations`.
