...
- **Component**: spec
- **Version**: latest
- **URL**: /spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html
...
the given micromap as the destination.

Micromaps created with `[VK_KHR_opacity_micromap](../../appendices/extensions.html#VK_KHR_opacity_micromap)`, which are
represented by [VkAccelerationStructureKHR](../resources.html#VkAccelerationStructureKHR) objects, are built with
[device build commands](../accelstructures.html#acceleration-structure-building).

When building micromaps with [vkCmdBuildAccelerationStructuresKHR](../accelstructures.html#vkCmdBuildAccelerationStructuresKHR), a
`VkAccelerationStructureGeometryMicromapDataKHR` structure can be added
to the `pNext` chain of [VkAccelerationStructureGeometryKHR](../accelstructures.html#VkAccelerationStructureGeometryKHR) to
...
* 
`pUsageCounts` is a pointer to an array of [VkMicromapUsageKHR](#VkMicromapUsageKHR)
structures.

* 
`ppUsageCounts` is a pointer to an array of pointers to
[VkMicromapUsageKHR](#VkMicromapUsageKHR) structures.
...
[VkMicromapTriangleKHR](#VkMicromapTriangleKHR) data
...
In practice, compilers compile [VkMicromapTriangleKHR](#VkMicromapTriangleKHR) to match this
pattern.

For opacity micromaps, the data at `data` is packed as either one bit
per element for [VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR](#VkOpacityMicromapFormatEXT) or two bits per
element for [VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](#VkOpacityMicromapFormatEXT) and is packed from
...
[`maxMicromapTriangles`](../limits.html#limits-maxMicromapTriangles)
...
`format` is [VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR](#VkOpacityMicromapFormatEXT),
...
[](#VUID-VkAccelerationStructureGeometryMicromapDataKHR-sType-sType) VUID-VkAccelerationStructureGeometryMicromapDataKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_MICROMAP_DATA_KHR](../fundamentals.html#VkStructureType)
...
[](#VUID-VkAccelerationStructureGeometryMicromapDataKHR-pUsageCounts-parameter) VUID-VkAccelerationStructureGeometryMicromapDataKHR-pUsageCounts-parameter
 ...
 If `usageCountsCount` is not `0`, and `pUsageCounts` is not `NULL`, `pUsageCounts` **must** be a valid pointer to an array of `usageCountsCount` valid [VkMicromapUsageKHR](#VkMicromapUsageKHR) structures
...
[](#VUID-VkAccelerationStructureGeometryMicromapDataKHR-ppUsageCounts-parameter) VUID-VkAccelerationStructureGeometryMicromapDataKHR-ppUsageCounts-parameter
 ...
 If `usageCountsCount` is not `0`, and `ppUsageCounts` is not `NULL`, `ppUsageCounts` **must** be a valid pointer to an array of `usageCountsCount` valid pointers to valid [VkMicromapUsageKHR](#VkMicromapUsageKHR) structures
...
* 
[VkAccelerationStructureGeometryKHR](../accelstructures.html#VkAccelerationStructureGeometryKHR)
...
[](#VUID-VkMicromapUsageKHR-format-parameter) VUID-VkMicromapUsageKHR-format-parameter
 ...
 `format` **must** be a valid [VkOpacityMicromapFormatKHR](#VkOpacityMicromapFormatKHR) value
...
Formats which **can** be set in [VkMicromapUsageKHR](#VkMicromapUsageKHR)::`format` and
[VkMicromapTriangleKHR](#VkMicromapTriangleKHR)::`format` for micromap builds, are:
...
* 
[VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR](#VkOpacityMicromapFormatEXT) specifies that the given
micromap format has one bit per subtriangle encoding either fully opaque
or fully transparent.

* 
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](#VkOpacityMicromapFormatEXT) specifies that the given
micromap format has two bits per subtriangle encoding four modes which
can be interpreted as described in [Ray Opacity    Micromap](../raytraversal.html#ray-opacity-micromap).

|  | For compactness, these values are stored as 16-bit in some structures. |
| --- | --- |

To build micromaps represented as a [VkMicromapEXT](../resources.html#VkMicromapEXT) object call:
...
implementation for the duration of the command’s execution on the device.
Micromaps **must** be fully self-contained.
The application **can** reuse or free any memory which was used by this
command’s execution on the device as an input or as scratch without
affecting the results of a subsequent acceleration structure build using the
micromap or traversal of that acceleration structure, provided proper
synchronization is used as described below.
...
* 
[](#VUID-vkCmdBuildMicromapsEXT-micromap-11648) VUID-vkCmdBuildMicromapsEXT-micromap-11648
...
* 
[](#VUID-vkCmdBuildMicromapsEXT-dstMicromap-11649) VUID-vkCmdBuildMicromapsEXT-dstMicromap-11649

The range of memory backing the `dstMicromap` member of any element
of `pInfos` that is accessed by the execution of this command on the
device **must** not overlap the memory backing the `dstMicromap` member
of any other element of `pInfos`, which is accessed by the execution
of this command on the device

* 
[](#VUID-vkCmdBuildMicromapsEXT-dstMicromap-11650) VUID-vkCmdBuildMicromapsEXT-dstMicromap-11650

The range of memory backing the `dstMicromap` member of any element
of `pInfos` that is accessed by the execution of this command on the
device **must** not overlap the memory backing the `scratchData` member
of any element of `pInfos` (including the same element), which is
accessed by the execution of this command on the device

* 
[](#VUID-vkCmdBuildMicromapsEXT-scratchData-11651) VUID-vkCmdBuildMicromapsEXT-scratchData-11651
...
* 
`flags` is a bitmask of [VkBuildMicromapFlagBitsEXT](#VkBuildMicromapFlagBitsEXT) specifying
...
* 
[](#VUID-VkMicromapBuildInfoEXT-format-11652) VUID-VkMicromapBuildInfoEXT-format-11652

If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](../resources.html#VkMicromapTypeEXT), for each
member of `pUsageCounts` or `ppUsageCounts`, `format` **must**
be a valid value from [VkOpacityMicromapFormatEXT](#VkOpacityMicromapFormatEXT)

* 
[](#VUID-VkMicromapBuildInfoEXT-format-11653) VUID-VkMicromapBuildInfoEXT-format-11653

If `type` is [VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](../resources.html#VkMicromapTypeEXT), for
each member of `pUsageCounts` or `ppUsageCounts`, `format`
**must** be a valid value from [VkDisplacementMicromapFormatNV](#VkDisplacementMicromapFormatNV)

* 
[](#VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11654) VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11654

If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](../resources.html#VkMicromapTypeEXT), for each
member of `pUsageCounts` or `ppUsageCounts`, if `format` is
[VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT](#VkOpacityMicromapFormatEXT), `subdivisionLevel`
...
* 
[](#VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11655) VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11655

If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](../resources.html#VkMicromapTypeEXT), for each
member of `pUsageCounts` or `ppUsageCounts`, if `format` is
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_EXT](#VkOpacityMicromapFormatEXT), `subdivisionLevel`
**must** be less than or equal to
...
* 
[](#VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11656) VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11656

If `type` is [VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](../resources.html#VkMicromapTypeEXT), for
each member of `pUsageCounts` or `ppUsageCounts`,
`subdivisionLevel` **must** be less than or equal to
...
* 
[](#VUID-VkMicromapBuildInfoEXT-format-11657) VUID-VkMicromapBuildInfoEXT-format-11657

If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](../resources.html#VkMicromapTypeEXT), for each
member of `triangleArray`, `format` **must** be a valid value from
[VkOpacityMicromapFormatEXT](#VkOpacityMicromapFormatEXT)

* 
[](#VUID-VkMicromapBuildInfoEXT-format-11658) VUID-VkMicromapBuildInfoEXT-format-11658

If `type` is [VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](../resources.html#VkMicromapTypeEXT), for
each member of `triangleArray`, `format` **must** be a valid value
from [VkDisplacementMicromapFormatNV](#VkDisplacementMicromapFormatNV)

* 
[](#VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11659) VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11659

If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](../resources.html#VkMicromapTypeEXT), for each
member of `triangleArray`, if `format` is
[VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT](#VkOpacityMicromapFormatEXT), `subdivisionLevel`
**must** be less than or equal to
[](../limits.html#limits-maxOpacity2StateSubdivisionLevelEXT)[VkPhysicalDeviceOpacityMicromapPropertiesEXT](../limits.html#VkPhysicalDeviceOpacityMicromapPropertiesEXT)::`maxOpacity2StateSubdivisionLevel`

* 
[](#VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11660) VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11660
...
* 
[](#VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11661) VUID-VkMicromapBuildInfoEXT-subdivisionLevel-11661

If `type` is [VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](../resources.html#VkMicromapTypeEXT), for
each member of `triangleArray`, `subdivisionLevel` **must** be less
than or equal to
[VkPhysicalDeviceDisplacementMicromapPropertiesNV](../limits.html#VkPhysicalDeviceDisplacementMicromapPropertiesNV)::`maxDisplacementMicromapSubdivisionLevel`
...
[](#VUID-VkMicromapBuildInfoEXT-flags-parameter) VUID-VkMicromapBuildInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBuildMicromapFlagBitsEXT](#VkBuildMicromapFlagBitsEXT) values
...
Bits which **can** be set in [VkMicromapBuildInfoEXT](#VkMicromapBuildInfoEXT)::`flags`
...
* 
[VK_BUILD_MICROMAP_ALLOW_COMPACTION_BIT_EXT](#VkBuildMicromapFlagBitsEXT) specifies that the
micromap **can** act as the source for a [copy micromap    command](#micromap-copying) with `mode` of [VK_COPY_MICROMAP_MODE_COMPACT_EXT](#VkCopyMicromapModeEXT) to
produce a compacted micromap.
...
Micromaps created with `[VK_KHR_opacity_micromap](../../appendices/extensions.html#VK_KHR_opacity_micromap)`, which are
represented by [VkAccelerationStructureKHR](../resources.html#VkAccelerationStructureKHR) objects, are copied with
[device copy commands](../accelstructures.html#acceleration-structure-copying).

For [VkMicromapEXT](../resources.html#VkMicromapEXT), an additional command exists for copying micromaps
without updating their contents.
Before copying, an application **must** query the size of the resulting
micromap.

To query [VkMicromapEXT](../resources.html#VkMicromapEXT) size parameters call:
...
* 
[](#VUID-vkCmdWriteMicromapsPropertiesEXT-None-12417) VUID-vkCmdWriteMicromapsPropertiesEXT-None-12417

All queries used by this command **must** be *unavailable*
...
* 
[](#VUID-vkCmdWriteMicromapsPropertiesEXT-pMicromaps-11662) VUID-vkCmdWriteMicromapsPropertiesEXT-pMicromaps-11662

All micromaps in `pMicromaps` **must** have been constructed prior to
the execution of this command on the device
...
[VK_BUILD_MICROMAP_ALLOW_COMPACTION_BIT_EXT](#VkBuildMicromapFlagBitsEXT) if `queryType` is
...
`queryType` **must** be
[VK_QUERY_TYPE_MICROMAP_COMPACTED_SIZE_EXT](../queries.html#VkQueryType), or
...
To copy a [VkMicromapEXT](../resources.html#VkMicromapEXT) call:
...
The `buffer` used to create `pInfo->dst` **must** **must** be bound to
device memory

* 
[](#VUID-vkCmdCopyMicromapEXT-src-07532) VUID-vkCmdCopyMicromapEXT-src-07532
...
[VK_BUILD_MICROMAP_ALLOW_COMPACTION_BIT_EXT](#VkBuildMicromapFlagBitsEXT) in the build
...
To copy a [VkMicromapEXT](../resources.html#VkMicromapEXT) to device memory call:
...
with the [VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT](../synchronization.html#VkPipelineStageFlagBits2KHR) pipeline stage and
an access type of [VK_ACCESS_TRANSFER_WRITE_BIT](../synchronization.html#VkAccessFlagBits).
...
The output **may** not necessarily be bit-for-bit identical, but is equally
compatible for use with either [vkCmdCopyMemoryToMicromapEXT](#vkCmdCopyMemoryToMicromapEXT) or
...
with the [VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT](../synchronization.html#VkPipelineStageFlagBits2KHR) pipeline stage and
an access type of [VK_ACCESS_TRANSFER_READ_BIT](../synchronization.html#VkAccessFlagBits).

This command **can** accept micromaps produced by either
[vkCopyMicromapToMemoryEXT](#vkCopyMicromapToMemoryEXT) or [vkCmdCopyMicromapToMemoryEXT](#vkCmdCopyMicromapToMemoryEXT).
...
To check if a serialized [VkMicromapEXT](../resources.html#VkMicromapEXT) is compatible with the current
device call:
...
* 
[](#VUID-vkGetDeviceMicromapCompatibilityEXT-micromap-11666) VUID-vkGetDeviceMicromapCompatibilityEXT-micromap-11666
...
serialized micromap that is loaded in memory.
...
To build [VkMicromapEXT](../resources.html#VkMicromapEXT) on the host, call:

|  | This functionality is superseded by [vkCmdBuildMicromapsEXT](#vkCmdBuildMicromapsEXT). See [Legacy Functionality](../../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
The input buffers passed to this command will be referenced by the
implementation for the duration of the command.
Micromaps **must** be fully self-contained.
...
The [    `VkPhysicalDeviceOpacityMicromapFeaturesEXT`::`micromapHostCommands`](../features.html#features-micromapHostCommandsEXT)
feature **must** be enabled
...
* 
[](#VUID-vkBuildMicromapsEXT-dstMicromap-11667) VUID-vkBuildMicromapsEXT-dstMicromap-11667
...
* 
[](#VUID-vkBuildMicromapsEXT-dstMicromap-11668) VUID-vkBuildMicromapsEXT-dstMicromap-11668
...
* 
[](#VUID-vkBuildMicromapsEXT-scratchData-11669) VUID-vkBuildMicromapsEXT-scratchData-11669
...
To copy or compact a [VkMicromapEXT](../resources.html#VkMicromapEXT) on the host, call:

|  | This functionality is superseded by [vkCmdCopyMicromapEXT](#vkCmdCopyMicromapEXT). See [Legacy Functionality](../../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
* 
[](#VUID-vkCopyMicromapEXT-src-11670) VUID-vkCopyMicromapEXT-src-11670
...
To copy host accessible [VkMicromapEXT](../resources.html#VkMicromapEXT) to a micromap, call:

|  | This functionality is superseded by [vkCmdCopyMemoryToMicromapEXT](#vkCmdCopyMemoryToMicromapEXT). See [Legacy Functionality](../../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
To copy a [VkMicromapEXT](../resources.html#VkMicromapEXT) to host accessible memory, call:

|  | This functionality is superseded by [vkCmdCopyMicromapToMemoryEXT](#vkCmdCopyMicromapToMemoryEXT). See [Legacy Functionality](../../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
The output **may** not necessarily be bit-for-bit identical, but is compatible
for use with either [vkCmdCopyMemoryToMicromapEXT](#vkCmdCopyMemoryToMicromapEXT) or
[vkCopyMemoryToMicromapEXT](#vkCopyMemoryToMicromapEXT).
...
To query [VkMicromapEXT](../resources.html#VkMicromapEXT) size parameters on the host, call:

|  | This functionality is superseded by [vkCmdWriteMicromapsPropertiesEXT](#vkCmdWriteMicromapsPropertiesEXT). See [Legacy Functionality](../../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
* 
[](#VUID-vkWriteMicromapsPropertiesEXT-pMicromaps-11671) VUID-vkWriteMicromapsPropertiesEXT-pMicromaps-11671
