...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Mobile_Development/05_vulkan_extensions.html

## Table of Contents

- [Vulkan Extensions for Mobile](#_vulkan_extensions_for_mobile)
- [Vulkan_Extensions_for_Mobile](#_vulkan_extensions_for_mobile)
- [VK_KHR_dynamic_rendering](#_vk_khr_dynamic_rendering)
- [Overview](#_overview)
- [Implementation (Step-by-step)](#_implementation_step_by_step)
- [Enable the extension and load entry points](#_enable_the_extension_and_load_entry_points)
- [Enable_the_extension_and_load_entry_points](#_enable_the_extension_and_load_entry_points)
- [Describe attachments for this rendering scope](#_describe_attachments_for_this_rendering_scope)
- [Describe_attachments_for_this_rendering_scope](#_describe_attachments_for_this_rendering_scope)
- [Begin rendering, draw, end rendering](#_begin_rendering_draw_end_rendering)
- [Begin_rendering,_draw,_end_rendering](#_begin_rendering_draw_end_rendering)
- [C++ bindings (vulkan.hpp) variant](#_c_bindings_vulkan_hpp_variant)
- [C++_bindings_(vulkan.hpp)_variant](#_c_bindings_vulkan_hpp_variant)
- [VK_KHR_dynamic_rendering_local_read](#_vk_khr_dynamic_rendering_local_read)
- [Overview](#_overview_2)
- [How It Reduces Memory Bandwidth](#_how_it_reduces_memory_bandwidth)
- [How_It_Reduces_Memory_Bandwidth](#_how_it_reduces_memory_bandwidth)
- [Implementation](#_implementation)
- [VK_EXT_shader_tile_image](#_vk_ext_shader_tile_image)
- [Overview](#_overview_3)
- [How It Reduces Memory Bandwidth](#_how_it_reduces_memory_bandwidth_2)
- [How_It_Reduces_Memory_Bandwidth](#_how_it_reduces_memory_bandwidth_2)
- [Implementation](#_implementation_2)
- [Combining Extensions for Maximum Performance](#_combining_extensions_for_maximum_performance)
- [Combining_Extensions_for_Maximum_Performance](#_combining_extensions_for_maximum_performance)
- [Device Extension Support](#_device_extension_support)
- [Device_Extension_Support](#_device_extension_support)
- [Device Extension Support Details](#_device_extension_support_details)
- [Device_Extension_Support_Details](#_device_extension_support_details)
- [Best Practices for Using Extensions](#_best_practices_for_using_extensions)
- [Best_Practices_for_Using_Extensions](#_best_practices_for_using_extensions)
...
std::vector supported_extensions;
