...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/Building_a_Simple_Engine/Engine_Architecture/05_rendering_pipeline.html

## Table of Contents

- [Rendering Pipeline](#_rendering_pipeline)
- [Rendering Pipeline Overview](#_rendering_pipeline_overview)
- [Rendering_Pipeline_Overview](#_rendering_pipeline_overview)
- [Rendering Pipeline Challenges](#_rendering_pipeline_challenges)
- [Rendering_Pipeline_Challenges](#_rendering_pipeline_challenges)
- [Rendering Pipeline Architecture](#_rendering_pipeline_architecture)
- [Rendering_Pipeline_Architecture](#_rendering_pipeline_architecture)
- [Scene Culling](#_scene_culling)
- [Render Pass Management](#_render_pass_management)
- [Render_Pass_Management](#_render_pass_management)
- [Rendergraphs and Synchronization](#_rendergraphs_and_synchronization)
- [Rendergraphs_and_Synchronization](#_rendergraphs_and_synchronization)
- [What is a Rendergraph?](#_what_is_a_rendergraph)
- [What_is_a_Rendergraph?](#_what_is_a_rendergraph)
- [Rendergraph: Data Structure Architecture and Resource Representation](#_rendergraph_data_structure_architecture_and_resource_representation)
- [Rendergraph:_Data_Structure_Architecture_and_Resource_Representation](#_rendergraph_data_structure_architecture_and_resource_representation)
- [Rendergraph: Resource Registration and Pass Definition Interface](#_rendergraph_resource_registration_and_pass_definition_interface)
- [Rendergraph:_Resource_Registration_and_Pass_Definition_Interface](#_rendergraph_resource_registration_and_pass_definition_interface)
- [Rendergraph: Dependency Analysis and Execution Ordering](#_rendergraph_dependency_analysis_and_execution_ordering)
- [Rendergraph:_Dependency_Analysis_and_Execution_Ordering](#_rendergraph_dependency_analysis_and_execution_ordering)
- [Rendergraph: Automatic Synchronization and Resource Allocation](#_rendergraph_automatic_synchronization_and_resource_allocation)
- [Rendergraph:_Automatic_Synchronization_and_Resource_Allocation](#_rendergraph_automatic_synchronization_and_resource_allocation)
- [Rendergraph: Execution Engine and Command Recording](#_rendergraph_execution_engine_and_command_recording)
- [Rendergraph:_Execution_Engine_and_Command_Recording](#_rendergraph_execution_engine_and_command_recording)
- [Vulkan Synchronization](#_vulkan_synchronization)
- [Pipeline Barriers](#_pipeline_barriers)
- [Image Layout Transition: Barrier Configuration and Resource Specification](#_image_layout_transition_barrier_configuration_and_resource_specification)
- [Image_Layout_Transition:_Barrier_Configuration_and_Resource_Specification](#_image_layout_transition_barrier_configuration_and_resource_specification)
- [Image Layout Transition: Pipeline Stage and Access Mask Determination](#_image_layout_transition_pipeline_stage_and_access_mask_determination)
- [Image_Layout_Transition:_Pipeline_Stage_and_Access_Mask_Determination](#_image_layout_transition_pipeline_stage_and_access_mask_determination)
- [Image Layout Transition: Barrier Execution and GPU Synchronization](#_image_layout_transition_barrier_execution_and_gpu_synchronization)
- [Image_Layout_Transition:_Barrier_Execution_and_GPU_Synchronization](#_image_layout_transition_barrier_execution_and_gpu_synchronization)
- [Semaphores and Fences](#_semaphores_and_fences)
- [Semaphores_and_Fences](#_semaphores_and_fences)
- [Frame Rendering: CPU-GPU Synchronization and Frame Pacing](#_frame_rendering_cpu_gpu_synchronization_and_frame_pacing)
- [Frame_Rendering:_CPU-GPU_Synchronization_and_Frame_Pacing](#_frame_rendering_cpu_gpu_synchronization_and_frame_pacing)
- [Frame Rendering: Swapchain Image Acquisition and Resource Preparation](#_frame_rendering_swapchain_image_acquisition_and_resource_preparation)
- [Frame_Rendering:_Swapchain_Image_Acquisition_and_Resource_Preparation](#_frame_rendering_swapchain_image_acquisition_and_resource_preparation)
- [Frame Rendering: GPU Work Submission and Inter-Queue Synchronization](#_frame_rendering_gpu_work_submission_and_inter_queue_synchronization)
- [Frame_Rendering:_GPU_Work_Submission_and_Inter-Queue_Synchronization](#_frame_rendering_gpu_work_submission_and_inter_queue_synchronization)
- [Frame Rendering: Presentation Coordination and Display Integration](#_frame_rendering_presentation_coordination_and_display_integration)
- [Frame_Rendering:_Presentation_Coordination_and_Display_Integration](#_frame_rendering_presentation_coordination_and_display_integration)
- [How Rendergraphs Help with Synchronization](#_how_rendergraphs_help_with_synchronization)
- [How_Rendergraphs_Help_with_Synchronization](#_how_rendergraphs_help_with_synchronization)
- [Dynamic Rendering and Its Integration with Rendergraphs](#_dynamic_rendering_and_its_integration_with_rendergraphs)
- [Dynamic_Rendering_and_Its_Integration_with_Rendergraphs](#_dynamic_rendering_and_its_integration_with_rendergraphs)
- [Benefits of Dynamic Rendering](#_benefits_of_dynamic_rendering)
- [Benefits_of_Dynamic_Rendering](#_benefits_of_dynamic_rendering)
- [Dynamic Rendering in Rendergraphs](#_dynamic_rendering_in_rendergraphs)
- [Dynamic_Rendering_in_Rendergraphs](#_dynamic_rendering_in_rendergraphs)
- [Example: Implementing a Deferred Renderer with a Rendergraph and Dynamic Rendering](#_example_implementing_a_deferred_renderer_with_a_rendergraph_and_dynamic_rendering)
- [Example:_Implementing_a_Deferred_Renderer_with_a_Rendergraph_and_Dynamic_Rendering](#_example_implementing_a_deferred_renderer_with_a_rendergraph_and_dynamic_rendering)
- [Deferred Renderer Setup: G-Buffer Resource Configuration](#_deferred_renderer_setup_g_buffer_resource_configuration)
- [Deferred_Renderer_Setup:_G-Buffer_Resource_Configuration](#_deferred_renderer_setup_g_buffer_resource_configuration)
- [Deferred Renderer Setup: Geometry Pass Configuration and Multiple Render Target Setup](#_deferred_renderer_setup_geometry_pass_configuration_and_multiple_render_target_setup)
- [Deferred_Renderer_Setup:_Geometry_Pass_Configuration_and_Multiple_Render_Target_Setup](#_deferred_renderer_setup_geometry_pass_configuration_and_multiple_render_target_setup)
- [Deferred Renderer Setup: Lighting Pass Configuration and Screen-Space Processing](#_deferred_renderer_setup_lighting_pass_configuration_and_screen_space_processing)
- [Deferred_Renderer_Setup:_Lighting_Pass_Configuration_and_Screen-Space_Processing](#_deferred_renderer_setup_lighting_pass_configuration_and_screen_space_processing)
- [Best Practices for Rendergraphs and Synchronization](#_best_practices_for_rendergraphs_and_synchronization)
- [Best_Practices_for_Rendergraphs_and_Synchronization](#_best_practices_for_rendergraphs_and_synchronization)
- [Implementing Specific Render Passes](#_implementing_specific_render_passes)
- [Implementing_Specific_Render_Passes](#_implementing_specific_render_passes)
- [Command Generation and Execution](#_command_generation_and_execution)
- [Command_Generation_and_Execution](#_command_generation_and_execution)
...
public:
    ...
    void CullScene(const std::vector& allEntities) {
    ...
    const std::vector& GetVisibleEntities() const {
...
private:
    ...
    struct Pass {
        ...
        std::vector inputs;      // Resources this pass reads from (dependencies)
        std::vector outputs;     // Resources this pass writes to (products)
        std::function executeFunc;  // The actual rendering code
    };

    // Core data storage for the rendergraph system
    std::unordered_map resources;  // All resources referenced in the graph
    std::vector passes;                             // All rendering passes in definition order
    std::vector executionOrder;                   // Computed optimal execution sequence

    // Automatic synchronization management
    // These objects ensure correct GPU execution order without manual barriers
    std::vector semaphores;          // GPU synchronization primitives
    std::vector> semaphoreSignalWaitPairs;  // (signaling pass, waiting pass)
...
Now we implement the core algorithmic logic that analyzes pass dependencies and computes an optimal execution order for the rendering pipeline.
    ...
    void Compile() {
        ...
        std::vector> dependencies(passes.size());  // What each pass depends on
        std::vector> dependents(passes.size());    // What depends on each pass

        // Track which pass produces each resource (write-after-write dependencies)
        std::unordered_map resourceWriters;

        // Dependency Discovery Through Resource Usage Analysis
        // Analyze each pass to determine data flow relationships
        for (size_t i = 0; i second);      // This pass depends on the producer
        ...
        std::vector visited(passes.size(), false);       // Track completed nodes
        std::vector inStack(passes.size(), false);       // Track current recursion path

        std::function visit = [&](size_t node) {
            if (inStack[node]) {
...
Next create the GPU synchronization objects needed for correct execution ordering and allocate the actual Vulkan resources for all registered resources.
        ...
        for (size_t i = 0; i second : nullptr;
    }
...
Finally, implement the execution engine that coordinates pass execution with proper synchronization and resource transitions.
    ...
    void Execute(vk::raii::CommandBuffer& commandBuffer, vk::Queue queue) {
        ...
        std::vector cmdBuffers;           // Command buffer storage
        std::vector waitSemaphores;           // Synchronization dependencies for current pass
        std::vector waitStages;      // Pipeline stages to wait on
        std::vector signalSemaphores;         // Semaphores to signal after current pass
        ...
        for (auto passIdx : executionOrder) {
            ...
            for (size_t i = 0; i (waitSemaphores.size()))      // Dependencies to wait for
                      ...
                      .setSignalSemaphoreCount(static_cast(signalSemaphores.size()))  // Semaphores to signal
...
* 
[Synchronization](../../03_Drawing_a_triangle/03_Drawing/02_Rendering_and_presentation.html)

* 
[Frames In Flight](../../03_Drawing_a_triangle/03_Drawing/03_Frames_in_flight.html)

* 
[Compute Shader](../../11_Compute_Shader.html)

* 
[Multithreading](../../17_Multithreading.html)
...
private:
    std::unordered_map> renderPasses;
    std::vector sortedPasses;
    bool dirty = true;

public:
    template
    T* AddRenderPass(const std::string& name, Args&&... args) {
        static_assert(std::is_base_of::value, "T must derive from RenderPass");
        ...
        auto pass = std::make_unique(std::forward(args)...);
        T* passPtr = pass.get();
...
private:
    ...
    void TopologicalSort(const std::string& name,
                         const std::unordered_map& passMap,
                         std::unordered_set& visited,
                         std::unordered_set& visiting) {
...
private:
    void SetupRenderPasses() {
        ...
        auto geometryPass = renderPassManager.AddRenderPass("GeometryPass", &cullingSystem);

        // Create lighting pass
        auto lightingPass = renderPassManager.AddRenderPass("LightingPass", geometryPass);

        // Create post-process pass
        auto postProcessPass = renderPassManager.AddRenderPass("PostProcessPass", lightingPass);
