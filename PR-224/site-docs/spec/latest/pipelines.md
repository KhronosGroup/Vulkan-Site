...
- [Vertex_Input_State](#pipelines-graphics-subsets-vertex-input)
- [Pre-Rasterization Shader State](#pipelines-graphics-subsets-pre-rasterization)
- [Pre-Rasterization_Shader_State](#pipelines-graphics-subsets-pre-rasterization)
- [Fragment Shader State](#pipelines-graphics-subsets-fragment-shader)
- [Fragment_Shader_State](#pipelines-graphics-subsets-fragment-shader)
- [Fragment Output State](#pipelines-graphics-subsets-fragment-output)
- [Fragment_Output_State](#pipelines-graphics-subsets-fragment-output)
- [Dynamic State](#pipelines-graphics-subsets-dynamic-state)
- [Complete Graphics Pipelines](#pipelines-graphics-subsets-complete)
- [Complete_Graphics_Pipelines](#pipelines-graphics-subsets-complete)
- [Graphics Pipeline Library Layouts](#_graphics_pipeline_library_layouts)
- [Graphics_Pipeline_Library_Layouts](#_graphics_pipeline_library_layouts)
...
[](#VUID-VkPipelineCreateFlags2CreateInfo-flags-parameter) VUID-VkPipelineCreateFlags2CreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineCreateFlagBits2](#VkPipelineCreateFlagBits2) values
...
// Provided by VK_EXT_legacy_dithering with (VK_KHR_dynamic_rendering or VK_VERSION_1_3) and (VK_VERSION_1_4 or VK_KHR_extended_flags or VK_KHR_maintenance5)
...
// Provided by VK_KHR_extended_flags with VK_NV_ray_tracing, VK_KHR_maintenance5 with VK_NV_ray_tracing
static const VkPipelineCreateFlagBits2 VK_PIPELINE_CREATE_2_DEFER_COMPILE_BIT_NV = 0x00000020ULL;
// Provided by VK_KHR_extended_flags with VK_KHR_pipeline_executable_properties, VK_KHR_maintenance5 with VK_KHR_pipeline_executable_properties
...
// Provided by VK_KHR_extended_flags with VK_VERSION_1_3 or VK_EXT_pipeline_creation_cache_control, VK_KHR_maintenance5 with VK_VERSION_1_3 or VK_EXT_pipeline_creation_cache_control
...
// Provided by VK_KHR_extended_flags with VK_EXT_graphics_pipeline_library, VK_KHR_maintenance5 with VK_EXT_graphics_pipeline_library
...
// Provided by VK_KHR_extended_flags with VK_KHR_pipeline_library, VK_KHR_maintenance5 with VK_KHR_pipeline_library
...
// Provided by VK_KHR_extended_flags with VK_NV_device_generated_commands, VK_KHR_maintenance5 with VK_NV_device_generated_commands
static const VkPipelineCreateFlagBits2 VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV = 0x00040000ULL;
// Provided by VK_KHR_extended_flags with VK_NV_ray_tracing_motion_blur, VK_KHR_maintenance5 with VK_NV_ray_tracing_motion_blur
static const VkPipelineCreateFlagBits2 VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NV = 0x00100000ULL;
// Provided by VK_KHR_extended_flags with (VK_KHR_dynamic_rendering or VK_VERSION_1_3) and VK_KHR_fragment_shading_rate, VK_KHR_maintenance5 with (VK_KHR_dynamic_rendering or VK_VERSION_1_3) and VK_KHR_fragment_shading_rate
...
// Provided by VK_KHR_extended_flags with (VK_KHR_dynamic_rendering or VK_VERSION_1_3) and VK_EXT_fragment_density_map, VK_KHR_maintenance5 with (VK_KHR_dynamic_rendering or VK_VERSION_1_3) and VK_EXT_fragment_density_map
...
// Provided by VK_KHR_extended_flags with VK_EXT_attachment_feedback_loop_layout, VK_KHR_maintenance5 with VK_EXT_attachment_feedback_loop_layout
...
// Provided by VK_KHR_extended_flags with VK_NV_displacement_micromap, VK_KHR_maintenance5 with VK_NV_displacement_micromap
#ifdef VK_ENABLE_BETA_EXTENSIONS
...
// Provided by VK_KHR_extended_flags with VK_ARM_pipeline_opacity_micromap, VK_KHR_maintenance5 with VK_ARM_pipeline_opacity_micromap, VK_ARM_pipeline_opacity_micromap
...
// Provided by VK_KHR_opacity_micromap with VK_VERSION_1_4 or VK_KHR_extended_flags or VK_KHR_maintenance5
...
pipeline will be used with [descriptor buffers](descriptorbuffers.html#descriptorbuffers),
rather than [descriptor sets](descriptors.html#descriptors).
...
* 
[VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits2KHR)
...
This flag has no effect on using opacity micromaps with ray queries.
...
* 
[VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR](#VkPipelineCreateFlagBits2KHR)
specifies that the pipeline **cannot** be used with acceleration structures
which are built with geometry that have an index buffer including both
special indices and indices pointing to an associated micromap array.
...
* 
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits) specifies
...
`flags` **must** not include
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits)

* 
[](#VUID-VkComputePipelineCreateInfo-flags-11593) VUID-VkComputePipelineCreateInfo-flags-11593
...
* 
[](#VUID-VkComputePipelineCreateInfo-layout-12396) VUID-VkComputePipelineCreateInfo-layout-12396

If `layout` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), it **must** not have been
created with [VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT](descriptorsets.html#VkPipelineLayoutCreateFlagBits)
...
* 
[](#VUID-VkPipelineShaderStageCreateInfo-pNext-12454) VUID-VkPipelineShaderStageCreateInfo-pNext-12454
...
[](#VUID-VkPipelineShaderStageCreateInfo-flags-parameter) VUID-VkPipelineShaderStageCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineShaderStageCreateFlagBits](#VkPipelineShaderStageCreateFlagBits) values
...
[required subgroup size](shaders.html#shaders-required-subgroup-size) is specified,
...
[](#VUID-vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI-pMaxWorkgroupSize-parameter) VUID-vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI-pMaxWorkgroupSize-parameter
 ...
 `pMaxWorkgroupSize` **must** be a valid pointer to a [VkExtent2D](fundamentals.html#VkExtent2D) structure
...
Resources bound as [VK_DESCRIPTOR_TYPE_MUTABLE_EXT](descriptors.html#VkDescriptorType) will have the
...
* 
The format parameters of [VkPipelineRenderingCreateInfo](#VkPipelineRenderingCreateInfo)
(`viewMask` is ignored)
...
If the pipeline requires [    fragment output interface state](#pipelines-graphics-subsets-fragment-output),
the [    `multisampledRenderToSingleSampled`](features.html#features-multisampledRenderToSingleSampled) feature is not enabled,
the `[VK_AMD_mixed_attachment_samples](../appendices/extensions.html#VK_AMD_mixed_attachment_samples)` extension is not enabled,
the `[VK_NV_framebuffer_mixed_samples](../appendices/extensions.html#VK_NV_framebuffer_mixed_samples)` extension is not enabled,
`rasterizationSamples` is not dynamic, and `subpass` uses color
...
[    `multisampledRenderToSingleSampled`](features.html#features-multisampledRenderToSingleSampled) feature is not enabled,
`rasterizationSamples` is not dynamic, and `subpass` has a
[VkMultisampledRenderToSingleSampledInfoEXT](renderpass.html#VkMultisampledRenderToSingleSampledInfoEXT) structure included in
the [VkSubpassDescription2](renderpass.html#VkSubpassDescription2)::`pNext` chain with
...
* 
[](#VUID-VkGraphicsPipelineCreateInfo-pNext-12427) VUID-VkGraphicsPipelineCreateInfo-pNext-12427

If [VkPipelineRenderingCreateInfo](#VkPipelineRenderingCreateInfo) is included in the `pNext`
chain, then `renderPass` **must** be [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE)
...
the pipeline requires [    pre-rasterization shader state](#pipelines-graphics-subsets-pre-rasterization) or
[fragment shader state](#pipelines-graphics-subsets-fragment-shader),
and `renderPass` is [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE),
...
If the pipeline requires [    pre-rasterization shader state](#pipelines-graphics-subsets-pre-rasterization) or
[fragment shader state](#pipelines-graphics-subsets-fragment-shader),
and `renderPass` is [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the index of the most
significant bit in [VkPipelineRenderingCreateInfo](#VkPipelineRenderingCreateInfo)::`viewMask`
**must** be less than [    `maxMultiviewViewCount`](devsandqueues.html#limits-maxMultiviewViewCount)
...
If `renderPass` is [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the `attachmentCount`
member of `pColorBlendState` is not ignored, and the pipeline is
being created with [    fragment output interface state](#pipelines-graphics-subsets-fragment-output),
...
[VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT](#VkGraphicsPipelineLibraryFlagBitsEXT) or
[VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT](#VkGraphicsPipelineLibraryFlagBitsEXT), and the
other element is included in
[VkPipelineLibraryCreateInfoKHR](#VkPipelineLibraryCreateInfoKHR)::`pLibraries`, and
`renderPass` is [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the value of
...
If [VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT](#VkGraphicsPipelineLibraryFlagBitsEXT)
and [VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT](#VkGraphicsPipelineLibraryFlagBitsEXT) are
included in two elements of
[VkPipelineLibraryCreateInfoKHR](#VkPipelineLibraryCreateInfoKHR)::`pLibraries`, and
`renderPass` was [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE) for both libraries, the value
of [VkPipelineRenderingCreateInfo](#VkPipelineRenderingCreateInfo)::`viewMask` set by each
...
* 
[](#VUID-VkGraphicsPipelineCreateInfo-pLibraries-11594) VUID-VkGraphicsPipelineCreateInfo-pLibraries-11594

If `flags` includes
[VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR](#VkPipelineCreateFlagBits2KHR),
each element of [VkPipelineLibraryCreateInfoKHR](#VkPipelineLibraryCreateInfoKHR)::`pLibraries`
**must** have been created with the
[VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR](#VkPipelineCreateFlagBits2KHR)
bit set

* 
[](#VUID-VkGraphicsPipelineCreateInfo-flags-11595) VUID-VkGraphicsPipelineCreateInfo-flags-11595
...
* 
[](#VUID-VkRayTracingPipelineCreateInfoKHR-layout-12402) VUID-VkRayTracingPipelineCreateInfoKHR-layout-12402
...
* 
[](#VUID-VkRayTracingPipelineCreateInfoKHR-flags-11597) VUID-VkRayTracingPipelineCreateInfoKHR-flags-11597

If `flags` includes
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits), at least
...
[](#VUID-VkRayTracingPipelineCreateInfoKHR-pLibraries-11598) VUID-VkRayTracingPipelineCreateInfoKHR-pLibraries-11598

If `flags` includes
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits), each
element of `pLibraryInfo->pLibraries` **must** have been created with
the [VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits) bit
set

[](#VUID-VkRayTracingPipelineCreateInfoKHR-flags-11599) VUID-VkRayTracingPipelineCreateInfoKHR-flags-11599
...
include both
[VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](#VkPipelineCreateFlagBits2KHR) and
...
* 
[](#VUID-VkRayTracingPipelineCreateInfoNV-layout-12402) VUID-VkRayTracingPipelineCreateInfoNV-layout-12402
...
* 
[](#VUID-VkRayTracingPipelineCreateInfoNV-flags-11596) VUID-VkRayTracingPipelineCreateInfoNV-flags-11596

`flags` **must** not include any of the following bits
...
`firstGroup`, with subsequent handles corresponding to consecutive
shader groups in the order they appear in the
[VkRayTracingPipelineCreateInfoKHR](#VkRayTracingPipelineCreateInfoKHR)::`pGroups` array.
...
[](#VUID-VkPipelineCacheCreateInfo-flags-parameter) VUID-VkPipelineCacheCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineCacheCreateFlagBits](#VkPipelineCacheCreateFlagBits) values
...
* 
[](#VUID-VkPipelineBinaryKeyKHR-key-parameter) VUID-VkPipelineBinaryKeyKHR-key-parameter

 Each element of `key` **must** be a valid pointer to an array of `keySize` `uint8_t` values

* 
[](#VUID-VkPipelineBinaryKeyKHR-keySize-arraylength) VUID-VkPipelineBinaryKeyKHR-keySize-arraylength

 `keySize` **must** be greater than `0`
