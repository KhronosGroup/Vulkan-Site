...
[](#VUID-VkOpticalFlowSessionCreateInfoNV-hintGridSize-parameter) VUID-VkOpticalFlowSessionCreateInfoNV-hintGridSize-parameter
 ...
 If `hintGridSize` is not `0`, `hintGridSize` **must** be a valid combination of [VkOpticalFlowGridSizeFlagBitsNV](#VkOpticalFlowGridSizeFlagBitsNV) values
...
[](#VUID-VkOpticalFlowSessionCreateInfoNV-flags-parameter) VUID-VkOpticalFlowSessionCreateInfoNV-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkOpticalFlowSessionCreateFlagBitsNV](#VkOpticalFlowSessionCreateFlagBitsNV) values
...
[](#VUID-VkOpticalFlowExecuteInfoNV-flags-parameter) VUID-VkOpticalFlowExecuteInfoNV-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkOpticalFlowExecuteFlagBitsNV](#VkOpticalFlowExecuteFlagBitsNV) values
