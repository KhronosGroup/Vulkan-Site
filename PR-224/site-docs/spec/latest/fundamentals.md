...
A valid combination is the bitwise OR of valid bit flags.
...
Unless otherwise noted, if an implementation encounters conflicting
conditions such that both a runtime error and a status success code such as
[VK_INCOMPLETE](#VkResult) would be returned, reporting of the runtime error
