...
- [Elapsed Timer Queries](#queries-elapsed-timer)
- [Elapsed_Timer_Queries](#queries-elapsed-timer)
...
- [Per Picture Partition Feedback](#queries-video-encode-per-partition-feedback)
- [Per_Picture_Partition_Feedback](#queries-video-encode-per-partition-feedback)
...
* 
[](#VUID-VkQueryPoolCreateInfo-queryType-12416) VUID-VkQueryPoolCreateInfo-queryType-12416

If the [elapsedTimerQuery](features.html#features-elapsedTimerQuery) feature is not
enabled, `queryType` **must** not be
[VK_QUERY_TYPE_TIME_ELAPSED_QCOM](#VkQueryType)
...
* 
[](#VUID-VkQueryPoolCreateInfo-queryType-12437) VUID-VkQueryPoolCreateInfo-queryType-12437

If `queryType` is [VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR](#VkQueryType) and
the `pNext` chain includes a
[VkQueryPoolVideoEncodeFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodeFeedbackCreateInfoKHR) structure with its
`encodeFeedbackFlags` member containing
[VK_VIDEO_ENCODE_FEEDBACK_AVERAGE_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_MIN_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_MAX_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR), or
[VK_VIDEO_ENCODE_FEEDBACK_PICTURE_PARTITION_COUNT_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR), then
[`videoEncodeFeedback2`](features.html#features-videoEncodeFeedback2) **must** be
enabled

* 
[](#VUID-VkQueryPoolCreateInfo-queryType-12438) VUID-VkQueryPoolCreateInfo-queryType-12438

If `queryType` is [VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR](#VkQueryType) and
the `pNext` chain includes a
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR) structure
with a non-zero `maxPerPartitionFeedbackEntries` member, then
[`videoEncodeFeedback2`](features.html#features-videoEncodeFeedback2) **must** be
enabled

* 
[](#VUID-VkQueryPoolCreateInfo-queryType-12439) VUID-VkQueryPoolCreateInfo-queryType-12439

If `queryType` is [VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR](#VkQueryType) and
the `pNext` chain includes a
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR) structure
with a non-zero `maxPerPartitionFeedbackEntries` member, then
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR)::`perPartitionEncodeFeedbackFlags`
**must** not be zero

* 
[](#VUID-VkQueryPoolCreateInfo-queryType-12440) VUID-VkQueryPoolCreateInfo-queryType-12440

If `queryType` is [VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR](#VkQueryType) and
the `pNext` chain includes a
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR) structure,
then its `maxPerPartitionFeedbackEntries` **must** be less than or
equal to
[VkVideoEncodeFeedback2CapabilitiesKHR](videocoding.html#VkVideoEncodeFeedback2CapabilitiesKHR)::`maxPerPartitionFeedbackEntries`,
as returned by [vkGetPhysicalDeviceVideoCapabilitiesKHR](videocoding.html#vkGetPhysicalDeviceVideoCapabilitiesKHR) for the
[video profile](videocoding.html#video-profiles) described by
[VkVideoProfileInfoKHR](videocoding.html#VkVideoProfileInfoKHR) and its `pNext` chain

* 
[](#VUID-VkQueryPoolCreateInfo-queryType-12441) VUID-VkQueryPoolCreateInfo-queryType-12441

If `queryType` is [VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR](#VkQueryType) and
the `pNext` chain includes a
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR) structure,
then its `perPartitionEncodeFeedbackFlags` **must** not contain any
bits that are not set in
[VkVideoEncodeFeedback2CapabilitiesKHR](videocoding.html#VkVideoEncodeFeedback2CapabilitiesKHR)::`supportedPerPartitionEncodeFeedbackFlags`,
as returned by [vkGetPhysicalDeviceVideoCapabilitiesKHR](videocoding.html#vkGetPhysicalDeviceVideoCapabilitiesKHR) for the
[video profile](videocoding.html#video-profiles) described by
[VkVideoProfileInfoKHR](videocoding.html#VkVideoProfileInfoKHR) and its `pNext` chain
...
[](#VUID-VkQueryPoolCreateInfo-flags-parameter) VUID-VkQueryPoolCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkQueryPoolCreateFlagBits](#VkQueryPoolCreateFlagBits) values
...
* 
[VK_QUERY_TYPE_TIME_ELAPSED_QCOM](#VkQueryType) specifies an
[elapsed timer query](#queries-elapsed-timer).

* 
[VK_QUERY_TYPE_MICROMAP_SERIALIZATION_SIZE_EXT](#VkQueryType) specifies a micromap
query to get the size required by a serialized micromap.

* 
[VK_QUERY_TYPE_MICROMAP_COMPACTED_SIZE_EXT](#VkQueryType) specifies a micromap
query to get the size required by a compacted micromap.
...
[vkCmdWriteMicromapsPropertiesEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdWriteMicromapsPropertiesEXT),
...
occlusion queries count drawn samples,
elapsed timer queries count elapsed time
...
For a secondary command buffer to be executed while an occlusion query or
pipeline statistics query is active, it **must** set the
`occlusionQueryEnable`, `queryFlags`, and/or
...
If the `queryType` of the pool is [VK_QUERY_TYPE_TIME_ELAPSED_QCOM](#VkQueryType),
this command also defines an execution dependency on commands that were
submitted before it, and starting the timer.

The first synchronization scope includes all commands that occur earlier in
submission order.
...
* 
[](#VUID-vkCmdBeginQuery-queryType-08972) VUID-vkCmdBeginQuery-queryType-08972

The `queryType` used to create `queryPool` **must** not be
[VK_QUERY_TYPE_MICROMAP_SERIALIZATION_SIZE_EXT](#VkQueryType), or
[VK_QUERY_TYPE_MICROMAP_COMPACTED_SIZE_EXT](#VkQueryType)
...
* 
[](#VUID-vkCmdBeginQuery-queryType-12423) VUID-vkCmdBeginQuery-queryType-12423

If the `queryType` used to create `queryPool` was
[VK_QUERY_TYPE_TIME_ELAPSED_QCOM](#VkQueryType), the command pool’s queue family
**must** support a non-zero `timestampValidBits`
...
[](#VUID-vkCmdBeginQuery-flags-parameter) VUID-vkCmdBeginQuery-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkQueryControlFlagBits](#VkQueryControlFlagBits) values
...
* 
[](#VUID-vkCmdBeginQueryIndexedEXT-queryType-08972) VUID-vkCmdBeginQueryIndexedEXT-queryType-08972
...
* 
[](#VUID-vkCmdBeginQueryIndexedEXT-queryType-12423) VUID-vkCmdBeginQueryIndexedEXT-queryType-12423
...
If the `queryType` of the pool is [VK_QUERY_TYPE_TIME_ELAPSED_QCOM](#VkQueryType),
this command also defines an execution dependency on commands that were
submitted before it, and ending the timer.

The first synchronization scope includes all commands that occur earlier in
submission order.

The second synchronization scope includes only the ending of the timer.
...
* 
Elapsed timer queries write one integer value - the elapsed time
between `vkCmdBeginQuery` and `vkCmdEndQuery`.
...
Depending on the query type, additional results are written for each
query in a tightly packed array of result values as follows:

* 
If [per picture partition     feedback](#queries-video-encode-per-partition-feedback) is requested, video encode feedback queries write one or
more integer values after the primary query results for each encoded
picture partition for each bit that is enabled in
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR)::`perPartitionEncodeFeedbackFlags`
when the pool is created.
The feedback values are written in picture-partition-major order and,
for each encoded picture partition but at most for
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR)::`maxPerPartitionFeedbackEntries`
number of picture partitions, in bit order starting from the least
significant bit.

|  | Per picture partition feedback values follow all primary query results,
| --- | --- |
including the availability or result status written as the final element of
the primary query results in response to
[VK_QUERY_RESULT_WITH_AVAILABILITY_BIT](#VkQueryResultFlagBits) or
[VK_QUERY_RESULT_WITH_STATUS_BIT_KHR](#VkQueryResultFlagBits), respectively.
Implementations will never write more per picture partition results than the
`maxPerPartitionFeedbackEntries` requested when the query pool was
created. |
...
* 
[](#VUID-vkGetQueryPoolResults-queryType-12424) VUID-vkGetQueryPoolResults-queryType-12424

    If the `queryType` used to create `queryPool` was
    [VK_QUERY_TYPE_TIME_ELAPSED_QCOM](#VkQueryType), `flags` **must** not contain
    [VK_QUERY_RESULT_PARTIAL_BIT](#VkQueryResultFlagBits)
or [VK_QUERY_RESULT_WITH_STATUS_BIT_KHR](#VkQueryResultFlagBits)
...
[](#VUID-vkGetQueryPoolResults-flags-parameter) VUID-vkGetQueryPoolResults-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkQueryResultFlagBits](#VkQueryResultFlagBits) values
...
* 
[](#VUID-vkCmdCopyQueryPoolResultsToMemoryKHR-queryType-12424) VUID-vkCmdCopyQueryPoolResultsToMemoryKHR-queryType-12424
...
[](#VUID-vkCmdCopyQueryPoolResultsToMemoryKHR-dstFlags-parameter) VUID-vkCmdCopyQueryPoolResultsToMemoryKHR-dstFlags-parameter
 ...
 If `dstFlags` is not `0`, `dstFlags` **must** be a valid combination of [VkAddressCommandFlagBitsKHR](fundamentals.html#VkAddressCommandFlagBitsKHR) values
...
[](#VUID-vkCmdCopyQueryPoolResultsToMemoryKHR-queryResultFlags-parameter) VUID-vkCmdCopyQueryPoolResultsToMemoryKHR-queryResultFlags-parameter
 ...
 If `queryResultFlags` is not `0`, `queryResultFlags` **must** be a valid combination of [VkQueryResultFlagBits](#VkQueryResultFlagBits) values
...
* 
[](#VUID-vkCmdCopyQueryPoolResults-queryType-12424) VUID-vkCmdCopyQueryPoolResults-queryType-12424
...
Elapsed timer queries **must** count the device execution time for all
operations performed between the start and end of the query.
...
Some implementations **may** track the number of samples that pass the
per-fragment tests multiplied for each color output.
Such implementation **may** produce inconsistent values if more than one color
output is written in the fragment shader.
...
volume, and either the primitive is not rasterized according to the
[Basic Polygon Rasterization](primsrast.html#primsrast-polygons-basic) rules, or at
least one sample point for a fragment lies within the rasterized
triangle according to those rules, the counter is incremented by one or
more.
...
* 
[](#VUID-vkCmdWriteTimestamp2-stage-11541) VUID-vkCmdWriteTimestamp2-stage-11541
...
[](#VUID-vkCmdWriteTimestamp2-stage-parameter) VUID-vkCmdWriteTimestamp2-stage-parameter
 ...
 If `stage` is not `0`, `stage` **must** be a valid combination of [VkPipelineStageFlagBits2](synchronization.html#VkPipelineStageFlagBits2) values
...
Elapsed timer queries provide a mechanism to query the elapsed time between
a [vkCmdBeginQuery](#vkCmdBeginQuery) and a [vkCmdEndQuery](#vkCmdEndQuery) command.
The time calculated is generated by the `VkPhysicalDevice`, and **can** be
read from the host (using [vkGetQueryPoolResults](#vkGetQueryPoolResults)) or copied to a
`VkBuffer` (using [vkCmdCopyQueryPoolResults](#vkCmdCopyQueryPoolResults)).

The implementation uses timestamps to calculate the elapsed time, therefore
these queries are supported on any queue which reports a non-zero value for
`timestampValidBits` via [vkGetPhysicalDeviceQueueFamilyProperties](devsandqueues.html#vkGetPhysicalDeviceQueueFamilyProperties).
If the [`timestampComputeAndGraphics`](limits.html#limits-timestampComputeAndGraphics) limit is [VK_TRUE](fundamentals.html#VK_TRUE), elapsed timer
queries are supported by every queue family that supports either graphics or
compute operations (see [VkQueueFamilyProperties](devsandqueues.html#VkQueueFamilyProperties)).

If
`[VK_KHR_calibrated_timestamps](../appendices/extensions.html#VK_KHR_calibrated_timestamps)`
or
`[VK_EXT_calibrated_timestamps](../appendices/extensions.html#VK_EXT_calibrated_timestamps)`
is enabled, the timestamps used by the start and end commands **must** be in
the
[VK_TIME_DOMAIN_DEVICE_KHR](synchronization.html#VkTimeDomainEXT)
[time domain](synchronization.html#VkTimeDomainKHR).

The number of valid bits when measuring the start and stop times is
determined by the `VkQueueFamilyProperties`::`timestampValidBits`
property of the queue on which the query is recorded.

However, the implementation **may** internally use scratch memory of a size
other than `timestampValidBits` to perform the elapsed time calculation.
The scratch memory **should** use enough bits to make overflows unlikely to
happen.
If an overflow occurs while measuring the elapsed time, the resulting value
is **undefined**.

If an overflow does not occur, the implementation **must** not produce a result
from a calculation using timestamps where the start time is greater than the
stop time.
The start time **must** be recorded by the device with a time that is less than
or equal to the stop time.

The result is given in timestamp units which the application **can** convert to
nanoseconds by multiplying it with the
...
the [VkQueryPoolVideoEncodeFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodeFeedbackCreateInfoKHR) structure included in
the `pNext` chain of [VkQueryPoolCreateInfo](#VkQueryPoolCreateInfo).
...
* 
[VK_VIDEO_ENCODE_FEEDBACK_AVERAGE_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies
that queries managed by the pool will capture the average quantization
used across the encoded coding blocks.

* 
[VK_VIDEO_ENCODE_FEEDBACK_MIN_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies that
queries managed by the pool will capture the minimum quantization used
across the encoded coding blocks.

* 
[VK_VIDEO_ENCODE_FEEDBACK_MAX_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies that
queries managed by the pool will capture the maximum quantization used
across the encoded coding blocks.

* 
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies that
...
* 
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies that
queries managed by the pool will capture the number of pixels encoded as
inter blocks, including or excluding any skipped blocks, as described
below.

* 
[VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies that
queries managed by the pool will capture the number of pixels encoded as
skipped blocks.

* 
[VK_VIDEO_ENCODE_FEEDBACK_PICTURE_PARTITION_COUNT_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) specifies
...
[VK_VIDEO_ENCODE_FEEDBACK_AVERAGE_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_MIN_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR), and/or
[VK_VIDEO_ENCODE_FEEDBACK_MAX_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) are specified,
respectively, depend on the used video profile:

* 
In case of [H.264 encode profiles](videocoding.html#encode-h264-profile), this value is
a signed integer indicating the average, minimum, or maximum QP used
across the encoded coding blocks, respectively.

* 
In case of [H.265 encode profiles](videocoding.html#encode-h265-profile) this value is a
signed integer indicating the average, minimum, or maximum QP used
across the encoded coding blocks, respectively.

* 
In case of [AV1 encode profiles](videocoding.html#encode-av1-profile) this value is an
...
[VK_VIDEO_ENCODE_FEEDBACK_AVERAGE_QUANTIZATION_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) is specified is
**undefined**.

The number of pixels captured when
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR),
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR), and/or
[VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) are specified include
padding pixels beyond the requested coded extent that are part of the
complete coding blocks encoded for the picture.

If [VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) is not supported
for a video encode profile, then the results captured for
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) and
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) will always include
...
* 
In case of [H.264 encode profiles](videocoding.html#encode-h264-profile), skipped blocks
...
* 
In case of [H.265 encode profiles](videocoding.html#encode-h265-profile), skipped blocks
are always inter blocks and the results captured for
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) will always include
pixels encoded as skipped blocks.
...
* 
In case of [AV1 encode profiles](videocoding.html#encode-av1-profile), both inter and
...
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) and
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR), respectively, if
possible.
However, some implementations **may** not be able to do so if they do not
differentiate between skipped intra and inter blocks.
Therefore, in case of [AV1 encode profiles](videocoding.html#encode-av1-profile) that do
support [VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR)
...
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) and
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR), respectively.
...
If [per picture partition feedback](#queries-video-encode-per-partition-feedback) is enabled, this is followed by the values corresponding to each
...
If the [`videoEncodeFeedback2`](features.html#features-videoEncodeFeedback2) feature
is enabled, video encode feedback queries also allow the application to
capture additional feedback values for each picture partition generated by
video encode operations.
The availability of individual per picture partition video encode feedback
values is indicated by the bits of
[VkVideoEncodeFeedback2CapabilitiesKHR](videocoding.html#VkVideoEncodeFeedback2CapabilitiesKHR)::`supportedPerPartitionEncodeFeedbackFlags`,
as returned by [vkGetPhysicalDeviceVideoCapabilitiesKHR](videocoding.html#vkGetPhysicalDeviceVideoCapabilitiesKHR) for the
[video profile](videocoding.html#video-profiles) the queries are intended to be used with.

The set of enabled per picture partition video encode feedback values **must**
be configured on the query pool at the time of its creation by using the
`perPartitionEncodeFeedbackFlags` member of the
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR) structure
included in the `pNext` chain of [VkQueryPoolCreateInfo](#VkQueryPoolCreateInfo).
...
[VkVideoEncodePerPartitionFeedbackFlagBitsKHR](#VkVideoEncodePerPartitionFeedbackFlagBitsKHR) values specifying the
...
[](#VUID-VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR-sType-sType) VUID-VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_QUERY_POOL_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_CREATE_INFO_KHR](fundamentals.html#VkStructureType)
...
[](#VUID-VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR-perPartitionEncodeFeedbackFlags-parameter) VUID-VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR-perPartitionEncodeFeedbackFlags-parameter
 ...
 If `perPartitionEncodeFeedbackFlags` is not `0`, `perPartitionEncodeFeedbackFlags` **must** be a valid combination of [VkVideoEncodePerPartitionFeedbackFlagBitsKHR](#VkVideoEncodePerPartitionFeedbackFlagBitsKHR) values
...
* 
[VK_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_STATUS_BIT_KHR](#VkVideoEncodePerPartitionFeedbackFlagBitsKHR) specifies
that queries managed by the pool will capture the result status of each
encoded picture partition.
These result status values are reported as [VkQueryResultStatusKHR](#VkQueryResultStatusKHR)
values, similar to [result status queries](#queries-result-status-only)
...
* 
[VK_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_BITSTREAM_BUFFER_OFFSET_BIT_KHR](#VkVideoEncodePerPartitionFeedbackFlagBitsKHR)
...
[VkVideoEncodeInfoKHR](videocoding.html#VkVideoEncodeInfoKHR)::`dstBuffer` relative to the offset
specified in [VkVideoEncodeInfoKHR](videocoding.html#VkVideoEncodeInfoKHR)::`dstBufferOffset`.

* 
[VK_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_BITSTREAM_BYTES_WRITTEN_BIT_KHR](#VkVideoEncodePerPartitionFeedbackFlagBitsKHR)
...
[VkVideoEncodeInfoKHR](videocoding.html#VkVideoEncodeInfoKHR)::`dstBuffer`.
...
| --- | --- |
the [VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_BUFFER_OFFSET_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) and
[VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_BYTES_WRITTEN_BIT_KHR](#VkVideoEncodeFeedbackFlagBitsKHR) feedback
...
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](#VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR) structure the
...
status of
[VK_QUERY_RESULT_STATUS_INSUFFICIENT_BITSTREAM_BUFFER_RANGE_KHR](#VkQueryResultStatusKHR) for the
...
`VkVideoEncodePerPartitionFeedbackFlagsKHR` is a bitmask type for
setting a mask of zero or more
[VkVideoEncodePerPartitionFeedbackFlagBitsKHR](#VkVideoEncodePerPartitionFeedbackFlagBitsKHR).
