...
If [VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE) is included in the
`pNext` chain, and a sparse buffer is being created, the alignment for
buffer device addresses **can** be controlled.
For non-sparse buffers, alignment requirements are specified at device
memory allocation time in [vkAllocateMemory](memory.html#vkAllocateMemory) instead.
For implementations which allocate buffer device addresses regardless at
buffer create time, the implementation is expected to allocate buffer device
addresses with alignment equal to
[`maxBufferDeviceAddressAllocationAlignment`](limits.html#limits-maxBufferDeviceAddressAllocationAlignment),
effectively ignoring any application-requested alignment.
...
[](#VUID-VkBufferCreateInfo-flags-12515) VUID-VkBufferCreateInfo-flags-12515

If `flags` does not include
[VK_BUFFER_CREATE_SPARSE_BINDING_BIT](#VkBufferCreateFlagBits),
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE)::`alignment`
**must** be 0

[](#VUID-VkBufferCreateInfo-alignment-12516) VUID-VkBufferCreateInfo-alignment-12516

If
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE)::`alignment`
is not 0, the [effective usage    flags](#resources-effective-buffer-usage) **must** include [VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT](#VkBufferUsageFlagBits2KHR)

[](#VUID-VkBufferCreateInfo-alignment-12517) VUID-VkBufferCreateInfo-alignment-12517
...
[](#VUID-VkBufferCreateInfo-flags-parameter) VUID-VkBufferCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBufferCreateFlagBits](#VkBufferCreateFlagBits) values
...
[](#VUID-VkExternalMemoryBufferCreateInfo-handleTypes-parameter) VUID-VkExternalMemoryBufferCreateInfo-handleTypes-parameter
 ...
 If `handleTypes` is not `0`, `handleTypes` **must** be a valid combination of [VkExternalMemoryHandleTypeFlagBits](capabilities.html#VkExternalMemoryHandleTypeFlagBits) values
...
[VK_BUFFER_CREATE_SPARSE_BINDING_BIT](#VkBufferCreateFlagBits), the returned address of the
buffer minus [VkBindBufferMemoryInfo](#VkBindBufferMemoryInfo)::`memoryOffset` or equivalent
[vkBindBufferMemory](#vkBindBufferMemory) offset.
The required alignment is the maximum of the following values:

* 
The value of [VkMemoryRequirements](#VkMemoryRequirements)::`alignment` queried via
[vkGetBufferMemoryRequirements](#vkGetBufferMemoryRequirements) for `pInfo->buffer`

* 
[`minStorageBufferOffsetAlignment`](limits.html#limits-minStorageBufferOffsetAlignment)
if `pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT](#VkBufferUsageFlagBits2KHR)

* 
[`minUniformBufferOffsetAlignment`](limits.html#limits-minUniformBufferOffsetAlignment)
if `pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT](#VkBufferUsageFlagBits2KHR)

* 
[`minTexelBufferOffsetAlignment`](limits.html#limits-minTexelBufferOffsetAlignment)
if `pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT](#VkBufferUsageFlagBits2KHR) or
[VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT](#VkBufferUsageFlagBits2KHR)

* 
[`resourceHeapAlignment`](limits.html#limits-resourceHeapAlignment) if
`pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT](#VkBufferUsageFlagBits2KHR)

* 
[`samplerHeapAlignment`](limits.html#limits-samplerHeapAlignment) if
`pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT](#VkBufferUsageFlagBits2KHR)

* 
[`descriptorBufferOffsetAlignment`](limits.html#limits-descriptorBufferOffsetAlignment)
if `pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT](#VkBufferUsageFlagBits2KHR) or
[VK_BUFFER_USAGE_2_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT](#VkBufferUsageFlagBits2KHR)

* 
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE)::`alignment`
if `pInfo->buffer` was created without
[VK_BUFFER_CREATE_SPARSE_BINDING_BIT](#VkBufferCreateFlagBits) and the bound
[VkDeviceMemory](memory.html#VkDeviceMemory) was created with specified non-zero alignment of
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE)::`alignment`

* 
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE)::`alignment`
if `pInfo->buffer` was created with
[VK_BUFFER_CREATE_SPARSE_BINDING_BIT](#VkBufferCreateFlagBits), and the buffer was created
with non-zero
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](memory.html#VkBufferDeviceAddressAlignmentAllocateInfoVALVE)::`alignment`

* 
256, if `pInfo->buffer` was created with
[VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR](#VkBufferUsageFlagBits2KHR), and
`[VK_KHR_device_address_commands](../appendices/extensions.html#VK_KHR_device_address_commands)` is supported
...
`imageCreateFormatFeatures` is empty.
...
* 
[](#VUID-VkImageCreateInfo-pNext-12503) VUID-VkImageCreateInfo-pNext-12503

If the `pNext` chain includes a [VkExternalFormatANDROID](#VkExternalFormatANDROID)
structure with non-zero `externalFormat`, `usage` **must** not
include [VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM](#VkImageUsageFlagBits)
...
[](#VUID-VkImageCreateInfo-flags-parameter) VUID-VkImageCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkImageCreateFlagBits](#VkImageCreateFlagBits) values
...
[](#VUID-VkExternalMemoryImageCreateInfoNV-handleTypes-parameter) VUID-VkExternalMemoryImageCreateInfoNV-handleTypes-parameter
 ...
 If `handleTypes` is not `0`, `handleTypes` **must** be a valid combination of [VkExternalMemoryHandleTypeFlagBitsNV](memory.html#VkExternalMemoryHandleTypeFlagBitsNV) values
...
**can** be used as a weight image in [weight image    sampling operations](textures.html#textures-weightimage).
...
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](#VkImageCreateFlagBits), `format` **must** equal the
`format` used to create `image`.

If `image` was created with [VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](#VkImageCreateFlagBits),
`format` **can** be set to a different format as follows:

* 
If `image` was created with the
[VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT](#VkImageCreateFlagBits) flag and
`format` is an uncompressed format, it **must** be
[*size-compatible*](formats.html#formats-size-compatibility) with the `format`
used to create `image`.

* 
If creating a [single-plane view](#image-views-plane-view), `format`
**must** equal one of the [*plane view formats*](#image-views-plane-view).

* 
If creating a [multi-plane view](#image-views-multi-plane-view),
`format` **must** equal the `format` used to create `image`.

* 

Otherwise,
    `format` **must** be [compatible](formats.html#formats-compatibility-classes) with
    the `format` of `image`.
...
If `image` was created with the
[VK_IMAGE_CREATE_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT](#VkImageCreateFlagBits) flag and
`format` is an uncompressed format, the dimensions equal the
dimensions of the selected mip level divided by the compressed texel
block size and rounded up.

* 
If creating a [single-plane view](#image-views-plane-view), the
dimensions equal the [*plane view    dimensions*](#image-views-plane-view).

* 
Otherwise, the dimensions are equal to the dimensions of the selected
mip level as defined in [Image Mip    Level Sizing](#resources-image-mip-level-sizing)

If `subresourceRange.aspectMask` is one of the
[multi-planar aspect mask](formats.html#formats-multiplanar-image-aspect) bits, a
single-plane image view will be created.
The `image` of a single-plane view **must** have been created with a
[multi-planar format](formats.html#formats-multiplanar) and the
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](#VkImageCreateFlagBits) create flag.

The set of *plane view formats* for the plane is the
[compatible plane format](formats.html#formats-compatible-planes) and the formats
[compatible](formats.html#formats-compatibility-classes) with it.

The *plane view dimensions* are derived from the dimensions of the
`image` in the manner listed for [plane compatibility](formats.html#formats-compatible-planes) for the plane.

The plane view’s aspect mask is considered to be equivalent to
[VK_IMAGE_ASPECT_COLOR_BIT](#VkImageAspectFlagBits) when used as a framebuffer attachment.

If the `format` of the `image` is a
[multi-planar format](formats.html#formats-multiplanar) and
`subresourceRange.aspectMask` is equal to
[VK_IMAGE_ASPECT_COLOR_BIT](#VkImageAspectFlagBits), a multi-plane image view will be created.
...
Image views with [formats that require YCBCR conversion](formats.html#formats-requiring-sampler-ycbcr-conversion) and `usage` containing
[VK_IMAGE_USAGE_SAMPLED_BIT](#VkImageUsageFlagBits)
...
flag,
and a [single-plane view](#image-views-plane-view) and a
[multi-plane view](#image-views-multi-plane-view) is not being created,
...
If creating a [single-plane view](#image-views-plane-view), `format`
**must** be compatible with the [VkFormat](formats.html#VkFormat) for the plane of the
`image` `format` indicated by `subresourceRange.aspectMask`,
as defined in [Compatible Formats of Planes of Multi-Planar Formats](formats.html#formats-compatible-planes)
...
[](#VUID-VkImageViewCreateInfo-usage-12506) VUID-VkImageViewCreateInfo-usage-12506

If `usage` contains [VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM](#VkImageUsageFlagBits),
then the image view’s [format    features](#resources-image-view-format-features) **must** contain [VK_FORMAT_FEATURE_2_WEIGHT_IMAGE_BIT_QCOM](formats.html#VkFormatFeatureFlagBits2KHR)

[](#VUID-VkImageViewCreateInfo-usage-12507) VUID-VkImageViewCreateInfo-usage-12507

If `usage` contains
[VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM](#VkImageUsageFlagBits), then the image view’s
[format features](#resources-image-view-format-features) **must** contain
...
`subresourceRange.aspectMask` **must** [be    valid](#resources-valid-aspect-mask) for the `format` the `image` was created with
...
[](#VUID-VkImageViewCreateInfo-pNext-12508) VUID-VkImageViewCreateInfo-pNext-12508

The `pNext` chain **must** contain at most one of the
[VkImageViewUsageCreateInfo](#VkImageViewUsageCreateInfo) and
[VkImageViewUsage2CreateInfoKHR](#VkImageViewUsage2CreateInfoKHR) structures
...
[](#VUID-VkImageViewCreateInfo-flags-parameter) VUID-VkImageViewCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkImageViewCreateFlagBits](#VkImageViewCreateFlagBits) values
...
When creating a [VkImageView](#VkImageView), if `image` was created with
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](#VkImageCreateFlagBits), and the image `format` is a
[multi-planar format](formats.html#formats-multiplanar), then `aspectMask` **can** be
set to one of the [multi-planar aspect](formats.html#formats-multiplanar-image-aspect)
bits.

When creating a [VkImageView](#VkImageView), if `image` was created with an
[Android hardware buffer external format](memory.html#memory-external-android-hardware-buffer-external-formats), then `aspectMask` **must** equal
[VK_IMAGE_ASPECT_COLOR_BIT](#VkImageAspectFlagBits).
...
When creating an image view of a depth/stencil image to be used as a
[descriptor](descriptors.html#descriptors) (e.g. for sampling in the shader, or for use as
an input attachment), the `aspectMask` **must** only include one bit, which
selects whether the image view is used for depth reads (i.e. using a
floating-point sampler or input attachment in the shader) or stencil reads
...
[multi-planar aspect mask](formats.html#formats-multiplanar-image-aspect) bits
...
[](#VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-parameter) VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-parameter
 ...
 If `createFlags` is not `0`, `createFlags` **must** be a valid combination of [VkAccelerationStructureCreateFlagBitsKHR](#VkAccelerationStructureCreateFlagBitsKHR) values
...
[](#VUID-VkAccelerationStructureCreateInfo2KHR-addressFlags-parameter) VUID-VkAccelerationStructureCreateInfo2KHR-addressFlags-parameter
 ...
 If `addressFlags` is not `0`, `addressFlags` **must** be a valid combination of [VkAddressCommandFlagBitsKHR](fundamentals.html#VkAddressCommandFlagBitsKHR) values
...
[](#VUID-VkAccelerationStructureInfoNV-flags-parameter) VUID-VkAccelerationStructureInfoNV-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBuildAccelerationStructureFlagBitsKHR](#VkBuildAccelerationStructureFlagBitsKHR) values
...
[](#VUID-VkGeometryNV-flags-parameter) VUID-VkGeometryNV-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkGeometryFlagBitsKHR](#VkGeometryFlagBitsKHR) values
...
[](#VUID-VkMicromapCreateInfoEXT-createFlags-parameter) VUID-VkMicromapCreateInfoEXT-createFlags-parameter
 ...
 If `createFlags` is not `0`, `createFlags` **must** be a valid combination of [VkMicromapCreateFlagBitsEXT](#VkMicromapCreateFlagBitsEXT) values
...
If `planeAspect` is not 0 and `pCreateInfo->flags` does not have
[VK_IMAGE_CREATE_DISJOINT_BIT](#VkImageCreateFlagBits) set, then `planeAspect` must be a
...
[](#VUID-VkImageConstraintsInfoFUCHSIA-flags-parameter) VUID-VkImageConstraintsInfoFUCHSIA-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkImageConstraintsInfoFlagBitsFUCHSIA](#VkImageConstraintsInfoFlagBitsFUCHSIA) values
...
[](#VUID-VkBufferConstraintsInfoFUCHSIA-requiredFormatFeatures-parameter) VUID-VkBufferConstraintsInfoFUCHSIA-requiredFormatFeatures-parameter
 ...
 If `requiredFormatFeatures` is not `0`, `requiredFormatFeatures` **must** be a valid combination of [VkFormatFeatureFlagBits](formats.html#VkFormatFeatureFlagBits) values
...
[](#VUID-VkTensorCreateInfoARM-flags-parameter) VUID-VkTensorCreateInfoARM-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkTensorCreateFlagBitsARM](#VkTensorCreateFlagBitsARM) values
...
[](#VUID-VkTensorViewCreateInfoARM-flags-parameter) VUID-VkTensorViewCreateInfoARM-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkTensorViewCreateFlagBitsARM](#VkTensorViewCreateFlagBitsARM) values
