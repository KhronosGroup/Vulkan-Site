...
- [Frame Attribution](#low-latency2-frame-attribution)
...
* 
`dpy` is a connection to the X11 server that currently owns
`display`.
...
* 
`physicalDevice` is the physical device to query the display handle
on.

* 
`dpy` is a connection to the X11 server from which `rrOutput`
was queried.
...
* 
`pDisplay` is a pointer to a [VkDisplayKHR](#VkDisplayKHR) handle where the
display is returned.

If there is no [VkDisplayKHR](#VkDisplayKHR) corresponding to `rrOutput` on
`physicalDevice`, [VK_NULL_HANDLE](../../appendices/boilerplate.html#VK_NULL_HANDLE) will be returned in
`pDisplay`.
...
* 
`physicalDevice` is the physical device on which to query the
display handle.

* 
`deviceRelativeId` is the value of the
...
To acquire permission to directly control a display in Vulkan from the
Direct Rendering Manager (DRM) interface, call:
...
The provided `drmFd` **must** correspond to the one owned by the
`physicalDevice`.
If not, the error code [VK_ERROR_UNKNOWN](../fundamentals.html#VkResult) will be returned.
...
|  | This functionality is superseded by [vkGetPhysicalDeviceSurfaceCapabilities2KHR](#vkGetPhysicalDeviceSurfaceCapabilities2KHR). See [Legacy Functionality](../../appendices/legacy.html#legacy-gpdsc2) for more information. |
| --- | --- |
...
See [vkCreateSwapchainKHR](#vkCreateSwapchainKHR) for details of swapchain creation.
...
|  | This functionality is superseded by [VK_KHR_get_surface_capabilities2](../../appendices/extensions.html#VK_KHR_get_surface_capabilities2). See [Legacy Functionality](../../appendices/legacy.html#legacy-gpdsc2) for more information. |
| --- | --- |
...
provided by
[VkSharedPresentSurfaceCapabilities2KHR](#VkSharedPresentSurfaceCapabilities2KHR) or
...
* 
[](#VUID-vkGetPhysicalDeviceSurfaceCapabilities2KHR-pNext-12446) VUID-vkGetPhysicalDeviceSurfaceCapabilities2KHR-pNext-12446

If a [VkSwapchainFlagsSurfaceCapabilitiesEXT](#VkSwapchainFlagsSurfaceCapabilitiesEXT) structure is included
in the `pNext` chain of `pSurfaceCapabilities`,
`pSurfaceInfo->surface` **must** be a valid [VkSurfaceKHR](#VkSurfaceKHR) handle
...
Only usage flags representable in [VkImageUsageFlagBits](../resources.html#VkImageUsageFlagBits) are returned in
`surfaceCapabilities.supportedUsageFlags`.
If the `pNext` chain includes a [VkImageUsageFlags2CreateInfoKHR](../resources.html#VkImageUsageFlags2CreateInfoKHR)
structure, all usage flags are returned in
[VkImageUsageFlags2CreateInfoKHR](../resources.html#VkImageUsageFlags2CreateInfoKHR)::`usage`.
...
[](#VUID-VkSurfaceCapabilities2KHR-pNext-pNext) VUID-VkSurfaceCapabilities2KHR-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkDisplayNativeHdrSurfaceCapabilitiesAMD](#VkDisplayNativeHdrSurfaceCapabilitiesAMD), [VkImageUsageFlags2CreateInfoKHR](../resources.html#VkImageUsageFlags2CreateInfoKHR), [VkLatencySurfaceCapabilitiesNV](#VkLatencySurfaceCapabilitiesNV), [VkPresentTimingSurfaceCapabilitiesEXT](#VkPresentTimingSurfaceCapabilitiesEXT), [VkSharedPresentSurfaceCapabilities2KHR](#VkSharedPresentSurfaceCapabilities2KHR), [VkSharedPresentSurfaceCapabilitiesKHR](#VkSharedPresentSurfaceCapabilitiesKHR), [VkSurfaceCapabilitiesFullScreenExclusiveEXT](#VkSurfaceCapabilitiesFullScreenExclusiveEXT), [VkSurfaceCapabilitiesPresentBarrierNV](#VkSurfaceCapabilitiesPresentBarrierNV), [VkSurfaceCapabilitiesPresentId2KHR](#VkSurfaceCapabilitiesPresentId2KHR), [VkSurfaceCapabilitiesPresentWait2KHR](#VkSurfaceCapabilitiesPresentWait2KHR), [VkSurfacePresentModeCompatibilityKHR](#VkSurfacePresentModeCompatibilityKHR), [VkSurfacePresentScalingCapabilitiesKHR](#VkSurfacePresentScalingCapabilitiesKHR), [VkSurfaceProtectedCapabilitiesKHR](#VkSurfaceProtectedCapabilitiesKHR), or [VkSwapchainFlagsSurfaceCapabilitiesEXT](#VkSwapchainFlagsSurfaceCapabilitiesEXT)
...
[](#VUID-VkSurfacePresentScalingCapabilitiesKHR-supportedPresentScaling-parameter) VUID-VkSurfacePresentScalingCapabilitiesKHR-supportedPresentScaling-parameter
 ...
 If `supportedPresentScaling` is not `0`, `supportedPresentScaling` **must** be a valid combination of [VkPresentScalingFlagBitsKHR](#VkPresentScalingFlagBitsKHR) values
...
[](#VUID-VkSurfacePresentScalingCapabilitiesKHR-supportedPresentGravityX-parameter) VUID-VkSurfacePresentScalingCapabilitiesKHR-supportedPresentGravityX-parameter
 ...
 If `supportedPresentGravityX` is not `0`, `supportedPresentGravityX` **must** be a valid combination of [VkPresentGravityFlagBitsKHR](#VkPresentGravityFlagBitsKHR) values
...
[](#VUID-VkSurfacePresentScalingCapabilitiesKHR-supportedPresentGravityY-parameter) VUID-VkSurfacePresentScalingCapabilitiesKHR-supportedPresentGravityY-parameter
 ...
 If `supportedPresentGravityY` is not `0`, `supportedPresentGravityY` **must** be a valid combination of [VkPresentGravityFlagBitsKHR](#VkPresentGravityFlagBitsKHR) values
...
[VkSurfaceCapabilities2KHR](#VkSurfaceCapabilities2KHR) to determine supported usage when using
[VK_PRESENT_MODE_SHARED_DEMAND_REFRESH_KHR](#VkPresentModeKHR) or
[VK_PRESENT_MODE_SHARED_CONTINUOUS_REFRESH_KHR](#VkPresentModeKHR) presentation mode.
...
* 
`sharedPresentSupportedUsageFlags` is a bitmask of
[VkImageUsageFlagBits2KHR](../resources.html#VkImageUsageFlagBits2KHR) representing the ways the application
**can** use the shared presentable image from a swapchain created with
[VkPresentModeKHR](#VkPresentModeKHR) set to
[VK_PRESENT_MODE_SHARED_DEMAND_REFRESH_KHR](#VkPresentModeKHR) or
[VK_PRESENT_MODE_SHARED_CONTINUOUS_REFRESH_KHR](#VkPresentModeKHR) for the surface on
the specified device.
[VK_IMAGE_USAGE_2_COLOR_ATTACHMENT_BIT_KHR](../resources.html#VkImageUsageFlagBits2KHR) **must** be included in the
...
[](#VUID-VkSharedPresentSurfaceCapabilities2KHR-sType-sType) VUID-VkSharedPresentSurfaceCapabilities2KHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_2_KHR](../fundamentals.html#VkStructureType)
...
[VkSwapchainCreateFlagsKHR](#VkSwapchainCreateFlagsKHR) representing the supported flags in
[VkSwapchainCreateInfoKHR](#VkSwapchainCreateInfoKHR) when creating a swapchain for the surface
on the specified device.
If a [VkSurfacePresentModeKHR](#VkSurfacePresentModeKHR) structure is included in the
`pNext` chain of `pSurfaceInfo` in
[vkGetPhysicalDeviceSurfaceCapabilities2KHR](#vkGetPhysicalDeviceSurfaceCapabilities2KHR), this value represents
the supported flags for the specified present mode and those compatible
with it as returned in [VkSurfacePresentModeCompatibilityKHR](#VkSurfacePresentModeCompatibilityKHR).
...
[](#VUID-VkSwapchainFlagsSurfaceCapabilitiesEXT-sType-sType) VUID-VkSwapchainFlagsSurfaceCapabilitiesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_SWAPCHAIN_FLAGS_SURFACE_CAPABILITIES_EXT](../fundamentals.html#VkStructureType)
...
If `presentTimingSupported` is [VK_TRUE](../fundamentals.html#VK_TRUE), the implementation **must**
also advertise support for at least the
[VK_PRESENT_STAGE_QUEUE_OPERATIONS_END_BIT_EXT](#VkPresentStageFlagBitsEXT) present stage in pname
`presentStageQueries`.
...
counter types.
It **must** not include [VK_SURFACE_COUNTER_VBLANK_BIT_EXT](#VkSurfaceCounterFlagBitsEXT) unless the
surface queried is a [display surface](#wsi-display-surfaces)
...
// Provided by VK_KHR_display, VK_KHR_surface
...
|  | This functionality is superseded by [vkGetPhysicalDeviceSurfaceFormats2KHR](#vkGetPhysicalDeviceSurfaceFormats2KHR). See [Legacy Functionality](../../appendices/legacy.html#legacy-gpdsc2) for more information. |
| --- | --- |
...
|  | Some display technologies allow the vblank interval to be decoupled from the
| --- | --- |
display’s effective refresh rate.
In other words, presented images are visible for a fixed duration
(`refreshDuration`) that is a multiple of the vblank interval
(`refreshInterval`) which **may** be much smaller.
This allows such displays, for example, to effectively operate at a fixed
refresh rate with the ability to quickly change that refresh rate to adapt
to the current system’s workload.

Note that `VkSwapchainTimingPropertiesEXT` only represents the current
swapchain’s view of those capabilities, which **may** differ from the actual
hardware capabilities, based e.g. on the current surface properties.
For example, swapchains that render to a windowed surface requiring complex
composition **may** not be able to reach their display hardware’s full
potential. |
...
[VK_TIME_DOMAIN_PRESENT_STAGE_LOCAL_EXT](../synchronization.html#VkTimeDomainEXT).
...
[](#VUID-VkPastPresentationTimingInfoEXT-flags-parameter) VUID-VkPastPresentationTimingInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPastPresentationTimingFlagBitsEXT](#VkPastPresentationTimingFlagBitsEXT) values
...
[VK_IMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT](../resources.html#VkImageCreateFlagBits) is set if
[VK_SWAPCHAIN_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT](#VkSwapchainCreateFlagBitsKHR) is set
...
`imageUsage` defines the [effective usage flags](../fundamentals.html#fundamentals-effective-flags) for the swapchain image(s).
If the `pNext` chain includes a [VkImageUsageFlags2CreateInfoKHR](../resources.html#VkImageUsageFlags2CreateInfoKHR)
structure, `imageUsage` is ignored, and the effective usage flags are
defined by [VkImageUsageFlags2CreateInfoKHR](../resources.html#VkImageUsageFlags2CreateInfoKHR)::`usage`.
...
or [vkGetPhysicalDeviceImageFormatProperties2](../capabilities.html#vkGetPhysicalDeviceImageFormatProperties2)
...
* 
[](#VUID-VkSwapchainCreateInfoKHR-multisampledRenderToSwapchain-12447) VUID-VkSwapchainCreateInfoKHR-multisampledRenderToSwapchain-12447

If the [    `multisampledRenderToSwapchain`](../features.html#features-multisampledRenderToSwapchain) feature is not enabled,
`flags` **must** not contain
[VK_SWAPCHAIN_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT](#VkSwapchainCreateFlagBitsKHR)

* 
[](#VUID-VkSwapchainCreateInfoKHR-flags-12448) VUID-VkSwapchainCreateInfoKHR-flags-12448

`flags` **must** be a subset of flags returned in
[VkSwapchainFlagsSurfaceCapabilitiesEXT](#VkSwapchainFlagsSurfaceCapabilitiesEXT)::`swapchainSupportedFlags`
...
[](#VUID-VkSwapchainCreateInfoKHR-flags-parameter) VUID-VkSwapchainCreateInfoKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkSwapchainCreateFlagBitsKHR](#VkSwapchainCreateFlagBitsKHR) values
...
[](#VUID-VkSwapchainCounterCreateInfoEXT-surfaceCounters-parameter) VUID-VkSwapchainCounterCreateInfoEXT-surfaceCounters-parameter
 ...
 If `surfaceCounters` is not `0`, `surfaceCounters` **must** be a valid combination of [VkSurfaceCounterFlagBitsEXT](#VkSurfaceCounterFlagBitsEXT) values
...
[](#VUID-VkSwapchainPresentScalingCreateInfoKHR-scalingBehavior-parameter) VUID-VkSwapchainPresentScalingCreateInfoKHR-scalingBehavior-parameter
 ...
 If `scalingBehavior` is not `0`, `scalingBehavior` **must** be a valid combination of [VkPresentScalingFlagBitsKHR](#VkPresentScalingFlagBitsKHR) values
...
[](#VUID-VkSwapchainPresentScalingCreateInfoKHR-presentGravityX-parameter) VUID-VkSwapchainPresentScalingCreateInfoKHR-presentGravityX-parameter
 ...
 If `presentGravityX` is not `0`, `presentGravityX` **must** be a valid combination of [VkPresentGravityFlagBitsKHR](#VkPresentGravityFlagBitsKHR) values
...
[](#VUID-VkSwapchainPresentScalingCreateInfoKHR-presentGravityY-parameter) VUID-VkSwapchainPresentScalingCreateInfoKHR-presentGravityY-parameter
 ...
 If `presentGravityY` is not `0`, `presentGravityY` **must** be a valid combination of [VkPresentGravityFlagBitsKHR](#VkPresentGravityFlagBitsKHR) values
...
[VkPresentStageFlagsEXT](#VkPresentStageFlagsEXT) value indicating which present stages the
...
If no slots are available, or if
[vkSetSwapchainPresentTimingQueueSizeEXT](#vkSetSwapchainPresentTimingQueueSizeEXT) was never called, presentation
fails and returns [VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT](../fundamentals.html#VkResult).
...
[](#VUID-VkPresentTimingInfoEXT-flags-parameter) VUID-VkPresentTimingInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPresentTimingInfoFlagBitsEXT](#VkPresentTimingInfoFlagBitsEXT) values

* 
[](#VUID-VkPresentTimingInfoEXT-presentStageQueries-parameter) VUID-VkPresentTimingInfoEXT-presentStageQueries-parameter

 If `presentStageQueries` is not `0`, `presentStageQueries` **must** be a valid combination of [VkPresentStageFlagBitsEXT](#VkPresentStageFlagBitsEXT) values
...
[](#VUID-VkPresentTimingInfoEXT-targetTimeDomainPresentStage-parameter) VUID-VkPresentTimingInfoEXT-targetTimeDomainPresentStage-parameter
 ...
 If `targetTimeDomainPresentStage` is not `0`, `targetTimeDomainPresentStage` **must** be a valid combination of [VkPresentStageFlagBitsEXT](#VkPresentStageFlagBitsEXT) values
...
|  | This extension relies on grouping work into a series of
| --- | --- |
“application-rendered frames”.
This term is used because application-rendered frames do not correspond
one-to-one with `vkQueuePresentKHR` calls.
Technologies such as frame generation can present multiple images for a
single application-rendered frame. |
...
* 
`swapchain` is the swapchain to delay associated CPU work for, based
on the [frame attribution](#low-latency2-frame-attribution) rules.
...
`presentID` is the application-defined identifier of the
    application-rendered frame that this marker belongs to.
    A single application-rendered frame **may** correspond to multiple
    `vkQueuePresentKHR` calls.
...
* 
[VK_LATENCY_MARKER_PRESENT_END_NV](#VkLatencyMarkerNV) **should** be called when that
...
|  | The [VK_LATENCY_MARKER_OUT_OF_BAND_RENDERSUBMIT_START_NV](#VkLatencyMarkerNV),
| --- | --- |
[VK_LATENCY_MARKER_OUT_OF_BAND_RENDERSUBMIT_END_NV](#VkLatencyMarkerNV),
[VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_START_NV](#VkLatencyMarkerNV), and
[VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_END_NV](#VkLatencyMarkerNV) markers are not intended
for use by typical applications.
See [Frame Attribution](#low-latency2-frame-attribution) for information on how the
...
[VK_LATENCY_MARKER_PRESENT_START_NV](#VkLatencyMarkerNV) and
[VK_LATENCY_MARKER_PRESENT_END_NV](#VkLatencyMarkerNV) markers in place and emit
[VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_START_NV](#VkLatencyMarkerNV) and
[VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_END_NV](#VkLatencyMarkerNV) markers surrounding each
...
* 
`presentID` is the application-defined identifier of the
    application-rendered frame described by this structure.
    It is the same value that the application passes to
    [vkSetLatencyMarkerNV](#vkSetLatencyMarkerNV) via
    [VkSetLatencyMarkerInfoNV](#VkSetLatencyMarkerInfoNV)::`presentID`.
    It is not related to presentIds passed via
[VkPresentIdKHR](#VkPresentIdKHR)::`pPresentIds` or
[VkPresentId2KHR](#VkPresentId2KHR)::`pPresentIds`.
...
[Frame Attribution](#low-latency2-frame-attribution) are not sufficient, an application **can**
...
advertising support for `[VK_NV_low_latency2](../../appendices/extensions.html#VK_NV_low_latency2)` with a
[VkExtensionProperties](../extensions.html#VkExtensionProperties)::`specVersion` greater than or equal to 3.
...
| --- | --- |
The implicit rules described in [Frame Attribution](#low-latency2-frame-attribution) are
...
VK_NV_low_latency2 relies on attributing each `vkQueuePresentKHR` and
`vkQueueSubmit` call to an application-rendered frame, identified by the
`presentID` values from [VkSetLatencyMarkerInfoNV](#VkSetLatencyMarkerInfoNV).
Correct attribution is required for latency reduction.
This attribution **can** be used to measure frame timing statistics even when
low latency sleep mode is disabled.

A `vkQueuePresentKHR` call is attributed to an application-rendered
frame according to the first of these rules to apply.

* 
If a [VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_START_NV](#VkLatencyMarkerNV) marker has
been observed without an intervening
[VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_END_NV](#VkLatencyMarkerNV), the frame’s
`presentID` is the `presentID` from that marker.

* 
If the most recent [VK_LATENCY_MARKER_PRESENT_START_NV](#VkLatencyMarkerNV) marker’s
`presentID` has not already been mapped to a `vkQueuePresentKHR`
call, its `presentID` is used.

* 
Otherwise the `vkQueuePresentKHR` call is considered a new
application-rendered frame with no `presentID`.

|  | The first rule allows frame generation implementations to map multiple
| --- | --- |
`vkQueuePresentKHR` calls to the same `presentID`, by emitting
multiple pairs of [VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_START_NV](#VkLatencyMarkerNV) and
[VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_END_NV](#VkLatencyMarkerNV) markers with the same
`presentID` around each `vkQueuePresentKHR` call. |

Each `vkQueueSubmit`
or `vkQueueSubmit2`
call is attributed to an application-rendered frame according to the first
of these rules that applies.

* 
If the queue has been marked as
[VK_OUT_OF_BAND_QUEUE_TYPE_PRESENT_NV](#VkOutOfBandQueueTypeNV) via
[vkQueueNotifyOutOfBandNV](#vkQueueNotifyOutOfBandNV), the submission is ignored.

* 
If the device is in explicit submission attribution mode as described
under [VkLatencySubmissionPresentIdNV](#VkLatencySubmissionPresentIdNV), the `presentID`
determined by that structure’s rules is used.

* 
If the queue has been marked as
[VK_OUT_OF_BAND_QUEUE_TYPE_RENDER_NV](#VkOutOfBandQueueTypeNV), the submission is attributed
to the `presentID` of the most recent
[VK_LATENCY_MARKER_OUT_OF_BAND_RENDERSUBMIT_START_NV](#VkLatencyMarkerNV) marker that
has been observed.

* 
Otherwise the submission will be added to a list of pending submissions.
All submissions in this list will be mapped to the same
application-rendered frame once one of the following frame delimiters is
reached.
If any queue has been marked as out-of-band via
[vkQueueNotifyOutOfBandNV](#vkQueueNotifyOutOfBandNV), application-rendered frames are
delimited by [VK_LATENCY_MARKER_PRESENT_END_NV](#VkLatencyMarkerNV) markers, and the
pending submission list is attributed to that marker’s `presentID`.
Otherwise, application-rendered frames are delimited by
`vkQueuePresentKHR` calls, and the group is attributed to that
present’s application-rendered frame according to the
`vkQueuePresentKHR` mapping rules above.
...
* 
`pPresentModes` is a list of presentation modes optimized for use
with low latency mode with `presentModeCount` entries.

If `pPresentModes` is `NULL`, then the number of present modes that are
optimized for use with low latency mode is returned in
`presentModeCount`.
Otherwise, `presentModeCount` **must** be set by the application to the
number of elements in the `pPresentModes` array, and on return is
overwritten with the number of values actually written to
