...
- [Shader Abort Messages](#_shader_abort_messages)
- [Shader_Abort_Messages](#_shader_abort_messages)
...
[](#VUID-VkDeviceAddressBindingCallbackDataEXT-flags-parameter) VUID-VkDeviceAddressBindingCallbackDataEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkDeviceAddressBindingFlagBitsEXT](#VkDeviceAddressBindingFlagBitsEXT) values
...
[](#VUID-VkDebugReportCallbackCreateInfoEXT-flags-parameter) VUID-VkDebugReportCallbackCreateInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkDebugReportFlagBitsEXT](#VkDebugReportFlagBitsEXT) values
...
[VkDeviceFaultInfoKHR](#VkDeviceFaultInfoKHR) structures in which fault information is
returned.
...
[VK_TIMEOUT](fundamentals.html#VkResult) will be returned in this case if no faults have occurred,
even though no actual wait was performed.

If a fault has occurred before the `timeout` has expired,
`vkGetDeviceFaultReportsKHR` returns [VK_SUCCESS](fundamentals.html#VkResult).
Otherwise, `vkGetDeviceFaultReportsKHR` returns [VK_TIMEOUT](fundamentals.html#VkResult) after
...
most `pFaultCount` structures will be written, and [VK_INCOMPLETE](fundamentals.html#VkResult)
...
[](#VUID-vkGetDeviceFaultReportsKHR-pFaultInfo-parameter) VUID-vkGetDeviceFaultReportsKHR-pFaultInfo-parameter
 ...
 If `pFaultInfo` is not `NULL`, `pFaultInfo` **must** be a valid pointer to an array of `pFaultCounts` [VkDeviceFaultInfoKHR](#VkDeviceFaultInfoKHR) structures
...
* 
`flags` is a bitmask of [VkDeviceFaultFlagBitsKHR](#VkDeviceFaultFlagBitsKHR) values giving
...
* 
`faultAddressInfo` is a [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR) structure
providing details of the memory access which caused a fault.

* 
`instructionAddressInfo` is a [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR)
structure providing details of the GPU instruction which cause a fault.

* 
`vendorInfo` is a [VkDeviceFaultVendorInfoKHR](#VkDeviceFaultVendorInfoKHR) structure
providing vendor specific fault information.

An implementation **should** populate as many members of
[VkDeviceFaultInfoKHR](#VkDeviceFaultInfoKHR) as possible, given the information available at
...
the `[VK_EXT_device_address_binding_report](../appendices/extensions.html#VK_EXT_device_address_binding_report)` extension may allow
...
[](#VUID-VkDeviceFaultInfoKHR-sType-sType) VUID-VkDeviceFaultInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_DEVICE_FAULT_INFO_KHR](fundamentals.html#VkStructureType)
...
or more [VkDeviceFaultFlagBitsKHR](#VkDeviceFaultFlagBitsKHR).

Bits which **can** be set in [VkDeviceFaultInfoKHR](#VkDeviceFaultInfoKHR)::`flags` providing
...
* 
[VK_DEVICE_FAULT_FLAG_DEVICE_LOST_KHR](#VkDeviceFaultFlagBitsKHR) specifies that the fault has
resulted in a device lost condition.
No subsequent entries will be returned for this device.

* 
[VK_DEVICE_FAULT_FLAG_MEMORY_ADDRESS_KHR](#VkDeviceFaultFlagBitsKHR) specifies that the fault
has associated memory access address information which is stored in the
faultAddressInfo field (see [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR)).

* 
[VK_DEVICE_FAULT_FLAG_INSTRUCTION_ADDRESS_KHR](#VkDeviceFaultFlagBitsKHR) specifies that the
fault has an associated instruction address which is stored in the
instructionAddressInfo field (see [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR)).

* 
[VK_DEVICE_FAULT_FLAG_VENDOR_KHR](#VkDeviceFaultFlagBitsKHR) specifies that the fault has
associated vendor information stored in the vendorInfo field (see
[VkDeviceFaultVendorInfoKHR](#VkDeviceFaultVendorInfoKHR)).

* 
[VK_DEVICE_FAULT_FLAG_WATCHDOG_TIMEOUT_KHR](#VkDeviceFaultFlagBitsKHR) specifies that the fault
was the result of a GPU timeout.
Further information **may** be made available using other platform specific
extensions via the pNext chain of the [VkDeviceFaultInfoKHR](#VkDeviceFaultInfoKHR)
structure.

* 
[VK_DEVICE_FAULT_FLAG_OVERFLOW_KHR](#VkDeviceFaultFlagBitsKHR) specifies that prior faults have
...
If the [vendor-specific crash dumps](features.html#features-deviceFaultVendorBinaryEXT)
...
The length of `pAddressInfos` is specified by the
[VkDeviceFaultCountsEXT](#VkDeviceFaultCountsEXT)::`addressInfoCount` value passed to
[vkGetDeviceFaultInfoEXT](#vkGetDeviceFaultInfoEXT).
If not `NULL`, each element of `pAddressInfos` describes a bounded
region of GPU virtual address space containing either the GPU virtual
address accessed, or the value of an active instruction pointer.
...
fault information.
The length of `pVendorInfos` is specified by the
[VkDeviceFaultCountsEXT](#VkDeviceFaultCountsEXT)::`vendorInfoCount` value passed to
[vkGetDeviceFaultInfoEXT](#vkGetDeviceFaultInfoEXT).
...
[VkDeviceFaultCountsEXT](#VkDeviceFaultCountsEXT)::`vendorBinarySize` value passed to
[vkGetDeviceFaultInfoEXT](#vkGetDeviceFaultInfoEXT).
...
Possible values of [VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR)::`addressType` are:
...
* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_NONE_KHR](#VkDeviceFaultAddressTypeEXT) specifies that
[VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR) does not describe a page fault, or an
instruction address.

* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_READ_INVALID_KHR](#VkDeviceFaultAddressTypeEXT) specifies that
[VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR) describes a page fault triggered by an
invalid read operation.

* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_WRITE_INVALID_KHR](#VkDeviceFaultAddressTypeEXT) specifies that
[VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR) describes a page fault triggered by an
invalid write operation.

* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_EXECUTE_INVALID_KHR](#VkDeviceFaultAddressTypeEXT) specifies that
[VkDeviceFaultAddressInfoKHR](#VkDeviceFaultAddressInfoKHR) describes a page fault triggered by an
attempt to execute non-executable memory.

* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_INSTRUCTION_POINTER_UNKNOWN_KHR](#VkDeviceFaultAddressTypeEXT)
specifies an instruction pointer value at the time the fault occurred.
This may or may not be related to a fault.

* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_INSTRUCTION_POINTER_INVALID_KHR](#VkDeviceFaultAddressTypeEXT)
specifies an instruction pointer value associated with an invalid
instruction fault.

* 
[VK_DEVICE_FAULT_ADDRESS_TYPE_INSTRUCTION_POINTER_FAULT_KHR](#VkDeviceFaultAddressTypeEXT)
...
Applications **can** retrieve extended vendor-specific binary crash dump data
for later analysis using external tools.

When VK_KHR_device_fault is enabled, crash dump data can be retrieved by
calling [vkGetDeviceFaultDebugInfoKHR](#vkGetDeviceFaultDebugInfoKHR).

When VK_EXT_device_fault is enabled, crash dump data can be retrieved by
calling [vkGetDeviceFaultInfoEXT](#vkGetDeviceFaultInfoEXT).
...
to [vkGetDeviceFaultDebugInfoKHR](#vkGetDeviceFaultDebugInfoKHR) for the same `device` **must** return
...
`device` **must** be [lost](devsandqueues.html#devsandqueues-lost-device)
...
[](#VUID-vkGetDeviceFaultDebugInfoKHR-pDebugInfo-parameter) VUID-vkGetDeviceFaultDebugInfoKHR-pDebugInfo-parameter
 ...
 `pDebugInfo` **must** be a valid pointer to a [VkDeviceFaultDebugInfoKHR](#VkDeviceFaultDebugInfoKHR) structure
...
[](#VUID-VkDeviceFaultDebugInfoKHR-sType-sType) VUID-VkDeviceFaultDebugInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_DEVICE_FAULT_DEBUG_INFO_KHR](fundamentals.html#VkStructureType)

* 
[](#VUID-VkDeviceFaultDebugInfoKHR-pNext-pNext) VUID-VkDeviceFaultDebugInfoKHR-pNext-pNext

 `pNext` **must** be `NULL` or a pointer to a valid instance of [VkDeviceFaultShaderAbortMessageInfoKHR](#VkDeviceFaultShaderAbortMessageInfoKHR)
...
The format of this crash dump data **may** depend on the vendor ID, device ID,
...
`VkDeviceFaultInfoEXT`::`pVendorBinaryData`, or to
`VkDeviceFaultDebugInfoKHR`::`pVendorBinaryData` **must** begin with a
valid crash dump header.
...
* 
`headerVersion` is a [VkDeviceFaultVendorBinaryHeaderVersionKHR](#VkDeviceFaultVendorBinaryHeaderVersionKHR)
...
[VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_KHR](#VkDeviceFaultVendorBinaryHeaderVersionEXT)
...
[](#VUID-VkDeviceFaultVendorBinaryHeaderVersionOneKHR-headerVersion-parameter) VUID-VkDeviceFaultVendorBinaryHeaderVersionOneKHR-headerVersion-parameter
 ...
 `headerVersion` **must** be a valid [VkDeviceFaultVendorBinaryHeaderVersionKHR](#VkDeviceFaultVendorBinaryHeaderVersionKHR) value
...
* 
[VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_KHR](#VkDeviceFaultVendorBinaryHeaderVersionEXT) specifies
version one of the binary crash dump header.

Applications making use of the `OpAbortKHR` instruction in their shaders
**can** retrieve the messages passed through those instructions with the
...
This structure **can** be included in the `pNext` chain of
[VkDeviceFaultDebugInfoKHR](#VkDeviceFaultDebugInfoKHR) to retrieve messages returned by
...
[](#VUID-VkDeviceFaultShaderAbortMessageInfoKHR-sType-sType) VUID-VkDeviceFaultShaderAbortMessageInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_DEVICE_FAULT_SHADER_ABORT_MESSAGE_INFO_KHR](fundamentals.html#VkStructureType)
...
* 
[VkDeviceFaultDebugInfoKHR](#VkDeviceFaultDebugInfoKHR)
...
[](#VUID-VkFrameBoundaryEXT-flags-parameter) VUID-VkFrameBoundaryEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkFrameBoundaryFlagBitsEXT](#VkFrameBoundaryFlagBitsEXT) values
