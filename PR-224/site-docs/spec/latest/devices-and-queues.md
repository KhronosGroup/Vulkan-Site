...
descriptors that the implementation uses for sampled images with
[Y′CBCR conversion](samplers.html#samplers-YCbCr-conversion).
...
[](#VUID-VkPhysicalDeviceInfoPropertiesINTEL-sType-sType) VUID-VkPhysicalDeviceInfoPropertiesINTEL-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INFO_PROPERTIES_INTEL](fundamentals.html#VkStructureType)
...
[](#VUID-VkDeviceDiagnosticsConfigCreateInfoNV-flags-parameter) VUID-VkDeviceDiagnosticsConfigCreateInfoNV-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkDeviceDiagnosticsConfigFlagBitsNV](#VkDeviceDiagnosticsConfigFlagBitsNV) values
...
[](#VUID-VkDeviceQueueCreateInfo-flags-parameter) VUID-VkDeviceQueueCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkDeviceQueueCreateFlagBits](#VkDeviceQueueCreateFlagBits) values
