...
* 
Remove micromaps or [VkOpacityMicromapSpecialIndexKHR](#VkOpacityMicromapSpecialIndexKHR) values from a
geometry which previously had them, or vice versa.

* 
Change between use of [VkOpacityMicromapSpecialIndexKHR](#VkOpacityMicromapSpecialIndexKHR) values and
...
Acceleration structures constructed by deserialization with
[vkCmdCopyMemoryToAccelerationStructureKHR](#vkCmdCopyMemoryToAccelerationStructureKHR) and originally built with
the
[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_BIT_EXT](resources.html#VkBuildAccelerationStructureFlagBitsNV)
flag **must** provide a micromap deserialized using the exact serialized output
of the micromap that was originally referenced by the serialized
acceleration structure.

|  | If applications need to update micromap data referenced by a deserialized
| --- | --- |
acceleration structure, then it must originally build the acceleration
structure with the
[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV)
flag and perform a full micromap update. |
...
micromap
unless [VkMicromapBuildSizesInfoEXT](resources.html#VkMicromapBuildSizesInfoEXT)::`discardable` is [VK_TRUE](fundamentals.html#VK_TRUE)
.

If the original acceleration structure was built using opacity micromaps and
neither opacity micromap update flag is set, the application **must** provide
the original micromap to the update operation or the deserialized micromap
from the original micromap’s exact serialized data if the original
acceleration structure was deserialized prior.
...
and **must** be NULL:
  ...
  ** [VK_GEOMETRY_TYPE_MICROMAP_KHR](resources.html#VkGeometryTypeNV) |
...
[VkAccelerationStructureGeometryMicromapDataKHR](VK_KHR_opacity_micromap/micromaps.html#VkAccelerationStructureGeometryMicromapDataKHR)::`data`,
[VkAccelerationStructureGeometryMicromapDataKHR](VK_KHR_opacity_micromap/micromaps.html#VkAccelerationStructureGeometryMicromapDataKHR)::`triangleArray`,
...
* 
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV)
...
For each element of `pInfos`[i] whose `pGeometries` or
`ppGeometries` members have a `geometryType` of
[VK_GEOMETRY_TYPE_MICROMAP_KHR](resources.html#VkGeometryTypeNV), `ppBuildRangeInfos`[i] **must** be
`NULL`
...
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV), its
`mode` **must** equal
[VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR](#VkBuildAccelerationStructureModeKHR)
...
For each element of `pInfos`, if its `type` member is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV), its
`srcAccelerationStructure` **must** be [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE)
...
either [VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV) or
...
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR)::`micromap`
...
specify an access within the range of the [VkBuffer](resources.html#VkBuffer) that `data`
...
be within the range of the [VkBuffer](resources.html#VkBuffer) from which the
...
[VkOpacityMicromapFormatKHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatKHR)
...
[VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT), `subdivisionLevel`
**must** be less than or equal to
[    `maxOpacity2StateSubdivisionLevel`](limits.html#limits-maxOpacity2StateSubdivisionLevel)
...
[VK_GEOMETRY_TYPE_TRIANGLES_KHR](resources.html#VkGeometryTypeNV), if its `geometry.triangles`
member includes a
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) structure in
its `pNext` chain, the micromap’s `indexType` member is not
[VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), and `micromap` is not
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), for each *index* in `indexBuffer`[*j*] greater
...
[VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), `indexBuffer`

(`indexStride` * numTrianglesInGeometry) **must** be within the range
of the [VkBuffer](resources.html#VkBuffer) from which the `indexBuffer` device address
...
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) structure in
its `pNext` chain, the micromap’s `indexType` member is not
[VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), and `micromap` is
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), for each *index* in `indexBuffer`[*j*] where
*j* is within the range from [0, numTrianglesInGeometry - 1],
*index* **must** be a valid [VkOpacityMicromapSpecialIndexKHR](#VkOpacityMicromapSpecialIndexKHR) value
...
[VK_GEOMETRY_TYPE_INSTANCES_KHR](resources.html#VkGeometryTypeNV), it **must** be fully backed by
physical memory
...
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](#VkGeometryInstanceFlagBitsNV) is set in
...
[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV)
...
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) in the
...
of [VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV)
...
`VkAccelerationStructureGeometryKHR` structure referred to by its
`pGeometries` or `ppGeometries` members, if `geometryType`
is [VK_GEOMETRY_TYPE_TRIANGLES_KHR](resources.html#VkGeometryTypeNV), and the same geometry in the
original build of `srcAccelerationStructure` was built with an
instance of [VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) in
its `geometry.triangles.pNext` chain with a valid `micromap`
member, then an instance of
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) **must** be
...
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) **must** not be
...
deserialization with [vkCmdCopyMemoryToAccelerationStructureKHR](#vkCmdCopyMemoryToAccelerationStructureKHR),
then for each `VkAccelerationStructureGeometryKHR` structure
referred to by its `pGeometries` or `ppGeometries` members, if
`geometryType` is [VK_GEOMETRY_TYPE_TRIANGLES_KHR](resources.html#VkGeometryTypeNV), and the same
geometry in the original build of `srcAccelerationStructure` was
built with an instance of
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) in its
`geometry.triangles.pNext` chain with a valid `micromap` member,
then an instance of
[VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR) **must** be
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11701) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11701
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11624) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11624
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11625) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11625
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11626) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11626
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11627) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11627
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11628) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11628
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11629) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11629
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11632) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-micromap-11632
...
[](#VUID-vkCmdBuildAccelerationStructuresIndirectKHR-type-11557) VUID-vkCmdBuildAccelerationStructuresIndirectKHR-type-11557

For any element of `pInfos`, its `type` member **must** not be
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV)
...
[VkAccelerationStructureBuildGeometryInfoKHR](#VkAccelerationStructureBuildGeometryInfoKHR) is used as the *geometry
...
* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11558) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11558
...
* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11709) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11709
...
* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11710) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11710
...
* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11711) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11711
...
* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-micromap-11559) VUID-VkAccelerationStructureBuildGeometryInfoKHR-micromap-11559

If `type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV), the
[`VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap)
feature **must** be enabled

* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryCount-11560) VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryCount-11560
...
* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryType-11561) VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryType-11561

If `type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV), the
`geometryType` member of elements of either `pGeometries` or
`ppGeometries` **must** be [VK_GEOMETRY_TYPE_MICROMAP_KHR](resources.html#VkGeometryTypeNV)

* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryType-11707) VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryType-11707

If `type` is not
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV), the
`geometryType` member of elements of either `pGeometries` or
`ppGeometries` **must** not be [VK_GEOMETRY_TYPE_MICROMAP_KHR](resources.html#VkGeometryTypeNV)

* 
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11562) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11562

If `type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV), `flags`
**must** only include the following bits:

[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV)

* 
[VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV)

* 
[VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV)

* 
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV)

[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-type-11563) VUID-VkAccelerationStructureBuildGeometryInfoKHR-type-11563

If `flags` includes
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV), `type`
**must** be [VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV)

[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-format-11712) VUID-VkAccelerationStructureBuildGeometryInfoKHR-format-11712

If `flags` includes
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV), for each
...
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11564) VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11564
...
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT), its `subdivisionLevel`
member **must** be less than or equal to
[    `maxOpacity4StateSubdivisionLevel`](limits.html#limits-maxOpacity4StateSubdivisionLevel)

[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11565) VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11565
...
less than or equal to [    `maxOpacityLossy4StateSubdivisionLevel`](limits.html#limits-maxOpacity4StateSubdivisionLevel)

[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-format-11713) VUID-VkAccelerationStructureBuildGeometryInfoKHR-format-11713
...
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11566) VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11566
...
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11567) VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11567
...
[    `maxOpacityLossy4StateSubdivisionLevel`](limits.html#limits-maxOpacity4StateSubdivisionLevel)
...
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-parameter) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBuildAccelerationStructureFlagBitsKHR](resources.html#VkBuildAccelerationStructureFlagBitsKHR) values
...
* 
[](#VUID-VkAccelerationStructureGeometryKHR-micromap-11568) VUID-VkAccelerationStructureGeometryKHR-micromap-11568

If `geometryType` is [VK_GEOMETRY_TYPE_MICROMAP_KHR](resources.html#VkGeometryTypeNV),
`pNext` chain **must** include a single
[VkAccelerationStructureGeometryMicromapDataKHR](VK_KHR_opacity_micromap/micromaps.html#VkAccelerationStructureGeometryMicromapDataKHR) structure

* 
[](#VUID-VkAccelerationStructureGeometryKHR-flags-11569) VUID-VkAccelerationStructureGeometryKHR-flags-11569
...
[](#VUID-VkAccelerationStructureGeometryKHR-pNext-pNext) VUID-VkAccelerationStructureGeometryKHR-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkAccelerationStructureDenseGeometryFormatTrianglesDataAMDX](#VkAccelerationStructureDenseGeometryFormatTrianglesDataAMDX), [VkAccelerationStructureGeometryLinearSweptSpheresDataNV](#VkAccelerationStructureGeometryLinearSweptSpheresDataNV), [VkAccelerationStructureGeometryMicromapDataKHR](VK_KHR_opacity_micromap/micromaps.html#VkAccelerationStructureGeometryMicromapDataKHR), or [VkAccelerationStructureGeometrySpheresDataNV](#VkAccelerationStructureGeometrySpheresDataNV)
...
[](#VUID-VkAccelerationStructureGeometryKHR-flags-parameter) VUID-VkAccelerationStructureGeometryKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkGeometryFlagBitsKHR](resources.html#VkGeometryFlagBitsKHR) values
...
[](#VUID-VkAccelerationStructureGeometryTrianglesDataKHR-pNext-pNext) VUID-VkAccelerationStructureGeometryTrianglesDataKHR-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkAccelerationStructureGeometryMotionTrianglesDataNV](#VkAccelerationStructureGeometryMotionTrianglesDataNV), [VkAccelerationStructureTrianglesDisplacementMicromapNV](#VkAccelerationStructureTrianglesDisplacementMicromapNV), [VkAccelerationStructureTrianglesOpacityMicromapEXT](#VkAccelerationStructureTrianglesOpacityMicromapEXT), or [VkAccelerationStructureTrianglesOpacityMicromapKHR](#VkAccelerationStructureTrianglesOpacityMicromapKHR)
...
if present.
If `indexType` is [VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), then the index used is
the index of the triangle in the geometry.

If that value is the unsigned cast of one of the values from
[VkOpacityMicromapSpecialIndexKHR](#VkOpacityMicromapSpecialIndexKHR) then that triangle behaves as
...
`indexType` **must** be
[VK_INDEX_TYPE_UINT8](drawing.html#VkIndexType),
[VK_INDEX_TYPE_UINT16](drawing.html#VkIndexType), [VK_INDEX_TYPE_UINT32](drawing.html#VkIndexType), or
[VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType)
...
If `indexType` is [VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), `indexBuffer`
**must** be 0
...
If `indexType` is not [VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType),
...
If `indexType` is [VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), for each triangle
...
If `indexType` is [VK_INDEX_TYPE_NONE_KHR](drawing.html#VkIndexType), `micromap` **must**
not be [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE)
...
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-sType-sType) VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_TRIANGLES_OPACITY_MICROMAP_KHR](fundamentals.html#VkStructureType)
...
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-micromap-parameter) VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-micromap-parameter
 ...
 If `micromap` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), `micromap` **must** be a valid [VkAccelerationStructureKHR](resources.html#VkAccelerationStructureKHR) handle
...
* 
`pUsageCounts` is a pointer to an array of [VkMicromapUsageEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapUsageEXT)
structures.

* 
`ppUsageCounts` is a pointer to an array of pointers to
[VkMicromapUsageEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapUsageEXT) structures.
...
* 
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-format-11679) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-format-11679

If `micromap` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the `type` used to
construct `micromap` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](resources.html#VkMicromapTypeEXT),
the `format` member of each element of `pUsageCounts` or
`ppUsageCounts` **must** be a valid value from
[VkOpacityMicromapFormatEXT](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT)

* 
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11680) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11680

If `micromap` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the `type` used to
build `micromap` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](resources.html#VkMicromapTypeEXT), for
each member of `pUsageCounts` or `ppUsageCounts` with
`format` equal to [VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT),
`subdivisionLevel` **must** be less than or equal to
[](limits.html#limits-maxOpacity2StateSubdivisionLevelEXT)[VkPhysicalDeviceOpacityMicromapPropertiesEXT](limits.html#VkPhysicalDeviceOpacityMicromapPropertiesEXT)::`maxOpacity2StateSubdivisionLevel`

* 
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11681) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11681

If `micromap` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the `type` used to
build `micromap` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](resources.html#VkMicromapTypeEXT), for
each member of `pUsageCounts` or `ppUsageCounts` with
`format` equal to [VK_OPACITY_MICROMAP_FORMAT_4_STATE_EXT](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT),
`subdivisionLevel` **must** be less than or equal to
[](limits.html#limits-maxOpacity4StateSubdivisionLevelEXT)[VkPhysicalDeviceOpacityMicromapPropertiesEXT](limits.html#VkPhysicalDeviceOpacityMicromapPropertiesEXT)::`maxOpacity4StateSubdivisionLevel`

* 
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-format-11682) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-format-11682

If `micromap` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the `type` used to
construct `micromap` is
[VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](resources.html#VkMicromapTypeEXT), the `format` member
of each element of `pUsageCounts` or `ppUsageCounts` **must** be a
valid value from [VkDisplacementMicromapFormatNV](VK_KHR_opacity_micromap/micromaps.html#VkDisplacementMicromapFormatNV)

* 
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11683) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11683

If `micromap` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), the `type` used to
construct `micromap` is
[VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](resources.html#VkMicromapTypeEXT), for each member of
...
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-pUsageCounts-parameter) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-pUsageCounts-parameter
 ...
 If `usageCountsCount` is not `0`, and `pUsageCounts` is not `NULL`, `pUsageCounts` **must** be a valid pointer to an array of `usageCountsCount` [VkMicromapUsageEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapUsageEXT) structures
...
[](#VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-ppUsageCounts-parameter) VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-ppUsageCounts-parameter
 ...
 If `usageCountsCount` is not `0`, and `ppUsageCounts` is not `NULL`, `ppUsageCounts` **must** be a valid pointer to an array of `usageCountsCount` valid pointers to [VkMicromapUsageEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapUsageEXT) structures
...
The [VkOpacityMicromapSpecialIndexKHR](#VkOpacityMicromapSpecialIndexKHR) enumeration is defined as:
...
* 
[VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_TRANSPARENT_KHR](#VkOpacityMicromapSpecialIndexEXT) specifies
that the entire triangle is fully transparent.

* 
[VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_OPAQUE_KHR](#VkOpacityMicromapSpecialIndexEXT) specifies that
the entire triangle is fully opaque.

* 
[VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_UNKNOWN_TRANSPARENT_KHR](#VkOpacityMicromapSpecialIndexEXT)
specifies that the entire triangle is unknown-transparent.

* 
[VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_UNKNOWN_OPAQUE_KHR](#VkOpacityMicromapSpecialIndexEXT)
...
The [VkAccelerationStructureSerializedBlockTypeKHR](#VkAccelerationStructureSerializedBlockTypeKHR) enumeration is
defined as:
...
* 
[VK_ACCELERATION_STRUCTURE_SERIALIZED_BLOCK_TYPE_OPACITY_MICROMAP_KHR](#VkAccelerationStructureSerializedBlockTypeKHR)
...
* 
[](#VUID-VkAccelerationStructureInstanceKHR-micromap-11580) VUID-VkAccelerationStructureInstanceKHR-micromap-11580

If `flags` includes
[VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR](#VkGeometryInstanceFlagBitsNV) or
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](#VkGeometryInstanceFlagBitsNV), the
[`VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap)
or
[`VkPhysicalDeviceOpacityMicromapFeaturesEXT`::`micromap`](features.html#features-micromapEXT)
feature **must** be enabled
...
* 
[](#VUID-VkAccelerationStructureInstanceKHR-flags-11581) VUID-VkAccelerationStructureInstanceKHR-flags-11581
...
[](#VUID-VkAccelerationStructureInstanceKHR-flags-parameter) VUID-VkAccelerationStructureInstanceKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkGeometryInstanceFlagBitsKHR](#VkGeometryInstanceFlagBitsKHR) values
...
* 
[VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR](#VkGeometryInstanceFlagBitsNV) forces
the micromap format to 2 state mode as described in
[traversal](raytraversal.html#ray-opacity-micromap).

* 
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](#VkGeometryInstanceFlagBitsNV) disables
any opacity micromaps referenced by acceleration structures referenced
by this instance as described in [traversal](raytraversal.html#ray-opacity-micromap).
...
[VkAccelerationStructureGeometryTrianglesDataKHR](#VkAccelerationStructureGeometryTrianglesDataKHR)::`maxVertex`
**must** be greater than or equal to firstVertex + primitiveCount x 3 -
1
...
* 
If `queryType` is
[VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SIZE_KHR](queries.html#VkQueryType), then the value
written out is the number of bytes required by the acceleration
structure.

* 
[VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_BOTTOM_LEVEL_POINTERS_KHR](queries.html#VkQueryType)
specifies a [serialization acceleration structure    pointer count query](#serialized-as-header).
...
* 
[](#VUID-vkCmdWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-11684) VUID-vkCmdWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-11684

All acceleration structures in `pAccelerationStructures` **must** have
been constructed prior to the execution of this command on the device
...
* 
[](#VUID-vkCmdWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-12425) VUID-vkCmdWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-12425

All acceleration structures in `pAccelerationStructures` **must** have
been built with [VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR](resources.html#VkAccelerationStructureTypeNV) if
`queryType` is
[VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_BOTTOM_LEVEL_POINTERS_KHR](queries.html#VkQueryType)
...
* 
[](#VUID-vkCmdWriteAccelerationStructuresPropertiesNV-pAccelerationStructures-11685) VUID-vkCmdWriteAccelerationStructuresPropertiesNV-pAccelerationStructures-11685
...
* 
[](#VUID-vkCmdCopyAccelerationStructureKHR-src-11634) VUID-vkCmdCopyAccelerationStructureKHR-src-11634
...
* 
[](#VUID-VkCopyAccelerationStructureInfoKHR-mode-12418) VUID-VkCopyAccelerationStructureInfoKHR-mode-12418

If `mode` is [VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_KHR](#VkCopyAccelerationStructureModeNV),
...
* 
[](#VUID-VkCopyAccelerationStructureInfoKHR-mode-12419) VUID-VkCopyAccelerationStructureInfoKHR-mode-12419
...
* 
[](#VUID-vkCmdCopyAccelerationStructureNV-mode-12418) VUID-vkCmdCopyAccelerationStructureNV-mode-12418
...
* 
[](#VUID-vkCmdCopyAccelerationStructureNV-mode-12419) VUID-vkCmdCopyAccelerationStructureNV-mode-12419
...
with the exception of `size`, which **must** at least as large as the
queried [VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SIZE_KHR](queries.html#VkQueryType) size
.
...
structure.
After deserialization, the destination acceleration structure is treated
as having the same acceleration structure type as the originally
...
values in the [VkAccelerationStructureSerializedBlockTypeKHR](#VkAccelerationStructureSerializedBlockTypeKHR)
enumeration
...
and match the values returned by [vkGetBufferDeviceAddressKHR](resources.html#vkGetBufferDeviceAddressKHR) for the
...
[VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR](resources.html#VkAccelerationStructureCreateFlagBitsKHR)
flag set.

Before using the deserialized acceleration structure, the micromaps **must** be
deserialized using the exact serialized output of the micromap that was
originally referenced by the serialized acceleration structure, or, if the
acceleration structure was originally built with the
[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV),
...
* 
[](#VUID-VkCopyAccelerationStructureToMemoryInfoKHR-src-11582) VUID-VkCopyAccelerationStructureToMemoryInfoKHR-src-11582

If the source acceleration structure `src` was constructed through
...
* 
[](#VUID-VkCopyAccelerationStructureToMemoryInfoKHR-mode-11714) VUID-VkCopyAccelerationStructureToMemoryInfoKHR-mode-11714

The range of `src` accessed by this command **must** be fully backed by
physical memory

* 
[](#VUID-VkCopyAccelerationStructureToMemoryInfoKHR-mode-11715) VUID-VkCopyAccelerationStructureToMemoryInfoKHR-mode-11715
...
The application **must** also provide any required micromap addresses in the
header as described in
[`vkCmdCopyAccelerationStructureToMemoryKHR`](#serialized-as-header).
...
* 
[](#VUID-vkCmdCopyAccelerationStructureToMemoryKHR-pInfo-11700) VUID-vkCmdCopyAccelerationStructureToMemoryKHR-pInfo-11700

If the serialized acceleration structure in `pInfo->src` was
originally built with a `type` of
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](resources.html#VkAccelerationStructureTypeNV),
...
[VkAccelerationStructureCreateInfoKHR](resources.html#VkAccelerationStructureCreateInfoKHR)::`type` equal to either
...
structure, `dst` **must** have been created with a value of
[VkAccelerationStructureCreateInfoKHR](resources.html#VkAccelerationStructureCreateInfoKHR)::`type` equal to either
[VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR](resources.html#VkAccelerationStructureTypeNV) or
[VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR](resources.html#VkAccelerationStructureTypeNV).
...
value in [VkAccelerationStructureSerializedBlockTypeKHR](#VkAccelerationStructureSerializedBlockTypeKHR)
...
[vkGetBufferDeviceAddressKHR](resources.html#vkGetBufferDeviceAddressKHR) for the underlying buffer objects of
[compatible micromaps](#serialized-as-header) constructed on the
[VkDevice](devsandqueues.html#VkDevice) when the command is executed
...
[](#VUID-VkClusterAccelerationStructureCommandsInfoNV-addressResolutionFlags-parameter) VUID-VkClusterAccelerationStructureCommandsInfoNV-addressResolutionFlags-parameter
 ...
 If `addressResolutionFlags` is not `0`, `addressResolutionFlags` **must** be a valid combination of [VkClusterAccelerationStructureAddressResolutionFlagBitsNV](#VkClusterAccelerationStructureAddressResolutionFlagBitsNV) values
...
[](#VUID-VkClusterAccelerationStructureBuildTriangleClusterInfoNV-clusterFlags-parameter) VUID-VkClusterAccelerationStructureBuildTriangleClusterInfoNV-clusterFlags-parameter
 ...
 If `clusterFlags` is not `0`, `clusterFlags` **must** be a valid combination of [VkClusterAccelerationStructureClusterFlagBitsNV](#VkClusterAccelerationStructureClusterFlagBitsNV) values
...
[](#VUID-VkPartitionedAccelerationStructureWriteInstanceDataNV-instanceFlags-parameter) VUID-VkPartitionedAccelerationStructureWriteInstanceDataNV-instanceFlags-parameter
 ...
 If `instanceFlags` is not `0`, `instanceFlags` **must** be a valid combination of [VkPartitionedAccelerationStructureInstanceFlagBitsNV](#VkPartitionedAccelerationStructureInstanceFlagBitsNV) values
...
|  | This functionality is superseded by [vkCmdBuildAccelerationStructuresKHR](#vkCmdBuildAccelerationStructuresKHR). See [Legacy Functionality](../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
* 
[](#VUID-vkBuildAccelerationStructuresKHR-pInfos-03708) VUID-vkBuildAccelerationStructuresKHR-pInfos-03708
...
* 
[](#VUID-vkBuildAccelerationStructuresKHR-pInfos-03707) VUID-vkBuildAccelerationStructuresKHR-pInfos-03707
...
* 
[](#VUID-vkBuildAccelerationStructuresKHR-pInfos-03709) VUID-vkBuildAccelerationStructuresKHR-pInfos-03709
...
* 
[](#VUID-vkBuildAccelerationStructuresKHR-pInfos-11702) VUID-vkBuildAccelerationStructuresKHR-pInfos-11702
...
* 
[](#VUID-vkBuildAccelerationStructuresKHR-pInfos-11705) VUID-vkBuildAccelerationStructuresKHR-pInfos-11705
...
|  | This functionality is superseded by [vkCmdCopyAccelerationStructureKHR](#vkCmdCopyAccelerationStructureKHR). See [Legacy Functionality](../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
* 
[](#VUID-vkCopyAccelerationStructureKHR-src-11586) VUID-vkCopyAccelerationStructureKHR-src-11586

The source acceleration structure `pInfo->src` **must** have been
constructed prior to the execution of this command

* 
[](#VUID-vkCopyAccelerationStructureKHR-src-11587) VUID-vkCopyAccelerationStructureKHR-src-11587
...
|  | This functionality is superseded by [vkCmdCopyMemoryToAccelerationStructureKHR](#vkCmdCopyMemoryToAccelerationStructureKHR). See [Legacy Functionality](../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
|  | This functionality is superseded by [vkCmdCopyAccelerationStructureToMemoryKHR](#vkCmdCopyAccelerationStructureToMemoryKHR). See [Legacy Functionality](../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
|  | This functionality is superseded by [vkCmdWriteAccelerationStructuresPropertiesKHR](#vkCmdWriteAccelerationStructuresPropertiesKHR). See [Legacy Functionality](../appendices/legacy.html#legacy-host-builds) for more information. |
| --- | --- |
...
* 
[](#VUID-vkWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-12425) VUID-vkWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-12425
...
* 
[](#VUID-vkWriteAccelerationStructuresPropertiesKHR-buffer-03736) VUID-vkWriteAccelerationStructuresPropertiesKHR-buffer-03736
...
* 
[](#VUID-vkWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-11591) VUID-vkWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-11591
