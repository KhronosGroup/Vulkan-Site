...
- [Consecutive Binding Updates](#descriptors-sets-updates-consecutive)
- [Consecutive_Binding_Updates](#descriptors-sets-updates-consecutive)
...
[](#VUID-VkDescriptorSetLayoutCreateInfo-flags-parameter) VUID-VkDescriptorSetLayoutCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkDescriptorSetLayoutCreateFlagBits](#VkDescriptorSetLayoutCreateFlagBits) values
...
`descriptorCount` is not `0`, then `stageFlags` **must** be 0 or a
valid combination of [VK_SHADER_STAGE_VERTEX_BIT](pipelines.html#VkShaderStageFlagBits),
...
[VK_DESCRIPTOR_TYPE_SAMPLER](descriptors.html#VkDescriptorType) and
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) accessible to any given
shader stage across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxPerStageDescriptorSamplers`](limits.html#limits-maxPerStageDescriptorSamplers) and
[    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxPerStageDescriptorUpdateAfterBindSamplers`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindSamplers)

* 
[](#VUID-VkPipelineLayoutCreateInfo-descriptorType-03023) VUID-VkPipelineLayoutCreateInfo-descriptorType-03023

The total number of descriptors with a `descriptorType` of
[VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) and
[VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) accessible to any given
shader stage across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxPerStageDescriptorUniformBuffers`](limits.html#limits-maxPerStageDescriptorUniformBuffers)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxPerStageDescriptorUpdateAfterBindUniformBuffers`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindUniformBuffers)

* 
[](#VUID-VkPipelineLayoutCreateInfo-descriptorType-03024) VUID-VkPipelineLayoutCreateInfo-descriptorType-03024

The total number of descriptors with a `descriptorType` of
[VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) and
[VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) accessible to any given
shader stage across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxPerStageDescriptorStorageBuffers`](limits.html#limits-maxPerStageDescriptorStorageBuffers)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxPerStageDescriptorUpdateAfterBindStorageBuffers`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindStorageBuffers)
...
shader stage across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxPerStageDescriptorSampledImages`](limits.html#limits-maxPerStageDescriptorSampledImages)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxPerStageDescriptorUpdateAfterBindSampledImages`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindSampledImages)

* 
[](#VUID-VkPipelineLayoutCreateInfo-descriptorType-03026) VUID-VkPipelineLayoutCreateInfo-descriptorType-03026

The total number of descriptors with a `descriptorType` of
[VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType), and
[VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) accessible to any given
shader stage across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxPerStageDescriptorStorageImages`](limits.html#limits-maxPerStageDescriptorStorageImages)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxPerStageDescriptorUpdateAfterBindStorageImages`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindStorageImages)
...
equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxPerStageDescriptorInputAttachments`](limits.html#limits-maxPerStageDescriptorInputAttachments)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxPerStageDescriptorUpdateAfterBindInputAttachments`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindInputAttachments)
...
[    `VkPhysicalDeviceInlineUniformBlockProperties`::`maxPerStageDescriptorInlineUniformBlocks`](devsandqueues.html#limits-maxPerStageDescriptorInlineUniformBlocks)
and [    `VkPhysicalDeviceInlineUniformBlockProperties`::`maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks`](devsandqueues.html#limits-maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks)
...
[    `VkPhysicalDeviceMaintenance7PropertiesKHR`::`maxDescriptorSetTotalBuffersDynamic`](limits.html#limits-maxDescriptorSetTotalBuffersDynamic)
and [    `VkPhysicalDeviceMaintenance7PropertiesKHR`::`maxDescriptorSetUpdateAfterBindTotalBuffersDynamic`](limits.html#limits-maxDescriptorSetUpdateAfterBindTotalBuffersDynamic)
...
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) accessible across all
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxDescriptorSetSamplers`](limits.html#limits-maxDescriptorSetSamplers) and
[    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindSamplers`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindSamplers)

* 
[](#VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03037) VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03037

The total number of descriptors of the type
[VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) accessible across all shader
stages and across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxDescriptorSetUniformBuffers`](limits.html#limits-maxDescriptorSetUniformBuffers) and
[    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindUniformBuffers`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindUniformBuffers)
...
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of
[    `VkPhysicalDeviceLimits`::`maxDescriptorSetUniformBuffersDynamic`](limits.html#limits-maxDescriptorSetUniformBuffersDynamic)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindUniformBuffersDynamic`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindUniformBuffersDynamic)
...
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of
[    `VkPhysicalDeviceMaintenance7PropertiesKHR`::`maxDescriptorSetTotalUniformBuffersDynamic`](limits.html#limits-maxDescriptorSetTotalUniformBuffersDynamic)
and [    `VkPhysicalDeviceMaintenance7PropertiesKHR`::`maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic`](limits.html#limits-maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic)

* 
[](#VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03039) VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03039

The total number of descriptors of the type
[VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) accessible across all shader
stages and across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxDescriptorSetStorageBuffers`](limits.html#limits-maxDescriptorSetStorageBuffers) and
[    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindStorageBuffers`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindStorageBuffers)
...
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of
[    `VkPhysicalDeviceLimits`::`maxDescriptorSetStorageBuffersDynamic`](limits.html#limits-maxDescriptorSetStorageBuffersDynamic)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindStorageBuffersDynamic`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindStorageBuffersDynamic)
...
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of
[    `VkPhysicalDeviceMaintenance7PropertiesKHR`::`maxDescriptorSetTotalStorageBuffersDynamic`](limits.html#limits-maxDescriptorSetTotalStorageBuffersDynamic)
and [    `VkPhysicalDeviceMaintenance7PropertiesKHR`::`maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic`](limits.html#limits-maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic)
...
[VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) accessible across all
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxDescriptorSetSampledImages`](limits.html#limits-maxDescriptorSetSampledImages) and
[    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindSampledImages`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindSampledImages)
...
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxDescriptorSetStorageImages`](limits.html#limits-maxDescriptorSetStorageImages) and
[    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindStorageImages`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindStorageImages)
...
stages and across all elements of `pSetLayouts` **must** be less than
or equal to the maximum of [    `VkPhysicalDeviceLimits`::`maxDescriptorSetInputAttachments`](limits.html#limits-maxDescriptorSetInputAttachments)
and [    `VkPhysicalDeviceDescriptorIndexingProperties`::`maxDescriptorSetUpdateAfterBindInputAttachments`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindInputAttachments)
...
shader stages and across all elements of `pSetLayouts` **must** be less
than or equal to the maximum of
[    `VkPhysicalDeviceInlineUniformBlockProperties`::`maxDescriptorSetInlineUniformBlocks`](devsandqueues.html#limits-maxDescriptorSetInlineUniformBlocks)
and [    `VkPhysicalDeviceInlineUniformBlockProperties`::`maxDescriptorSetUpdateAfterBindInlineUniformBlocks`](devsandqueues.html#limits-maxDescriptorSetUpdateAfterBindInlineUniformBlocks)
...
given shader stage across all elements of `pSetLayouts` **must** be
less than or equal to
[](limits.html#limits-maxPerStageDescriptorAccelerationStructures)[VkPhysicalDeviceAccelerationStructurePropertiesKHR](limits.html#VkPhysicalDeviceAccelerationStructurePropertiesKHR)::`maxPerStageDescriptorAccelerationStructures`
...
[](limits.html#limits-maxPerStageDescriptorAccelerationStructures)[VkPhysicalDeviceAccelerationStructurePropertiesKHR](limits.html#VkPhysicalDeviceAccelerationStructurePropertiesKHR)::`maxPerStageDescriptorAccelerationStructures`
and [](limits.html#limits-maxPerStageDescriptorUpdateAfterBindAccelerationStructures)[VkPhysicalDeviceAccelerationStructurePropertiesKHR](limits.html#VkPhysicalDeviceAccelerationStructurePropertiesKHR)::`maxPerStageDescriptorUpdateAfterBindAccelerationStructures`
...
less than or equal to [](limits.html#limits-maxDescriptorSetAccelerationStructures)[VkPhysicalDeviceAccelerationStructurePropertiesKHR](limits.html#VkPhysicalDeviceAccelerationStructurePropertiesKHR)::`maxDescriptorSetAccelerationStructures`
...
all shader stages and across all elements of `pSetLayouts` **must** be
less than or equal to the maximum of
[](limits.html#limits-maxDescriptorSetAccelerationStructures)[VkPhysicalDeviceAccelerationStructurePropertiesKHR](limits.html#VkPhysicalDeviceAccelerationStructurePropertiesKHR)::`maxDescriptorSetAccelerationStructures`
and [](limits.html#limits-maxDescriptorSetUpdateAfterBindAccelerationStructures)[VkPhysicalDeviceAccelerationStructurePropertiesKHR](limits.html#VkPhysicalDeviceAccelerationStructurePropertiesKHR)::`maxDescriptorSetUpdateAfterBindAccelerationStructures`
...
accessible across all shader stages and across all elements of
`pSetLayouts` **must** be less than or equal to
[](limits.html#limits-maxDescriptorSetStorageTensors)[VkPhysicalDeviceTensorPropertiesARM](limits.html#VkPhysicalDeviceTensorPropertiesARM)::`maxDescriptorSetStorageTensors`
...
to the maximum of [](limits.html#limits-maxDescriptorSetStorageTensors)[VkPhysicalDeviceTensorPropertiesARM](limits.html#VkPhysicalDeviceTensorPropertiesARM)::`maxDescriptorSetStorageTensors`
and [](limits.html#limits-maxDescriptorSetUpdateAfterBindStorageTensors)[VkPhysicalDeviceTensorPropertiesARM](limits.html#VkPhysicalDeviceTensorPropertiesARM)::`maxDescriptorSetUpdateAfterBindStorageTensors`
...
the maximum of [    `VkPhysicalDeviceTensorPropertiesARM`::`maxPerStageDescriptorSetStorageTensors`](limits.html#limits-maxPerStageDescriptorSetStorageTensors)
and [    `VkPhysicalDeviceTensorPropertiesARM`::`maxPerStageDescriptorUpdateAfterBindStorageTensors`](limits.html#limits-maxPerStageDescriptorUpdateAfterBindStorageTensors)

* 
[](#VUID-VkPipelineLayoutCreateInfo-flags-13352) VUID-VkPipelineLayoutCreateInfo-flags-13352

If `flags` has
[VK_PIPELINE_LAYOUT_CREATE_NO_TASK_SHADER_BIT_KHR](#VkPipelineLayoutCreateFlagBits) set, then
[VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT](#VkPipelineLayoutCreateFlagBits) **must** also be
set
...
[](#VUID-VkPipelineLayoutCreateInfo-flags-parameter) VUID-VkPipelineLayoutCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineLayoutCreateFlagBits](#VkPipelineLayoutCreateFlagBits) values
...
typedef enum VkPipelineLayoutCreateFlagBits {
  // Provided by VK_KHR_maintenance11 with VK_EXT_shader_object, VK_EXT_graphics_pipeline_library
    VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT = 0x00000002,
  // Provided by VK_KHR_maintenance11 with VK_EXT_shader_object and (VK_EXT_mesh_shader or VK_NV_mesh_shader)
...
* 
[VK_PIPELINE_LAYOUT_CREATE_NO_TASK_SHADER_BIT_KHR](#VkPipelineLayoutCreateFlagBits), when used in
combination with
[VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT](#VkPipelineLayoutCreateFlagBits), specifies that
this pipeline layout will only be used to draw with shader objects
created with [VK_SHADER_CREATE_NO_TASK_SHADER_BIT_EXT](shaders.html#VkShaderCreateFlagBitsEXT).
...
[](#VUID-VkDescriptorPoolCreateInfo-flags-parameter) VUID-VkDescriptorPoolCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkDescriptorPoolCreateFlagBits](#VkDescriptorPoolCreateFlagBits) values
...
| --- | --- |
image samplers with [Y′CBCR conversion](samplers.html#samplers-YCbCr-conversion), an
...
property to conservatively size the `descriptorCount` value instead of
querying `combinedImageSamplerDescriptorCount` for each format.

Applications **must** use `maxCombinedImageSamplerDescriptorCount` to size
the `descriptorCount` value for image samplers with an
[Android external format](memory.html#memory-external-android-hardware-buffer-external-formats) as it is not possible to query
`combinedImageSamplerDescriptorCount` for those formats. |
