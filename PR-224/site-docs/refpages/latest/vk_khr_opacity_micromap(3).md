...
requires the shader or pipeline to declare that it does so.
Traversal performed by [pipeline trace ray](../../../../spec/latest/appendices/glossary.html#glossary-pipeline-trace-ray)
instructions requires the pipeline to have been created with
[VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR](VkPipelineCreateFlagBits.html).
Traversal performed by `OpRayQueryProceedKHR` instead requires the shader
to declare the `OpacityMicromapIdKHR` execution mode, added by
`SPV_KHR_opacity_micromap`, with its specialization-constant operand equal
to [VK_TRUE](VK_TRUE.html).
See [Ray Opacity Micromap](../../../../spec/latest/chapters/raytraversal.html#ray-opacity-micromap) for details.
...
If [Vulkan Version 1.4](../../../../spec/latest/appendices/versions.html#versions-1.4) or [VK_KHR_extended_flags](VK_KHR_extended_flags.html) or [VK_KHR_maintenance5](VK_KHR_maintenance5.html) is supported:
