...
[](#VUID-VkVideoProfileInfoKHR-chromaBitDepth-parameter) VUID-VkVideoProfileInfoKHR-chromaBitDepth-parameter
 ...
 If `chromaBitDepth` is not `0`, `chromaBitDepth` **must** be a valid combination of [VkVideoComponentBitDepthFlagBitsKHR](VkVideoComponentBitDepthFlagBitsKHR.html) values
