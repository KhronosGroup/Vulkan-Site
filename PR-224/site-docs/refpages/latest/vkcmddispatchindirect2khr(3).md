...
not enabled, then any [VkImageView](VkImageView.html) being sampled as a result of
...
[VK_PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT](VkPipelineCreateFlagBits.html),
or a [VkShaderEXT](VkShaderEXT.html) created with a `VkDescriptorSetLayout` that
was created with
