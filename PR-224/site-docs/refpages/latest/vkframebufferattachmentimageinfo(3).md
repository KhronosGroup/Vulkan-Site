...
by [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html)::`flags`.
...
[](#VUID-VkFramebufferAttachmentImageInfo-pNext-pNext) VUID-VkFramebufferAttachmentImageInfo-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkImageCreateFlags2CreateInfoKHR](VkImageCreateFlags2CreateInfoKHR.html) or [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html)
