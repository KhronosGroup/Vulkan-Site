...
the
[`VkPhysicalDeviceOpacityMicromapFeaturesEXT`::`micromapCaptureReplay`](../../../../spec/latest/chapters/features.html#features-micromapCaptureReplayEXT)
...
[VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT](VkMicromapCreateFlagBitsEXT.html) included in
`createFlags`.
...
If `createFlags` includes
[VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT](VkMicromapCreateFlagBitsEXT.html) and
...
[](#VUID-VkMicromapCreateInfoEXT-createFlags-parameter) VUID-VkMicromapCreateInfoEXT-createFlags-parameter
 ...
 If `createFlags` is not `0`, `createFlags` **must** be a valid combination of [VkMicromapCreateFlagBitsEXT](VkMicromapCreateFlagBitsEXT.html) values
