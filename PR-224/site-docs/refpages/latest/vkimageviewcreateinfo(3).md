...
Otherwise,
    `format` **must** be [compatible](../../../../spec/latest/chapters/formats.html#formats-compatibility-classes) with
    the `format` of `image`.
...
`subresourceRange.aspectMask` **must** [be    valid](../../../../spec/latest/chapters/resources.html#resources-valid-aspect-mask) for the `format` the `image` was created with
...
[](#VUID-VkImageViewCreateInfo-flags-parameter) VUID-VkImageViewCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkImageViewCreateFlagBits](VkImageViewCreateFlagBits.html) values
