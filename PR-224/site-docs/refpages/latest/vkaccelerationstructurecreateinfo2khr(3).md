...
[](#VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-parameter) VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-parameter
 ...
 If `createFlags` is not `0`, `createFlags` **must** be a valid combination of [VkAccelerationStructureCreateFlagBitsKHR](VkAccelerationStructureCreateFlagBitsKHR.html) values
