...
[](#VUID-VkMemoryBarrierAccessFlags3KHR-srcAccessMask3-parameter) VUID-VkMemoryBarrierAccessFlags3KHR-srcAccessMask3-parameter
 ...
 If `srcAccessMask3` is not `0`, `srcAccessMask3` **must** be a valid combination of [VkAccessFlagBits3KHR](VkAccessFlagBits3KHR.html) values
...
[](#VUID-VkMemoryBarrierAccessFlags3KHR-dstAccessMask3-parameter) VUID-VkMemoryBarrierAccessFlags3KHR-dstAccessMask3-parameter
 ...
 If `dstAccessMask3` is not `0`, `dstAccessMask3` **must** be a valid combination of [VkAccessFlagBits3KHR](VkAccessFlagBits3KHR.html) values
