...
[](#VUID-VkVideoEncodeUsageInfoKHR-videoUsageHints-parameter) VUID-VkVideoEncodeUsageInfoKHR-videoUsageHints-parameter
 ...
 If `videoUsageHints` is not `0`, `videoUsageHints` **must** be a valid combination of [VkVideoEncodeUsageFlagBitsKHR](VkVideoEncodeUsageFlagBitsKHR.html) values

* 
[](#VUID-VkVideoEncodeUsageInfoKHR-videoContentHints-parameter) VUID-VkVideoEncodeUsageInfoKHR-videoContentHints-parameter

 If `videoContentHints` is not `0`, `videoContentHints` **must** be a valid combination of [VkVideoEncodeContentFlagBitsKHR](VkVideoEncodeContentFlagBitsKHR.html) values
