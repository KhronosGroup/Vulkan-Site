...
[](#VUID-VkPipelineShaderStageCreateInfo-flags-parameter) VUID-VkPipelineShaderStageCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineShaderStageCreateFlagBits](VkPipelineShaderStageCreateFlagBits.html) values
