...
* 
[](#VUID-RuntimeSpirv-maxClipDistances-00708) VUID-RuntimeSpirv-maxClipDistances-00708

If `VkPhysicalDeviceLimits`::`maxClipDistances` is not zero,
then any entry point interface variable declared with the
`ClipDistance` `BuiltIn` decoration, **must** not have an array size
greater than `VkPhysicalDeviceLimits`::`maxClipDistances`

* 
[](#VUID-RuntimeSpirv-maxCullDistances-00709) VUID-RuntimeSpirv-maxCullDistances-00709

If `VkPhysicalDeviceLimits`::`maxCullDistances` is not zero,
then any entry point interface variable declared with the
`CullDistance` `BuiltIn` decoration, **must** not have an array size
greater than `VkPhysicalDeviceLimits`::`maxCullDistances`

* 
[](#VUID-RuntimeSpirv-maxCombinedClipAndCullDistances-00710) VUID-RuntimeSpirv-maxCombinedClipAndCullDistances-00710

If `VkPhysicalDeviceLimits`::`maxCombinedClipAndCullDistances`
is not zero, then any entry point interface variable declared with the
`ClipDistance` `BuiltIn` and `CullDistance` `BuiltIn`
decoration **must** not have array sizes which sum to more than
`VkPhysicalDeviceLimits`::`maxCombinedClipAndCullDistances`

* 
[](#VUID-RuntimeSpirv-maxClipDistances-08448) VUID-RuntimeSpirv-maxClipDistances-08448

If `VkPhysicalDeviceLimits`::`maxClipDistances` is zero, then
entry point interface variables declared with the `ClipDistance`
`BuiltIn` decoration **must** not be statically accessed

* 
[](#VUID-RuntimeSpirv-maxCullDistances-08449) VUID-RuntimeSpirv-maxCullDistances-08449

If `VkPhysicalDeviceLimits`::`maxCullDistances` is zero, then
entry point interface variables declared with the `CullDistance`
`BuiltIn` decoration **must** not be statically accessed
...
if the [](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixProperties2EXT)[VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT](VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT.html)::`cooperativeMatrixProperties2`
feature is not enabled,
the type **must** match one of the supported
[VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) structures as defined in
[    VkCooperativeMatrixPropertiesKHR Type Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties-khr-type-matching)
...
[VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) structure as defined in
[    VkCooperativeMatrixPropertiesKHR Multiply-Add Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties-khr-muladd-matching)
...
[](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixProperties2EXT)[VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT](VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT.html)::`cooperativeMatrixProperties2`
feature is enabled
and the [    `cooperativeMatrixFlexibleDimensions`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixFlexibleDimensions) feature is not enabled
then the type **must** either match one of the supported
[VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) structures as defined in
[    VkCooperativeMatrixPropertiesKHR Type Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties-khr-type-matching), or match one of the
supported [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html) structures as defined
in [    VkCooperativeMatrixProperties2EXT Type Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties2-type-matching)
...
feature is enabled
and the [    `cooperativeMatrixFlexibleDimensions`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixFlexibleDimensions) feature is not enabled
then the operands **must** either match one of the supported
[VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) structures as defined in
[    VkCooperativeMatrixPropertiesKHR Multiply-Add Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties-khr-muladd-matching), or match one
of the supported [VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html) structures as
defined in [    VkCooperativeMatrixProperties2EXT Multiply-Add Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties2-muladd-matching)

[](#VUID-RuntimeSpirv-cooperativeMatrixFlexibleDimensions-10165) VUID-RuntimeSpirv-cooperativeMatrixFlexibleDimensions-10165

For `OpTypeCooperativeMatrixKHR`, if the
[    `cooperativeMatrixFlexibleDimensions`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixFlexibleDimensions) feature is enabled, the type
**must** match one of the following:

* 
A supported [VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) structure as defined
in [     VkCooperativeMatrixPropertiesKHR Type Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties-khr-type-matching)

* 
If the [     `cooperativeMatrixProperties2`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixProperties2EXT) feature is enabled, a supported
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html) structure as defined in
[     VkCooperativeMatrixProperties2EXT Type Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties2-type-matching)

* 
A supported [VkCooperativeMatrixFlexibleDimensionsPropertiesNV](VkCooperativeMatrixFlexibleDimensionsPropertiesNV.html)
structure as defined in
[     VkCooperativeMatrixFlexibleDimensionsPropertiesNV Type Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-flexible-dimensions-properties-type-matching)
...
operands **must** match one of the following:

* 
A supported [VkCooperativeMatrixPropertiesKHR](VkCooperativeMatrixPropertiesKHR.html) structure as defined
in [     VkCooperativeMatrixPropertiesKHR Multiply-Add Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties-khr-muladd-matching)

* 
If the [     `cooperativeMatrixProperties2`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixProperties2EXT) feature is enabled, a supported
[VkCooperativeMatrixProperties2EXT](VkCooperativeMatrixProperties2EXT.html) structure as defined in
[     VkCooperativeMatrixProperties2EXT Multiply-Add Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-properties2-muladd-matching)

* 
A supported [VkCooperativeMatrixFlexibleDimensionsPropertiesNV](VkCooperativeMatrixFlexibleDimensionsPropertiesNV.html)
structure as defined in
VkCooperativeMatrixFlexibleDimensionsPropertiesNV
[     Multiply-Add Matching](../../../../spec/latest/chapters/shaders.html#shaders-cooperative-matrix-flexible-dimensions-properties-muladd-matching)
...
If the [    `cooperativeMatrixFlexibleDimensions`](../../../../spec/latest/chapters/features.html#features-cooperativeMatrixFlexibleDimensions) feature is enabled, all
`OpTypeCooperativeMatrixKHR` dimensions **must** be less than or equal
to
...
specialization constant operand equal to [VK_TRUE](VK_TRUE.html), the pipeline
...
or `OpImageGatherQCOM`
    ...
    [`minTexelGatherOffset`](../../../../spec/latest/chapters/limits.html#limits-minTexelGatherOffset)
...
or `OpImageGatherQCOM`
    ...
    [`maxTexelGatherOffset`](../../../../spec/latest/chapters/limits.html#limits-maxTexelGatherOffset)
...
[`maxComputeSharedMemorySize`](../../../../spec/latest/chapters/limits.html#limits-maxComputeSharedMemorySize)
minus
[`splitBarrierReservedSharedMemory`](../../../../spec/latest/chapters/limits.html#limits-splitBarrierReservedSharedMemory)
...
**must** be less than or equal to
[VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM](VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM.html)::`maxShaderWaitQueues`
...
[Image Format and Type Matching Between    SPIR-V Image Formats and Vulkan Formats](../../../../spec/latest/appendices/spirvenv.html#spirvenv-format-type-matching)
...
than or equal to [`maxPushDataSize`](../../../../spec/latest/chapters/limits.html#limits-maxPushDataSize)
