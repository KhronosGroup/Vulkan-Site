...
[](#VUID-VkPipelineDepthStencilStateCreateInfo-flags-parameter) VUID-VkPipelineDepthStencilStateCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineDepthStencilStateCreateFlagBits](VkPipelineDepthStencilStateCreateFlagBits.html) values
