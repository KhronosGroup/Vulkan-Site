...
* 
[VK_QCOM_tile_properties](../../../../refpages/latest/refpages/source/VK_QCOM_tile_properties.html) which exposes tile locations
and dimensions to the application.

* 
[VK_KHR_dynamic_rendering_local_read](../../../../refpages/latest/refpages/source/VK_KHR_dynamic_rendering_local_read.html)
...
* 
Fragment shaders can declare [tile image attachment](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-attachment-access)
...
* 
[Tile aprons](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-aprons) can be enabled and pixels in the apron
region can be accessed by the fragment shader.

* 
A new state command is added that enables/disables
[per-tile execution model](../../../../spec/latest/chapters/renderpass.html#renderpass-per-tile-execution-model).
...
This includes load/store/sample of [tile image attachments](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-attachment-access),
[built-in input variables](#spirv-changes), and [tile aprons](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-aprons).
...
[tile apron](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-aprons).
...
Within a render pass that [enables tile shading](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading),
the [per-tile execution mode](../../../../spec/latest/chapters/renderpass.html#renderpass-per-tile-execution-model)
...
[Per-Tile Command Restrictions](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-command-restrictions) apply.
...
When [per-tile execution mode](../../../../spec/latest/chapters/renderpass.html#renderpass-per-tile-execution-model)
...
Where *per-tile execution model* is enabled the following are disallowed:
  ...
  * Access of an attachment with layout `VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL`
    as provided by [VK_EXT_attachment_feedback_loop_layout](../../../../refpages/latest/refpages/source/VK_EXT_attachment_feedback_loop_layout.html).
...
[VK_ANDROID_external_format_resolve](../../../../refpages/latest/refpages/source/VK_ANDROID_external_format_resolve.html).
...
[VK_QCOM_tile_properties](../../../../refpages/latest/refpages/source/VK_QCOM_tile_properties.html)
...
of two and less than or equal to the [maxTileShadingRate](../../../../spec/latest/chapters/limits.html#limits-maxTileShadingRate) limit.
...
[Tile attachment](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-attachment-access) variables are declared
...
* 
If the [tile apron](../../../../spec/latest/chapters/renderpass.html#renderpass-tile-shading-aprons) has width or height greater than zero, then loads
...
be tile-sized regions, where [VK_QCOM_tile_properties](../../../../refpages/latest/refpages/source/VK_QCOM_tile_properties.html)
...
[per-tile execution](../../../../spec/latest/chapters/renderpass.html#renderpass-per-tile-execution-model) is enabled.
...
[VK_QCOM_tile_properties](../../../../refpages/latest/refpages/source/VK_QCOM_tile_properties.html) reports
...
[per-tile execution model](../../../../spec/latest/chapters/renderpass.html#renderpass-per-tile-execution-model), then
...
[per-tile execution mode](../../../../spec/latest/chapters/renderpass.html#renderpass-per-tile-execution-model) is enabled. Similarly,
