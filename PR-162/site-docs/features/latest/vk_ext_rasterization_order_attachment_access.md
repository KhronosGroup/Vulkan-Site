...
- [4.3. What is the interaction with the VK_EXT_shader_object extension?](#_what_is_the_interaction_with_the_vk_ext_shader_object_extension)
- [4.3._What_is_the_interaction_with_the_VK_EXT_shader_object_extension?](#_what_is_the_interaction_with_the_vk_ext_shader_object_extension)
...
For simplicity, this proposal extends the original render pass API and not the [VK_KHR_dynamic_rendering](../../../../refpages/latest/refpages/source/VK_KHR_dynamic_rendering.html) API.
...
Render pass instances begun with `vkCmdBeginRenderingKHR` do not have input attachments and thus a different mechanism was needed to provide similar functionality in this case.
This was provided by `VK_KHR_dynamic_rendering_local_read`, which enables reads from attachments and resources written by previous fragment shaders within a dynamic render pass.
