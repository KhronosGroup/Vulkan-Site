...
They are largely the same as [VK_EXT_descriptor_indexing](../../../../refpages/latest/refpages/source/VK_EXT_descriptor_indexing.html) with all features enabled - indexing may be non-uniform, but does not need the expression to be tagged as non-uniform.
