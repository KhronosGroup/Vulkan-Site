...
[`vkGetPhysicalDeviceSurfaceFormatsKHR`](../../../../refpages/latest/refpages/source/vkGetPhysicalDeviceSurfaceFormatsKHR.html)
...
without a [`VkSurfaceKHR`](../../../../refpages/latest/refpages/source/VkSurfaceKHR.html).
...
* 
[`vkGetPhysicalDeviceSurfacePresentModesKHR`](../../../../refpages/latest/refpages/source/vkGetPhysicalDeviceSurfacePresentModesKHR.html)

* 
`pSurfaceInfo→surface` passed to
[`vkGetPhysicalDeviceSurfaceCapabilities2KHR`](../../../../refpages/latest/refpages/source/vkGetPhysicalDeviceSurfaceCapabilities2KHR.html)
if
[`VkSurfaceProtectedCapabilitiesKHR`](../../../../refpages/latest/refpages/source/VkSurfaceProtectedCapabilitiesKHR.html)
is chained to `pSurfaceCapabilities`.
In this case, only the protected information is populated, while
[`VkSurfaceCapabilities2KHR`](../../../../refpages/latest/refpages/source/VkSurfaceCapabilities2KHR.html)`::surfaceCapabilities`
