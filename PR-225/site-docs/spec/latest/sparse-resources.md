...
with `format`, `type`, `tiling`, and `usage` equal to
...
* 
`usage` is a bitmask of [VkImageUsageFlagBits](resources.html#VkImageUsageFlagBits) describing the
...
[](#VUID-VkPhysicalDeviceSparseImageFormatInfo2-pNext-pNext) VUID-VkPhysicalDeviceSparseImageFormatInfo2-pNext-pNext
 ...
 `pNext` **must** be `NULL` or a pointer to a valid instance of [VkImageUsageFlags2CreateInfoKHR](resources.html#VkImageUsageFlags2CreateInfoKHR)

* 
[](#VUID-VkPhysicalDeviceSparseImageFormatInfo2-sType-unique) VUID-VkPhysicalDeviceSparseImageFormatInfo2-sType-unique
...
[](#VUID-VkSparseMemoryBind-flags-parameter) VUID-VkSparseMemoryBind-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkSparseMemoryBindFlagBits](#VkSparseMemoryBindFlagBits) values
