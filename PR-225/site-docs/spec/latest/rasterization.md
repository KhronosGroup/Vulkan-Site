...
[](#VUID-VkPipelineRasterizationStateCreateInfo-cullMode-parameter) VUID-VkPipelineRasterizationStateCreateInfo-cullMode-parameter
 ...
 If `cullMode` is not `0`, `cullMode` **must** be a valid combination of [VkCullModeFlagBits](#VkCullModeFlagBits) values
...
A size of 1.0 will always be supported - support for additional sizes is
advertised by the [`largePoints`](features.html#features-largePoints) feature and
the [`pointSizeRange`](limits.html#limits-pointSizeRange) and
[`pointSizeGranularity`](limits.html#limits-pointSizeGranularity) limits indicate
the available size range and gradations.
...
// Provided by VK_EXT_extended_dynamic_state3 with VK_VERSION_1_4 or VK_KHR_line_rasterization or VK_EXT_line_rasterization, VK_EXT_shader_object with VK_VERSION_1_4 or VK_KHR_line_rasterization or VK_EXT_line_rasterization
