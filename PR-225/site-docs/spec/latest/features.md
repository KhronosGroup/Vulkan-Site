...
property which indicates the maximum number of descriptors required for
sampled images with [Y′CBCR conversion](samplers.html#samplers-YCbCr-conversion).
...
device-level object by creating a [VkPrivateDataSlot](private_data.html#VkPrivateDataSlot) with
[VK_PRIVATE_DATA_SLOT_CREATE_BASE_OBJECT_HANDLE_BIT_NV](private_data.html#VkPrivateDataSlotCreateFlagBitsEXT) and calling
`vkGetPrivateData`.
...
[](#VUID-VkPhysicalDevicePrivateDataBaseHandleFeaturesNV-sType-sType) VUID-VkPhysicalDevicePrivateDataBaseHandleFeaturesNV-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_BASE_HANDLE_FEATURES_NV](fundamentals.html#VkStructureType)
...
The `VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR` structure
is defined as:

// Provided by VK_KHR_pipeline_library_group_handles
...
// Equivalent to VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR
...
If the `VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR` structure is included in the `pNext` chain of the
[VkPhysicalDeviceFeatures2](#VkPhysicalDeviceFeatures2) structure passed to
[vkGetPhysicalDeviceFeatures2](#vkGetPhysicalDeviceFeatures2), it is filled in to indicate whether each
corresponding feature is supported.
If the application wishes to use a [VkDevice](devsandqueues.html#VkDevice) with any features
described by `VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR`, it **must** add an instance of the structure,
with the desired feature members set to [VK_TRUE](fundamentals.html#VK_TRUE), to the `pNext`
chain of [VkDeviceCreateInfo](devsandqueues.html#VkDeviceCreateInfo) when creating the [VkDevice](devsandqueues.html#VkDevice).
...
* 
[](#VUID-VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR-sType-sType) VUID-VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR-sType-sType

 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_LIBRARY_GROUP_HANDLES_FEATURES_KHR](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE-sType-sType) VUID-VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_ALLOCATION_ALIGNMENT_FEATURES_VALVE](fundamentals.html#VkStructureType)
...
If `[VK_KHR_pipeline_library_group_handles](../appendices/extensions.html#VK_KHR_pipeline_library_group_handles)` is supported,
...
If `[VK_NV_private_data_base_handle](../appendices/extensions.html#VK_NV_private_data_base_handle)` is supported,
[`privateDataBaseHandle`](#features-privateDataBaseHandle) **must** be supported

If `[VK_VALVE_buffer_device_address_allocation_alignment](../appendices/extensions.html#VK_VALVE_buffer_device_address_allocation_alignment)` is supported,
[`VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE`::`bufferDeviceAddressAllocationAlignment`](#features-bufferDeviceAddressAllocationAlignment) **must** be supported
