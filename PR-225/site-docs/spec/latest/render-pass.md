...
- [Access Via Different Image Resources Types](#_access_via_different_image_resources_types)
- [Access_Via_Different_Image_Resources_Types](#_access_via_different_image_resources_types)
...
[VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID](#VkResolveModeFlagBitsKHR), or
its `imageView` member not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), its
`resolveMode` member not set to [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR), and
`resolveImageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), then the
...
and `pDepthAttachment->resolveImageView` is not
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), then `pDepthAttachment->resolveImageView`
**must** have been created with the
[VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT](resources.html#VkImageUsageFlagBits) usage flag set
...
and `pStencilAttachment->resolveImageView` is not
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), then `pStencilAttachment->resolveImageView`
**must** have been created with the
[VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT](resources.html#VkImageUsageFlagBits) usage flag set
...
either its `resolveMode` member set to
[VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID](#VkResolveModeFlagBitsKHR), or
its `imageView` member not set to [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), its
`resolveMode` member not set to [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR), and
`resolveImageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), then the
`resolveImageView` member of that element of `pColorAttachments`
**must** have been created with the
...
`pDepthAttachment->resolveMode` is not [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR),
and `pDepthAttachment->resolveImageView` is not
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), `pDepthAttachment->resolveImageView` **must**
...
`pStencilAttachment->resolveMode` is not [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR),
and `pStencilAttachment->resolveImageView` is not
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), `pStencilAttachment->resolveImageView` **must**
have been created with the
[identity swizzle](resources.html#resources-image-views-identity-mappings)
...
[](#VUID-VkRenderingInfo-flags-parameter) VUID-VkRenderingInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkRenderingFlagBits](#VkRenderingFlagBits) values
...
command buffers, and [vkCmdExecuteCommands](cmdbuffers.html#vkCmdExecuteCommands) is the only valid
command in the command buffer until
[vkCmdEndRendering2KHR](#vkCmdEndRendering2KHR) or
...
* 
[VK_RENDERING_CONTENTS_INLINE_BIT_KHR](#VkRenderingFlagBitsKHR) specifies that contents for
...
contents to be recorded both inline and in secondary command buffers.
...
If `resolveMode` is not [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR),
[multisampled rendering to single-sampled attachments](#multisampled-render-to-single-sampled) is enabled, and `imageView` has a sample
count of [VK_SAMPLE_COUNT_1_BIT](limits.html#VkSampleCountFlagBits), `resolveImageView` **must** be
[VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE).
Otherwise,
`resolveImageView` **must** not be [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE).

If `resolveMode` is not [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR), a
...
* 
`storeOp` is [VK_ATTACHMENT_STORE_OP_STORE](#VkAttachmentStoreOp)
...
* 
`resolveImageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE)

* 
`resolveMode` is not [VK_RESOLVE_MODE_NONE](#VkResolveModeFlagBitsKHR)

* 
`resolveMode` is not [VK_RESOLVE_MODE_CUSTOM_BIT_EXT](#VkResolveModeFlagBitsKHR)
...
[](#VUID-VkRenderingAttachmentInfo-imageView-06136) VUID-VkRenderingAttachmentInfo-imageView-06136
    ...
    If `resolveImageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE),
    `resolveImageLayout` **must** not be [VK_IMAGE_LAYOUT_UNDEFINED](resources.html#VkImageLayout),
    [VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL](resources.html#VkImageLayout),
    [VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL](resources.html#VkImageLayout),
    [VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL](resources.html#VkImageLayout),
[VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT](resources.html#VkImageLayout),
...
[](#VUID-VkRenderingAttachmentInfo-imageView-12470) VUID-VkRenderingAttachmentInfo-imageView-12470

If `imageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), it **must** have been
created with a [VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo)::`viewType` not equal to
[VK_IMAGE_VIEW_TYPE_3D](resources.html#VkImageViewType)

[](#VUID-VkRenderingAttachmentInfo-resolveImageView-12471) VUID-VkRenderingAttachmentInfo-resolveImageView-12471

If `resolveImageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE), it **must** have
been created with a [VkImageViewCreateInfo](resources.html#VkImageViewCreateInfo)::`viewType` not
equal to [VK_IMAGE_VIEW_TYPE_3D](resources.html#VkImageViewType)

[](#VUID-VkRenderingAttachmentInfo-imageView-12486) VUID-VkRenderingAttachmentInfo-imageView-12486

If `imageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE) it **must** only specify a
single mip level

[](#VUID-VkRenderingAttachmentInfo-resolveImageView-12487) VUID-VkRenderingAttachmentInfo-resolveImageView-12487

If `resolveImageView` is not [VK_NULL_HANDLE](../appendices/boilerplate.html#VK_NULL_HANDLE) it **must** only
specify a single mip level
...
[](#VUID-VkRenderingAttachmentFlagsInfoKHR-flags-parameter) VUID-VkRenderingAttachmentFlagsInfoKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkRenderingAttachmentFlagBitsKHR](#VkRenderingAttachmentFlagBitsKHR) values
...
[](#VUID-VkRenderPassCreateInfo-flags-parameter) VUID-VkRenderPassCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkRenderPassCreateFlagBits](#VkRenderPassCreateFlagBits) values
...
[](#VUID-VkAttachmentDescription-flags-parameter) VUID-VkAttachmentDescription-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkAttachmentDescriptionFlagBits](#VkAttachmentDescriptionFlagBits) values
...
[](#VUID-VkSubpassDescription-flags-parameter) VUID-VkSubpassDescription-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkSubpassDescriptionFlagBits](#VkSubpassDescriptionFlagBits) values
...
[](#VUID-VkSubpassDependency-srcStageMask-parameter) VUID-VkSubpassDependency-srcStageMask-parameter
 ...
 If `srcStageMask` is not `0`, `srcStageMask` **must** be a valid combination of [VkPipelineStageFlagBits](synchronization.html#VkPipelineStageFlagBits) values

* 
[](#VUID-VkSubpassDependency-dstStageMask-parameter) VUID-VkSubpassDependency-dstStageMask-parameter

 If `dstStageMask` is not `0`, `dstStageMask` **must** be a valid combination of [VkPipelineStageFlagBits](synchronization.html#VkPipelineStageFlagBits) values

* 
[](#VUID-VkSubpassDependency-srcAccessMask-parameter) VUID-VkSubpassDependency-srcAccessMask-parameter

 If `srcAccessMask` is not `0`, `srcAccessMask` **must** be a valid combination of [VkAccessFlagBits](synchronization.html#VkAccessFlagBits) values

* 
[](#VUID-VkSubpassDependency-dstAccessMask-parameter) VUID-VkSubpassDependency-dstAccessMask-parameter

 If `dstAccessMask` is not `0`, `dstAccessMask` **must** be a valid combination of [VkAccessFlagBits](synchronization.html#VkAccessFlagBits) values

* 
[](#VUID-VkSubpassDependency-dependencyFlags-parameter) VUID-VkSubpassDependency-dependencyFlags-parameter

 If `dependencyFlags` is not `0`, `dependencyFlags` **must** be a valid combination of [VkDependencyFlagBits](synchronization.html#VkDependencyFlagBits) values
...
[](#VUID-vkCmdSetAttachmentFeedbackLoopEnableEXT-aspectMask-parameter) VUID-vkCmdSetAttachmentFeedbackLoopEnableEXT-aspectMask-parameter
 ...
 If `aspectMask` is not `0`, `aspectMask` **must** be a valid combination of [VkImageAspectFlagBits](resources.html#VkImageAspectFlagBits) values
...
[](#VUID-VkFramebufferCreateInfo-flags-parameter) VUID-VkFramebufferCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkFramebufferCreateFlagBits](#VkFramebufferCreateFlagBits) values
...
If the `pNext` chain includes a [VkImageCreateFlags2CreateInfoKHR](resources.html#VkImageCreateFlags2CreateInfoKHR)
structure, `flags` is ignored, and the effective create flags are
defined by [VkImageCreateFlags2CreateInfoKHR](resources.html#VkImageCreateFlags2CreateInfoKHR)::`flags`.
...
by [VkImageUsageFlags2CreateInfoKHR](resources.html#VkImageUsageFlags2CreateInfoKHR)::`flags`.
...
[](#VUID-VkFramebufferAttachmentImageInfo-pNext-pNext) VUID-VkFramebufferAttachmentImageInfo-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkImageCreateFlags2CreateInfoKHR](resources.html#VkImageCreateFlags2CreateInfoKHR) or [VkImageUsageFlags2CreateInfoKHR](resources.html#VkImageUsageFlags2CreateInfoKHR)

* 
[](#VUID-VkFramebufferAttachmentImageInfo-sType-unique) VUID-VkFramebufferAttachmentImageInfo-sType-unique
...
[](#VUID-VkFramebufferAttachmentImageInfo-flags-parameter) VUID-VkFramebufferAttachmentImageInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkImageCreateFlagBits](resources.html#VkImageCreateFlagBits) values
...
If overlapping ranges of a non-attachment image resource is accessed via
different resource types in the same render pass instance, and at least one
of the accesses is a write operation, there is a data race.

For example, a write to a [storage image](descriptors.html#descriptors-storageimage) **may**
not be visible to a subsequent read from a [sampled image](descriptors.html#descriptors-sampledimage).
This is true even if the resources use the same layout, such as
[VK_IMAGE_LAYOUT_GENERAL](resources.html#VkImageLayout).

If the image resource is also used as an attachment in the render pass
instance, the overlapping range is as described for
[feedback loops](#renderpass-feedbackloop).
...
[](#VUID-VkRenderPassTileShadingCreateInfoQCOM-flags-parameter) VUID-VkRenderPassTileShadingCreateInfoQCOM-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkTileShadingRenderPassFlagBitsQCOM](#VkTileShadingRenderPassFlagBitsQCOM) values
...
`OpImage*Gather`,
`OpImageGatherQCOM`,
or `OpImageSparse*Gather`, and with an `Image` operand from storage
class `TileAttachmentQCOM`, the `Coordinate` operand **must** not result
in a any texels accessed that are outside the `renderArea` or outside
the combined extent of the tile and apron.
