...
[](#VUID-VkInstanceCreateInfo-flags-parameter) VUID-VkInstanceCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkInstanceCreateFlagBits](#VkInstanceCreateFlagBits) values
...
* 
[VkComputePipelineCreateInfo](pipelines.html#VkComputePipelineCreateInfo)
...
* 
[VkRayTracingPipelineCreateInfoKHR](pipelines.html#VkRayTracingPipelineCreateInfoKHR)
