...
[](#VUID-VkVideoSessionParametersCreateInfoKHR-flags-parameter) VUID-VkVideoSessionParametersCreateInfoKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkVideoSessionParametersCreateFlagBitsKHR](VkVideoSessionParametersCreateFlagBitsKHR.html) values
