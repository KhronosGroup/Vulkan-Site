...
and the execution of any earlier [vkCmdWaitEvents](vkCmdWaitEvents.html) in
[submission order](../../../../spec/latest/chapters/synchronization.html#synchronization-submission-order) that includes
...
There **must** be an execution dependency between `vkCmdResetEvent2`
and the execution of any earlier [vkCmdWaitEvents2](vkCmdWaitEvents2.html) in
[submission order](../../../../spec/latest/chapters/synchronization.html#synchronization-submission-order) that includes
`event` in its `pEvents` parameter
...
[](#VUID-vkCmdResetEvent2-stageMask-parameter) VUID-vkCmdResetEvent2-stageMask-parameter
 ...
 If `stageMask` is not `0`, `stageMask` **must** be a valid combination of [VkPipelineStageFlagBits2](VkPipelineStageFlagBits2.html) values
