...
If `type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](VkAccelerationStructureTypeKHR.html), the
[`VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](../../../../spec/latest/chapters/features.html#features-micromap)
feature **must** be enabled
...
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](VkAccelerationStructureTypeKHR.html), the
`geometryType` member of elements of either `pGeometries` or
`ppGeometries` **must** be [VK_GEOMETRY_TYPE_MICROMAP_KHR](VkGeometryTypeKHR.html)
...
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](VkAccelerationStructureTypeKHR.html), the
`geometryType` member of elements of either `pGeometries` or
`ppGeometries` **must** not be [VK_GEOMETRY_TYPE_MICROMAP_KHR](VkGeometryTypeKHR.html)
...
If `type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](VkAccelerationStructureTypeKHR.html), `flags`
**must** only include the following bits:

[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_KHR](VkBuildAccelerationStructureFlagBitsKHR.html)

* 
[VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR](VkBuildAccelerationStructureFlagBitsKHR.html)

* 
[VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_KHR](VkBuildAccelerationStructureFlagBitsKHR.html)
...
If `flags` includes
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](VkBuildAccelerationStructureFlagBitsKHR.html), `type`
**must** be [VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](VkAccelerationStructureTypeKHR.html)
...
If `flags` includes
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](VkBuildAccelerationStructureFlagBitsKHR.html), for each
...
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](VkOpacityMicromapFormatKHR.html)
...
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](VkOpacityMicromapFormatKHR.html), its `subdivisionLevel`
member **must** be less than or equal to
[    `maxOpacity4StateSubdivisionLevel`](../../../../spec/latest/chapters/limits.html#limits-maxOpacity4StateSubdivisionLevel)
...
less than or equal to [    `maxOpacityLossy4StateSubdivisionLevel`](../../../../spec/latest/chapters/limits.html#limits-maxOpacity4StateSubdivisionLevel)
...
[    `maxOpacityLossy4StateSubdivisionLevel`](../../../../spec/latest/chapters/limits.html#limits-maxOpacity4StateSubdivisionLevel)
...
[](#VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-parameter) VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBuildAccelerationStructureFlagBitsKHR](VkBuildAccelerationStructureFlagBitsKHR.html) values
