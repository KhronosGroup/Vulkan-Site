...
If `flags` contains
[VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXT](VkPipelineCreateFlagBits2.html) then a
...
[](#VUID-VkDataGraphPipelineCreateInfoARM-flags-parameter) VUID-VkDataGraphPipelineCreateInfoARM-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkPipelineCreateFlagBits2](VkPipelineCreateFlagBits2.html) values
