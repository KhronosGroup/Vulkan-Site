...
`imageUsage` defines the [effective usage flags](../../../../spec/latest/chapters/fundamentals.html#fundamentals-effective-flags) for the swapchain image(s).
...
defined by [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html)::`usage`.
...
or [vkGetPhysicalDeviceImageFormatProperties2](vkGetPhysicalDeviceImageFormatProperties2.html)
...
If the [    `multisampledRenderToSwapchain`](../../../../spec/latest/chapters/features.html#features-multisampledRenderToSwapchain) feature is not enabled,
`flags` **must** not contain
...
[VkSwapchainFlagsSurfaceCapabilitiesEXT](VkSwapchainFlagsSurfaceCapabilitiesEXT.html)::`swapchainSupportedFlags`
...
[](#VUID-VkSwapchainCreateInfoKHR-flags-parameter) VUID-VkSwapchainCreateInfoKHR-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkSwapchainCreateFlagBitsKHR](VkSwapchainCreateFlagBitsKHR.html) values
