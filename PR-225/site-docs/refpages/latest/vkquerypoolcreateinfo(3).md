...
If the [elapsedTimerQuery](../../../../spec/latest/chapters/features.html#features-elapsedTimerQuery) feature is not
...
[VkQueryPoolVideoEncodeFeedbackCreateInfoKHR](VkQueryPoolVideoEncodeFeedbackCreateInfoKHR.html) structure with its
...
[VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](VkVideoEncodeFeedbackFlagBitsKHR.html), or
[VK_VIDEO_ENCODE_FEEDBACK_PICTURE_PARTITION_COUNT_BIT_KHR](VkVideoEncodeFeedbackFlagBitsKHR.html), then
[`videoEncodeFeedback2`](../../../../spec/latest/chapters/features.html#features-videoEncodeFeedback2) **must** be
enabled
...
If `queryType` is [VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR](VkQueryType.html) and
the `pNext` chain includes a
[VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR](VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR.html) structure
...
equal to
[VkVideoEncodeFeedback2CapabilitiesKHR](VkVideoEncodeFeedback2CapabilitiesKHR.html)::`maxPerPartitionFeedbackEntries`,
as returned by [vkGetPhysicalDeviceVideoCapabilitiesKHR](vkGetPhysicalDeviceVideoCapabilitiesKHR.html) for the
[video profile](../../../../spec/latest/chapters/videocoding.html#video-profiles) described by
[VkVideoProfileInfoKHR](VkVideoProfileInfoKHR.html) and its `pNext` chain
...
[VkVideoEncodeFeedback2CapabilitiesKHR](VkVideoEncodeFeedback2CapabilitiesKHR.html)::`supportedPerPartitionEncodeFeedbackFlags`,
as returned by [vkGetPhysicalDeviceVideoCapabilitiesKHR](vkGetPhysicalDeviceVideoCapabilitiesKHR.html) for the
[video profile](../../../../spec/latest/chapters/videocoding.html#video-profiles) described by
[VkVideoProfileInfoKHR](VkVideoProfileInfoKHR.html) and its `pNext` chain
...
[](#VUID-VkQueryPoolCreateInfo-flags-parameter) VUID-VkQueryPoolCreateInfo-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkQueryPoolCreateFlagBits](VkQueryPoolCreateFlagBits.html) values
