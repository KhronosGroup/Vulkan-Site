...
value for [VkVertexInputBindingDivisorDescription](VkVertexInputBindingDivisorDescription.html)::`divisor` is
supported.
...
sampled images with [Y′CBCR conversion](../../../../spec/latest/chapters/samplers.html#samplers-YCbCr-conversion).
