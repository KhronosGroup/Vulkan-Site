...
the [VkMicromapTriangleEXT](VkMicromapTriangleKHR.html) data
...
In practice, compilers compile [VkMicromapTriangleEXT](VkMicromapTriangleKHR.html) to match this
pattern.

For opacity micromaps, the data at `data` is packed as either one bit
per element for [VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT](VkOpacityMicromapFormatKHR.html) or two bits per
element for [VK_OPACITY_MICROMAP_FORMAT_4_STATE_EXT](VkOpacityMicromapFormatKHR.html) and is packed from
...
discussed in [Displacement Micromap Encoding](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#displacement-micromap-encoding).
...
If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](VkMicromapTypeEXT.html), for each
member of `pUsageCounts` or `ppUsageCounts`, `format` **must**
be a valid value from [VkOpacityMicromapFormatEXT](VkOpacityMicromapFormatKHR.html)

* 
[](#VUID-VkMicromapBuildInfoEXT-format-11653) VUID-VkMicromapBuildInfoEXT-format-11653

If `type` is [VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV](VkMicromapTypeEXT.html), for
each member of `pUsageCounts` or `ppUsageCounts`, `format`
**must** be a valid value from [VkDisplacementMicromapFormatNV](VkDisplacementMicromapFormatNV.html)
...
[VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT](VkOpacityMicromapFormatKHR.html), `subdivisionLevel`
**must** be less than or equal to
[](../../../../spec/latest/chapters/limits.html#limits-maxOpacity2StateSubdivisionLevelEXT)[VkPhysicalDeviceOpacityMicromapPropertiesEXT](VkPhysicalDeviceOpacityMicromapPropertiesEXT.html)::`maxOpacity2StateSubdivisionLevel`
...
If `type` is [VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT](VkMicromapTypeEXT.html), for each
member of `pUsageCounts` or `ppUsageCounts`, if `format` is
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_EXT](VkOpacityMicromapFormatKHR.html), `subdivisionLevel`
**must** be less than or equal to
[](../../../../spec/latest/chapters/limits.html#limits-maxOpacity4StateSubdivisionLevelEXT)[VkPhysicalDeviceOpacityMicromapPropertiesEXT](VkPhysicalDeviceOpacityMicromapPropertiesEXT.html)::`maxOpacity4StateSubdivisionLevel`
...
[](#VUID-VkMicromapBuildInfoEXT-flags-parameter) VUID-VkMicromapBuildInfoEXT-flags-parameter
 ...
 If `flags` is not `0`, `flags` **must** be a valid combination of [VkBuildMicromapFlagBitsEXT](VkBuildMicromapFlagBitsEXT.html) values
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/VK_KHR_opacity_micromap/micromaps.html#VkMicromapBuildInfoEXT).
