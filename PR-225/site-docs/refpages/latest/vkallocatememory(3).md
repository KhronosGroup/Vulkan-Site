...
Such alignment **can** be enforced by [vkCreateAccelerationStructure2KHR](vkCreateAccelerationStructure2KHR.html)
which inherits the device address verbatim.
If the parameters define an [import](../../../../spec/latest/chapters/memory.html#memory-import-operation) operation,
and the same memory object is imported into multiple [VkDeviceMemory](VkDeviceMemory.html)
handles,
[VkBufferDeviceAddressAlignmentAllocateInfoVALVE](VkBufferDeviceAddressAlignmentAllocateInfoVALVE.html)::`alignment` **may**
