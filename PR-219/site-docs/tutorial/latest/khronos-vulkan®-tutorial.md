...
The following tutorials were written by Holochip Corporation and released under the [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0):

* 
[Machine learning inference](ML_Inference/introduction.html)

* 
[Vulkan for XR](OpenXR_Vulkan_Spatial_Computing/introduction.html)

* 
[LLM-Assistant Vulkan Development](AI_Assisted_Vulkan/introduction.html)

* 
[Advanced glTF](Advanced_glTF/introduction.html)

* 
[Advanced Vulkan Compute](Advanced_Vulkan_Compute/introduction.html)

* 
[Building a Simple Game Engine](Building_a_Simple_Engine/introduction.html)

* 
[Synchronization](Synchronization/introduction.html)

* 
[Opacity Micromaps mini course](Building_a_Simple_Engine/Courses/Opacity_Micromaps/00_introduction.html)

The following courses were written by Arm Limited and released under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

* 
[SIGGRAPH 2025: Hands-on Vulkan Ray Tracing with Dynamic Rendering](courses/18_Ray_tracing/00_Overview.html)

* 
[SIGGRAPH 2026: How to write a Vulkan application in 2026](courses/siggraph2026_vk_tutorial/00_Overview.html)
...
This tutorial exclusively uses C++ and the Vulkan-Hpp bindings; it does not
provide a parallel C track. We use C++ features like classes and RAII to
...
* 
[Ray Tracing](courses/18_Ray_tracing/00_Overview.html)

* 
[Building a simple game engine](Building_a_Simple_Engine/introduction.html)

* 
[Opacity Micromaps](Building_a_Simple_Engine/Courses/Opacity_Micromaps/00_introduction.html)

* 
[Advanced compute techniques](Advanced_Vulkan_Compute/introduction.html)

* 
[Using new synchronization features](Synchronization/introduction.html)
...
* 
[OpenXR](OpenXR_Vulkan_Spatial_Computing/introduction.html)

* 
[AI-Assisted Vulkan Development](AI_Assisted_Vulkan/introduction.html)
