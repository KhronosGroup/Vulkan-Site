...
For problems with docs.vulkan.org navigation, style, search, and overall
site structure, file an issue here.

Problems with the underlying documentation components should be raised in
